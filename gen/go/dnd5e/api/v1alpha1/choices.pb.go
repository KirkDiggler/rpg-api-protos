...
const (
	...
	// Deprecated: never written and never read. Level-up choices carry
	// CHOICE_SOURCE_CLASS, because the level record already says which level
	// they belong to.
	//
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/choices.proto.
	ChoiceSource_CHOICE_SOURCE_LEVEL_UP ChoiceSource = 6
)
...
type EquipmentItem struct {
	...
	EquipmentDetail *Equipment `protobuf:"bytes,8,opt,name=equipment_detail,json=equipmentDetail,proto3" json:"equipment_detail,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *EquipmentItem) GetEquipmentDetail() *Equipment {
	if x != nil {
...
type EquipmentCategoryChoice struct {
	...
	Options          []*EquipmentItem       `protobuf:"bytes,6,rep,name=options,proto3" json:"options,omitempty"`                                                                                          // Concrete, enriched, eligible options (optional for backward compatibility)
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *EquipmentCategoryChoice) GetOptions() []*EquipmentItem {
	if x != nil {
		return x.Options
	}
	return nil
...
type SpellOptions struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// DEPRECATED: spells travel as ref strings in `available_refs`; producers no
	// longer write this field. The closed enum cannot name a spell the catalog
	// learned after it was generated, which is why the ref strings replace it.
	// Left in place, and left readable, so no client breaks the day the
	// producers stop writing it.
	//
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/choices.proto.
	...
	// THE LIVE FIELD. Canonical spell refs — "dnd5e:spells:vicious-mockery",
	// the full core.Ref.String() the toolkit's own catalog speaks
	// (refs/spells.go). Bare ids such as "vicious-mockery" are invalid.
	//
	// SUCCEEDS `available`, and is not read beside it (Kirk's ruling,
	// rpg-project#397; design rpg-project#405 R8): a ref string and an enum
	// value naming one spell are two names free to disagree, with every reader
	// left to learn which wins. Producers write this one alone. The catalog
	// grows without this contract changing, and a client that cannot resolve a
	// ref shows the ref rather than mistaking it for SPELL_UNSPECIFIED.
	AvailableRefs []string `protobuf:"bytes,4,rep,name=available_refs,json=availableRefs,proto3" json:"available_refs,omitempty"`
	// Automatically granted access, shown as locked options with source labels.
	// These refs are not selectable, do not consume choose_count, and must not
	// be submitted as selections. Producers omit them from available_refs.
	Grants        []*GrantedSpell `protobuf:"bytes,5,rep,name=grants,proto3" json:"grants,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SpellOptions) GetAvailableRefs() []string {
	if x != nil {
		return x.AvailableRefs
	}
	return nil
}

func (x *SpellOptions) GetGrants() []*GrantedSpell {
	if x != nil {
		return x.Grants
	}
	return nil
...
// Provider-authored spell or cantrip grant for a displayed choice.
type GrantedSpell struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SpellRef      string                 `protobuf:"bytes,1,opt,name=spell_ref,json=spellRef,proto3" json:"spell_ref,omitempty"`       // Canonical dnd5e:spells:<id> reference.
	SourceName    string                 `protobuf:"bytes,2,opt,name=source_name,json=sourceName,proto3" json:"source_name,omitempty"` // Display name, e.g. "Life Domain".
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GrantedSpell) Reset() {
	*x = GrantedSpell{}
...
func (x *GrantedSpell) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GrantedSpell) ProtoMessage() {}

func (x *GrantedSpell) ProtoReflect() protoreflect.Message {
	mi := &file_dnd5e_api_v1alpha1_choices_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GrantedSpell.ProtoReflect.Descriptor instead.
func (*GrantedSpell) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_choices_proto_rawDescGZIP(), []int{10}
}

func (x *GrantedSpell) GetSpellRef() string {
	if x != nil {
		return x.SpellRef
	}
	return ""
...
func (x *GrantedSpell) GetSourceName() string {
	if x != nil {
		return x.SourceName
	}
	return ""
...
type SpellSelection struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// DEPRECATED: spells travel as ref strings in `spell_refs`; producers no
	// longer write this field. See SpellOptions.available.
	//
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/choices.proto.
	Spells []Spell `protobuf:"varint,1,rep,packed,name=spells,proto3,enum=dnd5e.api.v1alpha1.Spell" json:"spells,omitempty"`
	// THE LIVE FIELD. Canonical spell refs, the same vocabulary
	// SpellOptions.available_refs offers and the same succession of the closed
	// enum. See that field.
	SpellRefs     []string `protobuf:"bytes,2,rep,name=spell_refs,json=spellRefs,proto3" json:"spell_refs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SpellSelection) GetSpellRefs() []string {
	if x != nil {
		return x.SpellRefs
	}
	return nil
...
func (x *ChoiceData) Reset() {
	*x = ChoiceData{}
	mi := &file_dnd5e_api_v1alpha1_choices_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChoiceData) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_choices_proto_rawDescGZIP(), []int{21}
}
...
type ChoiceData_Name struct {
	Name string `protobuf:"bytes,5,opt,name=name,proto3,oneof"` // For character name
}
...
type ChoiceData_Languages struct {
	Languages *LanguageSelection `protobuf:"bytes,7,opt,name=languages,proto3,oneof"`
}

type ChoiceData_AbilityScores struct {
	AbilityScores *AbilityScores `protobuf:"bytes,8,opt,name=ability_scores,json=abilityScores,proto3,oneof"`
}

type ChoiceData_FightingStyle struct {
	FightingStyle *FightingStyleSelection `protobuf:"bytes,9,opt,name=fighting_style,json=fightingStyle,proto3,oneof"`
}

type ChoiceData_Equipment struct {
	Equipment *EquipmentSelection `protobuf:"bytes,10,opt,name=equipment,proto3,oneof"`
}

type ChoiceData_Background struct {
	Background Background `protobuf:"varint,11,opt,name=background,proto3,enum=dnd5e.api.v1alpha1.Background,oneof"`
}

type ChoiceData_Spells struct {
	Spells *SpellSelection `protobuf:"bytes,12,opt,name=spells,proto3,oneof"`
}

type ChoiceData_Tools struct {
	Tools *ToolSelection `protobuf:"bytes,13,opt,name=tools,proto3,oneof"`
}

type ChoiceData_Expertise struct {
	Expertise *ExpertiseSelection `protobuf:"bytes,14,opt,name=expertise,proto3,oneof"`
}
...
const file_dnd5e_api_v1alpha1_choices_proto_rawDesc = "" +
	"\n" +
	" dnd5e/api/v1alpha1/choices.proto\x12\x12dnd5e.api.v1alpha1\x1a\x1fdnd5e/api/v1alpha1/common.proto\x1a\x1ednd5e/api/v1alpha1/enums.proto\x1a(dnd5e/api/v1alpha1/equipment_types.proto\"\xe3\x05\n" +
	"\x06Choice\x12\x0e\n" +
	...
	"\x10category_choices\x18\x04 \x03(\v2+.dnd5e.api.v1alpha1.EquipmentCategoryChoiceR\x0fcategoryChoices\"\xb0\x03\n" +
	"\rEquipmentItem\x12!\n" +
	...
	"ammunition\x12H\n" +
	"\x10equipment_detail\x18\b \x01(\v2\x1d.dnd5e.api.v1alpha1.EquipmentR\x0fequipmentDetailB\v\n" +
	"\ttype_hint\"\xee\x02\n" +
	...
	"\aoptions\x18\x06 \x03(\v2!.dnd5e.api.v1alpha1.EquipmentItemR\aoptions\"M\n" +
	...
	"\tavailable\x18\x01 \x03(\x0e2!.dnd5e.api.v1alpha1.FightingStyleR\tavailable\"\x9c\x02\n" +
	"\fSpellOptions\x12;\n" +
	"\tavailable\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SpellB\x02\x18\x01R\tavailable\x12\x1f\n" +
	"\vspell_level\x18\x02 \x01(\x05R\n" +
	"spellLevel\x12M\n" +
	"\x0eselection_type\x18\x03 \x01(\x0e2&.dnd5e.api.v1alpha1.SpellSelectionTypeR\rselectionType\x12%\n" +
	"\x0eavailable_refs\x18\x04 \x03(\tR\ravailableRefs\x128\n" +
	"\x06grants\x18\x05 \x03(\v2 .dnd5e.api.v1alpha1.GrantedSpellR\x06grants\"L\n" +
	"\fGrantedSpell\x12\x1b\n" +
	"\tspell_ref\x18\x01 \x01(\tR\bspellRef\x12\x1f\n" +
	...
	"\x05style\x18\x01 \x01(\x0e2!.dnd5e.api.v1alpha1.FightingStyleR\x05style\"f\n" +
	"\x0eSpellSelection\x125\n" +
	"\x06spells\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SpellB\x02\x18\x01R\x06spells\x12\x1d\n" +
	"\n" +
	"spell_refs\x18\x02 \x03(\tR\tspellRefs\"w\n" +
	"\x12ExpertiseSelection\x121\n" +
	"\x06skills\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SkillR\x06skills\x12.\n" +
	"\x05tools\x18\x02 \x03(\x0e2\x18.dnd5e.api.v1alpha1.ToolR\x05tools\"\xd4\x06\n" +
	"\n" +
	"ChoiceData\x12>\n" +
	...
	"\toption_id\x18\x04 \x01(\tR\boptionId\x12\x14\n" +
	"\x04name\x18\x05 \x01(\tH\x00R\x04name\x12<\n" +
	"\x06skills\x18\x06 \x01(\v2\".dnd5e.api.v1alpha1.SkillSelectionH\x00R\x06skills\x12E\n" +
	"\tlanguages\x18\a \x01(\v2%.dnd5e.api.v1alpha1.LanguageSelectionH\x00R\tlanguages\x12J\n" +
	"\x0eability_scores\x18\b \x01(\v2!.dnd5e.api.v1alpha1.AbilityScoresH\x00R\rabilityScores\x12S\n" +
	"\x0efighting_style\x18\t \x01(\v2*.dnd5e.api.v1alpha1.FightingStyleSelectionH\x00R\rfightingStyle\x12F\n" +
	"\tequipment\x18\n" +
	" \x01(\v2&.dnd5e.api.v1alpha1.EquipmentSelectionH\x00R\tequipment\x12@\n" +
	"\n" +
	"background\x18\v \x01(\x0e2\x1e.dnd5e.api.v1alpha1.BackgroundH\x00R\n" +
	"background\x12<\n" +
	"\x06spells\x18\f \x01(\v2\".dnd5e.api.v1alpha1.SpellSelectionH\x00R\x06spells\x129\n" +
	"\x05tools\x18\r \x01(\v2!.dnd5e.api.v1alpha1.ToolSelectionH\x00R\x05tools\x12F\n" +
	"\texpertise\x18\x0e \x01(\v2&.dnd5e.api.v1alpha1.ExpertiseSelectionH\x00R\texpertiseB\v\n" +
	"\tselection*\xa1\x01\n" +
	...
	"\x1dSPELL_SELECTION_TYPE_PREPARED\x10\x03*\xd1\x01\n" +
	...
	"\x18CHOICE_SOURCE_BACKGROUND\x10\x05\x12\x1e\n" +
	"\x16CHOICE_SOURCE_LEVEL_UP\x10\x06\x1a\x02\b\x01*\xdd\x04\n" +
...
var file_dnd5e_api_v1alpha1_choices_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_dnd5e_api_v1alpha1_choices_proto_goTypes = []any{
	...
	(*GrantedSpell)(nil),            // 13: dnd5e.api.v1alpha1.GrantedSpell
	(*ExpertiseOptions)(nil),        // 14: dnd5e.api.v1alpha1.ExpertiseOptions
	(*ChoiceSubmission)(nil),        // 15: dnd5e.api.v1alpha1.ChoiceSubmission
	(*SkillSelection)(nil),          // 16: dnd5e.api.v1alpha1.SkillSelection
	(*EquipmentSelection)(nil),      // 17: dnd5e.api.v1alpha1.EquipmentSelection
	(*EquipmentSelectionItem)(nil),  // 18: dnd5e.api.v1alpha1.EquipmentSelectionItem
	(*LanguageSelection)(nil),       // 19: dnd5e.api.v1alpha1.LanguageSelection
	(*ToolSelection)(nil),           // 20: dnd5e.api.v1alpha1.ToolSelection
	(*FightingStyleSelection)(nil),  // 21: dnd5e.api.v1alpha1.FightingStyleSelection
	(*SpellSelection)(nil),          // 22: dnd5e.api.v1alpha1.SpellSelection
	(*ExpertiseSelection)(nil),      // 23: dnd5e.api.v1alpha1.ExpertiseSelection
	(*ChoiceData)(nil),              // 24: dnd5e.api.v1alpha1.ChoiceData
	(Skill)(0),                      // 25: dnd5e.api.v1alpha1.Skill
	(Weapon)(0),                     // 26: dnd5e.api.v1alpha1.Weapon
	(Armor)(0),                      // 27: dnd5e.api.v1alpha1.Armor
	(Tool)(0),                       // 28: dnd5e.api.v1alpha1.Tool
	(Pack)(0),                       // 29: dnd5e.api.v1alpha1.Pack
	(Ammunition)(0),                 // 30: dnd5e.api.v1alpha1.Ammunition
	(*Equipment)(nil),               // 31: dnd5e.api.v1alpha1.Equipment
	(WeaponCategory)(0),             // 32: dnd5e.api.v1alpha1.WeaponCategory
	(ArmorCategory)(0),              // 33: dnd5e.api.v1alpha1.ArmorCategory
	(ToolCategory)(0),               // 34: dnd5e.api.v1alpha1.ToolCategory
	(Language)(0),                   // 35: dnd5e.api.v1alpha1.Language
	(FightingStyle)(0),              // 36: dnd5e.api.v1alpha1.FightingStyle
	(Spell)(0),                      // 37: dnd5e.api.v1alpha1.Spell
	(*AbilityScores)(nil),           // 38: dnd5e.api.v1alpha1.AbilityScores
	(Background)(0),                 // 39: dnd5e.api.v1alpha1.Background
}
var file_dnd5e_api_v1alpha1_choices_proto_depIdxs = []int32{
	...
	14, // 7: dnd5e.api.v1alpha1.Choice.expertise_options:type_name -> dnd5e.api.v1alpha1.ExpertiseOptions
	25, // 8: dnd5e.api.v1alpha1.SkillOptions.available:type_name -> dnd5e.api.v1alpha1.Skill
	...
	26, // 12: dnd5e.api.v1alpha1.EquipmentItem.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	27, // 13: dnd5e.api.v1alpha1.EquipmentItem.armor:type_name -> dnd5e.api.v1alpha1.Armor
	28, // 14: dnd5e.api.v1alpha1.EquipmentItem.tool:type_name -> dnd5e.api.v1alpha1.Tool
	29, // 15: dnd5e.api.v1alpha1.EquipmentItem.pack:type_name -> dnd5e.api.v1alpha1.Pack
	30, // 16: dnd5e.api.v1alpha1.EquipmentItem.ammunition:type_name -> dnd5e.api.v1alpha1.Ammunition
	31, // 17: dnd5e.api.v1alpha1.EquipmentItem.equipment_detail:type_name -> dnd5e.api.v1alpha1.Equipment
	32, // 18: dnd5e.api.v1alpha1.EquipmentCategoryChoice.weapon_categories:type_name -> dnd5e.api.v1alpha1.WeaponCategory
	33, // 19: dnd5e.api.v1alpha1.EquipmentCategoryChoice.armor_categories:type_name -> dnd5e.api.v1alpha1.ArmorCategory
	34, // 20: dnd5e.api.v1alpha1.EquipmentCategoryChoice.tool_categories:type_name -> dnd5e.api.v1alpha1.ToolCategory
	7,  // 21: dnd5e.api.v1alpha1.EquipmentCategoryChoice.options:type_name -> dnd5e.api.v1alpha1.EquipmentItem
	35, // 22: dnd5e.api.v1alpha1.LanguageOptions.available:type_name -> dnd5e.api.v1alpha1.Language
	28, // 23: dnd5e.api.v1alpha1.ToolOptions.available:type_name -> dnd5e.api.v1alpha1.Tool
	36, // 24: dnd5e.api.v1alpha1.FightingStyleOptions.available:type_name -> dnd5e.api.v1alpha1.FightingStyle
	37, // 25: dnd5e.api.v1alpha1.SpellOptions.available:type_name -> dnd5e.api.v1alpha1.Spell
	0,  // 26: dnd5e.api.v1alpha1.SpellOptions.selection_type:type_name -> dnd5e.api.v1alpha1.SpellSelectionType
	13, // 27: dnd5e.api.v1alpha1.SpellOptions.grants:type_name -> dnd5e.api.v1alpha1.GrantedSpell
	25, // 28: dnd5e.api.v1alpha1.ExpertiseOptions.available_skills:type_name -> dnd5e.api.v1alpha1.Skill
	28, // 29: dnd5e.api.v1alpha1.ExpertiseOptions.available_tools:type_name -> dnd5e.api.v1alpha1.Tool
	2,  // 30: dnd5e.api.v1alpha1.ChoiceSubmission.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	1,  // 31: dnd5e.api.v1alpha1.ChoiceSubmission.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	16, // 32: dnd5e.api.v1alpha1.ChoiceSubmission.skills:type_name -> dnd5e.api.v1alpha1.SkillSelection
	17, // 33: dnd5e.api.v1alpha1.ChoiceSubmission.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	19, // 34: dnd5e.api.v1alpha1.ChoiceSubmission.languages:type_name -> dnd5e.api.v1alpha1.LanguageSelection
	20, // 35: dnd5e.api.v1alpha1.ChoiceSubmission.tools:type_name -> dnd5e.api.v1alpha1.ToolSelection
	21, // 36: dnd5e.api.v1alpha1.ChoiceSubmission.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyleSelection
	22, // 37: dnd5e.api.v1alpha1.ChoiceSubmission.spells:type_name -> dnd5e.api.v1alpha1.SpellSelection
	23, // 38: dnd5e.api.v1alpha1.ChoiceSubmission.expertise:type_name -> dnd5e.api.v1alpha1.ExpertiseSelection
	25, // 39: dnd5e.api.v1alpha1.SkillSelection.skills:type_name -> dnd5e.api.v1alpha1.Skill
	18, // 40: dnd5e.api.v1alpha1.EquipmentSelection.items:type_name -> dnd5e.api.v1alpha1.EquipmentSelectionItem
	26, // 41: dnd5e.api.v1alpha1.EquipmentSelectionItem.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	27, // 42: dnd5e.api.v1alpha1.EquipmentSelectionItem.armor:type_name -> dnd5e.api.v1alpha1.Armor
	28, // 43: dnd5e.api.v1alpha1.EquipmentSelectionItem.tool:type_name -> dnd5e.api.v1alpha1.Tool
	29, // 44: dnd5e.api.v1alpha1.EquipmentSelectionItem.pack:type_name -> dnd5e.api.v1alpha1.Pack
	30, // 45: dnd5e.api.v1alpha1.EquipmentSelectionItem.ammunition:type_name -> dnd5e.api.v1alpha1.Ammunition
	35, // 46: dnd5e.api.v1alpha1.LanguageSelection.languages:type_name -> dnd5e.api.v1alpha1.Language
	28, // 47: dnd5e.api.v1alpha1.ToolSelection.tools:type_name -> dnd5e.api.v1alpha1.Tool
	36, // 48: dnd5e.api.v1alpha1.FightingStyleSelection.style:type_name -> dnd5e.api.v1alpha1.FightingStyle
	37, // 49: dnd5e.api.v1alpha1.SpellSelection.spells:type_name -> dnd5e.api.v1alpha1.Spell
	25, // 50: dnd5e.api.v1alpha1.ExpertiseSelection.skills:type_name -> dnd5e.api.v1alpha1.Skill
	28, // 51: dnd5e.api.v1alpha1.ExpertiseSelection.tools:type_name -> dnd5e.api.v1alpha1.Tool
	2,  // 52: dnd5e.api.v1alpha1.ChoiceData.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	1,  // 53: dnd5e.api.v1alpha1.ChoiceData.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	16, // 54: dnd5e.api.v1alpha1.ChoiceData.skills:type_name -> dnd5e.api.v1alpha1.SkillSelection
	19, // 55: dnd5e.api.v1alpha1.ChoiceData.languages:type_name -> dnd5e.api.v1alpha1.LanguageSelection
	38, // 56: dnd5e.api.v1alpha1.ChoiceData.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	21, // 57: dnd5e.api.v1alpha1.ChoiceData.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyleSelection
	17, // 58: dnd5e.api.v1alpha1.ChoiceData.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	39, // 59: dnd5e.api.v1alpha1.ChoiceData.background:type_name -> dnd5e.api.v1alpha1.Background
	22, // 60: dnd5e.api.v1alpha1.ChoiceData.spells:type_name -> dnd5e.api.v1alpha1.SpellSelection
	20, // 61: dnd5e.api.v1alpha1.ChoiceData.tools:type_name -> dnd5e.api.v1alpha1.ToolSelection
	23, // 62: dnd5e.api.v1alpha1.ChoiceData.expertise:type_name -> dnd5e.api.v1alpha1.ExpertiseSelection
...
func file_dnd5e_api_v1alpha1_choices_proto_init() {
	...
	file_dnd5e_api_v1alpha1_choices_proto_msgTypes[12].OneofWrappers = []any{
	...
	file_dnd5e_api_v1alpha1_choices_proto_msgTypes[15].OneofWrappers = []any{
	...
	file_dnd5e_api_v1alpha1_choices_proto_msgTypes[21].OneofWrappers = []any{
		(*ChoiceData_Name)(nil),
