...
var file_dnd5e_api_v1alpha1_choices_proto_depIdxs = []int32{
	...
	34, // 21: dnd5e.api.v1alpha1.LanguageOptions.available:type_name -> dnd5e.api.v1alpha1.Language
	27, // 22: dnd5e.api.v1alpha1.ToolOptions.available:type_name -> dnd5e.api.v1alpha1.Tool
	35, // 23: dnd5e.api.v1alpha1.FightingStyleOptions.available:type_name -> dnd5e.api.v1alpha1.FightingStyle
	36, // 24: dnd5e.api.v1alpha1.SpellOptions.available:type_name -> dnd5e.api.v1alpha1.Spell
	0,  // 25: dnd5e.api.v1alpha1.SpellOptions.selection_type:type_name -> dnd5e.api.v1alpha1.SpellSelectionType
	24, // 26: dnd5e.api.v1alpha1.ExpertiseOptions.available_skills:type_name -> dnd5e.api.v1alpha1.Skill
	27, // 27: dnd5e.api.v1alpha1.ExpertiseOptions.available_tools:type_name -> dnd5e.api.v1alpha1.Tool
	2,  // 28: dnd5e.api.v1alpha1.ChoiceSubmission.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	1,  // 29: dnd5e.api.v1alpha1.ChoiceSubmission.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	15, // 30: dnd5e.api.v1alpha1.ChoiceSubmission.skills:type_name -> dnd5e.api.v1alpha1.SkillSelection
	16, // 31: dnd5e.api.v1alpha1.ChoiceSubmission.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	18, // 32: dnd5e.api.v1alpha1.ChoiceSubmission.languages:type_name -> dnd5e.api.v1alpha1.LanguageSelection
	19, // 33: dnd5e.api.v1alpha1.ChoiceSubmission.tools:type_name -> dnd5e.api.v1alpha1.ToolSelection
	20, // 34: dnd5e.api.v1alpha1.ChoiceSubmission.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyleSelection
	21, // 35: dnd5e.api.v1alpha1.ChoiceSubmission.spells:type_name -> dnd5e.api.v1alpha1.SpellSelection
	22, // 36: dnd5e.api.v1alpha1.ChoiceSubmission.expertise:type_name -> dnd5e.api.v1alpha1.ExpertiseSelection
	24, // 37: dnd5e.api.v1alpha1.SkillSelection.skills:type_name -> dnd5e.api.v1alpha1.Skill
	17, // 38: dnd5e.api.v1alpha1.EquipmentSelection.items:type_name -> dnd5e.api.v1alpha1.EquipmentSelectionItem
	25, // 39: dnd5e.api.v1alpha1.EquipmentSelectionItem.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	26, // 40: dnd5e.api.v1alpha1.EquipmentSelectionItem.armor:type_name -> dnd5e.api.v1alpha1.Armor
	27, // 41: dnd5e.api.v1alpha1.EquipmentSelectionItem.tool:type_name -> dnd5e.api.v1alpha1.Tool
	28, // 42: dnd5e.api.v1alpha1.EquipmentSelectionItem.pack:type_name -> dnd5e.api.v1alpha1.Pack
	29, // 43: dnd5e.api.v1alpha1.EquipmentSelectionItem.ammunition:type_name -> dnd5e.api.v1alpha1.Ammunition
	34, // 44: dnd5e.api.v1alpha1.LanguageSelection.languages:type_name -> dnd5e.api.v1alpha1.Language
	27, // 45: dnd5e.api.v1alpha1.ToolSelection.tools:type_name -> dnd5e.api.v1alpha1.Tool
	35, // 46: dnd5e.api.v1alpha1.FightingStyleSelection.style:type_name -> dnd5e.api.v1alpha1.FightingStyle
	36, // 47: dnd5e.api.v1alpha1.SpellSelection.spells:type_name -> dnd5e.api.v1alpha1.Spell
	24, // 48: dnd5e.api.v1alpha1.ExpertiseSelection.skills:type_name -> dnd5e.api.v1alpha1.Skill
	27, // 49: dnd5e.api.v1alpha1.ExpertiseSelection.tools:type_name -> dnd5e.api.v1alpha1.Tool
	2,  // 50: dnd5e.api.v1alpha1.ChoiceData.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	1,  // 51: dnd5e.api.v1alpha1.ChoiceData.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	15, // 52: dnd5e.api.v1alpha1.ChoiceData.skills:type_name -> dnd5e.api.v1alpha1.SkillSelection
	18, // 53: dnd5e.api.v1alpha1.ChoiceData.languages:type_name -> dnd5e.api.v1alpha1.LanguageSelection
	37, // 54: dnd5e.api.v1alpha1.ChoiceData.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	20, // 55: dnd5e.api.v1alpha1.ChoiceData.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyleSelection
	16, // 56: dnd5e.api.v1alpha1.ChoiceData.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	38, // 57: dnd5e.api.v1alpha1.ChoiceData.background:type_name -> dnd5e.api.v1alpha1.Background
	21, // 58: dnd5e.api.v1alpha1.ChoiceData.spells:type_name -> dnd5e.api.v1alpha1.SpellSelection
	19, // 59: dnd5e.api.v1alpha1.ChoiceData.tools:type_name -> dnd5e.api.v1alpha1.ToolSelection
	22, // 60: dnd5e.api.v1alpha1.ChoiceData.expertise:type_name -> dnd5e.api.v1alpha1.ExpertiseSelection
