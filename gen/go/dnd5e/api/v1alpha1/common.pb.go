...
const file_dnd5e_api_v1alpha1_common_proto_rawDesc = "" +
	"\n" +
	"\x1fdnd5e/api/v1alpha1/common.proto\x12\x12dnd5e.api.v1alpha1\"\xc5\x01\n" +
...
var file_dnd5e_api_v1alpha1_common_proto_depIdxs = []int32{
	11, // 0: dnd5e.api.v1alpha1.ValidationResult.issues:type_name -> dnd5e.api.v1alpha1.ValidationResult.Issue
