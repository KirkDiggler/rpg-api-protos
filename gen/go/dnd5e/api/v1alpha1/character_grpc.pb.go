...
const (
	...
	CharacterService_GetNextLevel_FullMethodName          = "/dnd5e.api.v1alpha1.CharacterService/GetNextLevel"
	CharacterService_LevelUp_FullMethodName               = "/dnd5e.api.v1alpha1.CharacterService/LevelUp"
...
type CharacterServiceClient interface {
	...
	// service.
	GetNextLevel(ctx context.Context, in *GetNextLevelRequest, opts ...grpc.CallOption) (*GetNextLevelResponse, error)
...
func (c *characterServiceClient) GetNextLevel(ctx context.Context, in *GetNextLevelRequest, opts ...grpc.CallOption) (*GetNextLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetNextLevelResponse)
	err := c.cc.Invoke(ctx, CharacterService_GetNextLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *characterServiceClient) LevelUp(ctx context.Context, in *LevelUpRequest, opts ...grpc.CallOption) (*LevelUpResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CharacterServiceServer interface {
	...
	// is seeded on the persisted sheet, never called into existence through this
	// service.
	GetNextLevel(context.Context, *GetNextLevelRequest) (*GetNextLevelResponse, error)
...
func (UnimplementedCharacterServiceServer) GetNextLevel(context.Context, *GetNextLevelRequest) (*GetNextLevelResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetNextLevel not implemented")
}
func (UnimplementedCharacterServiceServer) LevelUp(context.Context, *LevelUpRequest) (*LevelUpResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method LevelUp not implemented")
}
...
func _CharacterService_GetNextLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetNextLevelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CharacterServiceServer).GetNextLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CharacterService_GetNextLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CharacterServiceServer).GetNextLevel(ctx, req.(*GetNextLevelRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CharacterService_LevelUp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CharacterServiceServer).LevelUp(ctx, req.(*LevelUpRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CharacterService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetNextLevel",
			Handler:    _CharacterService_GetNextLevel_Handler,
		},
		{
			MethodName: "LevelUp",
