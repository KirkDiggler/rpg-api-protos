...
RollDiceResponse::_table_ = {
  {
    ...
    // repeated .api.v1alpha1.DiceRoll rolls = 1 [json_name = "rolls"];
    {PROTOBUF_FIELD_OFFSET(RollDiceResponse, _impl_.rolls_), -1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // int64 expires_at = 2 [json_name = "expiresAt"];
    {PROTOBUF_FIELD_OFFSET(RollDiceResponse, _impl_.expires_at_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
  }},
  {{
...
DiceRoll::_table_ = {
  {
    ...
    // string roll_id = 1 [json_name = "rollId"];
    {PROTOBUF_FIELD_OFFSET(DiceRoll, _impl_.roll_id_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string notation = 2 [json_name = "notation"];
    {PROTOBUF_FIELD_OFFSET(DiceRoll, _impl_.notation_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // repeated int32 dice = 3 [json_name = "dice"];
    {PROTOBUF_FIELD_OFFSET(DiceRoll, _impl_.dice_), -1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kPackedInt32)},
    // int32 total = 4 [json_name = "total"];
    {PROTOBUF_FIELD_OFFSET(DiceRoll, _impl_.total_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // repeated int32 dropped = 5 [json_name = "dropped"];
    {PROTOBUF_FIELD_OFFSET(DiceRoll, _impl_.dropped_), -1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kPackedInt32)},
    // string description = 6 [json_name = "description"];
    {PROTOBUF_FIELD_OFFSET(DiceRoll, _impl_.description_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 dice_total = 7 [json_name = "diceTotal"];
    {PROTOBUF_FIELD_OFFSET(DiceRoll, _impl_.dice_total_), _Internal::kHasBitsOffset + 4, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // int32 modifier = 8 [json_name = "modifier"];
    {PROTOBUF_FIELD_OFFSET(DiceRoll, _impl_.modifier_), _Internal::kHasBitsOffset + 5, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
  }},
  // no aux_entries
  {{
...
GetRollSessionResponse::_table_ = {
  {
    ...
    // repeated .api.v1alpha1.DiceRoll rolls = 1 [json_name = "rolls"];
    {PROTOBUF_FIELD_OFFSET(GetRollSessionResponse, _impl_.rolls_), -1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // int64 expires_at = 2 [json_name = "expiresAt"];
    {PROTOBUF_FIELD_OFFSET(GetRollSessionResponse, _impl_.expires_at_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
    // int64 created_at = 3 [json_name = "createdAt"];
    {PROTOBUF_FIELD_OFFSET(GetRollSessionResponse, _impl_.created_at_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
  }},
  {{
      {::_pbi::TcParser::GetTable<::api::v1alpha1::DiceRoll>()},
  }},
