...
export type ClassInfo = Message<"dnd5e.api.v1alpha1.ClassInfo"> & {
   ...
   *
   * @generated from field: dnd5e.api.v1alpha1.Class group = 16;
   */
  group: Class;
};
