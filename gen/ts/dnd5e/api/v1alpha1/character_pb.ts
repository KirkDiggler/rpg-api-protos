...
export type ClassInfo = Message<"dnd5e.api.v1alpha1.ClassInfo"> & {
   ...
   *
   * @generated from field: string subclass_type = 18;
   */
  subclassType: string;
};
