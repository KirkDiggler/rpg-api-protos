...
type Choice struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	Id          string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                                                           // Unique identifier for tracking (e.g., "fighter-skills")
	Description string                 `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`                                                         // Human-readable description (e.g., "Choose 2 skills")
...
type Choice_SpellOptions struct {
	SpellOptions *SpellOptions `protobuf:"bytes,10,opt,name=spell_options,json=spellOptions,proto3,oneof"` // Add more as needed
}
...
type EquipmentBundle struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`       // Bundle identifier
	Label         string                 `protobuf:"bytes,2,opt,name=label,proto3" json:"label,omitempty"` // Display name (e.g., "Chain mail")
	Items         []*EquipmentItem       `protobuf:"bytes,3,rep,name=items,proto3" json:"items,omitempty"` // Items in this bundle
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type EquipmentItem struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	SelectionId string                 `protobuf:"bytes,1,opt,name=selection_id,json=selectionId,proto3" json:"selection_id,omitempty"` // Maps to toolkit's SelectionID (e.g., "chain-mail")
...
type ClassInfo struct {
	...
	Level_1Features []*FeatureInfo `protobuf:"bytes,10,rep,name=level_1_features,json=level1Features,proto3" json:"level_1_features,omitempty"`
	// Spellcasting information (if applicable)
	Spellcasting *SpellcastingInfo `protobuf:"bytes,11,opt,name=spellcasting,proto3" json:"spellcasting,omitempty"`
	// ALL requirements (choices) - skills, equipment, etc.
	// This is the ONE place for all choices
	Choices []*Choice `protobuf:"bytes,12,rep,name=choices,proto3" json:"choices,omitempty"`
	// Subclass options for this class (only populated for base classes like Cleric, not for subclasses)
	Subclasses    []*SubclassInfo `protobuf:"bytes,13,rep,name=subclasses,proto3" json:"subclasses,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_dnd5e_api_v1alpha1_character_proto_rawDesc = "" +
	...
	"\aoptions\x18\x04 \x03(\tR\aoptions\"\x8e\x05\n" +
	"\x06Choice\x12\x0e\n" +
	...
	"\rspell_options\x18\n" +
	" \x01(\v2 .dnd5e.api.v1alpha1.SpellOptionsH\x00R\fspellOptionsB\t\n" +
	"\aoptions\"G\n" +
	"\fSkillOptions\x127\n" +
	"\tavailable\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SkillR\tavailable\"Q\n" +
	"\x10EquipmentOptions\x12=\n" +
	"\abundles\x18\x01 \x03(\v2#.dnd5e.api.v1alpha1.EquipmentBundleR\abundles\"p\n" +
	"\x0fEquipmentBundle\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x127\n" +
	"\x05items\x18\x03 \x03(\v2!.dnd5e.api.v1alpha1.EquipmentItemR\x05items\"\xe6\x02\n" +
	"\rEquipmentItem\x12!\n" +
	...
	"\tavailable\x18\x01 \x03(\x0e2!.dnd5e.api.v1alpha1.FightingStyleR\tavailable\"h\n" +
	"\fSpellOptions\x127\n" +
	...
	"\x1asaving_throw_proficiencies\x18\t \x03(\x0e2\x1b.dnd5e.api.v1alpha1.AbilityR\x18savingThrowProficiencies\x12I\n" +
	"\x10level_1_features\x18\n" +
	" \x03(\v2\x1f.dnd5e.api.v1alpha1.FeatureInfoR\x0elevel1Features\x12H\n" +
	"\fspellcasting\x18\v \x01(\v2$.dnd5e.api.v1alpha1.SpellcastingInfoR\fspellcasting\x124\n" +
	"\achoices\x18\f \x03(\v2\x1a.dnd5e.api.v1alpha1.ChoiceR\achoices\x12@\n" +
	"\n" +
	"subclasses\x18\r \x03(\v2 .dnd5e.api.v1alpha1.SubclassInfoR\n" +
	"subclasses\"\xc5\x05\n" +
	"\fSubclassInfo\x12=\n" +
...
var file_dnd5e_api_v1alpha1_character_proto_msgTypes = make([]protoimpl.MessageInfo, 142)
var file_dnd5e_api_v1alpha1_character_proto_goTypes = []any{
	...
	(*SkillOptions)(nil),                  // 64: dnd5e.api.v1alpha1.SkillOptions
	(*EquipmentOptions)(nil),              // 65: dnd5e.api.v1alpha1.EquipmentOptions
	(*EquipmentBundle)(nil),               // 66: dnd5e.api.v1alpha1.EquipmentBundle
	(*EquipmentItem)(nil),                 // 67: dnd5e.api.v1alpha1.EquipmentItem
	(*LanguageOptions)(nil),               // 68: dnd5e.api.v1alpha1.LanguageOptions
	(*ToolOptions)(nil),                   // 69: dnd5e.api.v1alpha1.ToolOptions
	(*FightingStyleOptions)(nil),          // 70: dnd5e.api.v1alpha1.FightingStyleOptions
	(*SpellOptions)(nil),                  // 71: dnd5e.api.v1alpha1.SpellOptions
	...
	(*SpellDamage)(nil),                   // 132: dnd5e.api.v1alpha1.SpellDamage
	(*DamageAtSlotLevel)(nil),             // 133: dnd5e.api.v1alpha1.DamageAtSlotLevel
	(*AreaOfEffect)(nil),                  // 134: dnd5e.api.v1alpha1.AreaOfEffect
	(*ListEquipmentByTypeRequest)(nil),    // 135: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	(*ListEquipmentByTypeResponse)(nil),   // 136: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	(*ListSpellsByLevelRequest)(nil),      // 137: dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	(*ListSpellsByLevelResponse)(nil),     // 138: dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	(*GetCharacterInventoryRequest)(nil),  // 139: dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	(*GetCharacterInventoryResponse)(nil), // 140: dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	(*EquipItemRequest)(nil),              // 141: dnd5e.api.v1alpha1.EquipItemRequest
	(*EquipItemResponse)(nil),             // 142: dnd5e.api.v1alpha1.EquipItemResponse
	(*UnequipItemRequest)(nil),            // 143: dnd5e.api.v1alpha1.UnequipItemRequest
	(*UnequipItemResponse)(nil),           // 144: dnd5e.api.v1alpha1.UnequipItemResponse
	(*AddToInventoryRequest)(nil),         // 145: dnd5e.api.v1alpha1.AddToInventoryRequest
	(*InventoryAddition)(nil),             // 146: dnd5e.api.v1alpha1.InventoryAddition
	(*AddToInventoryResponse)(nil),        // 147: dnd5e.api.v1alpha1.AddToInventoryResponse
	(*RemoveFromInventoryRequest)(nil),    // 148: dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	(*RemoveFromInventoryResponse)(nil),   // 149: dnd5e.api.v1alpha1.RemoveFromInventoryResponse
	nil,                                   // 150: dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	nil,                                   // 151: dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	(Race)(0),                             // 152: dnd5e.api.v1alpha1.Race
	(Subrace)(0),                          // 153: dnd5e.api.v1alpha1.Subrace
	(Class)(0),                            // 154: dnd5e.api.v1alpha1.Class
	(Background)(0),                       // 155: dnd5e.api.v1alpha1.Background
	(Alignment)(0),                        // 156: dnd5e.api.v1alpha1.Alignment
	(Language)(0),                         // 157: dnd5e.api.v1alpha1.Language
	(FightingStyle)(0),                    // 158: dnd5e.api.v1alpha1.FightingStyle
	(Armor)(0),                            // 159: dnd5e.api.v1alpha1.Armor
	(Weapon)(0),                           // 160: dnd5e.api.v1alpha1.Weapon
	(Tool)(0),                             // 161: dnd5e.api.v1alpha1.Tool
	(Skill)(0),                            // 162: dnd5e.api.v1alpha1.Skill
	(Ability)(0),                          // 163: dnd5e.api.v1alpha1.Ability
	(Subclass)(0),                         // 164: dnd5e.api.v1alpha1.Subclass
	(*ValidationResult)(nil),              // 165: dnd5e.api.v1alpha1.ValidationResult
	(*ValidationWarning)(nil),             // 166: dnd5e.api.v1alpha1.ValidationWarning
	(*ValidationError)(nil),               // 167: dnd5e.api.v1alpha1.ValidationError
	(Pack)(0),                             // 168: dnd5e.api.v1alpha1.Pack
	(Ammunition)(0),                       // 169: dnd5e.api.v1alpha1.Ammunition
	(Spell)(0),                            // 170: dnd5e.api.v1alpha1.Spell
	(ArmorProficiencyCategory)(0),         // 171: dnd5e.api.v1alpha1.ArmorProficiencyCategory
	(WeaponProficiencyCategory)(0),        // 172: dnd5e.api.v1alpha1.WeaponProficiencyCategory
	(EquipmentCategory)(0),                // 173: dnd5e.api.v1alpha1.EquipmentCategory
	(WeaponCategory)(0),                   // 174: dnd5e.api.v1alpha1.WeaponCategory
	(DamageType)(0),                       // 175: dnd5e.api.v1alpha1.DamageType
	(WeaponProperty)(0),                   // 176: dnd5e.api.v1alpha1.WeaponProperty
	(ArmorCategory)(0),                    // 177: dnd5e.api.v1alpha1.ArmorCategory
	(GearCategory)(0),                     // 178: dnd5e.api.v1alpha1.GearCategory
	(Trait)(0),                            // 179: dnd5e.api.v1alpha1.Trait
	(EquipmentType)(0),                    // 180: dnd5e.api.v1alpha1.EquipmentType
}
var file_dnd5e_api_v1alpha1_character_proto_depIdxs = []int32{
	...
	152, // 2: dnd5e.api.v1alpha1.Character.race:type_name -> dnd5e.api.v1alpha1.Race
	153, // 3: dnd5e.api.v1alpha1.Character.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	154, // 4: dnd5e.api.v1alpha1.Character.class:type_name -> dnd5e.api.v1alpha1.Class
	155, // 5: dnd5e.api.v1alpha1.Character.background:type_name -> dnd5e.api.v1alpha1.Background
	156, // 6: dnd5e.api.v1alpha1.Character.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	...
	157, // 11: dnd5e.api.v1alpha1.Character.languages:type_name -> dnd5e.api.v1alpha1.Language
	...
	158, // 17: dnd5e.api.v1alpha1.Character.fighting_styles:type_name -> dnd5e.api.v1alpha1.FightingStyle
	...
	159, // 22: dnd5e.api.v1alpha1.ProficiencyGrants.armor:type_name -> dnd5e.api.v1alpha1.Armor
	160, // 23: dnd5e.api.v1alpha1.ProficiencyGrants.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	161, // 24: dnd5e.api.v1alpha1.ProficiencyGrants.tools:type_name -> dnd5e.api.v1alpha1.Tool
	162, // 25: dnd5e.api.v1alpha1.ProficiencyGrants.skills:type_name -> dnd5e.api.v1alpha1.Skill
	157, // 26: dnd5e.api.v1alpha1.ProficiencyGrants.languages:type_name -> dnd5e.api.v1alpha1.Language
	162, // 27: dnd5e.api.v1alpha1.Proficiencies.skills:type_name -> dnd5e.api.v1alpha1.Skill
	163, // 28: dnd5e.api.v1alpha1.Proficiencies.saving_throws:type_name -> dnd5e.api.v1alpha1.Ability
	159, // 29: dnd5e.api.v1alpha1.Proficiencies.armor:type_name -> dnd5e.api.v1alpha1.Armor
	160, // 30: dnd5e.api.v1alpha1.Proficiencies.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	161, // 31: dnd5e.api.v1alpha1.Proficiencies.tools:type_name -> dnd5e.api.v1alpha1.Tool
	...
	152, // 36: dnd5e.api.v1alpha1.CharacterDraftData.race:type_name -> dnd5e.api.v1alpha1.Race
	153, // 37: dnd5e.api.v1alpha1.CharacterDraftData.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	154, // 38: dnd5e.api.v1alpha1.CharacterDraftData.class:type_name -> dnd5e.api.v1alpha1.Class
	164, // 39: dnd5e.api.v1alpha1.CharacterDraftData.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	155, // 40: dnd5e.api.v1alpha1.CharacterDraftData.background:type_name -> dnd5e.api.v1alpha1.Background
	...
	152, // 45: dnd5e.api.v1alpha1.CharacterDraft.race:type_name -> dnd5e.api.v1alpha1.Race
	153, // 46: dnd5e.api.v1alpha1.CharacterDraft.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	154, // 47: dnd5e.api.v1alpha1.CharacterDraft.class:type_name -> dnd5e.api.v1alpha1.Class
	164, // 48: dnd5e.api.v1alpha1.CharacterDraft.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	155, // 49: dnd5e.api.v1alpha1.CharacterDraft.background:type_name -> dnd5e.api.v1alpha1.Background
	...
	165, // 53: dnd5e.api.v1alpha1.CharacterDraft.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	...
	166, // 63: dnd5e.api.v1alpha1.UpdateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	152, // 64: dnd5e.api.v1alpha1.UpdateRaceRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	153, // 65: dnd5e.api.v1alpha1.UpdateRaceRequest.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	109, // 66: dnd5e.api.v1alpha1.UpdateRaceRequest.race_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	154, // 67: dnd5e.api.v1alpha1.UpdateClassRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	109, // 68: dnd5e.api.v1alpha1.UpdateClassRequest.class_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	164, // 69: dnd5e.api.v1alpha1.UpdateClassRequest.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	155, // 70: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background:type_name -> dnd5e.api.v1alpha1.Background
	...
	162, // 74: dnd5e.api.v1alpha1.UpdateSkillsRequest.skills:type_name -> dnd5e.api.v1alpha1.Skill
	31,  // 75: dnd5e.api.v1alpha1.UpdateNameResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	166, // 76: dnd5e.api.v1alpha1.UpdateNameResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 77: dnd5e.api.v1alpha1.UpdateRaceResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	166, // 78: dnd5e.api.v1alpha1.UpdateRaceResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 79: dnd5e.api.v1alpha1.UpdateClassResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	166, // 80: dnd5e.api.v1alpha1.UpdateClassResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 81: dnd5e.api.v1alpha1.UpdateBackgroundResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	166, // 82: dnd5e.api.v1alpha1.UpdateBackgroundResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 83: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	166, // 84: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 85: dnd5e.api.v1alpha1.UpdateSkillsResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	166, // 86: dnd5e.api.v1alpha1.UpdateSkillsResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 87: dnd5e.api.v1alpha1.ListDraftsResponse.drafts:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	165, // 88: dnd5e.api.v1alpha1.ValidateDraftResponse.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	2,   // 89: dnd5e.api.v1alpha1.ValidateDraftResponse.missing_steps:type_name -> dnd5e.api.v1alpha1.CreationStep
	167, // 90: dnd5e.api.v1alpha1.ValidateDraftResponse.errors:type_name -> dnd5e.api.v1alpha1.ValidationError
	166, // 91: dnd5e.api.v1alpha1.ValidateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	...
	166, // 94: dnd5e.api.v1alpha1.GetDraftPreviewResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	167, // 95: dnd5e.api.v1alpha1.GetDraftPreviewResponse.errors:type_name -> dnd5e.api.v1alpha1.ValidationError
	14,  // 96: dnd5e.api.v1alpha1.FinalizeDraftResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	165, // 97: dnd5e.api.v1alpha1.FinalizeDraftResponse.final_validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	152, // 98: dnd5e.api.v1alpha1.RaceInfo.race_id:type_name -> dnd5e.api.v1alpha1.Race
	5,   // 99: dnd5e.api.v1alpha1.RaceInfo.size:type_name -> dnd5e.api.v1alpha1.Size
	150, // 100: dnd5e.api.v1alpha1.RaceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	...
	157, // 104: dnd5e.api.v1alpha1.RaceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	63,  // 105: dnd5e.api.v1alpha1.RaceInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	153, // 106: dnd5e.api.v1alpha1.SubraceInfo.subrace_id:type_name -> dnd5e.api.v1alpha1.Subrace
	151, // 107: dnd5e.api.v1alpha1.SubraceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	62,  // 108: dnd5e.api.v1alpha1.SubraceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	157, // 109: dnd5e.api.v1alpha1.SubraceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	...
	64,  // 112: dnd5e.api.v1alpha1.Choice.skill_options:type_name -> dnd5e.api.v1alpha1.SkillOptions
	65,  // 113: dnd5e.api.v1alpha1.Choice.equipment_options:type_name -> dnd5e.api.v1alpha1.EquipmentOptions
	68,  // 114: dnd5e.api.v1alpha1.Choice.language_options:type_name -> dnd5e.api.v1alpha1.LanguageOptions
	69,  // 115: dnd5e.api.v1alpha1.Choice.tool_options:type_name -> dnd5e.api.v1alpha1.ToolOptions
	70,  // 116: dnd5e.api.v1alpha1.Choice.fighting_style_options:type_name -> dnd5e.api.v1alpha1.FightingStyleOptions
	71,  // 117: dnd5e.api.v1alpha1.Choice.spell_options:type_name -> dnd5e.api.v1alpha1.SpellOptions
	162, // 118: dnd5e.api.v1alpha1.SkillOptions.available:type_name -> dnd5e.api.v1alpha1.Skill
	66,  // 119: dnd5e.api.v1alpha1.EquipmentOptions.bundles:type_name -> dnd5e.api.v1alpha1.EquipmentBundle
	67,  // 120: dnd5e.api.v1alpha1.EquipmentBundle.items:type_name -> dnd5e.api.v1alpha1.EquipmentItem
	160, // 121: dnd5e.api.v1alpha1.EquipmentItem.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	159, // 122: dnd5e.api.v1alpha1.EquipmentItem.armor:type_name -> dnd5e.api.v1alpha1.Armor
	161, // 123: dnd5e.api.v1alpha1.EquipmentItem.tool:type_name -> dnd5e.api.v1alpha1.Tool
	168, // 124: dnd5e.api.v1alpha1.EquipmentItem.pack:type_name -> dnd5e.api.v1alpha1.Pack
	169, // 125: dnd5e.api.v1alpha1.EquipmentItem.ammunition:type_name -> dnd5e.api.v1alpha1.Ammunition
	157, // 126: dnd5e.api.v1alpha1.LanguageOptions.available:type_name -> dnd5e.api.v1alpha1.Language
	161, // 127: dnd5e.api.v1alpha1.ToolOptions.available:type_name -> dnd5e.api.v1alpha1.Tool
	158, // 128: dnd5e.api.v1alpha1.FightingStyleOptions.available:type_name -> dnd5e.api.v1alpha1.FightingStyle
	170, // 129: dnd5e.api.v1alpha1.SpellOptions.available:type_name -> dnd5e.api.v1alpha1.Spell
	154, // 130: dnd5e.api.v1alpha1.ClassInfo.class_id:type_name -> dnd5e.api.v1alpha1.Class
	163, // 131: dnd5e.api.v1alpha1.ClassInfo.primary_ability:type_name -> dnd5e.api.v1alpha1.Ability
	171, // 132: dnd5e.api.v1alpha1.ClassInfo.armor_proficiency_categories:type_name -> dnd5e.api.v1alpha1.ArmorProficiencyCategory
	172, // 133: dnd5e.api.v1alpha1.ClassInfo.weapon_proficiency_categories:type_name -> dnd5e.api.v1alpha1.WeaponProficiencyCategory
	160, // 134: dnd5e.api.v1alpha1.ClassInfo.specific_weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.Weapon
	161, // 135: dnd5e.api.v1alpha1.ClassInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	163, // 136: dnd5e.api.v1alpha1.ClassInfo.saving_throw_proficiencies:type_name -> dnd5e.api.v1alpha1.Ability
	76,  // 137: dnd5e.api.v1alpha1.ClassInfo.level_1_features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	74,  // 138: dnd5e.api.v1alpha1.ClassInfo.spellcasting:type_name -> dnd5e.api.v1alpha1.SpellcastingInfo
	63,  // 139: dnd5e.api.v1alpha1.ClassInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	73,  // 140: dnd5e.api.v1alpha1.ClassInfo.subclasses:type_name -> dnd5e.api.v1alpha1.SubclassInfo
	164, // 141: dnd5e.api.v1alpha1.SubclassInfo.subclass_id:type_name -> dnd5e.api.v1alpha1.Subclass
	159, // 142: dnd5e.api.v1alpha1.SubclassInfo.armor_proficiencies:type_name -> dnd5e.api.v1alpha1.Armor
	160, // 143: dnd5e.api.v1alpha1.SubclassInfo.weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.Weapon
	161, // 144: dnd5e.api.v1alpha1.SubclassInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	63,  // 145: dnd5e.api.v1alpha1.SubclassInfo.additional_choices:type_name -> dnd5e.api.v1alpha1.Choice
	76,  // 146: dnd5e.api.v1alpha1.SubclassInfo.features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	155, // 147: dnd5e.api.v1alpha1.BackgroundInfo.background_id:type_name -> dnd5e.api.v1alpha1.Background
	162, // 148: dnd5e.api.v1alpha1.BackgroundInfo.skill_proficiencies:type_name -> dnd5e.api.v1alpha1.Skill
	161, // 149: dnd5e.api.v1alpha1.BackgroundInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	157, // 150: dnd5e.api.v1alpha1.BackgroundInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	122, // 151: dnd5e.api.v1alpha1.BackgroundInfo.starting_equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	63,  // 152: dnd5e.api.v1alpha1.FeatureInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	77,  // 153: dnd5e.api.v1alpha1.FeatureInfo.spell_selection:type_name -> dnd5e.api.v1alpha1.SpellSelectionInfo
	6,   // 154: dnd5e.api.v1alpha1.SpellSelectionInfo.selection_type:type_name -> dnd5e.api.v1alpha1.SpellSelectionType
	60,  // 155: dnd5e.api.v1alpha1.ListRacesResponse.races:type_name -> dnd5e.api.v1alpha1.RaceInfo
	72,  // 156: dnd5e.api.v1alpha1.ListClassesResponse.classes:type_name -> dnd5e.api.v1alpha1.ClassInfo
	75,  // 157: dnd5e.api.v1alpha1.ListBackgroundsResponse.backgrounds:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	60,  // 158: dnd5e.api.v1alpha1.GetRaceDetailsResponse.race:type_name -> dnd5e.api.v1alpha1.RaceInfo
	72,  // 159: dnd5e.api.v1alpha1.GetClassDetailsResponse.class:type_name -> dnd5e.api.v1alpha1.ClassInfo
	75,  // 160: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse.background:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	76,  // 161: dnd5e.api.v1alpha1.GetFeatureResponse.feature:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	93,  // 162: dnd5e.api.v1alpha1.RollAbilityScoresResponse.rolls:type_name -> dnd5e.api.v1alpha1.AbilityScoreRoll
	154, // 163: dnd5e.api.v1alpha1.GetRequirementsRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	152, // 164: dnd5e.api.v1alpha1.GetRequirementsRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	130, // 165: dnd5e.api.v1alpha1.GetRequirementsResponse.requirements:type_name -> dnd5e.api.v1alpha1.CharacterRequirements
	123, // 166: dnd5e.api.v1alpha1.SubmitChoicesRequest.submissions:type_name -> dnd5e.api.v1alpha1.ChoiceSubmission
	31,  // 167: dnd5e.api.v1alpha1.SubmitChoicesResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	165, // 168: dnd5e.api.v1alpha1.SubmitChoicesResponse.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	130, // 169: dnd5e.api.v1alpha1.SubmitChoicesResponse.remaining_requirements:type_name -> dnd5e.api.v1alpha1.CharacterRequirements
	173, // 170: dnd5e.api.v1alpha1.Equipment.category:type_name -> dnd5e.api.v1alpha1.EquipmentCategory
	100, // 171: dnd5e.api.v1alpha1.Equipment.cost:type_name -> dnd5e.api.v1alpha1.Cost
	101, // 172: dnd5e.api.v1alpha1.Equipment.weight:type_name -> dnd5e.api.v1alpha1.Weight
	103, // 173: dnd5e.api.v1alpha1.Equipment.weapon_data:type_name -> dnd5e.api.v1alpha1.WeaponData
	104, // 174: dnd5e.api.v1alpha1.Equipment.armor_data:type_name -> dnd5e.api.v1alpha1.ArmorData
	105, // 175: dnd5e.api.v1alpha1.Equipment.gear_data:type_name -> dnd5e.api.v1alpha1.GearData
	174, // 176: dnd5e.api.v1alpha1.WeaponData.weapon_category:type_name -> dnd5e.api.v1alpha1.WeaponCategory
	175, // 177: dnd5e.api.v1alpha1.WeaponData.damage_type:type_name -> dnd5e.api.v1alpha1.DamageType
	176, // 178: dnd5e.api.v1alpha1.WeaponData.properties:type_name -> dnd5e.api.v1alpha1.WeaponProperty
	177, // 179: dnd5e.api.v1alpha1.ArmorData.armor_category:type_name -> dnd5e.api.v1alpha1.ArmorCategory
	178, // 180: dnd5e.api.v1alpha1.GearData.gear_category:type_name -> dnd5e.api.v1alpha1.GearCategory
	107, // 181: dnd5e.api.v1alpha1.EquipmentSlots.main_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 182: dnd5e.api.v1alpha1.EquipmentSlots.off_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 183: dnd5e.api.v1alpha1.EquipmentSlots.armor:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 184: dnd5e.api.v1alpha1.EquipmentSlots.helmet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 185: dnd5e.api.v1alpha1.EquipmentSlots.boots:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 186: dnd5e.api.v1alpha1.EquipmentSlots.gloves:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 187: dnd5e.api.v1alpha1.EquipmentSlots.cloak:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 188: dnd5e.api.v1alpha1.EquipmentSlots.amulet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 189: dnd5e.api.v1alpha1.EquipmentSlots.ring_1:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 190: dnd5e.api.v1alpha1.EquipmentSlots.ring_2:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 191: dnd5e.api.v1alpha1.EquipmentSlots.belt:type_name -> dnd5e.api.v1alpha1.InventoryItem
	102, // 192: dnd5e.api.v1alpha1.InventoryItem.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	7,   // 193: dnd5e.api.v1alpha1.EncumbranceInfo.level:type_name -> dnd5e.api.v1alpha1.EncumbranceLevel
	4,   // 194: dnd5e.api.v1alpha1.ChoiceData.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 195: dnd5e.api.v1alpha1.ChoiceData.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	110, // 196: dnd5e.api.v1alpha1.ChoiceData.skills:type_name -> dnd5e.api.v1alpha1.SkillList
	111, // 197: dnd5e.api.v1alpha1.ChoiceData.languages:type_name -> dnd5e.api.v1alpha1.LanguageList
	13,  // 198: dnd5e.api.v1alpha1.ChoiceData.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	158, // 199: dnd5e.api.v1alpha1.ChoiceData.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyle
	112, // 200: dnd5e.api.v1alpha1.ChoiceData.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentList
	118, // 201: dnd5e.api.v1alpha1.ChoiceData.race:type_name -> dnd5e.api.v1alpha1.RaceChoice
	119, // 202: dnd5e.api.v1alpha1.ChoiceData.class:type_name -> dnd5e.api.v1alpha1.ClassChoice
	155, // 203: dnd5e.api.v1alpha1.ChoiceData.background:type_name -> dnd5e.api.v1alpha1.Background
	113, // 204: dnd5e.api.v1alpha1.ChoiceData.spells:type_name -> dnd5e.api.v1alpha1.SpellList
	114, // 205: dnd5e.api.v1alpha1.ChoiceData.cantrips:type_name -> dnd5e.api.v1alpha1.CantripList
	115, // 206: dnd5e.api.v1alpha1.ChoiceData.expertise:type_name -> dnd5e.api.v1alpha1.ExpertiseList
	116, // 207: dnd5e.api.v1alpha1.ChoiceData.traits:type_name -> dnd5e.api.v1alpha1.TraitList
	117, // 208: dnd5e.api.v1alpha1.ChoiceData.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.ToolProficiencyList
	162, // 209: dnd5e.api.v1alpha1.SkillList.skills:type_name -> dnd5e.api.v1alpha1.Skill
	157, // 210: dnd5e.api.v1alpha1.LanguageList.languages:type_name -> dnd5e.api.v1alpha1.Language
	122, // 211: dnd5e.api.v1alpha1.EquipmentList.items:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	170, // 212: dnd5e.api.v1alpha1.SpellList.spells:type_name -> dnd5e.api.v1alpha1.Spell
	170, // 213: dnd5e.api.v1alpha1.CantripList.cantrips:type_name -> dnd5e.api.v1alpha1.Spell
	162, // 214: dnd5e.api.v1alpha1.ExpertiseList.skills:type_name -> dnd5e.api.v1alpha1.Skill
	179, // 215: dnd5e.api.v1alpha1.TraitList.traits:type_name -> dnd5e.api.v1alpha1.Trait
	161, // 216: dnd5e.api.v1alpha1.ToolProficiencyList.tools:type_name -> dnd5e.api.v1alpha1.Tool
	152, // 217: dnd5e.api.v1alpha1.RaceChoice.race:type_name -> dnd5e.api.v1alpha1.Race
	153, // 218: dnd5e.api.v1alpha1.RaceChoice.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	154, // 219: dnd5e.api.v1alpha1.ClassChoice.class:type_name -> dnd5e.api.v1alpha1.Class
	121, // 220: dnd5e.api.v1alpha1.EquipmentChoice.options:type_name -> dnd5e.api.v1alpha1.EquipmentOption
	122, // 221: dnd5e.api.v1alpha1.EquipmentOption.items:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	160, // 222: dnd5e.api.v1alpha1.EquipmentSelection.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	159, // 223: dnd5e.api.v1alpha1.EquipmentSelection.armor:type_name -> dnd5e.api.v1alpha1.Armor
	161, // 224: dnd5e.api.v1alpha1.EquipmentSelection.tool:type_name -> dnd5e.api.v1alpha1.Tool
	168, // 225: dnd5e.api.v1alpha1.EquipmentSelection.pack:type_name -> dnd5e.api.v1alpha1.Pack
	169, // 226: dnd5e.api.v1alpha1.EquipmentSelection.ammunition:type_name -> dnd5e.api.v1alpha1.Ammunition
	4,   // 227: dnd5e.api.v1alpha1.ChoiceSubmission.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 228: dnd5e.api.v1alpha1.ChoiceSubmission.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	124, // 229: dnd5e.api.v1alpha1.ChoiceSubmission.skills:type_name -> dnd5e.api.v1alpha1.SkillSelection
	125, // 230: dnd5e.api.v1alpha1.ChoiceSubmission.languages:type_name -> dnd5e.api.v1alpha1.LanguageSelection
	122, // 231: dnd5e.api.v1alpha1.ChoiceSubmission.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	126, // 232: dnd5e.api.v1alpha1.ChoiceSubmission.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyleSelection
	127, // 233: dnd5e.api.v1alpha1.ChoiceSubmission.tools:type_name -> dnd5e.api.v1alpha1.ToolSelection
	128, // 234: dnd5e.api.v1alpha1.ChoiceSubmission.weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.WeaponProficiencySelection
	129, // 235: dnd5e.api.v1alpha1.ChoiceSubmission.armor_proficiencies:type_name -> dnd5e.api.v1alpha1.ArmorProficiencySelection
	162, // 236: dnd5e.api.v1alpha1.SkillSelection.skills:type_name -> dnd5e.api.v1alpha1.Skill
	157, // 237: dnd5e.api.v1alpha1.LanguageSelection.languages:type_name -> dnd5e.api.v1alpha1.Language
	158, // 238: dnd5e.api.v1alpha1.FightingStyleSelection.style:type_name -> dnd5e.api.v1alpha1.FightingStyle
	161, // 239: dnd5e.api.v1alpha1.ToolSelection.tools:type_name -> dnd5e.api.v1alpha1.Tool
	160, // 240: dnd5e.api.v1alpha1.WeaponProficiencySelection.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	180, // 241: dnd5e.api.v1alpha1.WeaponProficiencySelection.categories:type_name -> dnd5e.api.v1alpha1.EquipmentType
	159, // 242: dnd5e.api.v1alpha1.ArmorProficiencySelection.armors:type_name -> dnd5e.api.v1alpha1.Armor
	180, // 243: dnd5e.api.v1alpha1.ArmorProficiencySelection.categories:type_name -> dnd5e.api.v1alpha1.EquipmentType
	131, // 244: dnd5e.api.v1alpha1.CharacterRequirements.choices:type_name -> dnd5e.api.v1alpha1.RequiredChoice
	4,   // 245: dnd5e.api.v1alpha1.RequiredChoice.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 246: dnd5e.api.v1alpha1.RequiredChoice.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	64,  // 247: dnd5e.api.v1alpha1.RequiredChoice.skill_options:type_name -> dnd5e.api.v1alpha1.SkillOptions
	68,  // 248: dnd5e.api.v1alpha1.RequiredChoice.language_options:type_name -> dnd5e.api.v1alpha1.LanguageOptions
	120, // 249: dnd5e.api.v1alpha1.RequiredChoice.equipment_options:type_name -> dnd5e.api.v1alpha1.EquipmentChoice
	70,  // 250: dnd5e.api.v1alpha1.RequiredChoice.fighting_style_options:type_name -> dnd5e.api.v1alpha1.FightingStyleOptions
	69,  // 251: dnd5e.api.v1alpha1.RequiredChoice.tool_options:type_name -> dnd5e.api.v1alpha1.ToolOptions
	175, // 252: dnd5e.api.v1alpha1.SpellDamage.damage_type:type_name -> dnd5e.api.v1alpha1.DamageType
	133, // 253: dnd5e.api.v1alpha1.SpellDamage.damage_at_slot_level:type_name -> dnd5e.api.v1alpha1.DamageAtSlotLevel
	180, // 254: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest.equipment_type:type_name -> dnd5e.api.v1alpha1.EquipmentType
	102, // 255: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	154, // 256: dnd5e.api.v1alpha1.ListSpellsByLevelRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	170, // 257: dnd5e.api.v1alpha1.ListSpellsByLevelResponse.spells:type_name -> dnd5e.api.v1alpha1.Spell
	106, // 258: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.equipment_slots:type_name -> dnd5e.api.v1alpha1.EquipmentSlots
	107, // 259: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.inventory:type_name -> dnd5e.api.v1alpha1.InventoryItem
	108, // 260: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.encumbrance:type_name -> dnd5e.api.v1alpha1.EncumbranceInfo
	9,   // 261: dnd5e.api.v1alpha1.EquipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	14,  // 262: dnd5e.api.v1alpha1.EquipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	107, // 263: dnd5e.api.v1alpha1.EquipItemResponse.previously_equipped_item:type_name -> dnd5e.api.v1alpha1.InventoryItem
	9,   // 264: dnd5e.api.v1alpha1.UnequipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	14,  // 265: dnd5e.api.v1alpha1.UnequipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	146, // 266: dnd5e.api.v1alpha1.AddToInventoryRequest.items:type_name -> dnd5e.api.v1alpha1.InventoryAddition
	14,  // 267: dnd5e.api.v1alpha1.AddToInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	14,  // 268: dnd5e.api.v1alpha1.RemoveFromInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	32,  // 269: dnd5e.api.v1alpha1.CharacterService.CreateDraft:input_type -> dnd5e.api.v1alpha1.CreateDraftRequest
	34,  // 270: dnd5e.api.v1alpha1.CharacterService.GetDraft:input_type -> dnd5e.api.v1alpha1.GetDraftRequest
	50,  // 271: dnd5e.api.v1alpha1.CharacterService.ListDrafts:input_type -> dnd5e.api.v1alpha1.ListDraftsRequest
	58,  // 272: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:input_type -> dnd5e.api.v1alpha1.DeleteDraftRequest
	38,  // 273: dnd5e.api.v1alpha1.CharacterService.UpdateName:input_type -> dnd5e.api.v1alpha1.UpdateNameRequest
	39,  // 274: dnd5e.api.v1alpha1.CharacterService.UpdateRace:input_type -> dnd5e.api.v1alpha1.UpdateRaceRequest
	40,  // 275: dnd5e.api.v1alpha1.CharacterService.UpdateClass:input_type -> dnd5e.api.v1alpha1.UpdateClassRequest
	41,  // 276: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:input_type -> dnd5e.api.v1alpha1.UpdateBackgroundRequest
	42,  // 277: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:input_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	43,  // 278: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:input_type -> dnd5e.api.v1alpha1.UpdateSkillsRequest
	52,  // 279: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:input_type -> dnd5e.api.v1alpha1.ValidateDraftRequest
	54,  // 280: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:input_type -> dnd5e.api.v1alpha1.GetDraftPreviewRequest
	56,  // 281: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:input_type -> dnd5e.api.v1alpha1.FinalizeDraftRequest
	20,  // 282: dnd5e.api.v1alpha1.CharacterService.GetCharacter:input_type -> dnd5e.api.v1alpha1.GetCharacterRequest
	22,  // 283: dnd5e.api.v1alpha1.CharacterService.ListCharacters:input_type -> dnd5e.api.v1alpha1.ListCharactersRequest
	26,  // 284: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:input_type -> dnd5e.api.v1alpha1.DeleteCharacterRequest
	78,  // 285: dnd5e.api.v1alpha1.CharacterService.ListRaces:input_type -> dnd5e.api.v1alpha1.ListRacesRequest
	80,  // 286: dnd5e.api.v1alpha1.CharacterService.ListClasses:input_type -> dnd5e.api.v1alpha1.ListClassesRequest
	82,  // 287: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:input_type -> dnd5e.api.v1alpha1.ListBackgroundsRequest
	84,  // 288: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:input_type -> dnd5e.api.v1alpha1.GetRaceDetailsRequest
	86,  // 289: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:input_type -> dnd5e.api.v1alpha1.GetClassDetailsRequest
	88,  // 290: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:input_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	90,  // 291: dnd5e.api.v1alpha1.CharacterService.GetFeature:input_type -> dnd5e.api.v1alpha1.GetFeatureRequest
	92,  // 292: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:input_type -> dnd5e.api.v1alpha1.RollAbilityScoresRequest
	95,  // 293: dnd5e.api.v1alpha1.CharacterService.GetRequirements:input_type -> dnd5e.api.v1alpha1.GetRequirementsRequest
	97,  // 294: dnd5e.api.v1alpha1.CharacterService.SubmitChoices:input_type -> dnd5e.api.v1alpha1.SubmitChoicesRequest
	135, // 295: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:input_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	137, // 296: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:input_type -> dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	139, // 297: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:input_type -> dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	141, // 298: dnd5e.api.v1alpha1.CharacterService.EquipItem:input_type -> dnd5e.api.v1alpha1.EquipItemRequest
	143, // 299: dnd5e.api.v1alpha1.CharacterService.UnequipItem:input_type -> dnd5e.api.v1alpha1.UnequipItemRequest
	145, // 300: dnd5e.api.v1alpha1.CharacterService.AddToInventory:input_type -> dnd5e.api.v1alpha1.AddToInventoryRequest
	148, // 301: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:input_type -> dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	33,  // 302: dnd5e.api.v1alpha1.CharacterService.CreateDraft:output_type -> dnd5e.api.v1alpha1.CreateDraftResponse
	35,  // 303: dnd5e.api.v1alpha1.CharacterService.GetDraft:output_type -> dnd5e.api.v1alpha1.GetDraftResponse
	51,  // 304: dnd5e.api.v1alpha1.CharacterService.ListDrafts:output_type -> dnd5e.api.v1alpha1.ListDraftsResponse
	59,  // 305: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:output_type -> dnd5e.api.v1alpha1.DeleteDraftResponse
	44,  // 306: dnd5e.api.v1alpha1.CharacterService.UpdateName:output_type -> dnd5e.api.v1alpha1.UpdateNameResponse
	45,  // 307: dnd5e.api.v1alpha1.CharacterService.UpdateRace:output_type -> dnd5e.api.v1alpha1.UpdateRaceResponse
	46,  // 308: dnd5e.api.v1alpha1.CharacterService.UpdateClass:output_type -> dnd5e.api.v1alpha1.UpdateClassResponse
	47,  // 309: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:output_type -> dnd5e.api.v1alpha1.UpdateBackgroundResponse
	48,  // 310: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:output_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	49,  // 311: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:output_type -> dnd5e.api.v1alpha1.UpdateSkillsResponse
	53,  // 312: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:output_type -> dnd5e.api.v1alpha1.ValidateDraftResponse
	55,  // 313: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:output_type -> dnd5e.api.v1alpha1.GetDraftPreviewResponse
	57,  // 314: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:output_type -> dnd5e.api.v1alpha1.FinalizeDraftResponse
	21,  // 315: dnd5e.api.v1alpha1.CharacterService.GetCharacter:output_type -> dnd5e.api.v1alpha1.GetCharacterResponse
	23,  // 316: dnd5e.api.v1alpha1.CharacterService.ListCharacters:output_type -> dnd5e.api.v1alpha1.ListCharactersResponse
	27,  // 317: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:output_type -> dnd5e.api.v1alpha1.DeleteCharacterResponse
	79,  // 318: dnd5e.api.v1alpha1.CharacterService.ListRaces:output_type -> dnd5e.api.v1alpha1.ListRacesResponse
	81,  // 319: dnd5e.api.v1alpha1.CharacterService.ListClasses:output_type -> dnd5e.api.v1alpha1.ListClassesResponse
	83,  // 320: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:output_type -> dnd5e.api.v1alpha1.ListBackgroundsResponse
	85,  // 321: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:output_type -> dnd5e.api.v1alpha1.GetRaceDetailsResponse
	87,  // 322: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:output_type -> dnd5e.api.v1alpha1.GetClassDetailsResponse
	89,  // 323: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:output_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	91,  // 324: dnd5e.api.v1alpha1.CharacterService.GetFeature:output_type -> dnd5e.api.v1alpha1.GetFeatureResponse
	94,  // 325: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:output_type -> dnd5e.api.v1alpha1.RollAbilityScoresResponse
	96,  // 326: dnd5e.api.v1alpha1.CharacterService.GetRequirements:output_type -> dnd5e.api.v1alpha1.GetRequirementsResponse
	98,  // 327: dnd5e.api.v1alpha1.CharacterService.SubmitChoices:output_type -> dnd5e.api.v1alpha1.SubmitChoicesResponse
	136, // 328: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:output_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	138, // 329: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:output_type -> dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	140, // 330: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:output_type -> dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	142, // 331: dnd5e.api.v1alpha1.CharacterService.EquipItem:output_type -> dnd5e.api.v1alpha1.EquipItemResponse
	144, // 332: dnd5e.api.v1alpha1.CharacterService.UnequipItem:output_type -> dnd5e.api.v1alpha1.UnequipItemResponse
	147, // 333: dnd5e.api.v1alpha1.CharacterService.AddToInventory:output_type -> dnd5e.api.v1alpha1.AddToInventoryResponse
	149, // 334: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:output_type -> dnd5e.api.v1alpha1.RemoveFromInventoryResponse
	302, // [302:335] is the sub-list for method output_type
	269, // [269:302] is the sub-list for method input_type
...
func file_dnd5e_api_v1alpha1_character_proto_init() {
	...
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[138].OneofWrappers = []any{
