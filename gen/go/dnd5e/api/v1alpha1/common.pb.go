...
const file_dnd5e_api_v1alpha1_common_proto_rawDesc = "" +
	...
	"\x10SEVERITY_WARNING\x10\x03\"\xb3\x02\n" +
	"\tSourceRef\x124\n" +
	...
	"\x05spell\x18\x05 \x01(\x0e2\x19.dnd5e.api.v1alpha1.SpellH\x00R\x05spellB\b\n" +
	"\x06source*\xaf\x02\n" +
...
var file_dnd5e_api_v1alpha1_common_proto_depIdxs = []int32{
	...
	2,  // 7: dnd5e.api.v1alpha1.ValidationResult.Issue.severity:type_name -> dnd5e.api.v1alpha1.ValidationResult.Severity
	0,  // 8: dnd5e.api.v1alpha1.ValidationResult.Issue.source:type_name -> dnd5e.api.v1alpha1.ValidationSource
	1,  // 9: dnd5e.api.v1alpha1.ValidationResult.Issue.field:type_name -> dnd5e.api.v1alpha1.ValidationField
