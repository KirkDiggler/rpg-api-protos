...
const file_api_v1alpha1_dice_proto_rawDesc = "" +
	...
	"\x10ClearRollSession\x12%.api.v1alpha1.ClearRollSessionRequest\x1a&.api.v1alpha1.ClearRollSessionResponseB\x90\x01\n" +
	"\x10com.api.v1alpha1B\tDiceProtoP\x01Z clients/api/v1alpha1;apiv1alpha1\xa2\x02\x03AXX\xaa\x02\fApi.V1alpha1\xca\x02\fApi\\V1alpha1\xe2\x02\x18Api\\V1alpha1\\GPBMetadata\xea\x02\rApi::V1alpha1b\x06proto3"
