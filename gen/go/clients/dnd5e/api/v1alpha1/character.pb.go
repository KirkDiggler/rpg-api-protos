...
const (
	...
	ChoiceSource_CHOICE_SOURCE_RACE        ChoiceSource = 1
	ChoiceSource_CHOICE_SOURCE_SUBRACE     ChoiceSource = 2
	ChoiceSource_CHOICE_SOURCE_CLASS       ChoiceSource = 3
	ChoiceSource_CHOICE_SOURCE_BACKGROUND  ChoiceSource = 4
)
...
var (
	ChoiceSource_name = map[int32]string{
		...
		1: "CHOICE_SOURCE_RACE",
		2: "CHOICE_SOURCE_SUBRACE",
		3: "CHOICE_SOURCE_CLASS",
		4: "CHOICE_SOURCE_BACKGROUND",
	}
...
type CharacterDraftData struct {
	...
	Choices []*ChoiceSelection `protobuf:"bytes,11,rep,name=choices,proto3" json:"choices,omitempty"`
...
func (x *CharacterDraftData) GetChoices() []*ChoiceSelection {
	if x != nil {
		return x.Choices
	}
	return nil
...
func (x *CharacterDraft) GetChoices() []*ChoiceSelection {
	if x != nil {
		return x.Choices
	}
	return nil
...
type UpdateRaceRequest struct {
	...
	RaceChoices   []*ChoiceSelection     `protobuf:"bytes,4,rep,name=race_choices,json=raceChoices,proto3" json:"race_choices,omitempty"`       // Choices made for this race
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateRaceRequest) GetRaceChoices() []*ChoiceSelection {
	if x != nil {
...
type UpdateClassRequest struct {
	...
	ClassChoices  []*ChoiceSelection     `protobuf:"bytes,3,rep,name=class_choices,json=classChoices,proto3" json:"class_choices,omitempty"` // Choices made for this class
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateClassRequest) GetClassChoices() []*ChoiceSelection {
	if x != nil {
...
type UpdateBackgroundRequest struct {
	...
	BackgroundChoices []*ChoiceSelection     `protobuf:"bytes,3,rep,name=background_choices,json=backgroundChoices,proto3" json:"background_choices,omitempty"` // Choices made for this background
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *UpdateBackgroundRequest) GetBackgroundChoices() []*ChoiceSelection {
	if x != nil {
...
type GetDraftPreviewResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Draft         *CharacterDraft        `protobuf:"bytes,1,opt,name=draft,proto3" json:"draft,omitempty"`     // The draft with choices
...
type ChoiceSelection struct {
	state        protoimpl.MessageState `protogen:"open.v1"`
	ChoiceId     string                 `protobuf:"bytes,1,opt,name=choice_id,json=choiceId,proto3" json:"choice_id,omitempty"`                                           // ID from Choice in RaceInfo/ClassInfo
	ChoiceType   ChoiceType             `protobuf:"varint,2,opt,name=choice_type,json=choiceType,proto3,enum=dnd5e.api.v1alpha1.ChoiceType" json:"choice_type,omitempty"` // EQUIPMENT, SKILL, etc.
	...
	SelectedKeys []string               `protobuf:"bytes,4,rep,name=selected_keys,json=selectedKeys,proto3" json:"selected_keys,omitempty"`                               // What was selected
	// For ability score choices
	AbilityScoreChoices []*AbilityScoreChoice `protobuf:"bytes,5,rep,name=ability_score_choices,json=abilityScoreChoices,proto3" json:"ability_score_choices,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ChoiceSelection) GetChoiceId() string {
	if x != nil {
		return x.ChoiceId
	}
	return ""
...
func (x *ChoiceSelection) GetChoiceType() ChoiceType {
	if x != nil {
		return x.ChoiceType
	}
	return ChoiceType_CHOICE_TYPE_UNSPECIFIED
...
func (x *ChoiceSelection) GetSource() ChoiceSource {
	if x != nil {
		return x.Source
	}
...
func (x *ChoiceSelection) GetSelectedKeys() []string {
	if x != nil {
		return x.SelectedKeys
	}
	return nil
}

func (x *ChoiceSelection) GetAbilityScoreChoices() []*AbilityScoreChoice {
	if x != nil {
		return x.AbilityScoreChoices
	}
	return nil
}
...
type AbilityScoreChoice struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Ability       Ability                `protobuf:"varint,1,opt,name=ability,proto3,enum=dnd5e.api.v1alpha1.Ability" json:"ability,omitempty"`
	Bonus         int32                  `protobuf:"varint,2,opt,name=bonus,proto3" json:"bonus,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AbilityScoreChoice) Reset() {
	*x = AbilityScoreChoice{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[92]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AbilityScoreChoice) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AbilityScoreChoice) ProtoMessage() {}

func (x *AbilityScoreChoice) ProtoReflect() protoreflect.Message {
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[92]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AbilityScoreChoice.ProtoReflect.Descriptor instead.
func (*AbilityScoreChoice) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{92}
}

func (x *AbilityScoreChoice) GetAbility() Ability {
	if x != nil {
		return x.Ability
	}
...
func (x *AbilityScoreChoice) GetBonus() int32 {
	if x != nil {
		return x.Bonus
	}
	return 0
...
const file_dnd5e_api_v1alpha1_character_proto_rawDesc = "" +
	...
	"\bcharisma\x18\x06 \x01(\x05R\bcharisma\"\x82\t\n" +
	"\tCharacter\x12\x0e\n" +
	...
	"\vencumbrance\x18\x15 \x01(\v2#.dnd5e.api.v1alpha1.EncumbranceInfoR\vencumbrance\"\xc8\x01\n" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage\"\xee\x05\n" +
	...
	"\talignment\x18\n" +
	" \x01(\x0e2\x1d.dnd5e.api.v1alpha1.AlignmentR\talignment\x12=\n" +
	"\achoices\x18\v \x03(\v2#.dnd5e.api.v1alpha1.ChoiceSelectionR\achoices\x12@\n" +
	...
	"\bmetadata\x18\x10 \x01(\v2!.dnd5e.api.v1alpha1.DraftMetadataR\bmetadata\"\xf8\x02\n" +
	...
	"\x12discord_message_id\x18\x04 \x01(\tR\x10discordMessageId\"\xfa\x05\n" +
	...
	"\n" +
	"updated_at\x18\x0f \x01(\x03R\tupdatedAt\x12=\n" +
	"\bmetadata\x18\x10 \x01(\v2!.dnd5e.api.v1alpha1.DraftMetadataR\bmetadata\"\x9b\x01\n" +
	...
	"\asubrace\x18\x03 \x01(\x0e2\x1b.dnd5e.api.v1alpha1.SubraceR\asubrace\x12F\n" +
	"\frace_choices\x18\x04 \x03(\v2#.dnd5e.api.v1alpha1.ChoiceSelectionR\vraceChoices\"\xaa\x01\n" +
	"\x12UpdateClassRequest\x12\x19\n" +
	"\bdraft_id\x18\x01 \x01(\tR\adraftId\x12/\n" +
	"\x05class\x18\x02 \x01(\x0e2\x19.dnd5e.api.v1alpha1.ClassR\x05class\x12H\n" +
	"\rclass_choices\x18\x03 \x03(\v2#.dnd5e.api.v1alpha1.ChoiceSelectionR\fclassChoices\"\xc8\x01\n" +
	"\x17UpdateBackgroundRequest\x12\x19\n" +
	"\bdraft_id\x18\x01 \x01(\tR\adraftId\x12>\n" +
	"\n" +
	"background\x18\x02 \x01(\x0e2\x1e.dnd5e.api.v1alpha1.BackgroundR\n" +
	"background\x12R\n" +
	"\x12background_choices\x18\x03 \x03(\v2#.dnd5e.api.v1alpha1.ChoiceSelectionR\x11backgroundChoices\"\xe5\x01\n" +
	...
	"\rmissing_steps\x18\x05 \x03(\x0e2 .dnd5e.api.v1alpha1.CreationStepR\fmissingSteps\"3\n" +
	"\x16GetDraftPreviewRequest\x12\x19\n" +
	"\bdraft_id\x18\x01 \x01(\tR\adraftId\"\x8c\x02\n" +
	"\x17GetDraftPreviewResponse\x128\n" +
	"\x05draft\x18\x01 \x01(\v2\".dnd5e.api.v1alpha1.CharacterDraftR\x05draft\x127\n" +
	"\apreview\x18\x02 \x01(\v2\x1d.dnd5e.api.v1alpha1.CharacterR\apreview\x12A\n" +
	"\bwarnings\x18\x03 \x03(\v2%.dnd5e.api.v1alpha1.ValidationWarningR\bwarnings\x12;\n" +
	"\x06errors\x18\x04 \x03(\v2#.dnd5e.api.v1alpha1.ValidationErrorR\x06errors\"1\n" +
	...
	"\x0earea_of_effect\x18\x0e \x01(\v2 .dnd5e.api.v1alpha1.AreaOfEffectR\fareaOfEffect\"\xaa\x02\n" +
	"\x0fChoiceSelection\x12\x1b\n" +
	"\tchoice_id\x18\x01 \x01(\tR\bchoiceId\x12?\n" +
	"\vchoice_type\x18\x02 \x01(\x0e2\x1e.dnd5e.api.v1alpha1.ChoiceTypeR\n" +
	"choiceType\x128\n" +
	"\x06source\x18\x03 \x01(\x0e2 .dnd5e.api.v1alpha1.ChoiceSourceR\x06source\x12#\n" +
	"\rselected_keys\x18\x04 \x03(\tR\fselectedKeys\x12Z\n" +
	"\x15ability_score_choices\x18\x05 \x03(\v2&.dnd5e.api.v1alpha1.AbilityScoreChoiceR\x13abilityScoreChoices\"a\n" +
	"\x12AbilityScoreChoice\x125\n" +
	"\aability\x18\x01 \x01(\x0e2\x1b.dnd5e.api.v1alpha1.AbilityR\aability\x12\x14\n" +
	"\x05bonus\x18\x02 \x01(\x05R\x05bonus\"\x86\x01\n" +
	...
	"\tcharacter\x18\x01 \x01(\v2\x1d.dnd5e.api.v1alpha1.CharacterR\tcharacter\x12)\n" +
	"\x10quantity_removed\x18\x02 \x01(\x05R\x0fquantityRemoved*\x87\x02\n" +
	...
	"\x1dENCUMBRANCE_LEVEL_IMMOBILIZED\x10\x04*\x97\x01\n" +
	"\fChoiceSource\x12\x1d\n" +
	"\x19CHOICE_SOURCE_UNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12CHOICE_SOURCE_RACE\x10\x01\x12\x19\n" +
	"\x15CHOICE_SOURCE_SUBRACE\x10\x02\x12\x17\n" +
	"\x13CHOICE_SOURCE_CLASS\x10\x03\x12\x1c\n" +
	"\x18CHOICE_SOURCE_BACKGROUND\x10\x04*\xd8\x02\n" +
	...
	"\x13RemoveFromInventory\x12..dnd5e.api.v1alpha1.RemoveFromInventoryRequest\x1a/.dnd5e.api.v1alpha1.RemoveFromInventoryResponseB\xba\x01\n" +
...
var file_dnd5e_api_v1alpha1_character_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
...
var file_dnd5e_api_v1alpha1_character_proto_goTypes = []any{
	...
	(ChoiceSource)(0),                     // 6: dnd5e.api.v1alpha1.ChoiceSource
	(EquipmentSlot)(0),                    // 7: dnd5e.api.v1alpha1.EquipmentSlot
	(*AbilityScores)(nil),                 // 8: dnd5e.api.v1alpha1.AbilityScores
	...
	(*Proficiencies)(nil),                 // 12: dnd5e.api.v1alpha1.Proficiencies
	(*CharacterMetadata)(nil),             // 13: dnd5e.api.v1alpha1.CharacterMetadata
	(*GetCharacterRequest)(nil),           // 14: dnd5e.api.v1alpha1.GetCharacterRequest
	(*GetCharacterResponse)(nil),          // 15: dnd5e.api.v1alpha1.GetCharacterResponse
	(*ListCharactersRequest)(nil),         // 16: dnd5e.api.v1alpha1.ListCharactersRequest
	(*ListCharactersResponse)(nil),        // 17: dnd5e.api.v1alpha1.ListCharactersResponse
	(*UpdateCharacterRequest)(nil),        // 18: dnd5e.api.v1alpha1.UpdateCharacterRequest
	(*UpdateCharacterResponse)(nil),       // 19: dnd5e.api.v1alpha1.UpdateCharacterResponse
	(*DeleteCharacterRequest)(nil),        // 20: dnd5e.api.v1alpha1.DeleteCharacterRequest
	(*DeleteCharacterResponse)(nil),       // 21: dnd5e.api.v1alpha1.DeleteCharacterResponse
	(*CharacterDraftData)(nil),            // 22: dnd5e.api.v1alpha1.CharacterDraftData
	(*CreationProgress)(nil),              // 23: dnd5e.api.v1alpha1.CreationProgress
	(*DraftMetadata)(nil),                 // 24: dnd5e.api.v1alpha1.DraftMetadata
	(*CharacterDraft)(nil),                // 25: dnd5e.api.v1alpha1.CharacterDraft
	(*CreateDraftRequest)(nil),            // 26: dnd5e.api.v1alpha1.CreateDraftRequest
	(*CreateDraftResponse)(nil),           // 27: dnd5e.api.v1alpha1.CreateDraftResponse
	(*GetDraftRequest)(nil),               // 28: dnd5e.api.v1alpha1.GetDraftRequest
	(*GetDraftResponse)(nil),              // 29: dnd5e.api.v1alpha1.GetDraftResponse
	(*UpdateDraftRequest)(nil),            // 30: dnd5e.api.v1alpha1.UpdateDraftRequest
	(*UpdateDraftResponse)(nil),           // 31: dnd5e.api.v1alpha1.UpdateDraftResponse
	(*UpdateNameRequest)(nil),             // 32: dnd5e.api.v1alpha1.UpdateNameRequest
	(*UpdateRaceRequest)(nil),             // 33: dnd5e.api.v1alpha1.UpdateRaceRequest
	(*UpdateClassRequest)(nil),            // 34: dnd5e.api.v1alpha1.UpdateClassRequest
	(*UpdateBackgroundRequest)(nil),       // 35: dnd5e.api.v1alpha1.UpdateBackgroundRequest
	(*UpdateAbilityScoresRequest)(nil),    // 36: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	(*UpdateSkillsRequest)(nil),           // 37: dnd5e.api.v1alpha1.UpdateSkillsRequest
	(*UpdateNameResponse)(nil),            // 38: dnd5e.api.v1alpha1.UpdateNameResponse
	(*UpdateRaceResponse)(nil),            // 39: dnd5e.api.v1alpha1.UpdateRaceResponse
	(*UpdateClassResponse)(nil),           // 40: dnd5e.api.v1alpha1.UpdateClassResponse
	(*UpdateBackgroundResponse)(nil),      // 41: dnd5e.api.v1alpha1.UpdateBackgroundResponse
	(*UpdateAbilityScoresResponse)(nil),   // 42: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	(*UpdateSkillsResponse)(nil),          // 43: dnd5e.api.v1alpha1.UpdateSkillsResponse
	(*ListDraftsRequest)(nil),             // 44: dnd5e.api.v1alpha1.ListDraftsRequest
	(*ListDraftsResponse)(nil),            // 45: dnd5e.api.v1alpha1.ListDraftsResponse
	(*ValidateDraftRequest)(nil),          // 46: dnd5e.api.v1alpha1.ValidateDraftRequest
	(*ValidateDraftResponse)(nil),         // 47: dnd5e.api.v1alpha1.ValidateDraftResponse
	(*GetDraftPreviewRequest)(nil),        // 48: dnd5e.api.v1alpha1.GetDraftPreviewRequest
	(*GetDraftPreviewResponse)(nil),       // 49: dnd5e.api.v1alpha1.GetDraftPreviewResponse
	(*FinalizeDraftRequest)(nil),          // 50: dnd5e.api.v1alpha1.FinalizeDraftRequest
	(*FinalizeDraftResponse)(nil),         // 51: dnd5e.api.v1alpha1.FinalizeDraftResponse
	(*DeleteDraftRequest)(nil),            // 52: dnd5e.api.v1alpha1.DeleteDraftRequest
	(*DeleteDraftResponse)(nil),           // 53: dnd5e.api.v1alpha1.DeleteDraftResponse
	(*RaceInfo)(nil),                      // 54: dnd5e.api.v1alpha1.RaceInfo
	(*SubraceInfo)(nil),                   // 55: dnd5e.api.v1alpha1.SubraceInfo
	(*RacialTrait)(nil),                   // 56: dnd5e.api.v1alpha1.RacialTrait
	(*Choice)(nil),                        // 57: dnd5e.api.v1alpha1.Choice
	(*ExplicitOptions)(nil),               // 58: dnd5e.api.v1alpha1.ExplicitOptions
	(*CategoryReference)(nil),             // 59: dnd5e.api.v1alpha1.CategoryReference
	(*ChoiceOption)(nil),                  // 60: dnd5e.api.v1alpha1.ChoiceOption
	(*ItemReference)(nil),                 // 61: dnd5e.api.v1alpha1.ItemReference
	(*CountedItemReference)(nil),          // 62: dnd5e.api.v1alpha1.CountedItemReference
	(*ItemBundle)(nil),                    // 63: dnd5e.api.v1alpha1.ItemBundle
	(*BundleItem)(nil),                    // 64: dnd5e.api.v1alpha1.BundleItem
	(*NestedChoice)(nil),                  // 65: dnd5e.api.v1alpha1.NestedChoice
	(*ClassInfo)(nil),                     // 66: dnd5e.api.v1alpha1.ClassInfo
	(*SpellcastingInfo)(nil),              // 67: dnd5e.api.v1alpha1.SpellcastingInfo
	(*BackgroundInfo)(nil),                // 68: dnd5e.api.v1alpha1.BackgroundInfo
	(*FeatureInfo)(nil),                   // 69: dnd5e.api.v1alpha1.FeatureInfo
	(*SpellSelectionInfo)(nil),            // 70: dnd5e.api.v1alpha1.SpellSelectionInfo
	(*ListRacesRequest)(nil),              // 71: dnd5e.api.v1alpha1.ListRacesRequest
	(*ListRacesResponse)(nil),             // 72: dnd5e.api.v1alpha1.ListRacesResponse
	(*ListClassesRequest)(nil),            // 73: dnd5e.api.v1alpha1.ListClassesRequest
	(*ListClassesResponse)(nil),           // 74: dnd5e.api.v1alpha1.ListClassesResponse
	(*ListBackgroundsRequest)(nil),        // 75: dnd5e.api.v1alpha1.ListBackgroundsRequest
	(*ListBackgroundsResponse)(nil),       // 76: dnd5e.api.v1alpha1.ListBackgroundsResponse
	(*GetRaceDetailsRequest)(nil),         // 77: dnd5e.api.v1alpha1.GetRaceDetailsRequest
	(*GetRaceDetailsResponse)(nil),        // 78: dnd5e.api.v1alpha1.GetRaceDetailsResponse
	(*GetClassDetailsRequest)(nil),        // 79: dnd5e.api.v1alpha1.GetClassDetailsRequest
	(*GetClassDetailsResponse)(nil),       // 80: dnd5e.api.v1alpha1.GetClassDetailsResponse
	(*GetBackgroundDetailsRequest)(nil),   // 81: dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	(*GetBackgroundDetailsResponse)(nil),  // 82: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	(*GetFeatureRequest)(nil),             // 83: dnd5e.api.v1alpha1.GetFeatureRequest
	(*GetFeatureResponse)(nil),            // 84: dnd5e.api.v1alpha1.GetFeatureResponse
	(*RollAbilityScoresRequest)(nil),      // 85: dnd5e.api.v1alpha1.RollAbilityScoresRequest
	(*AbilityScoreRoll)(nil),              // 86: dnd5e.api.v1alpha1.AbilityScoreRoll
	(*RollAbilityScoresResponse)(nil),     // 87: dnd5e.api.v1alpha1.RollAbilityScoresResponse
	(*RollAssignments)(nil),               // 88: dnd5e.api.v1alpha1.RollAssignments
	(*Cost)(nil),                          // 89: dnd5e.api.v1alpha1.Cost
	(*Weight)(nil),                        // 90: dnd5e.api.v1alpha1.Weight
	(*Equipment)(nil),                     // 91: dnd5e.api.v1alpha1.Equipment
	(*WeaponData)(nil),                    // 92: dnd5e.api.v1alpha1.WeaponData
	(*ArmorData)(nil),                     // 93: dnd5e.api.v1alpha1.ArmorData
	(*GearData)(nil),                      // 94: dnd5e.api.v1alpha1.GearData
	(*EquipmentSlots)(nil),                // 95: dnd5e.api.v1alpha1.EquipmentSlots
	(*InventoryItem)(nil),                 // 96: dnd5e.api.v1alpha1.InventoryItem
	(*EncumbranceInfo)(nil),               // 97: dnd5e.api.v1alpha1.EncumbranceInfo
	(*Spell)(nil),                         // 98: dnd5e.api.v1alpha1.Spell
	(*ChoiceSelection)(nil),               // 99: dnd5e.api.v1alpha1.ChoiceSelection
	(*AbilityScoreChoice)(nil),            // 100: dnd5e.api.v1alpha1.AbilityScoreChoice
	(*SpellDamage)(nil),                   // 101: dnd5e.api.v1alpha1.SpellDamage
	(*DamageAtSlotLevel)(nil),             // 102: dnd5e.api.v1alpha1.DamageAtSlotLevel
	(*AreaOfEffect)(nil),                  // 103: dnd5e.api.v1alpha1.AreaOfEffect
	(*ListEquipmentByTypeRequest)(nil),    // 104: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	(*ListEquipmentByTypeResponse)(nil),   // 105: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	(*ListSpellsByLevelRequest)(nil),      // 106: dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	(*ListSpellsByLevelResponse)(nil),     // 107: dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	(*GetCharacterInventoryRequest)(nil),  // 108: dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	(*GetCharacterInventoryResponse)(nil), // 109: dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	(*EquipItemRequest)(nil),              // 110: dnd5e.api.v1alpha1.EquipItemRequest
	(*EquipItemResponse)(nil),             // 111: dnd5e.api.v1alpha1.EquipItemResponse
	(*UnequipItemRequest)(nil),            // 112: dnd5e.api.v1alpha1.UnequipItemRequest
	(*UnequipItemResponse)(nil),           // 113: dnd5e.api.v1alpha1.UnequipItemResponse
	(*AddToInventoryRequest)(nil),         // 114: dnd5e.api.v1alpha1.AddToInventoryRequest
	(*InventoryAddition)(nil),             // 115: dnd5e.api.v1alpha1.InventoryAddition
	(*AddToInventoryResponse)(nil),        // 116: dnd5e.api.v1alpha1.AddToInventoryResponse
	(*RemoveFromInventoryRequest)(nil),    // 117: dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	(*RemoveFromInventoryResponse)(nil),   // 118: dnd5e.api.v1alpha1.RemoveFromInventoryResponse
	nil,                                   // 119: dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	nil,                                   // 120: dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	...
	(Language)(0),                         // 126: dnd5e.api.v1alpha1.Language
	(Skill)(0),                            // 127: dnd5e.api.v1alpha1.Skill
	(Ability)(0),                          // 128: dnd5e.api.v1alpha1.Ability
	(*ValidationWarning)(nil),             // 129: dnd5e.api.v1alpha1.ValidationWarning
	(*ValidationError)(nil),               // 130: dnd5e.api.v1alpha1.ValidationError
	(EquipmentType)(0),                    // 131: dnd5e.api.v1alpha1.EquipmentType
}
var file_dnd5e_api_v1alpha1_character_proto_depIdxs = []int32{
	121, // 0: dnd5e.api.v1alpha1.Character.race:type_name -> dnd5e.api.v1alpha1.Race
	122, // 1: dnd5e.api.v1alpha1.Character.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	123, // 2: dnd5e.api.v1alpha1.Character.class:type_name -> dnd5e.api.v1alpha1.Class
	124, // 3: dnd5e.api.v1alpha1.Character.background:type_name -> dnd5e.api.v1alpha1.Background
	125, // 4: dnd5e.api.v1alpha1.Character.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	8,   // 5: dnd5e.api.v1alpha1.Character.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	10,  // 6: dnd5e.api.v1alpha1.Character.ability_modifiers:type_name -> dnd5e.api.v1alpha1.AbilityModifiers
	11,  // 7: dnd5e.api.v1alpha1.Character.combat_stats:type_name -> dnd5e.api.v1alpha1.CombatStats
	12,  // 8: dnd5e.api.v1alpha1.Character.proficiencies:type_name -> dnd5e.api.v1alpha1.Proficiencies
	126, // 9: dnd5e.api.v1alpha1.Character.languages:type_name -> dnd5e.api.v1alpha1.Language
	13,  // 10: dnd5e.api.v1alpha1.Character.metadata:type_name -> dnd5e.api.v1alpha1.CharacterMetadata
	95,  // 11: dnd5e.api.v1alpha1.Character.equipment_slots:type_name -> dnd5e.api.v1alpha1.EquipmentSlots
	96,  // 12: dnd5e.api.v1alpha1.Character.inventory:type_name -> dnd5e.api.v1alpha1.InventoryItem
	97,  // 13: dnd5e.api.v1alpha1.Character.encumbrance:type_name -> dnd5e.api.v1alpha1.EncumbranceInfo
	127, // 14: dnd5e.api.v1alpha1.Proficiencies.skills:type_name -> dnd5e.api.v1alpha1.Skill
	128, // 15: dnd5e.api.v1alpha1.Proficiencies.saving_throws:type_name -> dnd5e.api.v1alpha1.Ability
	9,   // 16: dnd5e.api.v1alpha1.GetCharacterResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	9,   // 17: dnd5e.api.v1alpha1.ListCharactersResponse.characters:type_name -> dnd5e.api.v1alpha1.Character
	9,   // 18: dnd5e.api.v1alpha1.UpdateCharacterRequest.character:type_name -> dnd5e.api.v1alpha1.Character
	9,   // 19: dnd5e.api.v1alpha1.UpdateCharacterResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	121, // 20: dnd5e.api.v1alpha1.CharacterDraftData.race:type_name -> dnd5e.api.v1alpha1.Race
	122, // 21: dnd5e.api.v1alpha1.CharacterDraftData.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	123, // 22: dnd5e.api.v1alpha1.CharacterDraftData.class:type_name -> dnd5e.api.v1alpha1.Class
	124, // 23: dnd5e.api.v1alpha1.CharacterDraftData.background:type_name -> dnd5e.api.v1alpha1.Background
	8,   // 24: dnd5e.api.v1alpha1.CharacterDraftData.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	125, // 25: dnd5e.api.v1alpha1.CharacterDraftData.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	99,  // 26: dnd5e.api.v1alpha1.CharacterDraftData.choices:type_name -> dnd5e.api.v1alpha1.ChoiceSelection
	23,  // 27: dnd5e.api.v1alpha1.CharacterDraftData.progress:type_name -> dnd5e.api.v1alpha1.CreationProgress
	24,  // 28: dnd5e.api.v1alpha1.CharacterDraftData.metadata:type_name -> dnd5e.api.v1alpha1.DraftMetadata
	0,   // 29: dnd5e.api.v1alpha1.CreationProgress.current_step:type_name -> dnd5e.api.v1alpha1.CreationStep
	54,  // 30: dnd5e.api.v1alpha1.CharacterDraft.race:type_name -> dnd5e.api.v1alpha1.RaceInfo
	55,  // 31: dnd5e.api.v1alpha1.CharacterDraft.subrace:type_name -> dnd5e.api.v1alpha1.SubraceInfo
	66,  // 32: dnd5e.api.v1alpha1.CharacterDraft.class:type_name -> dnd5e.api.v1alpha1.ClassInfo
	68,  // 33: dnd5e.api.v1alpha1.CharacterDraft.background:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	8,   // 34: dnd5e.api.v1alpha1.CharacterDraft.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	125, // 35: dnd5e.api.v1alpha1.CharacterDraft.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	99,  // 36: dnd5e.api.v1alpha1.CharacterDraft.choices:type_name -> dnd5e.api.v1alpha1.ChoiceSelection
	23,  // 37: dnd5e.api.v1alpha1.CharacterDraft.progress:type_name -> dnd5e.api.v1alpha1.CreationProgress
	24,  // 38: dnd5e.api.v1alpha1.CharacterDraft.metadata:type_name -> dnd5e.api.v1alpha1.DraftMetadata
	22,  // 39: dnd5e.api.v1alpha1.CreateDraftRequest.initial_data:type_name -> dnd5e.api.v1alpha1.CharacterDraftData
	25,  // 40: dnd5e.api.v1alpha1.CreateDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	25,  // 41: dnd5e.api.v1alpha1.GetDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	22,  // 42: dnd5e.api.v1alpha1.UpdateDraftRequest.updates:type_name -> dnd5e.api.v1alpha1.CharacterDraftData
	25,  // 43: dnd5e.api.v1alpha1.UpdateDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	129, // 44: dnd5e.api.v1alpha1.UpdateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	121, // 45: dnd5e.api.v1alpha1.UpdateRaceRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	122, // 46: dnd5e.api.v1alpha1.UpdateRaceRequest.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	99,  // 47: dnd5e.api.v1alpha1.UpdateRaceRequest.race_choices:type_name -> dnd5e.api.v1alpha1.ChoiceSelection
	123, // 48: dnd5e.api.v1alpha1.UpdateClassRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	99,  // 49: dnd5e.api.v1alpha1.UpdateClassRequest.class_choices:type_name -> dnd5e.api.v1alpha1.ChoiceSelection
	124, // 50: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background:type_name -> dnd5e.api.v1alpha1.Background
	99,  // 51: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background_choices:type_name -> dnd5e.api.v1alpha1.ChoiceSelection
	8,   // 52: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	88,  // 53: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.roll_assignments:type_name -> dnd5e.api.v1alpha1.RollAssignments
	127, // 54: dnd5e.api.v1alpha1.UpdateSkillsRequest.skills:type_name -> dnd5e.api.v1alpha1.Skill
	25,  // 55: dnd5e.api.v1alpha1.UpdateNameResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	129, // 56: dnd5e.api.v1alpha1.UpdateNameResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	25,  // 57: dnd5e.api.v1alpha1.UpdateRaceResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	129, // 58: dnd5e.api.v1alpha1.UpdateRaceResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	25,  // 59: dnd5e.api.v1alpha1.UpdateClassResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	129, // 60: dnd5e.api.v1alpha1.UpdateClassResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	25,  // 61: dnd5e.api.v1alpha1.UpdateBackgroundResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	129, // 62: dnd5e.api.v1alpha1.UpdateBackgroundResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	25,  // 63: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	129, // 64: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	25,  // 65: dnd5e.api.v1alpha1.UpdateSkillsResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	129, // 66: dnd5e.api.v1alpha1.UpdateSkillsResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	25,  // 67: dnd5e.api.v1alpha1.ListDraftsResponse.drafts:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	130, // 68: dnd5e.api.v1alpha1.ValidateDraftResponse.errors:type_name -> dnd5e.api.v1alpha1.ValidationError
	129, // 69: dnd5e.api.v1alpha1.ValidateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	0,   // 70: dnd5e.api.v1alpha1.ValidateDraftResponse.missing_steps:type_name -> dnd5e.api.v1alpha1.CreationStep
	25,  // 71: dnd5e.api.v1alpha1.GetDraftPreviewResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	9,   // 72: dnd5e.api.v1alpha1.GetDraftPreviewResponse.preview:type_name -> dnd5e.api.v1alpha1.Character
	129, // 73: dnd5e.api.v1alpha1.GetDraftPreviewResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	130, // 74: dnd5e.api.v1alpha1.GetDraftPreviewResponse.errors:type_name -> dnd5e.api.v1alpha1.ValidationError
	9,   // 75: dnd5e.api.v1alpha1.FinalizeDraftResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	3,   // 76: dnd5e.api.v1alpha1.RaceInfo.size:type_name -> dnd5e.api.v1alpha1.Size
	119, // 77: dnd5e.api.v1alpha1.RaceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	56,  // 78: dnd5e.api.v1alpha1.RaceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	55,  // 79: dnd5e.api.v1alpha1.RaceInfo.subraces:type_name -> dnd5e.api.v1alpha1.SubraceInfo
	126, // 80: dnd5e.api.v1alpha1.RaceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	57,  // 81: dnd5e.api.v1alpha1.RaceInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	120, // 82: dnd5e.api.v1alpha1.SubraceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	56,  // 83: dnd5e.api.v1alpha1.SubraceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	126, // 84: dnd5e.api.v1alpha1.SubraceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	2,   // 85: dnd5e.api.v1alpha1.Choice.choice_type:type_name -> dnd5e.api.v1alpha1.ChoiceType
	58,  // 86: dnd5e.api.v1alpha1.Choice.explicit_options:type_name -> dnd5e.api.v1alpha1.ExplicitOptions
	59,  // 87: dnd5e.api.v1alpha1.Choice.category_reference:type_name -> dnd5e.api.v1alpha1.CategoryReference
	60,  // 88: dnd5e.api.v1alpha1.ExplicitOptions.options:type_name -> dnd5e.api.v1alpha1.ChoiceOption
	61,  // 89: dnd5e.api.v1alpha1.ChoiceOption.item:type_name -> dnd5e.api.v1alpha1.ItemReference
	62,  // 90: dnd5e.api.v1alpha1.ChoiceOption.counted_item:type_name -> dnd5e.api.v1alpha1.CountedItemReference
	63,  // 91: dnd5e.api.v1alpha1.ChoiceOption.bundle:type_name -> dnd5e.api.v1alpha1.ItemBundle
	65,  // 92: dnd5e.api.v1alpha1.ChoiceOption.nested_choice:type_name -> dnd5e.api.v1alpha1.NestedChoice
	64,  // 93: dnd5e.api.v1alpha1.ItemBundle.items:type_name -> dnd5e.api.v1alpha1.BundleItem
	62,  // 94: dnd5e.api.v1alpha1.BundleItem.concrete_item:type_name -> dnd5e.api.v1alpha1.CountedItemReference
	65,  // 95: dnd5e.api.v1alpha1.BundleItem.choice_item:type_name -> dnd5e.api.v1alpha1.NestedChoice
	57,  // 96: dnd5e.api.v1alpha1.NestedChoice.choice:type_name -> dnd5e.api.v1alpha1.Choice
	69,  // 97: dnd5e.api.v1alpha1.ClassInfo.level_1_features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	67,  // 98: dnd5e.api.v1alpha1.ClassInfo.spellcasting:type_name -> dnd5e.api.v1alpha1.SpellcastingInfo
	57,  // 99: dnd5e.api.v1alpha1.ClassInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	126, // 100: dnd5e.api.v1alpha1.BackgroundInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	57,  // 101: dnd5e.api.v1alpha1.FeatureInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	70,  // 102: dnd5e.api.v1alpha1.FeatureInfo.spell_selection:type_name -> dnd5e.api.v1alpha1.SpellSelectionInfo
	4,   // 103: dnd5e.api.v1alpha1.SpellSelectionInfo.selection_type:type_name -> dnd5e.api.v1alpha1.SpellSelectionType
	54,  // 104: dnd5e.api.v1alpha1.ListRacesResponse.races:type_name -> dnd5e.api.v1alpha1.RaceInfo
	66,  // 105: dnd5e.api.v1alpha1.ListClassesResponse.classes:type_name -> dnd5e.api.v1alpha1.ClassInfo
	68,  // 106: dnd5e.api.v1alpha1.ListBackgroundsResponse.backgrounds:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	54,  // 107: dnd5e.api.v1alpha1.GetRaceDetailsResponse.race:type_name -> dnd5e.api.v1alpha1.RaceInfo
	66,  // 108: dnd5e.api.v1alpha1.GetClassDetailsResponse.class:type_name -> dnd5e.api.v1alpha1.ClassInfo
	68,  // 109: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse.background:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	69,  // 110: dnd5e.api.v1alpha1.GetFeatureResponse.feature:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	86,  // 111: dnd5e.api.v1alpha1.RollAbilityScoresResponse.rolls:type_name -> dnd5e.api.v1alpha1.AbilityScoreRoll
	89,  // 112: dnd5e.api.v1alpha1.Equipment.cost:type_name -> dnd5e.api.v1alpha1.Cost
	90,  // 113: dnd5e.api.v1alpha1.Equipment.weight:type_name -> dnd5e.api.v1alpha1.Weight
	92,  // 114: dnd5e.api.v1alpha1.Equipment.weapon_data:type_name -> dnd5e.api.v1alpha1.WeaponData
	93,  // 115: dnd5e.api.v1alpha1.Equipment.armor_data:type_name -> dnd5e.api.v1alpha1.ArmorData
	94,  // 116: dnd5e.api.v1alpha1.Equipment.gear_data:type_name -> dnd5e.api.v1alpha1.GearData
	96,  // 117: dnd5e.api.v1alpha1.EquipmentSlots.main_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	96,  // 118: dnd5e.api.v1alpha1.EquipmentSlots.off_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	96,  // 119: dnd5e.api.v1alpha1.EquipmentSlots.armor:type_name -> dnd5e.api.v1alpha1.InventoryItem
	96,  // 120: dnd5e.api.v1alpha1.EquipmentSlots.helmet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	96,  // 121: dnd5e.api.v1alpha1.EquipmentSlots.boots:type_name -> dnd5e.api.v1alpha1.InventoryItem
	96,  // 122: dnd5e.api.v1alpha1.EquipmentSlots.gloves:type_name -> dnd5e.api.v1alpha1.InventoryItem
	96,  // 123: dnd5e.api.v1alpha1.EquipmentSlots.cloak:type_name -> dnd5e.api.v1alpha1.InventoryItem
	96,  // 124: dnd5e.api.v1alpha1.EquipmentSlots.amulet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	96,  // 125: dnd5e.api.v1alpha1.EquipmentSlots.ring_1:type_name -> dnd5e.api.v1alpha1.InventoryItem
	96,  // 126: dnd5e.api.v1alpha1.EquipmentSlots.ring_2:type_name -> dnd5e.api.v1alpha1.InventoryItem
	96,  // 127: dnd5e.api.v1alpha1.EquipmentSlots.belt:type_name -> dnd5e.api.v1alpha1.InventoryItem
	91,  // 128: dnd5e.api.v1alpha1.InventoryItem.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	5,   // 129: dnd5e.api.v1alpha1.EncumbranceInfo.level:type_name -> dnd5e.api.v1alpha1.EncumbranceLevel
	101, // 130: dnd5e.api.v1alpha1.Spell.damage:type_name -> dnd5e.api.v1alpha1.SpellDamage
	103, // 131: dnd5e.api.v1alpha1.Spell.area_of_effect:type_name -> dnd5e.api.v1alpha1.AreaOfEffect
	2,   // 132: dnd5e.api.v1alpha1.ChoiceSelection.choice_type:type_name -> dnd5e.api.v1alpha1.ChoiceType
	6,   // 133: dnd5e.api.v1alpha1.ChoiceSelection.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	100, // 134: dnd5e.api.v1alpha1.ChoiceSelection.ability_score_choices:type_name -> dnd5e.api.v1alpha1.AbilityScoreChoice
	128, // 135: dnd5e.api.v1alpha1.AbilityScoreChoice.ability:type_name -> dnd5e.api.v1alpha1.Ability
	102, // 136: dnd5e.api.v1alpha1.SpellDamage.damage_at_slot_level:type_name -> dnd5e.api.v1alpha1.DamageAtSlotLevel
	131, // 137: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest.equipment_type:type_name -> dnd5e.api.v1alpha1.EquipmentType
	91,  // 138: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	123, // 139: dnd5e.api.v1alpha1.ListSpellsByLevelRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	98,  // 140: dnd5e.api.v1alpha1.ListSpellsByLevelResponse.spells:type_name -> dnd5e.api.v1alpha1.Spell
	95,  // 141: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.equipment_slots:type_name -> dnd5e.api.v1alpha1.EquipmentSlots
	96,  // 142: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.inventory:type_name -> dnd5e.api.v1alpha1.InventoryItem
	97,  // 143: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.encumbrance:type_name -> dnd5e.api.v1alpha1.EncumbranceInfo
	7,   // 144: dnd5e.api.v1alpha1.EquipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	9,   // 145: dnd5e.api.v1alpha1.EquipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	96,  // 146: dnd5e.api.v1alpha1.EquipItemResponse.previously_equipped_item:type_name -> dnd5e.api.v1alpha1.InventoryItem
	7,   // 147: dnd5e.api.v1alpha1.UnequipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	9,   // 148: dnd5e.api.v1alpha1.UnequipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	115, // 149: dnd5e.api.v1alpha1.AddToInventoryRequest.items:type_name -> dnd5e.api.v1alpha1.InventoryAddition
	9,   // 150: dnd5e.api.v1alpha1.AddToInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	9,   // 151: dnd5e.api.v1alpha1.RemoveFromInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	26,  // 152: dnd5e.api.v1alpha1.CharacterService.CreateDraft:input_type -> dnd5e.api.v1alpha1.CreateDraftRequest
	28,  // 153: dnd5e.api.v1alpha1.CharacterService.GetDraft:input_type -> dnd5e.api.v1alpha1.GetDraftRequest
	44,  // 154: dnd5e.api.v1alpha1.CharacterService.ListDrafts:input_type -> dnd5e.api.v1alpha1.ListDraftsRequest
	52,  // 155: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:input_type -> dnd5e.api.v1alpha1.DeleteDraftRequest
	32,  // 156: dnd5e.api.v1alpha1.CharacterService.UpdateName:input_type -> dnd5e.api.v1alpha1.UpdateNameRequest
	33,  // 157: dnd5e.api.v1alpha1.CharacterService.UpdateRace:input_type -> dnd5e.api.v1alpha1.UpdateRaceRequest
	34,  // 158: dnd5e.api.v1alpha1.CharacterService.UpdateClass:input_type -> dnd5e.api.v1alpha1.UpdateClassRequest
	35,  // 159: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:input_type -> dnd5e.api.v1alpha1.UpdateBackgroundRequest
	36,  // 160: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:input_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	37,  // 161: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:input_type -> dnd5e.api.v1alpha1.UpdateSkillsRequest
	46,  // 162: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:input_type -> dnd5e.api.v1alpha1.ValidateDraftRequest
	48,  // 163: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:input_type -> dnd5e.api.v1alpha1.GetDraftPreviewRequest
	50,  // 164: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:input_type -> dnd5e.api.v1alpha1.FinalizeDraftRequest
	14,  // 165: dnd5e.api.v1alpha1.CharacterService.GetCharacter:input_type -> dnd5e.api.v1alpha1.GetCharacterRequest
	16,  // 166: dnd5e.api.v1alpha1.CharacterService.ListCharacters:input_type -> dnd5e.api.v1alpha1.ListCharactersRequest
	20,  // 167: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:input_type -> dnd5e.api.v1alpha1.DeleteCharacterRequest
	71,  // 168: dnd5e.api.v1alpha1.CharacterService.ListRaces:input_type -> dnd5e.api.v1alpha1.ListRacesRequest
	73,  // 169: dnd5e.api.v1alpha1.CharacterService.ListClasses:input_type -> dnd5e.api.v1alpha1.ListClassesRequest
	75,  // 170: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:input_type -> dnd5e.api.v1alpha1.ListBackgroundsRequest
	77,  // 171: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:input_type -> dnd5e.api.v1alpha1.GetRaceDetailsRequest
	79,  // 172: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:input_type -> dnd5e.api.v1alpha1.GetClassDetailsRequest
	81,  // 173: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:input_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	83,  // 174: dnd5e.api.v1alpha1.CharacterService.GetFeature:input_type -> dnd5e.api.v1alpha1.GetFeatureRequest
	85,  // 175: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:input_type -> dnd5e.api.v1alpha1.RollAbilityScoresRequest
	104, // 176: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:input_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	106, // 177: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:input_type -> dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	108, // 178: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:input_type -> dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	110, // 179: dnd5e.api.v1alpha1.CharacterService.EquipItem:input_type -> dnd5e.api.v1alpha1.EquipItemRequest
	112, // 180: dnd5e.api.v1alpha1.CharacterService.UnequipItem:input_type -> dnd5e.api.v1alpha1.UnequipItemRequest
	114, // 181: dnd5e.api.v1alpha1.CharacterService.AddToInventory:input_type -> dnd5e.api.v1alpha1.AddToInventoryRequest
	117, // 182: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:input_type -> dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	27,  // 183: dnd5e.api.v1alpha1.CharacterService.CreateDraft:output_type -> dnd5e.api.v1alpha1.CreateDraftResponse
	29,  // 184: dnd5e.api.v1alpha1.CharacterService.GetDraft:output_type -> dnd5e.api.v1alpha1.GetDraftResponse
	45,  // 185: dnd5e.api.v1alpha1.CharacterService.ListDrafts:output_type -> dnd5e.api.v1alpha1.ListDraftsResponse
	53,  // 186: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:output_type -> dnd5e.api.v1alpha1.DeleteDraftResponse
	38,  // 187: dnd5e.api.v1alpha1.CharacterService.UpdateName:output_type -> dnd5e.api.v1alpha1.UpdateNameResponse
	39,  // 188: dnd5e.api.v1alpha1.CharacterService.UpdateRace:output_type -> dnd5e.api.v1alpha1.UpdateRaceResponse
	40,  // 189: dnd5e.api.v1alpha1.CharacterService.UpdateClass:output_type -> dnd5e.api.v1alpha1.UpdateClassResponse
	41,  // 190: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:output_type -> dnd5e.api.v1alpha1.UpdateBackgroundResponse
	42,  // 191: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:output_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	43,  // 192: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:output_type -> dnd5e.api.v1alpha1.UpdateSkillsResponse
	47,  // 193: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:output_type -> dnd5e.api.v1alpha1.ValidateDraftResponse
	49,  // 194: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:output_type -> dnd5e.api.v1alpha1.GetDraftPreviewResponse
	51,  // 195: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:output_type -> dnd5e.api.v1alpha1.FinalizeDraftResponse
	15,  // 196: dnd5e.api.v1alpha1.CharacterService.GetCharacter:output_type -> dnd5e.api.v1alpha1.GetCharacterResponse
	17,  // 197: dnd5e.api.v1alpha1.CharacterService.ListCharacters:output_type -> dnd5e.api.v1alpha1.ListCharactersResponse
	21,  // 198: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:output_type -> dnd5e.api.v1alpha1.DeleteCharacterResponse
	72,  // 199: dnd5e.api.v1alpha1.CharacterService.ListRaces:output_type -> dnd5e.api.v1alpha1.ListRacesResponse
	74,  // 200: dnd5e.api.v1alpha1.CharacterService.ListClasses:output_type -> dnd5e.api.v1alpha1.ListClassesResponse
	76,  // 201: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:output_type -> dnd5e.api.v1alpha1.ListBackgroundsResponse
	78,  // 202: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:output_type -> dnd5e.api.v1alpha1.GetRaceDetailsResponse
	80,  // 203: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:output_type -> dnd5e.api.v1alpha1.GetClassDetailsResponse
	82,  // 204: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:output_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	84,  // 205: dnd5e.api.v1alpha1.CharacterService.GetFeature:output_type -> dnd5e.api.v1alpha1.GetFeatureResponse
	87,  // 206: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:output_type -> dnd5e.api.v1alpha1.RollAbilityScoresResponse
	105, // 207: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:output_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	107, // 208: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:output_type -> dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	109, // 209: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:output_type -> dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	111, // 210: dnd5e.api.v1alpha1.CharacterService.EquipItem:output_type -> dnd5e.api.v1alpha1.EquipItemResponse
	113, // 211: dnd5e.api.v1alpha1.CharacterService.UnequipItem:output_type -> dnd5e.api.v1alpha1.UnequipItemResponse
	116, // 212: dnd5e.api.v1alpha1.CharacterService.AddToInventory:output_type -> dnd5e.api.v1alpha1.AddToInventoryResponse
	118, // 213: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:output_type -> dnd5e.api.v1alpha1.RemoveFromInventoryResponse
...
func file_dnd5e_api_v1alpha1_character_proto_init() {
	...
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[28].OneofWrappers = []any{
