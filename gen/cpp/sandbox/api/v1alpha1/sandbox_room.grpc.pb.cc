...
static const char* SandboxRoomService_method_names[] = {
  ...
  "/sandbox.api.v1alpha1.SandboxRoomService/CreateSandbox",
  "/sandbox.api.v1alpha1.SandboxRoomService/GetSandbox",
  "/sandbox.api.v1alpha1.SandboxRoomService/DeleteSandbox",
};
...
SandboxRoomService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_CreateSandbox_(SandboxRoomService_method_names[13], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetSandbox_(SandboxRoomService_method_names[14], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteSandbox_(SandboxRoomService_method_names[15], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status SandboxRoomService::Stub::CreateSandbox(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::CreateSandboxRequest& request, ::sandbox::api::v1alpha1::CreateSandboxResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::sandbox::api::v1alpha1::CreateSandboxRequest, ::sandbox::api::v1alpha1::CreateSandboxResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_CreateSandbox_, context, request, response);
}

void SandboxRoomService::Stub::async::CreateSandbox(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::CreateSandboxRequest* request, ::sandbox::api::v1alpha1::CreateSandboxResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::sandbox::api::v1alpha1::CreateSandboxRequest, ::sandbox::api::v1alpha1::CreateSandboxResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_CreateSandbox_, context, request, response, std::move(f));
}

void SandboxRoomService::Stub::async::CreateSandbox(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::CreateSandboxRequest* request, ::sandbox::api::v1alpha1::CreateSandboxResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_CreateSandbox_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::sandbox::api::v1alpha1::CreateSandboxResponse>* SandboxRoomService::Stub::PrepareAsyncCreateSandboxRaw(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::CreateSandboxRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::sandbox::api::v1alpha1::CreateSandboxResponse, ::sandbox::api::v1alpha1::CreateSandboxRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_CreateSandbox_, context, request);
}

::grpc::ClientAsyncResponseReader< ::sandbox::api::v1alpha1::CreateSandboxResponse>* SandboxRoomService::Stub::AsyncCreateSandboxRaw(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::CreateSandboxRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncCreateSandboxRaw(context, request, cq);
  result->StartCall();
  return result;
}

::grpc::Status SandboxRoomService::Stub::GetSandbox(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::GetSandboxRequest& request, ::sandbox::api::v1alpha1::GetSandboxResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::sandbox::api::v1alpha1::GetSandboxRequest, ::sandbox::api::v1alpha1::GetSandboxResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetSandbox_, context, request, response);
}

void SandboxRoomService::Stub::async::GetSandbox(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::GetSandboxRequest* request, ::sandbox::api::v1alpha1::GetSandboxResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::sandbox::api::v1alpha1::GetSandboxRequest, ::sandbox::api::v1alpha1::GetSandboxResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetSandbox_, context, request, response, std::move(f));
}

void SandboxRoomService::Stub::async::GetSandbox(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::GetSandboxRequest* request, ::sandbox::api::v1alpha1::GetSandboxResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetSandbox_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::sandbox::api::v1alpha1::GetSandboxResponse>* SandboxRoomService::Stub::PrepareAsyncGetSandboxRaw(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::GetSandboxRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::sandbox::api::v1alpha1::GetSandboxResponse, ::sandbox::api::v1alpha1::GetSandboxRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetSandbox_, context, request);
}

::grpc::ClientAsyncResponseReader< ::sandbox::api::v1alpha1::GetSandboxResponse>* SandboxRoomService::Stub::AsyncGetSandboxRaw(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::GetSandboxRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncGetSandboxRaw(context, request, cq);
  result->StartCall();
  return result;
}

::grpc::Status SandboxRoomService::Stub::DeleteSandbox(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::DeleteSandboxRequest& request, ::sandbox::api::v1alpha1::DeleteSandboxResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::sandbox::api::v1alpha1::DeleteSandboxRequest, ::sandbox::api::v1alpha1::DeleteSandboxResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_DeleteSandbox_, context, request, response);
}

void SandboxRoomService::Stub::async::DeleteSandbox(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::DeleteSandboxRequest* request, ::sandbox::api::v1alpha1::DeleteSandboxResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::sandbox::api::v1alpha1::DeleteSandboxRequest, ::sandbox::api::v1alpha1::DeleteSandboxResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_DeleteSandbox_, context, request, response, std::move(f));
}

void SandboxRoomService::Stub::async::DeleteSandbox(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::DeleteSandboxRequest* request, ::sandbox::api::v1alpha1::DeleteSandboxResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_DeleteSandbox_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::sandbox::api::v1alpha1::DeleteSandboxResponse>* SandboxRoomService::Stub::PrepareAsyncDeleteSandboxRaw(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::DeleteSandboxRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::sandbox::api::v1alpha1::DeleteSandboxResponse, ::sandbox::api::v1alpha1::DeleteSandboxRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_DeleteSandbox_, context, request);
}

::grpc::ClientAsyncResponseReader< ::sandbox::api::v1alpha1::DeleteSandboxResponse>* SandboxRoomService::Stub::AsyncDeleteSandboxRaw(::grpc::ClientContext* context, const ::sandbox::api::v1alpha1::DeleteSandboxRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncDeleteSandboxRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
SandboxRoomService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      SandboxRoomService_method_names[13],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SandboxRoomService::Service, ::sandbox::api::v1alpha1::CreateSandboxRequest, ::sandbox::api::v1alpha1::CreateSandboxResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SandboxRoomService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::sandbox::api::v1alpha1::CreateSandboxRequest* req,
             ::sandbox::api::v1alpha1::CreateSandboxResponse* resp) {
               return service->CreateSandbox(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      SandboxRoomService_method_names[14],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SandboxRoomService::Service, ::sandbox::api::v1alpha1::GetSandboxRequest, ::sandbox::api::v1alpha1::GetSandboxResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SandboxRoomService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::sandbox::api::v1alpha1::GetSandboxRequest* req,
             ::sandbox::api::v1alpha1::GetSandboxResponse* resp) {
               return service->GetSandbox(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      SandboxRoomService_method_names[15],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SandboxRoomService::Service, ::sandbox::api::v1alpha1::DeleteSandboxRequest, ::sandbox::api::v1alpha1::DeleteSandboxResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SandboxRoomService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::sandbox::api::v1alpha1::DeleteSandboxRequest* req,
             ::sandbox::api::v1alpha1::DeleteSandboxResponse* resp) {
               return service->DeleteSandbox(ctx, req, resp);
             }, this)));
}
...
::grpc::Status SandboxRoomService::Service::CreateSandbox(::grpc::ServerContext* context, const ::sandbox::api::v1alpha1::CreateSandboxRequest* request, ::sandbox::api::v1alpha1::CreateSandboxResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status SandboxRoomService::Service::GetSandbox(::grpc::ServerContext* context, const ::sandbox::api::v1alpha1::GetSandboxRequest* request, ::sandbox::api::v1alpha1::GetSandboxResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status SandboxRoomService::Service::DeleteSandbox(::grpc::ServerContext* context, const ::sandbox::api::v1alpha1::DeleteSandboxRequest* request, ::sandbox::api::v1alpha1::DeleteSandboxResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
