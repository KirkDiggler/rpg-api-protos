...
var file_dnd5e_api_v1alpha1_common_proto_goTypes = []any{
	...
	(ConditionId)(0),               // 15: dnd5e.api.v1alpha1.ConditionId
...
var file_dnd5e_api_v1alpha1_common_proto_depIdxs = []int32{
	12, // 0: dnd5e.api.v1alpha1.ValidationResult.issues:type_name -> dnd5e.api.v1alpha1.ValidationResult.Issue
	13, // 1: dnd5e.api.v1alpha1.SourceRef.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	14, // 2: dnd5e.api.v1alpha1.SourceRef.ability:type_name -> dnd5e.api.v1alpha1.Ability
	15, // 3: dnd5e.api.v1alpha1.SourceRef.condition:type_name -> dnd5e.api.v1alpha1.ConditionId
	16, // 4: dnd5e.api.v1alpha1.SourceRef.feature:type_name -> dnd5e.api.v1alpha1.FeatureId
	17, // 5: dnd5e.api.v1alpha1.SourceRef.spell:type_name -> dnd5e.api.v1alpha1.Spell
	2,  // 6: dnd5e.api.v1alpha1.ValidationResult.Issue.severity:type_name -> dnd5e.api.v1alpha1.ValidationResult.Severity
	0,  // 7: dnd5e.api.v1alpha1.ValidationResult.Issue.source:type_name -> dnd5e.api.v1alpha1.ValidationSource
	1,  // 8: dnd5e.api.v1alpha1.ValidationResult.Issue.field:type_name -> dnd5e.api.v1alpha1.ValidationField
