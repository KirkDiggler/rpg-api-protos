...
var file_dnd5e_api_v1alpha1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_dnd5e_api_v1alpha1_common_proto_goTypes = []any{
	...
	(*SourceRef)(nil),              // 10: dnd5e.api.v1alpha1.SourceRef
	(*ValidationResult_Issue)(nil), // 11: dnd5e.api.v1alpha1.ValidationResult.Issue
	(ConditionId)(0),               // 12: dnd5e.api.v1alpha1.ConditionId
	(Weapon)(0),                    // 13: dnd5e.api.v1alpha1.Weapon
	(Ability)(0),                   // 14: dnd5e.api.v1alpha1.Ability
	(FeatureId)(0),                 // 15: dnd5e.api.v1alpha1.FeatureId
	(Spell)(0),                     // 16: dnd5e.api.v1alpha1.Spell
	(MonsterTraitId)(0),            // 17: dnd5e.api.v1alpha1.MonsterTraitId
}
var file_dnd5e_api_v1alpha1_common_proto_depIdxs = []int32{
	12, // 0: dnd5e.api.v1alpha1.Condition.id:type_name -> dnd5e.api.v1alpha1.ConditionId
	11, // 1: dnd5e.api.v1alpha1.ValidationResult.issues:type_name -> dnd5e.api.v1alpha1.ValidationResult.Issue
	13, // 2: dnd5e.api.v1alpha1.SourceRef.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	14, // 3: dnd5e.api.v1alpha1.SourceRef.ability:type_name -> dnd5e.api.v1alpha1.Ability
	12, // 4: dnd5e.api.v1alpha1.SourceRef.condition:type_name -> dnd5e.api.v1alpha1.ConditionId
	15, // 5: dnd5e.api.v1alpha1.SourceRef.feature:type_name -> dnd5e.api.v1alpha1.FeatureId
	16, // 6: dnd5e.api.v1alpha1.SourceRef.spell:type_name -> dnd5e.api.v1alpha1.Spell
	17, // 7: dnd5e.api.v1alpha1.SourceRef.monster_trait:type_name -> dnd5e.api.v1alpha1.MonsterTraitId
...
func file_dnd5e_api_v1alpha1_common_proto_init() {
	...
	file_dnd5e_api_v1alpha1_common_proto_msgTypes[7].OneofWrappers = []any{
