...
const file_dnd5e_api_v1alpha1_encounter_proto_rawDesc = "" +
	"\n" +
	"\"dnd5e/api/v1alpha1/encounter.proto\x12\x12dnd5e.api.v1alpha1\x1a\x1eapi/v1alpha1/room_common.proto\x1a\"dnd5e/api/v1alpha1/character.proto\x1a\x1fdnd5e/api/v1alpha1/common.proto\"\xf1\x01\n" +
	...
	"\fupdated_room\x18\x05 \x01(\v2\x18.dnd5e.api.v1alpha1.RoomR\vupdatedRoom\"}\n" +
	...
	"\x14updated_combat_state\x18\x04 \x01(\v2\x1f.dnd5e.api.v1alpha1.CombatStateR\x12updatedCombatState2\xd5\x04\n" +
...
var file_dnd5e_api_v1alpha1_encounter_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_dnd5e_api_v1alpha1_encounter_proto_goTypes = []any{
	...
	(*RerollEvent)(nil),             // 17: dnd5e.api.v1alpha1.RerollEvent
	(*DamageComponent)(nil),         // 18: dnd5e.api.v1alpha1.DamageComponent
	(*DamageBreakdown)(nil),         // 19: dnd5e.api.v1alpha1.DamageBreakdown
	(*AttackResult)(nil),            // 20: dnd5e.api.v1alpha1.AttackResult
	(*AttackResponse)(nil),          // 21: dnd5e.api.v1alpha1.AttackResponse
	(*ActivateFeatureRequest)(nil),  // 22: dnd5e.api.v1alpha1.ActivateFeatureRequest
	(*ActivateFeatureResponse)(nil), // 23: dnd5e.api.v1alpha1.ActivateFeatureResponse
	nil,                             // 24: dnd5e.api.v1alpha1.Room.EntitiesEntry
	nil,                             // 25: dnd5e.api.v1alpha1.MovementError.DetailsEntry
	(*v1alpha1.Position)(nil),       // 26: api.v1alpha1.Position
	(v1alpha1.GridType)(0),          // 27: api.v1alpha1.GridType
	(*SourceRef)(nil),               // 28: dnd5e.api.v1alpha1.SourceRef
	(*Character)(nil),               // 29: dnd5e.api.v1alpha1.Character
}
var file_dnd5e_api_v1alpha1_encounter_proto_depIdxs = []int32{
	26, // 0: dnd5e.api.v1alpha1.EntityPlacement.position:type_name -> api.v1alpha1.Position
	27, // 1: dnd5e.api.v1alpha1.Room.grid_type:type_name -> api.v1alpha1.GridType
	24, // 2: dnd5e.api.v1alpha1.Room.entities:type_name -> dnd5e.api.v1alpha1.Room.EntitiesEntry
	...
	26, // 5: dnd5e.api.v1alpha1.TurnState.position:type_name -> api.v1alpha1.Position
	...
	26, // 10: dnd5e.api.v1alpha1.MoveCharacterRequest.path:type_name -> api.v1alpha1.Position
	0,  // 11: dnd5e.api.v1alpha1.MovementError.code:type_name -> dnd5e.api.v1alpha1.MovementError.ErrorCode
	25, // 12: dnd5e.api.v1alpha1.MovementError.details:type_name -> dnd5e.api.v1alpha1.MovementError.DetailsEntry
	11, // 13: dnd5e.api.v1alpha1.MoveCharacterResponse.error:type_name -> dnd5e.api.v1alpha1.MovementError
	26, // 14: dnd5e.api.v1alpha1.MoveCharacterResponse.final_position:type_name -> api.v1alpha1.Position
	2,  // 15: dnd5e.api.v1alpha1.MoveCharacterResponse.updated_room:type_name -> dnd5e.api.v1alpha1.Room
	...
	17, // 18: dnd5e.api.v1alpha1.DamageComponent.rerolls:type_name -> dnd5e.api.v1alpha1.RerollEvent
	28, // 19: dnd5e.api.v1alpha1.DamageComponent.source_ref:type_name -> dnd5e.api.v1alpha1.SourceRef
	18, // 20: dnd5e.api.v1alpha1.DamageBreakdown.components:type_name -> dnd5e.api.v1alpha1.DamageComponent
	19, // 21: dnd5e.api.v1alpha1.AttackResult.damage_breakdown:type_name -> dnd5e.api.v1alpha1.DamageBreakdown
	20, // 22: dnd5e.api.v1alpha1.AttackResponse.result:type_name -> dnd5e.api.v1alpha1.AttackResult
	7,  // 23: dnd5e.api.v1alpha1.AttackResponse.combat_state:type_name -> dnd5e.api.v1alpha1.CombatState
	2,  // 24: dnd5e.api.v1alpha1.AttackResponse.updated_room:type_name -> dnd5e.api.v1alpha1.Room
	29, // 25: dnd5e.api.v1alpha1.ActivateFeatureResponse.updated_character:type_name -> dnd5e.api.v1alpha1.Character
	7,  // 26: dnd5e.api.v1alpha1.ActivateFeatureResponse.updated_combat_state:type_name -> dnd5e.api.v1alpha1.CombatState
	1,  // 27: dnd5e.api.v1alpha1.Room.EntitiesEntry.value:type_name -> dnd5e.api.v1alpha1.EntityPlacement
	3,  // 28: dnd5e.api.v1alpha1.EncounterService.DungeonStart:input_type -> dnd5e.api.v1alpha1.DungeonStartRequest
	8,  // 29: dnd5e.api.v1alpha1.EncounterService.GetCombatState:input_type -> dnd5e.api.v1alpha1.GetCombatStateRequest
	10, // 30: dnd5e.api.v1alpha1.EncounterService.MoveCharacter:input_type -> dnd5e.api.v1alpha1.MoveCharacterRequest
	13, // 31: dnd5e.api.v1alpha1.EncounterService.EndTurn:input_type -> dnd5e.api.v1alpha1.EndTurnRequest
	16, // 32: dnd5e.api.v1alpha1.EncounterService.Attack:input_type -> dnd5e.api.v1alpha1.AttackRequest
	22, // 33: dnd5e.api.v1alpha1.EncounterService.ActivateFeature:input_type -> dnd5e.api.v1alpha1.ActivateFeatureRequest
	4,  // 34: dnd5e.api.v1alpha1.EncounterService.DungeonStart:output_type -> dnd5e.api.v1alpha1.DungeonStartResponse
	9,  // 35: dnd5e.api.v1alpha1.EncounterService.GetCombatState:output_type -> dnd5e.api.v1alpha1.GetCombatStateResponse
	12, // 36: dnd5e.api.v1alpha1.EncounterService.MoveCharacter:output_type -> dnd5e.api.v1alpha1.MoveCharacterResponse
	15, // 37: dnd5e.api.v1alpha1.EncounterService.EndTurn:output_type -> dnd5e.api.v1alpha1.EndTurnResponse
	21, // 38: dnd5e.api.v1alpha1.EncounterService.Attack:output_type -> dnd5e.api.v1alpha1.AttackResponse
	23, // 39: dnd5e.api.v1alpha1.EncounterService.ActivateFeature:output_type -> dnd5e.api.v1alpha1.ActivateFeatureResponse
