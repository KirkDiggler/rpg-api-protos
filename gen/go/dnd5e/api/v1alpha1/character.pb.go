...
func (x *RemoveFromInventoryResponse) Reset() {
	*x = RemoveFromInventoryResponse{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[144]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RemoveFromInventoryResponse) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{144}
}
...
const file_dnd5e_api_v1alpha1_character_proto_rawDesc = "" +
	...
	"\x0earea_of_effect\x18\x0e \x01(\v2 .dnd5e.api.v1alpha1.AreaOfEffectR\fareaOfEffect\"\x9b\b\n" +
	"\n" +
	"ChoiceData\x12>\n" +
	...
	"\vToolOptions\x126\n" +
	"\tavailable\x18\x01 \x03(\x0e2\x18.dnd5e.api.v1alpha1.ToolR\tavailable\"\x86\x01\n" +
...
var file_dnd5e_api_v1alpha1_character_proto_msgTypes = make([]protoimpl.MessageInfo, 147)
var file_dnd5e_api_v1alpha1_character_proto_goTypes = []any{
	...
	(*Spell)(nil),                         // 109: dnd5e.api.v1alpha1.Spell
	(*ChoiceData)(nil),                    // 110: dnd5e.api.v1alpha1.ChoiceData
	(*SkillList)(nil),                     // 111: dnd5e.api.v1alpha1.SkillList
	(*LanguageList)(nil),                  // 112: dnd5e.api.v1alpha1.LanguageList
	(*EquipmentList)(nil),                 // 113: dnd5e.api.v1alpha1.EquipmentList
	(*SpellList)(nil),                     // 114: dnd5e.api.v1alpha1.SpellList
	(*CantripList)(nil),                   // 115: dnd5e.api.v1alpha1.CantripList
	(*ExpertiseList)(nil),                 // 116: dnd5e.api.v1alpha1.ExpertiseList
	(*TraitList)(nil),                     // 117: dnd5e.api.v1alpha1.TraitList
	(*ToolProficiencyList)(nil),           // 118: dnd5e.api.v1alpha1.ToolProficiencyList
	(*RaceChoice)(nil),                    // 119: dnd5e.api.v1alpha1.RaceChoice
	(*ClassChoice)(nil),                   // 120: dnd5e.api.v1alpha1.ClassChoice
	(*EquipmentChoice)(nil),               // 121: dnd5e.api.v1alpha1.EquipmentChoice
	(*EquipmentOption)(nil),               // 122: dnd5e.api.v1alpha1.EquipmentOption
	(*EquipmentSelection)(nil),            // 123: dnd5e.api.v1alpha1.EquipmentSelection
	(*ChoiceSubmission)(nil),              // 124: dnd5e.api.v1alpha1.ChoiceSubmission
	(*SkillSelection)(nil),                // 125: dnd5e.api.v1alpha1.SkillSelection
	(*LanguageSelection)(nil),             // 126: dnd5e.api.v1alpha1.LanguageSelection
	(*FightingStyleSelection)(nil),        // 127: dnd5e.api.v1alpha1.FightingStyleSelection
	(*ToolSelection)(nil),                 // 128: dnd5e.api.v1alpha1.ToolSelection
	(*WeaponProficiencySelection)(nil),    // 129: dnd5e.api.v1alpha1.WeaponProficiencySelection
	(*ArmorProficiencySelection)(nil),     // 130: dnd5e.api.v1alpha1.ArmorProficiencySelection
	(*CharacterRequirements)(nil),         // 131: dnd5e.api.v1alpha1.CharacterRequirements
	(*RequiredChoice)(nil),                // 132: dnd5e.api.v1alpha1.RequiredChoice
	(*SkillOptions)(nil),                  // 133: dnd5e.api.v1alpha1.SkillOptions
	(*LanguageOptions)(nil),               // 134: dnd5e.api.v1alpha1.LanguageOptions
	(*FightingStyleOptions)(nil),          // 135: dnd5e.api.v1alpha1.FightingStyleOptions
	(*ToolOptions)(nil),                   // 136: dnd5e.api.v1alpha1.ToolOptions
	(*SpellDamage)(nil),                   // 137: dnd5e.api.v1alpha1.SpellDamage
	(*DamageAtSlotLevel)(nil),             // 138: dnd5e.api.v1alpha1.DamageAtSlotLevel
	(*AreaOfEffect)(nil),                  // 139: dnd5e.api.v1alpha1.AreaOfEffect
	(*ListEquipmentByTypeRequest)(nil),    // 140: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	(*ListEquipmentByTypeResponse)(nil),   // 141: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	(*ListSpellsByLevelRequest)(nil),      // 142: dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	(*ListSpellsByLevelResponse)(nil),     // 143: dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	(*GetCharacterInventoryRequest)(nil),  // 144: dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	(*GetCharacterInventoryResponse)(nil), // 145: dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	(*EquipItemRequest)(nil),              // 146: dnd5e.api.v1alpha1.EquipItemRequest
	(*EquipItemResponse)(nil),             // 147: dnd5e.api.v1alpha1.EquipItemResponse
	(*UnequipItemRequest)(nil),            // 148: dnd5e.api.v1alpha1.UnequipItemRequest
	(*UnequipItemResponse)(nil),           // 149: dnd5e.api.v1alpha1.UnequipItemResponse
	(*AddToInventoryRequest)(nil),         // 150: dnd5e.api.v1alpha1.AddToInventoryRequest
	(*InventoryAddition)(nil),             // 151: dnd5e.api.v1alpha1.InventoryAddition
	(*AddToInventoryResponse)(nil),        // 152: dnd5e.api.v1alpha1.AddToInventoryResponse
	(*RemoveFromInventoryRequest)(nil),    // 153: dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	(*RemoveFromInventoryResponse)(nil),   // 154: dnd5e.api.v1alpha1.RemoveFromInventoryResponse
	nil,                                   // 155: dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	nil,                                   // 156: dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	(Race)(0),                             // 157: dnd5e.api.v1alpha1.Race
	(Subrace)(0),                          // 158: dnd5e.api.v1alpha1.Subrace
	(Class)(0),                            // 159: dnd5e.api.v1alpha1.Class
	(Background)(0),                       // 160: dnd5e.api.v1alpha1.Background
	(Alignment)(0),                        // 161: dnd5e.api.v1alpha1.Alignment
	(Language)(0),                         // 162: dnd5e.api.v1alpha1.Language
	(FightingStyle)(0),                    // 163: dnd5e.api.v1alpha1.FightingStyle
	(Armor)(0),                            // 164: dnd5e.api.v1alpha1.Armor
	(Weapon)(0),                           // 165: dnd5e.api.v1alpha1.Weapon
	(Tool)(0),                             // 166: dnd5e.api.v1alpha1.Tool
	(Skill)(0),                            // 167: dnd5e.api.v1alpha1.Skill
	(Ability)(0),                          // 168: dnd5e.api.v1alpha1.Ability
	(Subclass)(0),                         // 169: dnd5e.api.v1alpha1.Subclass
	(*ValidationResult)(nil),              // 170: dnd5e.api.v1alpha1.ValidationResult
	(*ValidationWarning)(nil),             // 171: dnd5e.api.v1alpha1.ValidationWarning
	(*ValidationError)(nil),               // 172: dnd5e.api.v1alpha1.ValidationError
	(Pack)(0),                             // 173: dnd5e.api.v1alpha1.Pack
	(Ammunition)(0),                       // 174: dnd5e.api.v1alpha1.Ammunition
	(EquipmentType)(0),                    // 175: dnd5e.api.v1alpha1.EquipmentType
}
var file_dnd5e_api_v1alpha1_character_proto_depIdxs = []int32{
	...
	157, // 2: dnd5e.api.v1alpha1.Character.race:type_name -> dnd5e.api.v1alpha1.Race
	158, // 3: dnd5e.api.v1alpha1.Character.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	159, // 4: dnd5e.api.v1alpha1.Character.class:type_name -> dnd5e.api.v1alpha1.Class
	160, // 5: dnd5e.api.v1alpha1.Character.background:type_name -> dnd5e.api.v1alpha1.Background
	161, // 6: dnd5e.api.v1alpha1.Character.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	...
	162, // 11: dnd5e.api.v1alpha1.Character.languages:type_name -> dnd5e.api.v1alpha1.Language
	...
	163, // 17: dnd5e.api.v1alpha1.Character.fighting_styles:type_name -> dnd5e.api.v1alpha1.FightingStyle
	...
	164, // 22: dnd5e.api.v1alpha1.ProficiencyGrants.armor:type_name -> dnd5e.api.v1alpha1.Armor
	165, // 23: dnd5e.api.v1alpha1.ProficiencyGrants.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	166, // 24: dnd5e.api.v1alpha1.ProficiencyGrants.tools:type_name -> dnd5e.api.v1alpha1.Tool
	167, // 25: dnd5e.api.v1alpha1.ProficiencyGrants.skills:type_name -> dnd5e.api.v1alpha1.Skill
	162, // 26: dnd5e.api.v1alpha1.ProficiencyGrants.languages:type_name -> dnd5e.api.v1alpha1.Language
	167, // 27: dnd5e.api.v1alpha1.Proficiencies.skills:type_name -> dnd5e.api.v1alpha1.Skill
	168, // 28: dnd5e.api.v1alpha1.Proficiencies.saving_throws:type_name -> dnd5e.api.v1alpha1.Ability
	164, // 29: dnd5e.api.v1alpha1.Proficiencies.armor:type_name -> dnd5e.api.v1alpha1.Armor
	165, // 30: dnd5e.api.v1alpha1.Proficiencies.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	166, // 31: dnd5e.api.v1alpha1.Proficiencies.tools:type_name -> dnd5e.api.v1alpha1.Tool
	...
	157, // 36: dnd5e.api.v1alpha1.CharacterDraftData.race:type_name -> dnd5e.api.v1alpha1.Race
	158, // 37: dnd5e.api.v1alpha1.CharacterDraftData.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	159, // 38: dnd5e.api.v1alpha1.CharacterDraftData.class:type_name -> dnd5e.api.v1alpha1.Class
	169, // 39: dnd5e.api.v1alpha1.CharacterDraftData.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	160, // 40: dnd5e.api.v1alpha1.CharacterDraftData.background:type_name -> dnd5e.api.v1alpha1.Background
	13,  // 41: dnd5e.api.v1alpha1.CharacterDraftData.base_ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	110, // 42: dnd5e.api.v1alpha1.CharacterDraftData.choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	...
	157, // 45: dnd5e.api.v1alpha1.CharacterDraft.race:type_name -> dnd5e.api.v1alpha1.Race
	158, // 46: dnd5e.api.v1alpha1.CharacterDraft.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	159, // 47: dnd5e.api.v1alpha1.CharacterDraft.class:type_name -> dnd5e.api.v1alpha1.Class
	169, // 48: dnd5e.api.v1alpha1.CharacterDraft.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	160, // 49: dnd5e.api.v1alpha1.CharacterDraft.background:type_name -> dnd5e.api.v1alpha1.Background
	13,  // 50: dnd5e.api.v1alpha1.CharacterDraft.base_ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	110, // 51: dnd5e.api.v1alpha1.CharacterDraft.choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	29,  // 52: dnd5e.api.v1alpha1.CharacterDraft.progress:type_name -> dnd5e.api.v1alpha1.CreationProgress
	170, // 53: dnd5e.api.v1alpha1.CharacterDraft.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	...
	171, // 63: dnd5e.api.v1alpha1.UpdateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	157, // 64: dnd5e.api.v1alpha1.UpdateRaceRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	158, // 65: dnd5e.api.v1alpha1.UpdateRaceRequest.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	110, // 66: dnd5e.api.v1alpha1.UpdateRaceRequest.race_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	159, // 67: dnd5e.api.v1alpha1.UpdateClassRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	110, // 68: dnd5e.api.v1alpha1.UpdateClassRequest.class_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	169, // 69: dnd5e.api.v1alpha1.UpdateClassRequest.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	160, // 70: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background:type_name -> dnd5e.api.v1alpha1.Background
	110, // 71: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	...
	167, // 74: dnd5e.api.v1alpha1.UpdateSkillsRequest.skills:type_name -> dnd5e.api.v1alpha1.Skill
	31,  // 75: dnd5e.api.v1alpha1.UpdateNameResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	171, // 76: dnd5e.api.v1alpha1.UpdateNameResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 77: dnd5e.api.v1alpha1.UpdateRaceResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	171, // 78: dnd5e.api.v1alpha1.UpdateRaceResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 79: dnd5e.api.v1alpha1.UpdateClassResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	171, // 80: dnd5e.api.v1alpha1.UpdateClassResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 81: dnd5e.api.v1alpha1.UpdateBackgroundResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	171, // 82: dnd5e.api.v1alpha1.UpdateBackgroundResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 83: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	171, // 84: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 85: dnd5e.api.v1alpha1.UpdateSkillsResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	171, // 86: dnd5e.api.v1alpha1.UpdateSkillsResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 87: dnd5e.api.v1alpha1.ListDraftsResponse.drafts:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	170, // 88: dnd5e.api.v1alpha1.ValidateDraftResponse.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	2,   // 89: dnd5e.api.v1alpha1.ValidateDraftResponse.missing_steps:type_name -> dnd5e.api.v1alpha1.CreationStep
	172, // 90: dnd5e.api.v1alpha1.ValidateDraftResponse.errors:type_name -> dnd5e.api.v1alpha1.ValidationError
	171, // 91: dnd5e.api.v1alpha1.ValidateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	...
	171, // 94: dnd5e.api.v1alpha1.GetDraftPreviewResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	172, // 95: dnd5e.api.v1alpha1.GetDraftPreviewResponse.errors:type_name -> dnd5e.api.v1alpha1.ValidationError
	14,  // 96: dnd5e.api.v1alpha1.FinalizeDraftResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	170, // 97: dnd5e.api.v1alpha1.FinalizeDraftResponse.final_validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	157, // 98: dnd5e.api.v1alpha1.RaceInfo.race_id:type_name -> dnd5e.api.v1alpha1.Race
	5,   // 99: dnd5e.api.v1alpha1.RaceInfo.size:type_name -> dnd5e.api.v1alpha1.Size
	155, // 100: dnd5e.api.v1alpha1.RaceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	...
	162, // 104: dnd5e.api.v1alpha1.RaceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	63,  // 105: dnd5e.api.v1alpha1.RaceInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	158, // 106: dnd5e.api.v1alpha1.SubraceInfo.subrace_id:type_name -> dnd5e.api.v1alpha1.Subrace
	156, // 107: dnd5e.api.v1alpha1.SubraceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	62,  // 108: dnd5e.api.v1alpha1.SubraceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	162, // 109: dnd5e.api.v1alpha1.SubraceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	...
	159, // 123: dnd5e.api.v1alpha1.ClassInfo.class_id:type_name -> dnd5e.api.v1alpha1.Class
	168, // 124: dnd5e.api.v1alpha1.ClassInfo.primary_ability:type_name -> dnd5e.api.v1alpha1.Ability
	164, // 125: dnd5e.api.v1alpha1.ClassInfo.armor_proficiencies:type_name -> dnd5e.api.v1alpha1.Armor
	165, // 126: dnd5e.api.v1alpha1.ClassInfo.weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.Weapon
	166, // 127: dnd5e.api.v1alpha1.ClassInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	168, // 128: dnd5e.api.v1alpha1.ClassInfo.saving_throw_proficiencies:type_name -> dnd5e.api.v1alpha1.Ability
	167, // 129: dnd5e.api.v1alpha1.ClassInfo.available_skills:type_name -> dnd5e.api.v1alpha1.Skill
	...
	169, // 135: dnd5e.api.v1alpha1.SubclassInfo.subclass_id:type_name -> dnd5e.api.v1alpha1.Subclass
	164, // 136: dnd5e.api.v1alpha1.SubclassInfo.armor_proficiencies:type_name -> dnd5e.api.v1alpha1.Armor
	165, // 137: dnd5e.api.v1alpha1.SubclassInfo.weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.Weapon
	166, // 138: dnd5e.api.v1alpha1.SubclassInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	...
	160, // 141: dnd5e.api.v1alpha1.BackgroundInfo.background_id:type_name -> dnd5e.api.v1alpha1.Background
	167, // 142: dnd5e.api.v1alpha1.BackgroundInfo.skill_proficiencies:type_name -> dnd5e.api.v1alpha1.Skill
	166, // 143: dnd5e.api.v1alpha1.BackgroundInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	162, // 144: dnd5e.api.v1alpha1.BackgroundInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	...
	159, // 156: dnd5e.api.v1alpha1.GetRequirementsRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	157, // 157: dnd5e.api.v1alpha1.GetRequirementsRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	131, // 158: dnd5e.api.v1alpha1.GetRequirementsResponse.requirements:type_name -> dnd5e.api.v1alpha1.CharacterRequirements
	124, // 159: dnd5e.api.v1alpha1.SubmitChoicesRequest.submissions:type_name -> dnd5e.api.v1alpha1.ChoiceSubmission
	31,  // 160: dnd5e.api.v1alpha1.SubmitChoicesResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	170, // 161: dnd5e.api.v1alpha1.SubmitChoicesResponse.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	131, // 162: dnd5e.api.v1alpha1.SubmitChoicesResponse.remaining_requirements:type_name -> dnd5e.api.v1alpha1.CharacterRequirements
	100, // 163: dnd5e.api.v1alpha1.Equipment.cost:type_name -> dnd5e.api.v1alpha1.Cost
	101, // 164: dnd5e.api.v1alpha1.Equipment.weight:type_name -> dnd5e.api.v1alpha1.Weight
	103, // 165: dnd5e.api.v1alpha1.Equipment.weapon_data:type_name -> dnd5e.api.v1alpha1.WeaponData
	104, // 166: dnd5e.api.v1alpha1.Equipment.armor_data:type_name -> dnd5e.api.v1alpha1.ArmorData
	105, // 167: dnd5e.api.v1alpha1.Equipment.gear_data:type_name -> dnd5e.api.v1alpha1.GearData
	107, // 168: dnd5e.api.v1alpha1.EquipmentSlots.main_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 169: dnd5e.api.v1alpha1.EquipmentSlots.off_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 170: dnd5e.api.v1alpha1.EquipmentSlots.armor:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 171: dnd5e.api.v1alpha1.EquipmentSlots.helmet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 172: dnd5e.api.v1alpha1.EquipmentSlots.boots:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 173: dnd5e.api.v1alpha1.EquipmentSlots.gloves:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 174: dnd5e.api.v1alpha1.EquipmentSlots.cloak:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 175: dnd5e.api.v1alpha1.EquipmentSlots.amulet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 176: dnd5e.api.v1alpha1.EquipmentSlots.ring_1:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 177: dnd5e.api.v1alpha1.EquipmentSlots.ring_2:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 178: dnd5e.api.v1alpha1.EquipmentSlots.belt:type_name -> dnd5e.api.v1alpha1.InventoryItem
	102, // 179: dnd5e.api.v1alpha1.InventoryItem.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	7,   // 180: dnd5e.api.v1alpha1.EncumbranceInfo.level:type_name -> dnd5e.api.v1alpha1.EncumbranceLevel
	137, // 181: dnd5e.api.v1alpha1.Spell.damage:type_name -> dnd5e.api.v1alpha1.SpellDamage
	139, // 182: dnd5e.api.v1alpha1.Spell.area_of_effect:type_name -> dnd5e.api.v1alpha1.AreaOfEffect
	4,   // 183: dnd5e.api.v1alpha1.ChoiceData.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 184: dnd5e.api.v1alpha1.ChoiceData.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	111, // 185: dnd5e.api.v1alpha1.ChoiceData.skills:type_name -> dnd5e.api.v1alpha1.SkillList
	112, // 186: dnd5e.api.v1alpha1.ChoiceData.languages:type_name -> dnd5e.api.v1alpha1.LanguageList
	13,  // 187: dnd5e.api.v1alpha1.ChoiceData.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	163, // 188: dnd5e.api.v1alpha1.ChoiceData.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyle
	113, // 189: dnd5e.api.v1alpha1.ChoiceData.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentList
	119, // 190: dnd5e.api.v1alpha1.ChoiceData.race:type_name -> dnd5e.api.v1alpha1.RaceChoice
	120, // 191: dnd5e.api.v1alpha1.ChoiceData.class:type_name -> dnd5e.api.v1alpha1.ClassChoice
	160, // 192: dnd5e.api.v1alpha1.ChoiceData.background:type_name -> dnd5e.api.v1alpha1.Background
	114, // 193: dnd5e.api.v1alpha1.ChoiceData.spells:type_name -> dnd5e.api.v1alpha1.SpellList
	115, // 194: dnd5e.api.v1alpha1.ChoiceData.cantrips:type_name -> dnd5e.api.v1alpha1.CantripList
	116, // 195: dnd5e.api.v1alpha1.ChoiceData.expertise:type_name -> dnd5e.api.v1alpha1.ExpertiseList
	117, // 196: dnd5e.api.v1alpha1.ChoiceData.traits:type_name -> dnd5e.api.v1alpha1.TraitList
	118, // 197: dnd5e.api.v1alpha1.ChoiceData.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.ToolProficiencyList
	167, // 198: dnd5e.api.v1alpha1.SkillList.skills:type_name -> dnd5e.api.v1alpha1.Skill
	162, // 199: dnd5e.api.v1alpha1.LanguageList.languages:type_name -> dnd5e.api.v1alpha1.Language
	123, // 200: dnd5e.api.v1alpha1.EquipmentList.items:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	157, // 201: dnd5e.api.v1alpha1.RaceChoice.race:type_name -> dnd5e.api.v1alpha1.Race
	158, // 202: dnd5e.api.v1alpha1.RaceChoice.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	159, // 203: dnd5e.api.v1alpha1.ClassChoice.class:type_name -> dnd5e.api.v1alpha1.Class
	122, // 204: dnd5e.api.v1alpha1.EquipmentChoice.options:type_name -> dnd5e.api.v1alpha1.EquipmentOption
	123, // 205: dnd5e.api.v1alpha1.EquipmentOption.items:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	165, // 206: dnd5e.api.v1alpha1.EquipmentSelection.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	164, // 207: dnd5e.api.v1alpha1.EquipmentSelection.armor:type_name -> dnd5e.api.v1alpha1.Armor
	166, // 208: dnd5e.api.v1alpha1.EquipmentSelection.tool:type_name -> dnd5e.api.v1alpha1.Tool
	173, // 209: dnd5e.api.v1alpha1.EquipmentSelection.pack:type_name -> dnd5e.api.v1alpha1.Pack
	174, // 210: dnd5e.api.v1alpha1.EquipmentSelection.ammunition:type_name -> dnd5e.api.v1alpha1.Ammunition
	4,   // 211: dnd5e.api.v1alpha1.ChoiceSubmission.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 212: dnd5e.api.v1alpha1.ChoiceSubmission.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	125, // 213: dnd5e.api.v1alpha1.ChoiceSubmission.skills:type_name -> dnd5e.api.v1alpha1.SkillSelection
	126, // 214: dnd5e.api.v1alpha1.ChoiceSubmission.languages:type_name -> dnd5e.api.v1alpha1.LanguageSelection
	123, // 215: dnd5e.api.v1alpha1.ChoiceSubmission.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	127, // 216: dnd5e.api.v1alpha1.ChoiceSubmission.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyleSelection
	128, // 217: dnd5e.api.v1alpha1.ChoiceSubmission.tools:type_name -> dnd5e.api.v1alpha1.ToolSelection
	129, // 218: dnd5e.api.v1alpha1.ChoiceSubmission.weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.WeaponProficiencySelection
	130, // 219: dnd5e.api.v1alpha1.ChoiceSubmission.armor_proficiencies:type_name -> dnd5e.api.v1alpha1.ArmorProficiencySelection
	167, // 220: dnd5e.api.v1alpha1.SkillSelection.skills:type_name -> dnd5e.api.v1alpha1.Skill
	162, // 221: dnd5e.api.v1alpha1.LanguageSelection.languages:type_name -> dnd5e.api.v1alpha1.Language
	163, // 222: dnd5e.api.v1alpha1.FightingStyleSelection.style:type_name -> dnd5e.api.v1alpha1.FightingStyle
	166, // 223: dnd5e.api.v1alpha1.ToolSelection.tools:type_name -> dnd5e.api.v1alpha1.Tool
	165, // 224: dnd5e.api.v1alpha1.WeaponProficiencySelection.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	175, // 225: dnd5e.api.v1alpha1.WeaponProficiencySelection.categories:type_name -> dnd5e.api.v1alpha1.EquipmentType
	164, // 226: dnd5e.api.v1alpha1.ArmorProficiencySelection.armors:type_name -> dnd5e.api.v1alpha1.Armor
	175, // 227: dnd5e.api.v1alpha1.ArmorProficiencySelection.categories:type_name -> dnd5e.api.v1alpha1.EquipmentType
	132, // 228: dnd5e.api.v1alpha1.CharacterRequirements.choices:type_name -> dnd5e.api.v1alpha1.RequiredChoice
	4,   // 229: dnd5e.api.v1alpha1.RequiredChoice.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 230: dnd5e.api.v1alpha1.RequiredChoice.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	133, // 231: dnd5e.api.v1alpha1.RequiredChoice.skill_options:type_name -> dnd5e.api.v1alpha1.SkillOptions
	134, // 232: dnd5e.api.v1alpha1.RequiredChoice.language_options:type_name -> dnd5e.api.v1alpha1.LanguageOptions
	121, // 233: dnd5e.api.v1alpha1.RequiredChoice.equipment_options:type_name -> dnd5e.api.v1alpha1.EquipmentChoice
	135, // 234: dnd5e.api.v1alpha1.RequiredChoice.fighting_style_options:type_name -> dnd5e.api.v1alpha1.FightingStyleOptions
	136, // 235: dnd5e.api.v1alpha1.RequiredChoice.tool_options:type_name -> dnd5e.api.v1alpha1.ToolOptions
	167, // 236: dnd5e.api.v1alpha1.SkillOptions.available:type_name -> dnd5e.api.v1alpha1.Skill
	162, // 237: dnd5e.api.v1alpha1.LanguageOptions.available:type_name -> dnd5e.api.v1alpha1.Language
	163, // 238: dnd5e.api.v1alpha1.FightingStyleOptions.available:type_name -> dnd5e.api.v1alpha1.FightingStyle
	166, // 239: dnd5e.api.v1alpha1.ToolOptions.available:type_name -> dnd5e.api.v1alpha1.Tool
	138, // 240: dnd5e.api.v1alpha1.SpellDamage.damage_at_slot_level:type_name -> dnd5e.api.v1alpha1.DamageAtSlotLevel
	175, // 241: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest.equipment_type:type_name -> dnd5e.api.v1alpha1.EquipmentType
	102, // 242: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	159, // 243: dnd5e.api.v1alpha1.ListSpellsByLevelRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	109, // 244: dnd5e.api.v1alpha1.ListSpellsByLevelResponse.spells:type_name -> dnd5e.api.v1alpha1.Spell
	106, // 245: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.equipment_slots:type_name -> dnd5e.api.v1alpha1.EquipmentSlots
	107, // 246: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.inventory:type_name -> dnd5e.api.v1alpha1.InventoryItem
	108, // 247: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.encumbrance:type_name -> dnd5e.api.v1alpha1.EncumbranceInfo
	9,   // 248: dnd5e.api.v1alpha1.EquipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	14,  // 249: dnd5e.api.v1alpha1.EquipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	107, // 250: dnd5e.api.v1alpha1.EquipItemResponse.previously_equipped_item:type_name -> dnd5e.api.v1alpha1.InventoryItem
	9,   // 251: dnd5e.api.v1alpha1.UnequipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	14,  // 252: dnd5e.api.v1alpha1.UnequipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	151, // 253: dnd5e.api.v1alpha1.AddToInventoryRequest.items:type_name -> dnd5e.api.v1alpha1.InventoryAddition
	14,  // 254: dnd5e.api.v1alpha1.AddToInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	14,  // 255: dnd5e.api.v1alpha1.RemoveFromInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	32,  // 256: dnd5e.api.v1alpha1.CharacterService.CreateDraft:input_type -> dnd5e.api.v1alpha1.CreateDraftRequest
	34,  // 257: dnd5e.api.v1alpha1.CharacterService.GetDraft:input_type -> dnd5e.api.v1alpha1.GetDraftRequest
	50,  // 258: dnd5e.api.v1alpha1.CharacterService.ListDrafts:input_type -> dnd5e.api.v1alpha1.ListDraftsRequest
	58,  // 259: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:input_type -> dnd5e.api.v1alpha1.DeleteDraftRequest
	38,  // 260: dnd5e.api.v1alpha1.CharacterService.UpdateName:input_type -> dnd5e.api.v1alpha1.UpdateNameRequest
	39,  // 261: dnd5e.api.v1alpha1.CharacterService.UpdateRace:input_type -> dnd5e.api.v1alpha1.UpdateRaceRequest
	40,  // 262: dnd5e.api.v1alpha1.CharacterService.UpdateClass:input_type -> dnd5e.api.v1alpha1.UpdateClassRequest
	41,  // 263: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:input_type -> dnd5e.api.v1alpha1.UpdateBackgroundRequest
	42,  // 264: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:input_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	43,  // 265: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:input_type -> dnd5e.api.v1alpha1.UpdateSkillsRequest
	52,  // 266: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:input_type -> dnd5e.api.v1alpha1.ValidateDraftRequest
	54,  // 267: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:input_type -> dnd5e.api.v1alpha1.GetDraftPreviewRequest
	56,  // 268: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:input_type -> dnd5e.api.v1alpha1.FinalizeDraftRequest
	20,  // 269: dnd5e.api.v1alpha1.CharacterService.GetCharacter:input_type -> dnd5e.api.v1alpha1.GetCharacterRequest
	22,  // 270: dnd5e.api.v1alpha1.CharacterService.ListCharacters:input_type -> dnd5e.api.v1alpha1.ListCharactersRequest
	26,  // 271: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:input_type -> dnd5e.api.v1alpha1.DeleteCharacterRequest
	78,  // 272: dnd5e.api.v1alpha1.CharacterService.ListRaces:input_type -> dnd5e.api.v1alpha1.ListRacesRequest
	80,  // 273: dnd5e.api.v1alpha1.CharacterService.ListClasses:input_type -> dnd5e.api.v1alpha1.ListClassesRequest
	82,  // 274: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:input_type -> dnd5e.api.v1alpha1.ListBackgroundsRequest
	84,  // 275: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:input_type -> dnd5e.api.v1alpha1.GetRaceDetailsRequest
	86,  // 276: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:input_type -> dnd5e.api.v1alpha1.GetClassDetailsRequest
	88,  // 277: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:input_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	90,  // 278: dnd5e.api.v1alpha1.CharacterService.GetFeature:input_type -> dnd5e.api.v1alpha1.GetFeatureRequest
	92,  // 279: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:input_type -> dnd5e.api.v1alpha1.RollAbilityScoresRequest
	95,  // 280: dnd5e.api.v1alpha1.CharacterService.GetRequirements:input_type -> dnd5e.api.v1alpha1.GetRequirementsRequest
	97,  // 281: dnd5e.api.v1alpha1.CharacterService.SubmitChoices:input_type -> dnd5e.api.v1alpha1.SubmitChoicesRequest
	140, // 282: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:input_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	142, // 283: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:input_type -> dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	144, // 284: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:input_type -> dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	146, // 285: dnd5e.api.v1alpha1.CharacterService.EquipItem:input_type -> dnd5e.api.v1alpha1.EquipItemRequest
	148, // 286: dnd5e.api.v1alpha1.CharacterService.UnequipItem:input_type -> dnd5e.api.v1alpha1.UnequipItemRequest
	150, // 287: dnd5e.api.v1alpha1.CharacterService.AddToInventory:input_type -> dnd5e.api.v1alpha1.AddToInventoryRequest
	153, // 288: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:input_type -> dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	33,  // 289: dnd5e.api.v1alpha1.CharacterService.CreateDraft:output_type -> dnd5e.api.v1alpha1.CreateDraftResponse
	35,  // 290: dnd5e.api.v1alpha1.CharacterService.GetDraft:output_type -> dnd5e.api.v1alpha1.GetDraftResponse
	51,  // 291: dnd5e.api.v1alpha1.CharacterService.ListDrafts:output_type -> dnd5e.api.v1alpha1.ListDraftsResponse
	59,  // 292: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:output_type -> dnd5e.api.v1alpha1.DeleteDraftResponse
	44,  // 293: dnd5e.api.v1alpha1.CharacterService.UpdateName:output_type -> dnd5e.api.v1alpha1.UpdateNameResponse
	45,  // 294: dnd5e.api.v1alpha1.CharacterService.UpdateRace:output_type -> dnd5e.api.v1alpha1.UpdateRaceResponse
	46,  // 295: dnd5e.api.v1alpha1.CharacterService.UpdateClass:output_type -> dnd5e.api.v1alpha1.UpdateClassResponse
	47,  // 296: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:output_type -> dnd5e.api.v1alpha1.UpdateBackgroundResponse
	48,  // 297: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:output_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	49,  // 298: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:output_type -> dnd5e.api.v1alpha1.UpdateSkillsResponse
	53,  // 299: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:output_type -> dnd5e.api.v1alpha1.ValidateDraftResponse
	55,  // 300: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:output_type -> dnd5e.api.v1alpha1.GetDraftPreviewResponse
	57,  // 301: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:output_type -> dnd5e.api.v1alpha1.FinalizeDraftResponse
	21,  // 302: dnd5e.api.v1alpha1.CharacterService.GetCharacter:output_type -> dnd5e.api.v1alpha1.GetCharacterResponse
	23,  // 303: dnd5e.api.v1alpha1.CharacterService.ListCharacters:output_type -> dnd5e.api.v1alpha1.ListCharactersResponse
	27,  // 304: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:output_type -> dnd5e.api.v1alpha1.DeleteCharacterResponse
	79,  // 305: dnd5e.api.v1alpha1.CharacterService.ListRaces:output_type -> dnd5e.api.v1alpha1.ListRacesResponse
	81,  // 306: dnd5e.api.v1alpha1.CharacterService.ListClasses:output_type -> dnd5e.api.v1alpha1.ListClassesResponse
	83,  // 307: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:output_type -> dnd5e.api.v1alpha1.ListBackgroundsResponse
	85,  // 308: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:output_type -> dnd5e.api.v1alpha1.GetRaceDetailsResponse
	87,  // 309: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:output_type -> dnd5e.api.v1alpha1.GetClassDetailsResponse
	89,  // 310: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:output_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	91,  // 311: dnd5e.api.v1alpha1.CharacterService.GetFeature:output_type -> dnd5e.api.v1alpha1.GetFeatureResponse
	94,  // 312: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:output_type -> dnd5e.api.v1alpha1.RollAbilityScoresResponse
	96,  // 313: dnd5e.api.v1alpha1.CharacterService.GetRequirements:output_type -> dnd5e.api.v1alpha1.GetRequirementsResponse
	98,  // 314: dnd5e.api.v1alpha1.CharacterService.SubmitChoices:output_type -> dnd5e.api.v1alpha1.SubmitChoicesResponse
	141, // 315: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:output_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	143, // 316: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:output_type -> dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	145, // 317: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:output_type -> dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	147, // 318: dnd5e.api.v1alpha1.CharacterService.EquipItem:output_type -> dnd5e.api.v1alpha1.EquipItemResponse
	149, // 319: dnd5e.api.v1alpha1.CharacterService.UnequipItem:output_type -> dnd5e.api.v1alpha1.UnequipItemResponse
	152, // 320: dnd5e.api.v1alpha1.CharacterService.AddToInventory:output_type -> dnd5e.api.v1alpha1.AddToInventoryResponse
	154, // 321: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:output_type -> dnd5e.api.v1alpha1.RemoveFromInventoryResponse
	289, // [289:322] is the sub-list for method output_type
	256, // [256:289] is the sub-list for method input_type
...
func file_dnd5e_api_v1alpha1_character_proto_init() {
	...
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[100].OneofWrappers = []any{
		(*ChoiceData_Name)(nil),
	...
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[114].OneofWrappers = []any{
	...
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[143].OneofWrappers = []any{
