...
const file_dnd5e_api_v1alpha1_character_proto_rawDesc = "" +
	...
	"\titem_type\"B\n" +
	"\fNestedChoice\x122\n" +
	"\x06choice\x18\x01 \x01(\v2\x1a.dnd5e.api.v1alpha1.ChoiceR\x06choice\"\xee\x05\n" +
	"\tClassInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	...
	"\x05group\x18\x10 \x01(\x0e2\x19.dnd5e.api.v1alpha1.ClassR\x05group\"\x94\x02\n" +
...
var file_dnd5e_api_v1alpha1_character_proto_msgTypes = make([]protoimpl.MessageInfo, 125)
var file_dnd5e_api_v1alpha1_character_proto_goTypes = []any{
	...
	(*ExpertiseList)(nil),                 // 110: dnd5e.api.v1alpha1.ExpertiseList
	(*TraitList)(nil),                     // 111: dnd5e.api.v1alpha1.TraitList
	(*ToolProficiencyList)(nil),           // 112: dnd5e.api.v1alpha1.ToolProficiencyList
	(*RaceChoice)(nil),                    // 113: dnd5e.api.v1alpha1.RaceChoice
	(*ClassChoice)(nil),                   // 114: dnd5e.api.v1alpha1.ClassChoice
	(*SpellDamage)(nil),                   // 115: dnd5e.api.v1alpha1.SpellDamage
	(*DamageAtSlotLevel)(nil),             // 116: dnd5e.api.v1alpha1.DamageAtSlotLevel
	(*AreaOfEffect)(nil),                  // 117: dnd5e.api.v1alpha1.AreaOfEffect
	(*ListEquipmentByTypeRequest)(nil),    // 118: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	(*ListEquipmentByTypeResponse)(nil),   // 119: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	(*ListSpellsByLevelRequest)(nil),      // 120: dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	(*ListSpellsByLevelResponse)(nil),     // 121: dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	(*GetCharacterInventoryRequest)(nil),  // 122: dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	(*GetCharacterInventoryResponse)(nil), // 123: dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	(*EquipItemRequest)(nil),              // 124: dnd5e.api.v1alpha1.EquipItemRequest
	(*EquipItemResponse)(nil),             // 125: dnd5e.api.v1alpha1.EquipItemResponse
	(*UnequipItemRequest)(nil),            // 126: dnd5e.api.v1alpha1.UnequipItemRequest
	(*UnequipItemResponse)(nil),           // 127: dnd5e.api.v1alpha1.UnequipItemResponse
	(*AddToInventoryRequest)(nil),         // 128: dnd5e.api.v1alpha1.AddToInventoryRequest
	(*InventoryAddition)(nil),             // 129: dnd5e.api.v1alpha1.InventoryAddition
	(*AddToInventoryResponse)(nil),        // 130: dnd5e.api.v1alpha1.AddToInventoryResponse
	(*RemoveFromInventoryRequest)(nil),    // 131: dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	(*RemoveFromInventoryResponse)(nil),   // 132: dnd5e.api.v1alpha1.RemoveFromInventoryResponse
	nil,                                   // 133: dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	nil,                                   // 134: dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	(Race)(0),                             // 135: dnd5e.api.v1alpha1.Race
	(Subrace)(0),                          // 136: dnd5e.api.v1alpha1.Subrace
	(Class)(0),                            // 137: dnd5e.api.v1alpha1.Class
	(Background)(0),                       // 138: dnd5e.api.v1alpha1.Background
	(Alignment)(0),                        // 139: dnd5e.api.v1alpha1.Alignment
	(Language)(0),                         // 140: dnd5e.api.v1alpha1.Language
	(Skill)(0),                            // 141: dnd5e.api.v1alpha1.Skill
	(Ability)(0),                          // 142: dnd5e.api.v1alpha1.Ability
	(*ValidationResult)(nil),              // 143: dnd5e.api.v1alpha1.ValidationResult
	(*ValidationWarning)(nil),             // 144: dnd5e.api.v1alpha1.ValidationWarning
	(*ValidationError)(nil),               // 145: dnd5e.api.v1alpha1.ValidationError
...
var file_dnd5e_api_v1alpha1_character_proto_depIdxs = []int32{
	...
	135, // 2: dnd5e.api.v1alpha1.Character.race:type_name -> dnd5e.api.v1alpha1.Race
	136, // 3: dnd5e.api.v1alpha1.Character.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	137, // 4: dnd5e.api.v1alpha1.Character.class:type_name -> dnd5e.api.v1alpha1.Class
	138, // 5: dnd5e.api.v1alpha1.Character.background:type_name -> dnd5e.api.v1alpha1.Background
	139, // 6: dnd5e.api.v1alpha1.Character.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	...
	140, // 11: dnd5e.api.v1alpha1.Character.languages:type_name -> dnd5e.api.v1alpha1.Language
	...
	141, // 21: dnd5e.api.v1alpha1.Proficiencies.skills:type_name -> dnd5e.api.v1alpha1.Skill
	142, // 22: dnd5e.api.v1alpha1.Proficiencies.saving_throws:type_name -> dnd5e.api.v1alpha1.Ability
	...
	135, // 27: dnd5e.api.v1alpha1.CharacterDraftData.race:type_name -> dnd5e.api.v1alpha1.Race
	136, // 28: dnd5e.api.v1alpha1.CharacterDraftData.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	137, // 29: dnd5e.api.v1alpha1.CharacterDraftData.class:type_name -> dnd5e.api.v1alpha1.Class
	138, // 30: dnd5e.api.v1alpha1.CharacterDraftData.background:type_name -> dnd5e.api.v1alpha1.Background
	13,  // 31: dnd5e.api.v1alpha1.CharacterDraftData.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	139, // 32: dnd5e.api.v1alpha1.CharacterDraftData.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	...
	139, // 42: dnd5e.api.v1alpha1.CharacterDraft.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	...
	135, // 46: dnd5e.api.v1alpha1.CharacterDraft.race_id:type_name -> dnd5e.api.v1alpha1.Race
	136, // 47: dnd5e.api.v1alpha1.CharacterDraft.subrace_id:type_name -> dnd5e.api.v1alpha1.Subrace
	137, // 48: dnd5e.api.v1alpha1.CharacterDraft.class_id:type_name -> dnd5e.api.v1alpha1.Class
	138, // 49: dnd5e.api.v1alpha1.CharacterDraft.background_id:type_name -> dnd5e.api.v1alpha1.Background
	143, // 50: dnd5e.api.v1alpha1.CharacterDraft.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	27,  // 51: dnd5e.api.v1alpha1.CreateDraftRequest.initial_data:type_name -> dnd5e.api.v1alpha1.CharacterDraftData
	30,  // 52: dnd5e.api.v1alpha1.CreateDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	30,  // 53: dnd5e.api.v1alpha1.GetDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	27,  // 54: dnd5e.api.v1alpha1.UpdateDraftRequest.updates:type_name -> dnd5e.api.v1alpha1.CharacterDraftData
	30,  // 55: dnd5e.api.v1alpha1.UpdateDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	144, // 56: dnd5e.api.v1alpha1.UpdateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	135, // 57: dnd5e.api.v1alpha1.UpdateRaceRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	136, // 58: dnd5e.api.v1alpha1.UpdateRaceRequest.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	104, // 59: dnd5e.api.v1alpha1.UpdateRaceRequest.race_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	137, // 60: dnd5e.api.v1alpha1.UpdateClassRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	104, // 61: dnd5e.api.v1alpha1.UpdateClassRequest.class_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	138, // 62: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background:type_name -> dnd5e.api.v1alpha1.Background
	104, // 63: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	13,  // 64: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	93,  // 65: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.roll_assignments:type_name -> dnd5e.api.v1alpha1.RollAssignments
	141, // 66: dnd5e.api.v1alpha1.UpdateSkillsRequest.skills:type_name -> dnd5e.api.v1alpha1.Skill
	30,  // 67: dnd5e.api.v1alpha1.UpdateNameResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	144, // 68: dnd5e.api.v1alpha1.UpdateNameResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	30,  // 69: dnd5e.api.v1alpha1.UpdateRaceResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	144, // 70: dnd5e.api.v1alpha1.UpdateRaceResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	30,  // 71: dnd5e.api.v1alpha1.UpdateClassResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	144, // 72: dnd5e.api.v1alpha1.UpdateClassResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	30,  // 73: dnd5e.api.v1alpha1.UpdateBackgroundResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	144, // 74: dnd5e.api.v1alpha1.UpdateBackgroundResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	30,  // 75: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	144, // 76: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	30,  // 77: dnd5e.api.v1alpha1.UpdateSkillsResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	144, // 78: dnd5e.api.v1alpha1.UpdateSkillsResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	30,  // 79: dnd5e.api.v1alpha1.ListDraftsResponse.drafts:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	143, // 80: dnd5e.api.v1alpha1.ValidateDraftResponse.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	2,   // 81: dnd5e.api.v1alpha1.ValidateDraftResponse.missing_steps:type_name -> dnd5e.api.v1alpha1.CreationStep
	145, // 82: dnd5e.api.v1alpha1.ValidateDraftResponse.errors:type_name -> dnd5e.api.v1alpha1.ValidationError
	144, // 83: dnd5e.api.v1alpha1.ValidateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	30,  // 84: dnd5e.api.v1alpha1.GetDraftPreviewResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	14,  // 85: dnd5e.api.v1alpha1.GetDraftPreviewResponse.preview:type_name -> dnd5e.api.v1alpha1.Character
	144, // 86: dnd5e.api.v1alpha1.GetDraftPreviewResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	145, // 87: dnd5e.api.v1alpha1.GetDraftPreviewResponse.errors:type_name -> dnd5e.api.v1alpha1.ValidationError
	14,  // 88: dnd5e.api.v1alpha1.FinalizeDraftResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	143, // 89: dnd5e.api.v1alpha1.FinalizeDraftResponse.final_validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	5,   // 90: dnd5e.api.v1alpha1.RaceInfo.size:type_name -> dnd5e.api.v1alpha1.Size
	133, // 91: dnd5e.api.v1alpha1.RaceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	61,  // 92: dnd5e.api.v1alpha1.RaceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	60,  // 93: dnd5e.api.v1alpha1.RaceInfo.subraces:type_name -> dnd5e.api.v1alpha1.SubraceInfo
	140, // 94: dnd5e.api.v1alpha1.RaceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	62,  // 95: dnd5e.api.v1alpha1.RaceInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	134, // 96: dnd5e.api.v1alpha1.SubraceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	61,  // 97: dnd5e.api.v1alpha1.SubraceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	140, // 98: dnd5e.api.v1alpha1.SubraceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	4,   // 99: dnd5e.api.v1alpha1.Choice.choice_type:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	63,  // 100: dnd5e.api.v1alpha1.Choice.explicit_options:type_name -> dnd5e.api.v1alpha1.ExplicitOptions
	64,  // 101: dnd5e.api.v1alpha1.Choice.category_reference:type_name -> dnd5e.api.v1alpha1.CategoryReference
	65,  // 102: dnd5e.api.v1alpha1.ExplicitOptions.options:type_name -> dnd5e.api.v1alpha1.ChoiceOption
	66,  // 103: dnd5e.api.v1alpha1.ChoiceOption.item:type_name -> dnd5e.api.v1alpha1.ItemReference
	67,  // 104: dnd5e.api.v1alpha1.ChoiceOption.counted_item:type_name -> dnd5e.api.v1alpha1.CountedItemReference
	68,  // 105: dnd5e.api.v1alpha1.ChoiceOption.bundle:type_name -> dnd5e.api.v1alpha1.ItemBundle
	70,  // 106: dnd5e.api.v1alpha1.ChoiceOption.nested_choice:type_name -> dnd5e.api.v1alpha1.NestedChoice
	69,  // 107: dnd5e.api.v1alpha1.ItemBundle.items:type_name -> dnd5e.api.v1alpha1.BundleItem
	67,  // 108: dnd5e.api.v1alpha1.BundleItem.concrete_item:type_name -> dnd5e.api.v1alpha1.CountedItemReference
	70,  // 109: dnd5e.api.v1alpha1.BundleItem.choice_item:type_name -> dnd5e.api.v1alpha1.NestedChoice
	62,  // 110: dnd5e.api.v1alpha1.NestedChoice.choice:type_name -> dnd5e.api.v1alpha1.Choice
	74,  // 111: dnd5e.api.v1alpha1.ClassInfo.level_1_features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	72,  // 112: dnd5e.api.v1alpha1.ClassInfo.spellcasting:type_name -> dnd5e.api.v1alpha1.SpellcastingInfo
	62,  // 113: dnd5e.api.v1alpha1.ClassInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	137, // 114: dnd5e.api.v1alpha1.ClassInfo.group:type_name -> dnd5e.api.v1alpha1.Class
	140, // 115: dnd5e.api.v1alpha1.BackgroundInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	62,  // 116: dnd5e.api.v1alpha1.FeatureInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	75,  // 117: dnd5e.api.v1alpha1.FeatureInfo.spell_selection:type_name -> dnd5e.api.v1alpha1.SpellSelectionInfo
	6,   // 118: dnd5e.api.v1alpha1.SpellSelectionInfo.selection_type:type_name -> dnd5e.api.v1alpha1.SpellSelectionType
	59,  // 119: dnd5e.api.v1alpha1.ListRacesResponse.races:type_name -> dnd5e.api.v1alpha1.RaceInfo
	71,  // 120: dnd5e.api.v1alpha1.ListClassesResponse.classes:type_name -> dnd5e.api.v1alpha1.ClassInfo
	73,  // 121: dnd5e.api.v1alpha1.ListBackgroundsResponse.backgrounds:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	59,  // 122: dnd5e.api.v1alpha1.GetRaceDetailsResponse.race:type_name -> dnd5e.api.v1alpha1.RaceInfo
	71,  // 123: dnd5e.api.v1alpha1.GetClassDetailsResponse.class:type_name -> dnd5e.api.v1alpha1.ClassInfo
	73,  // 124: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse.background:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	74,  // 125: dnd5e.api.v1alpha1.GetFeatureResponse.feature:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	91,  // 126: dnd5e.api.v1alpha1.RollAbilityScoresResponse.rolls:type_name -> dnd5e.api.v1alpha1.AbilityScoreRoll
	94,  // 127: dnd5e.api.v1alpha1.Equipment.cost:type_name -> dnd5e.api.v1alpha1.Cost
	95,  // 128: dnd5e.api.v1alpha1.Equipment.weight:type_name -> dnd5e.api.v1alpha1.Weight
	97,  // 129: dnd5e.api.v1alpha1.Equipment.weapon_data:type_name -> dnd5e.api.v1alpha1.WeaponData
	98,  // 130: dnd5e.api.v1alpha1.Equipment.armor_data:type_name -> dnd5e.api.v1alpha1.ArmorData
	99,  // 131: dnd5e.api.v1alpha1.Equipment.gear_data:type_name -> dnd5e.api.v1alpha1.GearData
	101, // 132: dnd5e.api.v1alpha1.EquipmentSlots.main_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	101, // 133: dnd5e.api.v1alpha1.EquipmentSlots.off_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	101, // 134: dnd5e.api.v1alpha1.EquipmentSlots.armor:type_name -> dnd5e.api.v1alpha1.InventoryItem
	101, // 135: dnd5e.api.v1alpha1.EquipmentSlots.helmet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	101, // 136: dnd5e.api.v1alpha1.EquipmentSlots.boots:type_name -> dnd5e.api.v1alpha1.InventoryItem
	101, // 137: dnd5e.api.v1alpha1.EquipmentSlots.gloves:type_name -> dnd5e.api.v1alpha1.InventoryItem
	101, // 138: dnd5e.api.v1alpha1.EquipmentSlots.cloak:type_name -> dnd5e.api.v1alpha1.InventoryItem
	101, // 139: dnd5e.api.v1alpha1.EquipmentSlots.amulet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	101, // 140: dnd5e.api.v1alpha1.EquipmentSlots.ring_1:type_name -> dnd5e.api.v1alpha1.InventoryItem
	101, // 141: dnd5e.api.v1alpha1.EquipmentSlots.ring_2:type_name -> dnd5e.api.v1alpha1.InventoryItem
	101, // 142: dnd5e.api.v1alpha1.EquipmentSlots.belt:type_name -> dnd5e.api.v1alpha1.InventoryItem
	96,  // 143: dnd5e.api.v1alpha1.InventoryItem.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	7,   // 144: dnd5e.api.v1alpha1.EncumbranceInfo.level:type_name -> dnd5e.api.v1alpha1.EncumbranceLevel
	115, // 145: dnd5e.api.v1alpha1.Spell.damage:type_name -> dnd5e.api.v1alpha1.SpellDamage
	117, // 146: dnd5e.api.v1alpha1.Spell.area_of_effect:type_name -> dnd5e.api.v1alpha1.AreaOfEffect
	4,   // 147: dnd5e.api.v1alpha1.ChoiceData.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 148: dnd5e.api.v1alpha1.ChoiceData.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	105, // 149: dnd5e.api.v1alpha1.ChoiceData.skills:type_name -> dnd5e.api.v1alpha1.SkillList
	106, // 150: dnd5e.api.v1alpha1.ChoiceData.languages:type_name -> dnd5e.api.v1alpha1.LanguageList
	13,  // 151: dnd5e.api.v1alpha1.ChoiceData.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	107, // 152: dnd5e.api.v1alpha1.ChoiceData.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentList
	113, // 153: dnd5e.api.v1alpha1.ChoiceData.race:type_name -> dnd5e.api.v1alpha1.RaceChoice
	114, // 154: dnd5e.api.v1alpha1.ChoiceData.class:type_name -> dnd5e.api.v1alpha1.ClassChoice
	138, // 155: dnd5e.api.v1alpha1.ChoiceData.background:type_name -> dnd5e.api.v1alpha1.Background
	108, // 156: dnd5e.api.v1alpha1.ChoiceData.spells:type_name -> dnd5e.api.v1alpha1.SpellList
	109, // 157: dnd5e.api.v1alpha1.ChoiceData.cantrips:type_name -> dnd5e.api.v1alpha1.CantripList
	110, // 158: dnd5e.api.v1alpha1.ChoiceData.expertise:type_name -> dnd5e.api.v1alpha1.ExpertiseList
	111, // 159: dnd5e.api.v1alpha1.ChoiceData.traits:type_name -> dnd5e.api.v1alpha1.TraitList
	112, // 160: dnd5e.api.v1alpha1.ChoiceData.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.ToolProficiencyList
	141, // 161: dnd5e.api.v1alpha1.SkillList.skills:type_name -> dnd5e.api.v1alpha1.Skill
	140, // 162: dnd5e.api.v1alpha1.LanguageList.languages:type_name -> dnd5e.api.v1alpha1.Language
	135, // 163: dnd5e.api.v1alpha1.RaceChoice.race:type_name -> dnd5e.api.v1alpha1.Race
	136, // 164: dnd5e.api.v1alpha1.RaceChoice.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	137, // 165: dnd5e.api.v1alpha1.ClassChoice.class:type_name -> dnd5e.api.v1alpha1.Class
	116, // 166: dnd5e.api.v1alpha1.SpellDamage.damage_at_slot_level:type_name -> dnd5e.api.v1alpha1.DamageAtSlotLevel
	146, // 167: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest.equipment_type:type_name -> dnd5e.api.v1alpha1.EquipmentType
	96,  // 168: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	137, // 169: dnd5e.api.v1alpha1.ListSpellsByLevelRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	103, // 170: dnd5e.api.v1alpha1.ListSpellsByLevelResponse.spells:type_name -> dnd5e.api.v1alpha1.Spell
	100, // 171: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.equipment_slots:type_name -> dnd5e.api.v1alpha1.EquipmentSlots
	101, // 172: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.inventory:type_name -> dnd5e.api.v1alpha1.InventoryItem
	102, // 173: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.encumbrance:type_name -> dnd5e.api.v1alpha1.EncumbranceInfo
	9,   // 174: dnd5e.api.v1alpha1.EquipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	14,  // 175: dnd5e.api.v1alpha1.EquipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	101, // 176: dnd5e.api.v1alpha1.EquipItemResponse.previously_equipped_item:type_name -> dnd5e.api.v1alpha1.InventoryItem
	9,   // 177: dnd5e.api.v1alpha1.UnequipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	14,  // 178: dnd5e.api.v1alpha1.UnequipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	129, // 179: dnd5e.api.v1alpha1.AddToInventoryRequest.items:type_name -> dnd5e.api.v1alpha1.InventoryAddition
	14,  // 180: dnd5e.api.v1alpha1.AddToInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	14,  // 181: dnd5e.api.v1alpha1.RemoveFromInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	31,  // 182: dnd5e.api.v1alpha1.CharacterService.CreateDraft:input_type -> dnd5e.api.v1alpha1.CreateDraftRequest
	33,  // 183: dnd5e.api.v1alpha1.CharacterService.GetDraft:input_type -> dnd5e.api.v1alpha1.GetDraftRequest
	49,  // 184: dnd5e.api.v1alpha1.CharacterService.ListDrafts:input_type -> dnd5e.api.v1alpha1.ListDraftsRequest
	57,  // 185: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:input_type -> dnd5e.api.v1alpha1.DeleteDraftRequest
	37,  // 186: dnd5e.api.v1alpha1.CharacterService.UpdateName:input_type -> dnd5e.api.v1alpha1.UpdateNameRequest
	38,  // 187: dnd5e.api.v1alpha1.CharacterService.UpdateRace:input_type -> dnd5e.api.v1alpha1.UpdateRaceRequest
	39,  // 188: dnd5e.api.v1alpha1.CharacterService.UpdateClass:input_type -> dnd5e.api.v1alpha1.UpdateClassRequest
	40,  // 189: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:input_type -> dnd5e.api.v1alpha1.UpdateBackgroundRequest
	41,  // 190: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:input_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	42,  // 191: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:input_type -> dnd5e.api.v1alpha1.UpdateSkillsRequest
	51,  // 192: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:input_type -> dnd5e.api.v1alpha1.ValidateDraftRequest
	53,  // 193: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:input_type -> dnd5e.api.v1alpha1.GetDraftPreviewRequest
	55,  // 194: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:input_type -> dnd5e.api.v1alpha1.FinalizeDraftRequest
	19,  // 195: dnd5e.api.v1alpha1.CharacterService.GetCharacter:input_type -> dnd5e.api.v1alpha1.GetCharacterRequest
	21,  // 196: dnd5e.api.v1alpha1.CharacterService.ListCharacters:input_type -> dnd5e.api.v1alpha1.ListCharactersRequest
	25,  // 197: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:input_type -> dnd5e.api.v1alpha1.DeleteCharacterRequest
	76,  // 198: dnd5e.api.v1alpha1.CharacterService.ListRaces:input_type -> dnd5e.api.v1alpha1.ListRacesRequest
	78,  // 199: dnd5e.api.v1alpha1.CharacterService.ListClasses:input_type -> dnd5e.api.v1alpha1.ListClassesRequest
	80,  // 200: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:input_type -> dnd5e.api.v1alpha1.ListBackgroundsRequest
	82,  // 201: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:input_type -> dnd5e.api.v1alpha1.GetRaceDetailsRequest
	84,  // 202: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:input_type -> dnd5e.api.v1alpha1.GetClassDetailsRequest
	86,  // 203: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:input_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	88,  // 204: dnd5e.api.v1alpha1.CharacterService.GetFeature:input_type -> dnd5e.api.v1alpha1.GetFeatureRequest
	90,  // 205: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:input_type -> dnd5e.api.v1alpha1.RollAbilityScoresRequest
	118, // 206: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:input_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	120, // 207: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:input_type -> dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	122, // 208: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:input_type -> dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	124, // 209: dnd5e.api.v1alpha1.CharacterService.EquipItem:input_type -> dnd5e.api.v1alpha1.EquipItemRequest
	126, // 210: dnd5e.api.v1alpha1.CharacterService.UnequipItem:input_type -> dnd5e.api.v1alpha1.UnequipItemRequest
	128, // 211: dnd5e.api.v1alpha1.CharacterService.AddToInventory:input_type -> dnd5e.api.v1alpha1.AddToInventoryRequest
	131, // 212: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:input_type -> dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	32,  // 213: dnd5e.api.v1alpha1.CharacterService.CreateDraft:output_type -> dnd5e.api.v1alpha1.CreateDraftResponse
	34,  // 214: dnd5e.api.v1alpha1.CharacterService.GetDraft:output_type -> dnd5e.api.v1alpha1.GetDraftResponse
	50,  // 215: dnd5e.api.v1alpha1.CharacterService.ListDrafts:output_type -> dnd5e.api.v1alpha1.ListDraftsResponse
	58,  // 216: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:output_type -> dnd5e.api.v1alpha1.DeleteDraftResponse
	43,  // 217: dnd5e.api.v1alpha1.CharacterService.UpdateName:output_type -> dnd5e.api.v1alpha1.UpdateNameResponse
	44,  // 218: dnd5e.api.v1alpha1.CharacterService.UpdateRace:output_type -> dnd5e.api.v1alpha1.UpdateRaceResponse
	45,  // 219: dnd5e.api.v1alpha1.CharacterService.UpdateClass:output_type -> dnd5e.api.v1alpha1.UpdateClassResponse
	46,  // 220: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:output_type -> dnd5e.api.v1alpha1.UpdateBackgroundResponse
	47,  // 221: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:output_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	48,  // 222: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:output_type -> dnd5e.api.v1alpha1.UpdateSkillsResponse
	52,  // 223: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:output_type -> dnd5e.api.v1alpha1.ValidateDraftResponse
	54,  // 224: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:output_type -> dnd5e.api.v1alpha1.GetDraftPreviewResponse
	56,  // 225: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:output_type -> dnd5e.api.v1alpha1.FinalizeDraftResponse
	20,  // 226: dnd5e.api.v1alpha1.CharacterService.GetCharacter:output_type -> dnd5e.api.v1alpha1.GetCharacterResponse
	22,  // 227: dnd5e.api.v1alpha1.CharacterService.ListCharacters:output_type -> dnd5e.api.v1alpha1.ListCharactersResponse
	26,  // 228: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:output_type -> dnd5e.api.v1alpha1.DeleteCharacterResponse
	77,  // 229: dnd5e.api.v1alpha1.CharacterService.ListRaces:output_type -> dnd5e.api.v1alpha1.ListRacesResponse
	79,  // 230: dnd5e.api.v1alpha1.CharacterService.ListClasses:output_type -> dnd5e.api.v1alpha1.ListClassesResponse
	81,  // 231: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:output_type -> dnd5e.api.v1alpha1.ListBackgroundsResponse
	83,  // 232: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:output_type -> dnd5e.api.v1alpha1.GetRaceDetailsResponse
	85,  // 233: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:output_type -> dnd5e.api.v1alpha1.GetClassDetailsResponse
	87,  // 234: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:output_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	89,  // 235: dnd5e.api.v1alpha1.CharacterService.GetFeature:output_type -> dnd5e.api.v1alpha1.GetFeatureResponse
	92,  // 236: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:output_type -> dnd5e.api.v1alpha1.RollAbilityScoresResponse
	119, // 237: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:output_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	121, // 238: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:output_type -> dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	123, // 239: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:output_type -> dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	125, // 240: dnd5e.api.v1alpha1.CharacterService.EquipItem:output_type -> dnd5e.api.v1alpha1.EquipItemResponse
	127, // 241: dnd5e.api.v1alpha1.CharacterService.UnequipItem:output_type -> dnd5e.api.v1alpha1.UnequipItemResponse
	130, // 242: dnd5e.api.v1alpha1.CharacterService.AddToInventory:output_type -> dnd5e.api.v1alpha1.AddToInventoryResponse
	132, // 243: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:output_type -> dnd5e.api.v1alpha1.RemoveFromInventoryResponse
	213, // [213:244] is the sub-list for method output_type
	182, // [182:213] is the sub-list for method input_type
