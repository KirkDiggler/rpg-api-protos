...
class SandboxRoomService final {
 public:
  ...
  typedef WithStreamedUnaryMethod_GenerateRoom<WithStreamedUnaryMethod_BuildStaticRoom<WithStreamedUnaryMethod_GetRoom<WithStreamedUnaryMethod_ListRooms<WithStreamedUnaryMethod_DeleteRoom<WithStreamedUnaryMethod_CheckLineOfSight<WithStreamedUnaryMethod_FindPath<WithStreamedUnaryMethod_CalculateDistance<WithStreamedUnaryMethod_GetPositionsInRange<WithStreamedUnaryMethod_PlaceEntity<WithStreamedUnaryMethod_MoveEntity<WithStreamedUnaryMethod_RemoveEntity<WithStreamedUnaryMethod_GetEntitiesInRoom<Service > > > > > > > > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GenerateRoom<WithStreamedUnaryMethod_BuildStaticRoom<WithStreamedUnaryMethod_GetRoom<WithStreamedUnaryMethod_ListRooms<WithStreamedUnaryMethod_DeleteRoom<WithStreamedUnaryMethod_CheckLineOfSight<WithStreamedUnaryMethod_FindPath<WithStreamedUnaryMethod_CalculateDistance<WithStreamedUnaryMethod_GetPositionsInRange<WithStreamedUnaryMethod_PlaceEntity<WithStreamedUnaryMethod_MoveEntity<WithStreamedUnaryMethod_RemoveEntity<WithStreamedUnaryMethod_GetEntitiesInRoom<Service > > > > > > > > > > > > > StreamedService;
};
