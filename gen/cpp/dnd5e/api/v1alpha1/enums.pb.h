...
inline constexpr ConditionId ConditionId_MAX =
    static_cast<ConditionId>(10);
inline bool ConditionId_IsValid(int value) {
  return 0 <= value && value <= 10;
}
inline constexpr int ConditionId_ARRAYSIZE = 10 + 1;
...
inline const ::std::string& ConditionId_Name(ConditionId value) {
  return ::google::protobuf::internal::NameOfDenseEnum<ConditionId_descriptor, 0, 10>(
      static_cast<int>(value));
}
...
inline constexpr FeatureId FeatureId_MAX =
    static_cast<FeatureId>(7);
inline bool FeatureId_IsValid(int value) {
  return 0 <= value && value <= 7;
}
inline constexpr int FeatureId_ARRAYSIZE = 7 + 1;
...
inline const ::std::string& FeatureId_Name(FeatureId value) {
  return ::google::protobuf::internal::NameOfDenseEnum<FeatureId_descriptor, 0, 7>(
      static_cast<int>(value));
}
