...
func (UnimplementedCharacterServiceServer) GetDraftPreview(context.Context, *GetDraftPreviewRequest) (*GetDraftPreviewResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDraftPreview not implemented")
}
...
func (UnimplementedCharacterServiceServer) SubmitChoices(context.Context, *SubmitChoicesRequest) (*SubmitChoicesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitChoices not implemented")
}
...
func (UnimplementedCharacterServiceServer) AddToInventory(context.Context, *AddToInventoryRequest) (*AddToInventoryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddToInventory not implemented")
}
func (UnimplementedCharacterServiceServer) RemoveFromInventory(context.Context, *RemoveFromInventoryRequest) (*RemoveFromInventoryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveFromInventory not implemented")
}
