...
type Character struct {
	...
	FightingStyles []FightingStyle     `protobuf:"varint,23,rep,packed,name=fighting_styles,json=fightingStyles,proto3,enum=dnd5e.api.v1alpha1.FightingStyle" json:"fighting_styles,omitempty"`
	// Racial traits
...
func (x *Character) GetFightingStyles() []FightingStyle {
	if x != nil {
...
type ProficiencyGrants struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Armor         []Armor                `protobuf:"varint,1,rep,packed,name=armor,proto3,enum=dnd5e.api.v1alpha1.Armor" json:"armor,omitempty"`
	Weapons       []Weapon               `protobuf:"varint,2,rep,packed,name=weapons,proto3,enum=dnd5e.api.v1alpha1.Weapon" json:"weapons,omitempty"`
	Tools         []Tool                 `protobuf:"varint,3,rep,packed,name=tools,proto3,enum=dnd5e.api.v1alpha1.Tool" json:"tools,omitempty"`
	Skills        []Skill                `protobuf:"varint,4,rep,packed,name=skills,proto3,enum=dnd5e.api.v1alpha1.Skill" json:"skills,omitempty"`
	Languages     []Language             `protobuf:"varint,5,rep,packed,name=languages,proto3,enum=dnd5e.api.v1alpha1.Language" json:"languages,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProficiencyGrants) Reset() {
	*x = ProficiencyGrants{}
...
func (x *ProficiencyGrants) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProficiencyGrants) ProtoMessage() {}

func (x *ProficiencyGrants) ProtoReflect() protoreflect.Message {
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProficiencyGrants.ProtoReflect.Descriptor instead.
func (*ProficiencyGrants) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{7}
}

func (x *ProficiencyGrants) GetArmor() []Armor {
	if x != nil {
		return x.Armor
	}
	return nil
...
func (x *ProficiencyGrants) GetWeapons() []Weapon {
	if x != nil {
		return x.Weapons
	}
	return nil
...
func (x *ProficiencyGrants) GetTools() []Tool {
	if x != nil {
		return x.Tools
	}
	return nil
...
func (x *ProficiencyGrants) GetSkills() []Skill {
	if x != nil {
		return x.Skills
	}
	return nil
...
func (x *ProficiencyGrants) GetLanguages() []Language {
	if x != nil {
		return x.Languages
	}
	return nil
...
type Proficiencies struct {
	...
	Armor []Armor `protobuf:"varint,3,rep,packed,name=armor,proto3,enum=dnd5e.api.v1alpha1.Armor" json:"armor,omitempty"`
	// Weapon proficiencies - now using typed enums to match toolkit
	Weapons []Weapon `protobuf:"varint,4,rep,packed,name=weapons,proto3,enum=dnd5e.api.v1alpha1.Weapon" json:"weapons,omitempty"`
	// Tool proficiencies - now using typed enums to match toolkit
	Tools []Tool `protobuf:"varint,5,rep,packed,name=tools,proto3,enum=dnd5e.api.v1alpha1.Tool" json:"tools,omitempty"`
	// DEPRECATED: Use armor field instead - kept for backward compatibility
	//
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	ArmorStrings []string `protobuf:"bytes,6,rep,name=armor_strings,json=armorStrings,proto3" json:"armor_strings,omitempty"`
	// DEPRECATED: Use weapons field instead - kept for backward compatibility
	//
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	WeaponStrings []string `protobuf:"bytes,7,rep,name=weapon_strings,json=weaponStrings,proto3" json:"weapon_strings,omitempty"`
	// DEPRECATED: Use tools field instead - kept for backward compatibility
	//
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	ToolStrings   []string `protobuf:"bytes,8,rep,name=tool_strings,json=toolStrings,proto3" json:"tool_strings,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Proficiencies) GetArmor() []Armor {
	if x != nil {
		return x.Armor
	}
	return nil
...
func (x *Proficiencies) GetWeapons() []Weapon {
	if x != nil {
		return x.Weapons
	}
	return nil
...
func (x *Proficiencies) GetTools() []Tool {
	if x != nil {
		return x.Tools
	}
	return nil
...
// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
func (x *Proficiencies) GetArmorStrings() []string {
	if x != nil {
		return x.ArmorStrings
	}
	return nil
}

// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
func (x *Proficiencies) GetWeaponStrings() []string {
	if x != nil {
		return x.WeaponStrings
	}
	return nil
}

// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
func (x *Proficiencies) GetToolStrings() []string {
	if x != nil {
		return x.ToolStrings
	}
	return nil
}
...
type CharacterDraftData struct {
	...
	Subrace    Subrace    `protobuf:"varint,6,opt,name=subrace,proto3,enum=dnd5e.api.v1alpha1.Subrace" json:"subrace,omitempty"`
	Class      Class      `protobuf:"varint,7,opt,name=class,proto3,enum=dnd5e.api.v1alpha1.Class" json:"class,omitempty"`
	Subclass   Subclass   `protobuf:"varint,8,opt,name=subclass,proto3,enum=dnd5e.api.v1alpha1.Subclass" json:"subclass,omitempty"`
	Background Background `protobuf:"varint,9,opt,name=background,proto3,enum=dnd5e.api.v1alpha1.Background" json:"background,omitempty"`
	// Base ability scores (before racial modifiers)
	BaseAbilityScores *AbilityScores `protobuf:"bytes,10,opt,name=base_ability_scores,json=baseAbilityScores,proto3" json:"base_ability_scores,omitempty"`
...
func (x *CharacterDraftData) GetBaseAbilityScores() *AbilityScores {
	if x != nil {
		return x.BaseAbilityScores
	}
	return nil
}
...
type CharacterDraft struct {
	...
	Validation *ValidationResult `protobuf:"bytes,13,opt,name=validation,proto3" json:"validation,omitempty"`
	// Optional expanded info for UI display
	// These can be populated when needed for richer UI experience
	RaceInfo       *RaceInfo       `protobuf:"bytes,14,opt,name=race_info,json=raceInfo,proto3" json:"race_info,omitempty"`
	SubraceInfo    *SubraceInfo    `protobuf:"bytes,15,opt,name=subrace_info,json=subraceInfo,proto3" json:"subrace_info,omitempty"`
	ClassInfo      *ClassInfo      `protobuf:"bytes,16,opt,name=class_info,json=classInfo,proto3" json:"class_info,omitempty"`
	BackgroundInfo *BackgroundInfo `protobuf:"bytes,17,opt,name=background_info,json=backgroundInfo,proto3" json:"background_info,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *CharacterDraft) GetSubclass() Subclass {
	if x != nil {
		return x.Subclass
	}
	return Subclass_SUBCLASS_UNSPECIFIED
...
func (x *CharacterDraft) GetBaseAbilityScores() *AbilityScores {
	if x != nil {
		return x.BaseAbilityScores
	}
	return nil
...
func (x *CharacterDraft) GetRaceInfo() *RaceInfo {
	if x != nil {
		return x.RaceInfo
	}
	return nil
...
func (x *CharacterDraft) GetSubraceInfo() *SubraceInfo {
	if x != nil {
		return x.SubraceInfo
	}
	return nil
}

func (x *CharacterDraft) GetClassInfo() *ClassInfo {
	if x != nil {
		return x.ClassInfo
	}
	return nil
...
func (x *CharacterDraft) GetBackgroundInfo() *BackgroundInfo {
	if x != nil {
...
type RaceInfo struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The race enum value
	RaceId Race `protobuf:"varint,1,opt,name=race_id,json=raceId,proto3,enum=dnd5e.api.v1alpha1.Race" json:"race_id,omitempty"`
	...
	ProficiencyGrants *ProficiencyGrants `protobuf:"bytes,9,opt,name=proficiency_grants,json=proficiencyGrants,proto3" json:"proficiency_grants,omitempty"`
	// Starting languages
	...
	Choices []*Choice `protobuf:"bytes,11,rep,name=choices,proto3" json:"choices,omitempty"`
	...
	//
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	AgeDescription string `protobuf:"bytes,12,opt,name=age_description,json=ageDescription,proto3" json:"age_description,omitempty"` // e.g., "Elves can live to be 750 years old"
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	AlignmentDescription string `protobuf:"bytes,13,opt,name=alignment_description,json=alignmentDescription,proto3" json:"alignment_description,omitempty"` // e.g., "Most dwarves are lawful"
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	SizeDescription string `protobuf:"bytes,14,opt,name=size_description,json=sizeDescription,proto3" json:"size_description,omitempty"` // e.g., "4-5 feet tall, 150 pounds"
	// DEPRECATED: Use proficiency_grants instead
	//
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	Proficiencies []string `protobuf:"bytes,15,rep,name=proficiencies,proto3" json:"proficiencies,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RaceInfo) GetRaceId() Race {
	if x != nil {
		return x.RaceId
	}
	return Race_RACE_UNSPECIFIED
...
func (x *RaceInfo) GetProficiencyGrants() *ProficiencyGrants {
	if x != nil {
		return x.ProficiencyGrants
	}
	return nil
}
...
type SubraceInfo struct {
	...
	SubraceId   Subrace `protobuf:"varint,1,opt,name=subrace_id,json=subraceId,proto3,enum=dnd5e.api.v1alpha1.Subrace" json:"subrace_id,omitempty"`
	Name        string  `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Description string  `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
	...
	ProficiencyGrants *ProficiencyGrants `protobuf:"bytes,7,opt,name=proficiency_grants,json=proficiencyGrants,proto3" json:"proficiency_grants,omitempty"`
	// DEPRECATED: Use proficiency_grants instead
	//
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	Proficiencies []string `protobuf:"bytes,8,rep,name=proficiencies,proto3" json:"proficiencies,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SubraceInfo) GetSubraceId() Subrace {
	if x != nil {
		return x.SubraceId
	}
	return Subrace_SUBRACE_UNSPECIFIED
...
func (x *SubraceInfo) GetProficiencyGrants() *ProficiencyGrants {
	if x != nil {
		return x.ProficiencyGrants
	}
	return nil
...
type ItemReference struct {
	...
	//
	//	*ItemReference_Weapon
	//	*ItemReference_Armor
	//	*ItemReference_Tool
	//	*ItemReference_Pack
	//	*ItemReference_Ammunition
	//	*ItemReference_OtherItemId
	Item          isItemReference_Item `protobuf_oneof:"item"`
	Name          string               `protobuf:"bytes,7,opt,name=name,proto3" json:"name,omitempty"` // Display name
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ItemReference) GetItem() isItemReference_Item {
	if x != nil {
		return x.Item
	}
	return nil
...
func (x *ItemReference) GetWeapon() Weapon {
	if x != nil {
		if x, ok := x.Item.(*ItemReference_Weapon); ok {
			return x.Weapon
		}
	}
...
func (x *ItemReference) GetArmor() Armor {
	if x != nil {
		if x, ok := x.Item.(*ItemReference_Armor); ok {
			return x.Armor
		}
	}
...
func (x *ItemReference) GetTool() Tool {
	if x != nil {
		if x, ok := x.Item.(*ItemReference_Tool); ok {
			return x.Tool
		}
	}
...
func (x *ItemReference) GetPack() Pack {
	if x != nil {
		if x, ok := x.Item.(*ItemReference_Pack); ok {
			return x.Pack
		}
	}
...
func (x *ItemReference) GetAmmunition() Ammunition {
	if x != nil {
		if x, ok := x.Item.(*ItemReference_Ammunition); ok {
			return x.Ammunition
		}
	}
...
func (x *ItemReference) GetOtherItemId() string {
	if x != nil {
		if x, ok := x.Item.(*ItemReference_OtherItemId); ok {
			return x.OtherItemId
		}
	}
	return ""
}
...
type isItemReference_Item interface {
	isItemReference_Item()
}

type ItemReference_Weapon struct {
	Weapon Weapon `protobuf:"varint,1,opt,name=weapon,proto3,enum=dnd5e.api.v1alpha1.Weapon,oneof"`
}

type ItemReference_Armor struct {
	Armor Armor `protobuf:"varint,2,opt,name=armor,proto3,enum=dnd5e.api.v1alpha1.Armor,oneof"`
}

type ItemReference_Tool struct {
	Tool Tool `protobuf:"varint,3,opt,name=tool,proto3,enum=dnd5e.api.v1alpha1.Tool,oneof"`
}

type ItemReference_Pack struct {
	Pack Pack `protobuf:"varint,4,opt,name=pack,proto3,enum=dnd5e.api.v1alpha1.Pack,oneof"`
}

type ItemReference_Ammunition struct {
	Ammunition Ammunition `protobuf:"varint,5,opt,name=ammunition,proto3,enum=dnd5e.api.v1alpha1.Ammunition,oneof"`
}

type ItemReference_OtherItemId struct {
	OtherItemId string `protobuf:"bytes,6,opt,name=other_item_id,json=otherItemId,proto3,oneof"` // For items not yet enumerated
}

func (*ItemReference_Weapon) isItemReference_Item() {}

func (*ItemReference_Armor) isItemReference_Item() {}

func (*ItemReference_Tool) isItemReference_Item() {}

func (*ItemReference_Pack) isItemReference_Item() {}

func (*ItemReference_Ammunition) isItemReference_Item() {}

func (*ItemReference_OtherItemId) isItemReference_Item() {}
...
type CountedItemReference struct {
	...
	// Types that are valid to be assigned to Item:
	//
	//	*CountedItemReference_Weapon
	//	*CountedItemReference_Armor
	//	*CountedItemReference_Tool
	//	*CountedItemReference_Pack
	//	*CountedItemReference_Ammunition
	//	*CountedItemReference_OtherItemId
	Item          isCountedItemReference_Item `protobuf_oneof:"item"`
	Name          string                      `protobuf:"bytes,7,opt,name=name,proto3" json:"name,omitempty"`          // Display name
	Quantity      int32                       `protobuf:"varint,8,opt,name=quantity,proto3" json:"quantity,omitempty"` // e.g., 20 arrows
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CountedItemReference) GetItem() isCountedItemReference_Item {
	if x != nil {
		return x.Item
	}
	return nil
...
func (x *CountedItemReference) GetWeapon() Weapon {
	if x != nil {
		if x, ok := x.Item.(*CountedItemReference_Weapon); ok {
			return x.Weapon
		}
	}
	return Weapon_WEAPON_UNSPECIFIED
...
func (x *CountedItemReference) GetArmor() Armor {
	if x != nil {
		if x, ok := x.Item.(*CountedItemReference_Armor); ok {
			return x.Armor
		}
	}
	return Armor_ARMOR_UNSPECIFIED
...
func (x *CountedItemReference) GetTool() Tool {
	if x != nil {
		if x, ok := x.Item.(*CountedItemReference_Tool); ok {
			return x.Tool
		}
	}
	return Tool_TOOL_UNSPECIFIED
...
func (x *CountedItemReference) GetPack() Pack {
	if x != nil {
		if x, ok := x.Item.(*CountedItemReference_Pack); ok {
			return x.Pack
		}
	}
	return Pack_PACK_UNSPECIFIED
...
func (x *CountedItemReference) GetAmmunition() Ammunition {
	if x != nil {
		if x, ok := x.Item.(*CountedItemReference_Ammunition); ok {
			return x.Ammunition
		}
	}
	return Ammunition_AMMUNITION_UNSPECIFIED
...
func (x *CountedItemReference) GetOtherItemId() string {
	if x != nil {
		if x, ok := x.Item.(*CountedItemReference_OtherItemId); ok {
			return x.OtherItemId
		}
	}
	return ""
...
type isCountedItemReference_Item interface {
	isCountedItemReference_Item()
}

type CountedItemReference_Weapon struct {
	Weapon Weapon `protobuf:"varint,1,opt,name=weapon,proto3,enum=dnd5e.api.v1alpha1.Weapon,oneof"`
}

type CountedItemReference_Armor struct {
	Armor Armor `protobuf:"varint,2,opt,name=armor,proto3,enum=dnd5e.api.v1alpha1.Armor,oneof"`
}

type CountedItemReference_Tool struct {
	Tool Tool `protobuf:"varint,3,opt,name=tool,proto3,enum=dnd5e.api.v1alpha1.Tool,oneof"`
}

type CountedItemReference_Pack struct {
	Pack Pack `protobuf:"varint,4,opt,name=pack,proto3,enum=dnd5e.api.v1alpha1.Pack,oneof"`
}

type CountedItemReference_Ammunition struct {
	Ammunition Ammunition `protobuf:"varint,5,opt,name=ammunition,proto3,enum=dnd5e.api.v1alpha1.Ammunition,oneof"`
}

type CountedItemReference_OtherItemId struct {
	OtherItemId string `protobuf:"bytes,6,opt,name=other_item_id,json=otherItemId,proto3,oneof"` // For items not yet enumerated
}

func (*CountedItemReference_Weapon) isCountedItemReference_Item() {}

func (*CountedItemReference_Armor) isCountedItemReference_Item() {}

func (*CountedItemReference_Tool) isCountedItemReference_Item() {}

func (*CountedItemReference_Pack) isCountedItemReference_Item() {}

func (*CountedItemReference_Ammunition) isCountedItemReference_Item() {}

func (*CountedItemReference_OtherItemId) isCountedItemReference_Item() {}
...
type ClassInfo struct {
	...
	ClassId Class `protobuf:"varint,1,opt,name=class_id,json=classId,proto3,enum=dnd5e.api.v1alpha1.Class" json:"class_id,omitempty"`
	// Basic identification
	Name        string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Description string `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
	// Mechanical information
	HitDie         int32   `protobuf:"varint,4,opt,name=hit_die,json=hitDie,proto3" json:"hit_die,omitempty"`                                                         // e.g., 10 for d10
	PrimaryAbility Ability `protobuf:"varint,5,opt,name=primary_ability,json=primaryAbility,proto3,enum=dnd5e.api.v1alpha1.Ability" json:"primary_ability,omitempty"` // Primary ability for the class
	// Proficiency categories (e.g., "all light armor", "all martial weapons")
	ArmorProficiencyCategories  []ArmorProficiencyCategory  `protobuf:"varint,6,rep,packed,name=armor_proficiency_categories,json=armorProficiencyCategories,proto3,enum=dnd5e.api.v1alpha1.ArmorProficiencyCategory" json:"armor_proficiency_categories,omitempty"`
	WeaponProficiencyCategories []WeaponProficiencyCategory `protobuf:"varint,7,rep,packed,name=weapon_proficiency_categories,json=weaponProficiencyCategories,proto3,enum=dnd5e.api.v1alpha1.WeaponProficiencyCategory" json:"weapon_proficiency_categories,omitempty"`
	// Specific proficiencies (for individual items like "longsword" or "thieves' tools")
	SpecificWeaponProficiencies []Weapon  `protobuf:"varint,28,rep,packed,name=specific_weapon_proficiencies,json=specificWeaponProficiencies,proto3,enum=dnd5e.api.v1alpha1.Weapon" json:"specific_weapon_proficiencies,omitempty"`
	ToolProficiencies           []Tool    `protobuf:"varint,8,rep,packed,name=tool_proficiencies,json=toolProficiencies,proto3,enum=dnd5e.api.v1alpha1.Tool" json:"tool_proficiencies,omitempty"`
	SavingThrowProficiencies    []Ability `protobuf:"varint,9,rep,packed,name=saving_throw_proficiencies,json=savingThrowProficiencies,proto3,enum=dnd5e.api.v1alpha1.Ability" json:"saving_throw_proficiencies,omitempty"`
	// DEPRECATED: Use typed proficiency fields instead
	//
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	Proficiencies []string `protobuf:"bytes,27,rep,name=proficiencies,proto3" json:"proficiencies,omitempty"`
	// Skill choices
	...
	AvailableSkills   []Skill `protobuf:"varint,11,rep,packed,name=available_skills,json=availableSkills,proto3,enum=dnd5e.api.v1alpha1.Skill" json:"available_skills,omitempty"`
	// Starting equipment choices
	EquipmentChoices []*Choice `protobuf:"bytes,12,rep,name=equipment_choices,json=equipmentChoices,proto3" json:"equipment_choices,omitempty"`
	...
	Subclasses    []*SubclassInfo `protobuf:"bytes,16,rep,name=subclasses,proto3" json:"subclasses,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ClassInfo) GetClassId() Class {
	if x != nil {
		return x.ClassId
	}
	return Class_CLASS_UNSPECIFIED
...
func (x *ClassInfo) GetHitDie() int32 {
	if x != nil {
		return x.HitDie
	}
	return 0
...
func (x *ClassInfo) GetPrimaryAbility() Ability {
	if x != nil {
		return x.PrimaryAbility
	}
	return Ability_ABILITY_UNSPECIFIED
}

func (x *ClassInfo) GetArmorProficiencyCategories() []ArmorProficiencyCategory {
	if x != nil {
		return x.ArmorProficiencyCategories
	}
	return nil
}

func (x *ClassInfo) GetWeaponProficiencyCategories() []WeaponProficiencyCategory {
	if x != nil {
		return x.WeaponProficiencyCategories
	}
	return nil
}

func (x *ClassInfo) GetSpecificWeaponProficiencies() []Weapon {
	if x != nil {
		return x.SpecificWeaponProficiencies
	}
	return nil
}

func (x *ClassInfo) GetToolProficiencies() []Tool {
	if x != nil {
...
func (x *ClassInfo) GetSavingThrowProficiencies() []Ability {
	if x != nil {
...
// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
func (x *ClassInfo) GetProficiencies() []string {
	if x != nil {
		return x.Proficiencies
	}
	return nil
...
func (x *ClassInfo) GetAvailableSkills() []Skill {
	if x != nil {
...
func (x *ClassInfo) GetEquipmentChoices() []*Choice {
	if x != nil {
...
type SubclassInfo struct {
	...
	SubclassId Subclass `protobuf:"varint,1,opt,name=subclass_id,json=subclassId,proto3,enum=dnd5e.api.v1alpha1.Subclass" json:"subclass_id,omitempty"`
	// Basic identification
	Name        string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Description string `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
	...
	ArmorProficiencies  []Armor  `protobuf:"varint,5,rep,packed,name=armor_proficiencies,json=armorProficiencies,proto3,enum=dnd5e.api.v1alpha1.Armor" json:"armor_proficiencies,omitempty"`
	WeaponProficiencies []Weapon `protobuf:"varint,6,rep,packed,name=weapon_proficiencies,json=weaponProficiencies,proto3,enum=dnd5e.api.v1alpha1.Weapon" json:"weapon_proficiencies,omitempty"`
	ToolProficiencies   []Tool   `protobuf:"varint,7,rep,packed,name=tool_proficiencies,json=toolProficiencies,proto3,enum=dnd5e.api.v1alpha1.Tool" json:"tool_proficiencies,omitempty"`
	...
	//
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	ArmorProficiencyStrings []string `protobuf:"bytes,10,rep,name=armor_proficiency_strings,json=armorProficiencyStrings,proto3" json:"armor_proficiency_strings,omitempty"`
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	WeaponProficiencyStrings []string `protobuf:"bytes,11,rep,name=weapon_proficiency_strings,json=weaponProficiencyStrings,proto3" json:"weapon_proficiency_strings,omitempty"`
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	ToolProficiencyStrings []string `protobuf:"bytes,12,rep,name=tool_proficiency_strings,json=toolProficiencyStrings,proto3" json:"tool_proficiency_strings,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *SubclassInfo) GetSubclassId() Subclass {
	if x != nil {
		return x.SubclassId
	}
	return Subclass_SUBCLASS_UNSPECIFIED
...
func (x *SubclassInfo) GetArmorProficiencies() []Armor {
	if x != nil {
...
func (x *SubclassInfo) GetWeaponProficiencies() []Weapon {
	if x != nil {
...
func (x *SubclassInfo) GetToolProficiencies() []Tool {
	if x != nil {
		return x.ToolProficiencies
	}
	return nil
...
// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
func (x *SubclassInfo) GetArmorProficiencyStrings() []string {
	if x != nil {
		return x.ArmorProficiencyStrings
	}
	return nil
}

// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
func (x *SubclassInfo) GetWeaponProficiencyStrings() []string {
	if x != nil {
		return x.WeaponProficiencyStrings
	}
	return nil
}

// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
func (x *SubclassInfo) GetToolProficiencyStrings() []string {
	if x != nil {
		return x.ToolProficiencyStrings
	}
	return nil
}
...
type BackgroundInfo struct {
	...
	BackgroundId Background `protobuf:"varint,1,opt,name=background_id,json=backgroundId,proto3,enum=dnd5e.api.v1alpha1.Background" json:"background_id,omitempty"`
	// Basic identification
	Name        string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Description string `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
	// Mechanical benefits - structured to match toolkit types
	SkillProficiencies  []Skill    `protobuf:"varint,4,rep,packed,name=skill_proficiencies,json=skillProficiencies,proto3,enum=dnd5e.api.v1alpha1.Skill" json:"skill_proficiencies,omitempty"`
	ToolProficiencies   []Tool     `protobuf:"varint,5,rep,packed,name=tool_proficiencies,json=toolProficiencies,proto3,enum=dnd5e.api.v1alpha1.Tool" json:"tool_proficiencies,omitempty"`
	Languages           []Language `protobuf:"varint,6,rep,packed,name=languages,proto3,enum=dnd5e.api.v1alpha1.Language" json:"languages,omitempty"`
	...
	// Starting equipment
	StartingEquipment []*EquipmentSelection `protobuf:"bytes,8,rep,name=starting_equipment,json=startingEquipment,proto3" json:"starting_equipment,omitempty"`
	...
	//
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	SkillProficiencyStrings []string `protobuf:"bytes,16,rep,name=skill_proficiency_strings,json=skillProficiencyStrings,proto3" json:"skill_proficiency_strings,omitempty"`
	// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
	ToolProficiencyStrings []string `protobuf:"bytes,17,rep,name=tool_proficiency_strings,json=toolProficiencyStrings,proto3" json:"tool_proficiency_strings,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *BackgroundInfo) GetBackgroundId() Background {
	if x != nil {
...
func (x *BackgroundInfo) GetSkillProficiencies() []Skill {
	if x != nil {
...
func (x *BackgroundInfo) GetToolProficiencies() []Tool {
	if x != nil {
		return x.ToolProficiencies
	}
	return nil
...
func (x *BackgroundInfo) GetStartingEquipment() []*EquipmentSelection {
	if x != nil {
...
// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
func (x *BackgroundInfo) GetSkillProficiencyStrings() []string {
	if x != nil {
		return x.SkillProficiencyStrings
	}
	return nil
}

// Deprecated: Marked as deprecated in dnd5e/api/v1alpha1/character.proto.
func (x *BackgroundInfo) GetToolProficiencyStrings() []string {
	if x != nil {
		return x.ToolProficiencyStrings
	}
	return nil
...
type GetRequirementsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DraftId       string                 `protobuf:"bytes,1,opt,name=draft_id,json=draftId,proto3" json:"draft_id,omitempty"`
	Class         Class                  `protobuf:"varint,2,opt,name=class,proto3,enum=dnd5e.api.v1alpha1.Class" json:"class,omitempty"` // Optional: get requirements for a specific class
	Race          Race                   `protobuf:"varint,3,opt,name=race,proto3,enum=dnd5e.api.v1alpha1.Race" json:"race,omitempty"`    // Optional: get requirements for a specific race
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetRequirementsRequest) GetDraftId() string {
	if x != nil {
		return x.DraftId
	}
	return ""
...
func (x *GetRequirementsRequest) GetClass() Class {
	if x != nil {
		return x.Class
	}
	return Class_CLASS_UNSPECIFIED
...
func (x *GetRequirementsRequest) GetRace() Race {
	if x != nil {
		return x.Race
	}
	return Race_RACE_UNSPECIFIED
...
type GetRequirementsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Requirements  *CharacterRequirements `protobuf:"bytes,1,opt,name=requirements,proto3" json:"requirements,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetRequirementsResponse) Reset() {
	*x = GetRequirementsResponse{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[86]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetRequirementsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRequirementsResponse) ProtoMessage() {}

func (x *GetRequirementsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[86]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRequirementsResponse.ProtoReflect.Descriptor instead.
func (*GetRequirementsResponse) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{86}
}

func (x *GetRequirementsResponse) GetRequirements() *CharacterRequirements {
	if x != nil {
...
type SubmitChoicesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DraftId       string                 `protobuf:"bytes,1,opt,name=draft_id,json=draftId,proto3" json:"draft_id,omitempty"`
	Submissions   []*ChoiceSubmission    `protobuf:"bytes,2,rep,name=submissions,proto3" json:"submissions,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SubmitChoicesRequest) Reset() {
	*x = SubmitChoicesRequest{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[87]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SubmitChoicesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubmitChoicesRequest) ProtoMessage() {}

func (x *SubmitChoicesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[87]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubmitChoicesRequest.ProtoReflect.Descriptor instead.
func (*SubmitChoicesRequest) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{87}
}

func (x *SubmitChoicesRequest) GetDraftId() string {
	if x != nil {
		return x.DraftId
	}
	return ""
...
func (x *SubmitChoicesRequest) GetSubmissions() []*ChoiceSubmission {
	if x != nil {
...
type SubmitChoicesResponse struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	Draft                 *CharacterDraft        `protobuf:"bytes,1,opt,name=draft,proto3" json:"draft,omitempty"`
	Validation            *ValidationResult      `protobuf:"bytes,2,opt,name=validation,proto3" json:"validation,omitempty"`
	RemainingRequirements *CharacterRequirements `protobuf:"bytes,3,opt,name=remaining_requirements,json=remainingRequirements,proto3" json:"remaining_requirements,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}

func (x *SubmitChoicesResponse) Reset() {
	*x = SubmitChoicesResponse{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[88]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SubmitChoicesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubmitChoicesResponse) ProtoMessage() {}

func (x *SubmitChoicesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[88]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubmitChoicesResponse.ProtoReflect.Descriptor instead.
func (*SubmitChoicesResponse) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{88}
}

func (x *SubmitChoicesResponse) GetDraft() *CharacterDraft {
	if x != nil {
		return x.Draft
	}
	return nil
...
func (x *SubmitChoicesResponse) GetValidation() *ValidationResult {
	if x != nil {
		return x.Validation
	}
	return nil
...
func (x *SubmitChoicesResponse) GetRemainingRequirements() *CharacterRequirements {
	if x != nil {
		return x.RemainingRequirements
	}
	return nil
}
...
func (x *ChoiceData) GetFightingStyle() FightingStyle {
	if x != nil {
...
type ChoiceData_FightingStyle struct {
	FightingStyle FightingStyle `protobuf:"varint,8,opt,name=fighting_style,json=fightingStyle,proto3,enum=dnd5e.api.v1alpha1.FightingStyle,oneof"`
}
...
type EquipmentList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Items         []*EquipmentSelection  `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EquipmentList) GetItems() []*EquipmentSelection {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *SpellList) GetSpells() []Spell {
	if x != nil {
		return x.Spells
	}
	return nil
...
type CantripList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Cantrips      []Spell                `protobuf:"varint,1,rep,packed,name=cantrips,proto3,enum=dnd5e.api.v1alpha1.Spell" json:"cantrips,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CantripList) GetCantrips() []Spell {
	if x != nil {
		return x.Cantrips
	}
	return nil
...
type ExpertiseList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Skills        []Skill                `protobuf:"varint,1,rep,packed,name=skills,proto3,enum=dnd5e.api.v1alpha1.Skill" json:"skills,omitempty"` // Skills that get expertise (double proficiency)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExpertiseList) GetSkills() []Skill {
	if x != nil {
		return x.Skills
	}
	return nil
...
type TraitList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Traits        []Trait                `protobuf:"varint,1,rep,packed,name=traits,proto3,enum=dnd5e.api.v1alpha1.Trait" json:"traits,omitempty"` // Racial or class trait selections
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TraitList) GetTraits() []Trait {
	if x != nil {
		return x.Traits
	}
	return nil
...
type ToolProficiencyList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tools         []Tool                 `protobuf:"varint,1,rep,packed,name=tools,proto3,enum=dnd5e.api.v1alpha1.Tool" json:"tools,omitempty"` // Tool proficiency selections
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ToolProficiencyList) GetTools() []Tool {
	if x != nil {
		return x.Tools
	}
	return nil
...
type EquipmentChoice struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	ChoiceId    string                 `protobuf:"bytes,1,opt,name=choice_id,json=choiceId,proto3" json:"choice_id,omitempty"` // e.g., "fighter-armor-a"
	Description string                 `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`           // Human-readable description
	// Options for this choice
	Options       []*EquipmentOption `protobuf:"bytes,3,rep,name=options,proto3" json:"options,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EquipmentChoice) GetChoiceId() string {
	if x != nil {
		return x.ChoiceId
	}
	return ""
...
func (x *EquipmentChoice) GetOptions() []*EquipmentOption {
	if x != nil {
		return x.Options
	}
	return nil
...
type EquipmentOption struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	OptionId    string                 `protobuf:"bytes,1,opt,name=option_id,json=optionId,proto3" json:"option_id,omitempty"` // e.g., "leather-longbow"
	Description string                 `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	// Equipment items granted by this option
	Items         []*EquipmentSelection `protobuf:"bytes,3,rep,name=items,proto3" json:"items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EquipmentOption) GetOptionId() string {
	if x != nil {
		return x.OptionId
	}
	return ""
...
func (x *EquipmentOption) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *EquipmentOption) GetItems() []*EquipmentSelection {
	if x != nil {
		return x.Items
	}
	return nil
...
type EquipmentSelection struct {
	...
	//
	//	*EquipmentSelection_Weapon
	//	*EquipmentSelection_Armor
	//	*EquipmentSelection_Tool
	//	*EquipmentSelection_Pack
	//	*EquipmentSelection_Ammunition
	//	*EquipmentSelection_OtherEquipmentId
	Equipment     isEquipmentSelection_Equipment `protobuf_oneof:"equipment"`
...
func (x *EquipmentSelection) GetEquipment() isEquipmentSelection_Equipment {
	if x != nil {
		return x.Equipment
	}
	return nil
...
func (x *EquipmentSelection) GetWeapon() Weapon {
	if x != nil {
		if x, ok := x.Equipment.(*EquipmentSelection_Weapon); ok {
			return x.Weapon
		}
	}
	return Weapon_WEAPON_UNSPECIFIED
...
func (x *EquipmentSelection) GetArmor() Armor {
	if x != nil {
		if x, ok := x.Equipment.(*EquipmentSelection_Armor); ok {
			return x.Armor
		}
	}
	return Armor_ARMOR_UNSPECIFIED
...
func (x *EquipmentSelection) GetTool() Tool {
	if x != nil {
		if x, ok := x.Equipment.(*EquipmentSelection_Tool); ok {
			return x.Tool
		}
	}
	return Tool_TOOL_UNSPECIFIED
...
func (x *EquipmentSelection) GetPack() Pack {
	if x != nil {
		if x, ok := x.Equipment.(*EquipmentSelection_Pack); ok {
			return x.Pack
		}
	}
	return Pack_PACK_UNSPECIFIED
...
func (x *EquipmentSelection) GetAmmunition() Ammunition {
	if x != nil {
		if x, ok := x.Equipment.(*EquipmentSelection_Ammunition); ok {
			return x.Ammunition
		}
	}
	return Ammunition_AMMUNITION_UNSPECIFIED
...
func (x *EquipmentSelection) GetOtherEquipmentId() string {
	if x != nil {
		if x, ok := x.Equipment.(*EquipmentSelection_OtherEquipmentId); ok {
...
func (x *EquipmentSelection) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
type isEquipmentSelection_Equipment interface {
	isEquipmentSelection_Equipment()
}

type EquipmentSelection_Weapon struct {
	Weapon Weapon `protobuf:"varint,1,opt,name=weapon,proto3,enum=dnd5e.api.v1alpha1.Weapon,oneof"`
}

type EquipmentSelection_Armor struct {
	Armor Armor `protobuf:"varint,2,opt,name=armor,proto3,enum=dnd5e.api.v1alpha1.Armor,oneof"`
}

type EquipmentSelection_Tool struct {
	Tool Tool `protobuf:"varint,3,opt,name=tool,proto3,enum=dnd5e.api.v1alpha1.Tool,oneof"`
}

type EquipmentSelection_Pack struct {
	Pack Pack `protobuf:"varint,4,opt,name=pack,proto3,enum=dnd5e.api.v1alpha1.Pack,oneof"`
}

type EquipmentSelection_Ammunition struct {
	Ammunition Ammunition `protobuf:"varint,5,opt,name=ammunition,proto3,enum=dnd5e.api.v1alpha1.Ammunition,oneof"`
}

type EquipmentSelection_OtherEquipmentId struct {
...
func (*EquipmentSelection_Weapon) isEquipmentSelection_Equipment() {}

func (*EquipmentSelection_Armor) isEquipmentSelection_Equipment() {}

func (*EquipmentSelection_Tool) isEquipmentSelection_Equipment() {}

func (*EquipmentSelection_Pack) isEquipmentSelection_Equipment() {}

func (*EquipmentSelection_Ammunition) isEquipmentSelection_Equipment() {}

func (*EquipmentSelection_OtherEquipmentId) isEquipmentSelection_Equipment() {}
...
type ChoiceSubmission struct {
	...
	ChoiceId string                 `protobuf:"bytes,3,opt,name=choice_id,json=choiceId,proto3" json:"choice_id,omitempty"` // Which choice this is for
	OptionId string                 `protobuf:"bytes,4,opt,name=option_id,json=optionId,proto3" json:"option_id,omitempty"` // Which option was selected (for equipment)
	...
	//	*ChoiceSubmission_WeaponProficiencies
	//	*ChoiceSubmission_ArmorProficiencies
	Values        isChoiceSubmission_Values `protobuf_oneof:"values"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChoiceSubmission) GetValues() isChoiceSubmission_Values {
	if x != nil {
		return x.Values
	}
	return nil
...
func (x *ChoiceSubmission) GetSkills() *SkillSelection {
	if x != nil {
		if x, ok := x.Values.(*ChoiceSubmission_Skills); ok {
			return x.Skills
		}
	}
	return nil
...
func (x *ChoiceSubmission) GetLanguages() *LanguageSelection {
	if x != nil {
		if x, ok := x.Values.(*ChoiceSubmission_Languages); ok {
			return x.Languages
		}
	}
	return nil
...
func (x *ChoiceSubmission) GetEquipment() *EquipmentSelection {
	if x != nil {
		if x, ok := x.Values.(*ChoiceSubmission_Equipment); ok {
			return x.Equipment
		}
	}
	return nil
...
func (x *ChoiceSubmission) GetFightingStyle() *FightingStyleSelection {
	if x != nil {
		if x, ok := x.Values.(*ChoiceSubmission_FightingStyle); ok {
			return x.FightingStyle
		}
	}
	return nil
...
func (x *ChoiceSubmission) GetTools() *ToolSelection {
	if x != nil {
		if x, ok := x.Values.(*ChoiceSubmission_Tools); ok {
			return x.Tools
		}
	}
	return nil
...
func (x *ChoiceSubmission) GetWeaponProficiencies() *WeaponProficiencySelection {
	if x != nil {
		if x, ok := x.Values.(*ChoiceSubmission_WeaponProficiencies); ok {
			return x.WeaponProficiencies
		}
	}
	return nil
...
func (x *ChoiceSubmission) GetArmorProficiencies() *ArmorProficiencySelection {
	if x != nil {
		if x, ok := x.Values.(*ChoiceSubmission_ArmorProficiencies); ok {
			return x.ArmorProficiencies
		}
	}
	return nil
...
type isChoiceSubmission_Values interface {
	isChoiceSubmission_Values()
}

type ChoiceSubmission_Skills struct {
	Skills *SkillSelection `protobuf:"bytes,5,opt,name=skills,proto3,oneof"`
}

type ChoiceSubmission_Languages struct {
	Languages *LanguageSelection `protobuf:"bytes,6,opt,name=languages,proto3,oneof"`
}
...
type ChoiceSubmission_FightingStyle struct {
	FightingStyle *FightingStyleSelection `protobuf:"bytes,8,opt,name=fighting_style,json=fightingStyle,proto3,oneof"`
}
...
type ChoiceSubmission_WeaponProficiencies struct {
	WeaponProficiencies *WeaponProficiencySelection `protobuf:"bytes,10,opt,name=weapon_proficiencies,json=weaponProficiencies,proto3,oneof"`
}

type ChoiceSubmission_ArmorProficiencies struct {
	ArmorProficiencies *ArmorProficiencySelection `protobuf:"bytes,11,opt,name=armor_proficiencies,json=armorProficiencies,proto3,oneof"`
}

func (*ChoiceSubmission_Skills) isChoiceSubmission_Values() {}

func (*ChoiceSubmission_Languages) isChoiceSubmission_Values() {}

func (*ChoiceSubmission_Equipment) isChoiceSubmission_Values() {}

func (*ChoiceSubmission_FightingStyle) isChoiceSubmission_Values() {}

func (*ChoiceSubmission_Tools) isChoiceSubmission_Values() {}

func (*ChoiceSubmission_WeaponProficiencies) isChoiceSubmission_Values() {}

func (*ChoiceSubmission_ArmorProficiencies) isChoiceSubmission_Values() {}
...
type FightingStyleSelection struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Style         FightingStyle          `protobuf:"varint,1,opt,name=style,proto3,enum=dnd5e.api.v1alpha1.FightingStyle" json:"style,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type WeaponProficiencySelection struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Weapons       []Weapon               `protobuf:"varint,1,rep,packed,name=weapons,proto3,enum=dnd5e.api.v1alpha1.Weapon" json:"weapons,omitempty"`
	Categories    []EquipmentType        `protobuf:"varint,2,rep,packed,name=categories,proto3,enum=dnd5e.api.v1alpha1.EquipmentType" json:"categories,omitempty"` // For "all martial weapons" etc.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *WeaponProficiencySelection) Reset() {
	*x = WeaponProficiencySelection{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[118]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WeaponProficiencySelection) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WeaponProficiencySelection) ProtoMessage() {}

func (x *WeaponProficiencySelection) ProtoReflect() protoreflect.Message {
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[118]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WeaponProficiencySelection.ProtoReflect.Descriptor instead.
func (*WeaponProficiencySelection) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{118}
}

func (x *WeaponProficiencySelection) GetWeapons() []Weapon {
	if x != nil {
		return x.Weapons
	}
	return nil
...
func (x *WeaponProficiencySelection) GetCategories() []EquipmentType {
	if x != nil {
		return x.Categories
	}
	return nil
...
type ArmorProficiencySelection struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Armors        []Armor                `protobuf:"varint,1,rep,packed,name=armors,proto3,enum=dnd5e.api.v1alpha1.Armor" json:"armors,omitempty"`
	Categories    []EquipmentType        `protobuf:"varint,2,rep,packed,name=categories,proto3,enum=dnd5e.api.v1alpha1.EquipmentType" json:"categories,omitempty"` // For "all light armor" etc.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ArmorProficiencySelection) Reset() {
	*x = ArmorProficiencySelection{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[119]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ArmorProficiencySelection) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ArmorProficiencySelection) ProtoMessage() {}

func (x *ArmorProficiencySelection) ProtoReflect() protoreflect.Message {
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[119]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ArmorProficiencySelection.ProtoReflect.Descriptor instead.
func (*ArmorProficiencySelection) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{119}
}

func (x *ArmorProficiencySelection) GetArmors() []Armor {
	if x != nil {
		return x.Armors
	}
	return nil
...
func (x *ArmorProficiencySelection) GetCategories() []EquipmentType {
	if x != nil {
		return x.Categories
	}
	return nil
...
type CharacterRequirements struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// All choices that need to be made
	Choices []*RequiredChoice `protobuf:"bytes,1,rep,name=choices,proto3" json:"choices,omitempty"`
	// Validation state
	AllChoicesMade bool     `protobuf:"varint,2,opt,name=all_choices_made,json=allChoicesMade,proto3" json:"all_choices_made,omitempty"`
	MissingChoices []string `protobuf:"bytes,3,rep,name=missing_choices,json=missingChoices,proto3" json:"missing_choices,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *CharacterRequirements) Reset() {
	*x = CharacterRequirements{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[120]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CharacterRequirements) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CharacterRequirements) ProtoMessage() {}

func (x *CharacterRequirements) ProtoReflect() protoreflect.Message {
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[120]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CharacterRequirements.ProtoReflect.Descriptor instead.
func (*CharacterRequirements) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{120}
}

func (x *CharacterRequirements) GetChoices() []*RequiredChoice {
	if x != nil {
		return x.Choices
	}
	return nil
...
func (x *CharacterRequirements) GetAllChoicesMade() bool {
	if x != nil {
		return x.AllChoicesMade
	}
	return false
}

func (x *CharacterRequirements) GetMissingChoices() []string {
	if x != nil {
		return x.MissingChoices
	}
	return nil
}
...
type RequiredChoice struct {
	...
	Category    ChoiceCategory         `protobuf:"varint,2,opt,name=category,proto3,enum=dnd5e.api.v1alpha1.ChoiceCategory" json:"category,omitempty"`
	Source      ChoiceSource           `protobuf:"varint,3,opt,name=source,proto3,enum=dnd5e.api.v1alpha1.ChoiceSource" json:"source,omitempty"`
	Description string                 `protobuf:"bytes,4,opt,name=description,proto3" json:"description,omitempty"`
	Count       int32                  `protobuf:"varint,5,opt,name=count,proto3" json:"count,omitempty"` // How many to choose
	// Available options based on category
	//
	// Types that are valid to be assigned to Options:
	//
	//	*RequiredChoice_SkillOptions
	//	*RequiredChoice_LanguageOptions
	//	*RequiredChoice_EquipmentOptions
	//	*RequiredChoice_FightingStyleOptions
	//	*RequiredChoice_ToolOptions
	Options       isRequiredChoice_Options `protobuf_oneof:"options"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RequiredChoice) GetChoiceId() string {
	if x != nil {
		return x.ChoiceId
	}
	return ""
...
func (x *RequiredChoice) GetCategory() ChoiceCategory {
	if x != nil {
		return x.Category
	}
	return ChoiceCategory_CHOICE_CATEGORY_UNSPECIFIED
...
func (x *RequiredChoice) GetSource() ChoiceSource {
	if x != nil {
		return x.Source
	}
	return ChoiceSource_CHOICE_SOURCE_UNSPECIFIED
...
func (x *RequiredChoice) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *RequiredChoice) GetCount() int32 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *RequiredChoice) GetOptions() isRequiredChoice_Options {
	if x != nil {
		return x.Options
	}
	return nil
...
func (x *RequiredChoice) GetSkillOptions() *SkillOptions {
	if x != nil {
		if x, ok := x.Options.(*RequiredChoice_SkillOptions); ok {
...
func (x *RequiredChoice) GetLanguageOptions() *LanguageOptions {
	if x != nil {
		if x, ok := x.Options.(*RequiredChoice_LanguageOptions); ok {
...
func (x *RequiredChoice) GetEquipmentOptions() *EquipmentChoice {
	if x != nil {
		if x, ok := x.Options.(*RequiredChoice_EquipmentOptions); ok {
...
func (x *RequiredChoice) GetFightingStyleOptions() *FightingStyleOptions {
	if x != nil {
		if x, ok := x.Options.(*RequiredChoice_FightingStyleOptions); ok {
...
func (x *RequiredChoice) GetToolOptions() *ToolOptions {
	if x != nil {
		if x, ok := x.Options.(*RequiredChoice_ToolOptions); ok {
...
type isRequiredChoice_Options interface {
	isRequiredChoice_Options()
}

type RequiredChoice_SkillOptions struct {
	SkillOptions *SkillOptions `protobuf:"bytes,6,opt,name=skill_options,json=skillOptions,proto3,oneof"`
}

type RequiredChoice_LanguageOptions struct {
	LanguageOptions *LanguageOptions `protobuf:"bytes,7,opt,name=language_options,json=languageOptions,proto3,oneof"`
}

type RequiredChoice_EquipmentOptions struct {
	EquipmentOptions *EquipmentChoice `protobuf:"bytes,8,opt,name=equipment_options,json=equipmentOptions,proto3,oneof"`
}

type RequiredChoice_FightingStyleOptions struct {
...
type RequiredChoice_ToolOptions struct {
	ToolOptions *ToolOptions `protobuf:"bytes,10,opt,name=tool_options,json=toolOptions,proto3,oneof"`
}

func (*RequiredChoice_SkillOptions) isRequiredChoice_Options() {}

func (*RequiredChoice_LanguageOptions) isRequiredChoice_Options() {}

func (*RequiredChoice_EquipmentOptions) isRequiredChoice_Options() {}

func (*RequiredChoice_FightingStyleOptions) isRequiredChoice_Options() {}

func (*RequiredChoice_ToolOptions) isRequiredChoice_Options() {}

// Available skill options
type SkillOptions struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Available     []Skill                `protobuf:"varint,1,rep,packed,name=available,proto3,enum=dnd5e.api.v1alpha1.Skill" json:"available,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LanguageOptions struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Available     []Language             `protobuf:"varint,1,rep,packed,name=available,proto3,enum=dnd5e.api.v1alpha1.Language" json:"available,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FightingStyleOptions) Reset() {
	*x = FightingStyleOptions{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[124]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FightingStyleOptions) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{124}
}
...
func (x *ToolOptions) Reset() {
	*x = ToolOptions{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[125]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ToolOptions) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{125}
}
...
type SpellDamage struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	DamageType        DamageType             `protobuf:"varint,1,opt,name=damage_type,json=damageType,proto3,enum=dnd5e.api.v1alpha1.DamageType" json:"damage_type,omitempty"`
...
func (x *SpellDamage) Reset() {
	*x = SpellDamage{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[126]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SpellDamage) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{126}
}

func (x *SpellDamage) GetDamageType() DamageType {
	if x != nil {
		return x.DamageType
	}
	return DamageType_DAMAGE_TYPE_UNSPECIFIED
...
func (x *DamageAtSlotLevel) Reset() {
	*x = DamageAtSlotLevel{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[127]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DamageAtSlotLevel) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{127}
}
...
func (x *AreaOfEffect) Reset() {
	*x = AreaOfEffect{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[128]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AreaOfEffect) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{128}
}
...
func (x *ListEquipmentByTypeRequest) Reset() {
	*x = ListEquipmentByTypeRequest{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[129]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListEquipmentByTypeRequest) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{129}
}
...
func (x *ListEquipmentByTypeResponse) Reset() {
	*x = ListEquipmentByTypeResponse{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[130]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListEquipmentByTypeResponse) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{130}
}
...
func (x *ListSpellsByLevelRequest) Reset() {
	*x = ListSpellsByLevelRequest{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[131]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSpellsByLevelRequest) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{131}
}
...
func (x *ListSpellsByLevelResponse) Reset() {
	*x = ListSpellsByLevelResponse{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[132]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSpellsByLevelResponse) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{132}
}
...
func (x *GetCharacterInventoryRequest) Reset() {
	*x = GetCharacterInventoryRequest{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[133]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetCharacterInventoryRequest) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{133}
}
...
func (x *GetCharacterInventoryResponse) Reset() {
	*x = GetCharacterInventoryResponse{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[134]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetCharacterInventoryResponse) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{134}
}
...
func (x *EquipItemRequest) Reset() {
	*x = EquipItemRequest{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[135]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EquipItemRequest) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{135}
}
...
func (x *EquipItemResponse) Reset() {
	*x = EquipItemResponse{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[136]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EquipItemResponse) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{136}
}
...
func (x *UnequipItemRequest) Reset() {
	*x = UnequipItemRequest{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[137]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnequipItemRequest) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{137}
}
...
func (x *UnequipItemResponse) Reset() {
	*x = UnequipItemResponse{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[138]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnequipItemResponse) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{138}
}
...
func (x *AddToInventoryRequest) Reset() {
	*x = AddToInventoryRequest{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[139]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddToInventoryRequest) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{139}
}
...
func (x *InventoryAddition) Reset() {
	*x = InventoryAddition{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[140]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InventoryAddition) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{140}
}
...
func (x *AddToInventoryResponse) Reset() {
	*x = AddToInventoryResponse{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[141]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddToInventoryResponse) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{141}
}
...
func (x *RemoveFromInventoryRequest) Reset() {
	*x = RemoveFromInventoryRequest{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[142]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RemoveFromInventoryRequest) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{142}
}
...
func (x *RemoveFromInventoryResponse) Reset() {
	*x = RemoveFromInventoryResponse{}
	mi := &file_dnd5e_api_v1alpha1_character_proto_msgTypes[143]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RemoveFromInventoryResponse) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_character_proto_rawDescGZIP(), []int{143}
}
...
const file_dnd5e_api_v1alpha1_character_proto_rawDesc = "" +
	...
	"\bcharisma\x18\x06 \x01(\x05R\bcharisma\"\xbd\f\n" +
	"\tCharacter\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	...
	"\bfeatures\x18\x16 \x03(\v2$.dnd5e.api.v1alpha1.CharacterFeatureR\bfeatures\x12J\n" +
	"\x0ffighting_styles\x18\x17 \x03(\x0e2!.dnd5e.api.v1alpha1.FightingStyleR\x0efightingStyles\x12I\n" +
	...
	"\bhit_dice\x18\x06 \x01(\tR\ahitDice\"\x99\x02\n" +
	"\x11ProficiencyGrants\x12/\n" +
	"\x05armor\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.ArmorR\x05armor\x124\n" +
	"\aweapons\x18\x02 \x03(\x0e2\x1a.dnd5e.api.v1alpha1.WeaponR\aweapons\x12.\n" +
	"\x05tools\x18\x03 \x03(\x0e2\x18.dnd5e.api.v1alpha1.ToolR\x05tools\x121\n" +
	"\x06skills\x18\x04 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SkillR\x06skills\x12:\n" +
	"\tlanguages\x18\x05 \x03(\x0e2\x1c.dnd5e.api.v1alpha1.LanguageR\tlanguages\"\x96\x03\n" +
	"\rProficiencies\x121\n" +
	"\x06skills\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SkillR\x06skills\x12@\n" +
	"\rsaving_throws\x18\x02 \x03(\x0e2\x1b.dnd5e.api.v1alpha1.AbilityR\fsavingThrows\x12/\n" +
	"\x05armor\x18\x03 \x03(\x0e2\x19.dnd5e.api.v1alpha1.ArmorR\x05armor\x124\n" +
	"\aweapons\x18\x04 \x03(\x0e2\x1a.dnd5e.api.v1alpha1.WeaponR\aweapons\x12.\n" +
	"\x05tools\x18\x05 \x03(\x0e2\x18.dnd5e.api.v1alpha1.ToolR\x05tools\x12'\n" +
	"\rarmor_strings\x18\x06 \x03(\tB\x02\x18\x01R\farmorStrings\x12)\n" +
	"\x0eweapon_strings\x18\a \x03(\tB\x02\x18\x01R\rweaponStrings\x12%\n" +
	"\ftool_strings\x18\b \x03(\tB\x02\x18\x01R\vtoolStrings\"n\n" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage\"\xd3\x04\n" +
	...
	"\x04race\x18\x05 \x01(\x0e2\x18.dnd5e.api.v1alpha1.RaceR\x04race\x125\n" +
	"\asubrace\x18\x06 \x01(\x0e2\x1b.dnd5e.api.v1alpha1.SubraceR\asubrace\x12/\n" +
	"\x05class\x18\a \x01(\x0e2\x19.dnd5e.api.v1alpha1.ClassR\x05class\x128\n" +
	"\bsubclass\x18\b \x01(\x0e2\x1c.dnd5e.api.v1alpha1.SubclassR\bsubclass\x12>\n" +
	"\n" +
	"background\x18\t \x01(\x0e2\x1e.dnd5e.api.v1alpha1.BackgroundR\n" +
	"background\x12Q\n" +
	"\x13base_ability_scores\x18\n" +
	" \x01(\v2!.dnd5e.api.v1alpha1.AbilityScoresR\x11baseAbilityScores\x128\n" +
	"\achoices\x18\v \x03(\v2\x1e.dnd5e.api.v1alpha1.ChoiceDataR\achoices\x12@\n" +
	"\bprogress\x18\f \x01(\v2$.dnd5e.api.v1alpha1.CreationProgressR\bprogress\"\x84\x03\n" +
	...
	"\x12has_ability_scores\x18\x05 \x01(\bR\x10hasAbilityScores\x12!\n" +
	"\n" +
	"has_skills\x18\x06 \x01(\bB\x02\x18\x01R\thasSkills\x12'\n" +
	"\rhas_languages\x18\a \x01(\bB\x02\x18\x01R\fhasLanguages\x123\n" +
	"\x15completion_percentage\x18\b \x01(\x05R\x14completionPercentage\x12G\n" +
	"\fcurrent_step\x18\t \x01(\x0e2 .dnd5e.api.v1alpha1.CreationStepB\x02\x18\x01R\vcurrentStep\"\xa9\x01\n" +
	...
	"\x12discord_message_id\x18\x04 \x01(\tR\x10discordMessageId\"\x9f\a\n" +
	...
	" \x01(\v2!.dnd5e.api.v1alpha1.AbilityScoresR\x11baseAbilityScores\x128\n" +
	"\achoices\x18\v \x03(\v2\x1e.dnd5e.api.v1alpha1.ChoiceDataR\achoices\x12@\n" +
	"\bprogress\x18\f \x01(\v2$.dnd5e.api.v1alpha1.CreationProgressR\bprogress\x12D\n" +
	"\n" +
	"validation\x18\r \x01(\v2$.dnd5e.api.v1alpha1.ValidationResultR\n" +
	"validation\x129\n" +
	"\trace_info\x18\x0e \x01(\v2\x1c.dnd5e.api.v1alpha1.RaceInfoR\braceInfo\x12B\n" +
	"\fsubrace_info\x18\x0f \x01(\v2\x1f.dnd5e.api.v1alpha1.SubraceInfoR\vsubraceInfo\x12<\n" +
	"\n" +
	"class_info\x18\x10 \x01(\v2\x1d.dnd5e.api.v1alpha1.ClassInfoR\tclassInfo\x12K\n" +
	"\x0fbackground_info\x18\x11 \x01(\v2\".dnd5e.api.v1alpha1.BackgroundInfoR\x0ebackgroundInfo\"\x9b\x01\n" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage\"\xd2\x06\n" +
	"\bRaceInfo\x121\n" +
	"\arace_id\x18\x01 \x01(\x0e2\x18.dnd5e.api.v1alpha1.RaceR\x06raceId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	...
	"\bsubraces\x18\b \x03(\v2\x1f.dnd5e.api.v1alpha1.SubraceInfoR\bsubraces\x12T\n" +
	"\x12proficiency_grants\x18\t \x01(\v2%.dnd5e.api.v1alpha1.ProficiencyGrantsR\x11proficiencyGrants\x12:\n" +
	"\tlanguages\x18\n" +
	" \x03(\x0e2\x1c.dnd5e.api.v1alpha1.LanguageR\tlanguages\x124\n" +
	"\achoices\x18\v \x03(\v2\x1a.dnd5e.api.v1alpha1.ChoiceR\achoices\x12+\n" +
	"\x0fage_description\x18\f \x01(\tB\x02\x18\x01R\x0eageDescription\x127\n" +
	"\x15alignment_description\x18\r \x01(\tB\x02\x18\x01R\x14alignmentDescription\x12-\n" +
	"\x10size_description\x18\x0e \x01(\tB\x02\x18\x01R\x0fsizeDescription\x12(\n" +
	"\rproficiencies\x18\x0f \x03(\tB\x02\x18\x01R\rproficiencies\x1aA\n" +
	"\x13AbilityBonusesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\"\x95\x04\n" +
	"\vSubraceInfo\x12:\n" +
	"\n" +
	"subrace_id\x18\x01 \x01(\x0e2\x1b.dnd5e.api.v1alpha1.SubraceR\tsubraceId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	...
	"\tlanguages\x18\x06 \x03(\x0e2\x1c.dnd5e.api.v1alpha1.LanguageR\tlanguages\x12T\n" +
	"\x12proficiency_grants\x18\a \x01(\v2%.dnd5e.api.v1alpha1.ProficiencyGrantsR\x11proficiencyGrants\x12(\n" +
	"\rproficiencies\x18\b \x03(\tB\x02\x18\x01R\rproficiencies\x1aA\n" +
	"\x13AbilityBonusesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"ammunition\x12$\n" +
	"\rother_item_id\x18\x06 \x01(\tH\x00R\votherItemId\x12\x12\n" +
	"\x04name\x18\a \x01(\tR\x04nameB\x06\n" +
	"\x04item\"\xff\x02\n" +
	"\x14CountedItemReference\x124\n" +
	"\x06weapon\x18\x01 \x01(\x0e2\x1a.dnd5e.api.v1alpha1.WeaponH\x00R\x06weapon\x121\n" +
	"\x05armor\x18\x02 \x01(\x0e2\x19.dnd5e.api.v1alpha1.ArmorH\x00R\x05armor\x12.\n" +
	"\x04tool\x18\x03 \x01(\x0e2\x18.dnd5e.api.v1alpha1.ToolH\x00R\x04tool\x12.\n" +
	"\x04pack\x18\x04 \x01(\x0e2\x18.dnd5e.api.v1alpha1.PackH\x00R\x04pack\x12@\n" +
	...
	"\bquantity\x18\b \x01(\x05R\bquantityB\x06\n" +
	"\x04item\"B\n" +
	"\n" +
	"ItemBundle\x124\n" +
	...
	"\titem_type\"B\n" +
	"\fNestedChoice\x122\n" +
	"\x06choice\x18\x01 \x01(\v2\x1a.dnd5e.api.v1alpha1.ChoiceR\x06choice\"\xb3\t\n" +
	"\tClassInfo\x124\n" +
	"\bclass_id\x18\x01 \x01(\x0e2\x19.dnd5e.api.v1alpha1.ClassR\aclassId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x17\n" +
	"\ahit_die\x18\x04 \x01(\x05R\x06hitDie\x12D\n" +
	"\x0fprimary_ability\x18\x05 \x01(\x0e2\x1b.dnd5e.api.v1alpha1.AbilityR\x0eprimaryAbility\x12n\n" +
	"\x1carmor_proficiency_categories\x18\x06 \x03(\x0e2,.dnd5e.api.v1alpha1.ArmorProficiencyCategoryR\x1aarmorProficiencyCategories\x12q\n" +
	"\x1dweapon_proficiency_categories\x18\a \x03(\x0e2-.dnd5e.api.v1alpha1.WeaponProficiencyCategoryR\x1bweaponProficiencyCategories\x12^\n" +
	"\x1dspecific_weapon_proficiencies\x18\x1c \x03(\x0e2\x1a.dnd5e.api.v1alpha1.WeaponR\x1bspecificWeaponProficiencies\x12G\n" +
	"\x12tool_proficiencies\x18\b \x03(\x0e2\x18.dnd5e.api.v1alpha1.ToolR\x11toolProficiencies\x12Y\n" +
	"\x1asaving_throw_proficiencies\x18\t \x03(\x0e2\x1b.dnd5e.api.v1alpha1.AbilityR\x18savingThrowProficiencies\x12(\n" +
	"\rproficiencies\x18\x1b \x03(\tB\x02\x18\x01R\rproficiencies\x12.\n" +
	"\x13skill_choices_count\x18\n" +
	" \x01(\x05R\x11skillChoicesCount\x12D\n" +
	"\x10available_skills\x18\v \x03(\x0e2\x19.dnd5e.api.v1alpha1.SkillR\x0favailableSkills\x12G\n" +
	"\x11equipment_choices\x18\f \x03(\v2\x1a.dnd5e.api.v1alpha1.ChoiceR\x10equipmentChoices\x12I\n" +
	...
	"\achoices\x18\x0f \x03(\v2\x1a.dnd5e.api.v1alpha1.ChoiceR\achoices\x12@\n" +
	"\n" +
	"subclasses\x18\x10 \x03(\v2 .dnd5e.api.v1alpha1.SubclassInfoR\n" +
	"subclasses\"\xc5\x05\n" +
	"\fSubclassInfo\x12=\n" +
	"\vsubclass_id\x18\x01 \x01(\x0e2\x1c.dnd5e.api.v1alpha1.SubclassR\n" +
	"subclassId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x14\n" +
	"\x05level\x18\x04 \x01(\x05R\x05level\x12J\n" +
	"\x13armor_proficiencies\x18\x05 \x03(\x0e2\x19.dnd5e.api.v1alpha1.ArmorR\x12armorProficiencies\x12M\n" +
	"\x14weapon_proficiencies\x18\x06 \x03(\x0e2\x1a.dnd5e.api.v1alpha1.WeaponR\x13weaponProficiencies\x12G\n" +
	"\x12tool_proficiencies\x18\a \x03(\x0e2\x18.dnd5e.api.v1alpha1.ToolR\x11toolProficiencies\x12I\n" +
	"\x12additional_choices\x18\b \x03(\v2\x1a.dnd5e.api.v1alpha1.ChoiceR\x11additionalChoices\x12;\n" +
	"\bfeatures\x18\t \x03(\v2\x1f.dnd5e.api.v1alpha1.FeatureInfoR\bfeatures\x12>\n" +
	"\x19armor_proficiency_strings\x18\n" +
	" \x03(\tB\x02\x18\x01R\x17armorProficiencyStrings\x12@\n" +
	"\x1aweapon_proficiency_strings\x18\v \x03(\tB\x02\x18\x01R\x18weaponProficiencyStrings\x12<\n" +
	"\x18tool_proficiency_strings\x18\f \x03(\tB\x02\x18\x01R\x16toolProficiencyStrings\"\x94\x02\n" +
	...
	"\x13spell_slots_level_1\x18\x06 \x01(\x05R\x10spellSlotsLevel1\"\xd0\x06\n" +
	"\x0eBackgroundInfo\x12C\n" +
	"\rbackground_id\x18\x01 \x01(\x0e2\x1e.dnd5e.api.v1alpha1.BackgroundR\fbackgroundId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12J\n" +
	"\x13skill_proficiencies\x18\x04 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SkillR\x12skillProficiencies\x12G\n" +
	"\x12tool_proficiencies\x18\x05 \x03(\x0e2\x18.dnd5e.api.v1alpha1.ToolR\x11toolProficiencies\x12:\n" +
	"\tlanguages\x18\x06 \x03(\x0e2\x1c.dnd5e.api.v1alpha1.LanguageR\tlanguages\x121\n" +
	"\x14additional_languages\x18\a \x01(\x05R\x13additionalLanguages\x12U\n" +
	"\x12starting_equipment\x18\b \x03(\v2&.dnd5e.api.v1alpha1.EquipmentSelectionR\x11startingEquipment\x12#\n" +
	...
	"\x05flaws\x18\x0f \x03(\tR\x05flaws\x12>\n" +
	"\x19skill_proficiency_strings\x18\x10 \x03(\tB\x02\x18\x01R\x17skillProficiencyStrings\x12<\n" +
	"\x18tool_proficiency_strings\x18\x11 \x03(\tB\x02\x18\x01R\x16toolProficiencyStrings\"\xb0\x02\n" +
	...
	"\n" +
	"expires_at\x18\x02 \x01(\x03R\texpiresAt\"\x92\x01\n" +
	"\x16GetRequirementsRequest\x12\x19\n" +
	"\bdraft_id\x18\x01 \x01(\tR\adraftId\x12/\n" +
	"\x05class\x18\x02 \x01(\x0e2\x19.dnd5e.api.v1alpha1.ClassR\x05class\x12,\n" +
	"\x04race\x18\x03 \x01(\x0e2\x18.dnd5e.api.v1alpha1.RaceR\x04race\"h\n" +
	"\x17GetRequirementsResponse\x12M\n" +
	"\frequirements\x18\x01 \x01(\v2).dnd5e.api.v1alpha1.CharacterRequirementsR\frequirements\"y\n" +
	"\x14SubmitChoicesRequest\x12\x19\n" +
	"\bdraft_id\x18\x01 \x01(\tR\adraftId\x12F\n" +
	"\vsubmissions\x18\x02 \x03(\v2$.dnd5e.api.v1alpha1.ChoiceSubmissionR\vsubmissions\"\xf9\x01\n" +
	"\x15SubmitChoicesResponse\x128\n" +
	"\x05draft\x18\x01 \x01(\v2\".dnd5e.api.v1alpha1.CharacterDraftR\x05draft\x12D\n" +
	"\n" +
	"validation\x18\x02 \x01(\v2$.dnd5e.api.v1alpha1.ValidationResultR\n" +
	"validation\x12`\n" +
	"\x16remaining_requirements\x18\x03 \x01(\v2).dnd5e.api.v1alpha1.CharacterRequirementsR\x15remainingRequirements\"\x9b\x02\n" +
	...
	"\x05level\x18\x04 \x01(\x0e2$.dnd5e.api.v1alpha1.EncumbranceLevelR\x05level\"\x9b\b\n" +
	"\n" +
	"ChoiceData\x12>\n" +
	...
	"\x0eability_scores\x18\a \x01(\v2!.dnd5e.api.v1alpha1.AbilityScoresH\x00R\rabilityScores\x12J\n" +
	"\x0efighting_style\x18\b \x01(\x0e2!.dnd5e.api.v1alpha1.FightingStyleH\x00R\rfightingStyle\x12A\n" +
	...
	"\fLanguageList\x12:\n" +
	"\tlanguages\x18\x01 \x03(\x0e2\x1c.dnd5e.api.v1alpha1.LanguageR\tlanguages\"M\n" +
	"\rEquipmentList\x12<\n" +
	"\x05items\x18\x01 \x03(\v2&.dnd5e.api.v1alpha1.EquipmentSelectionR\x05items\">\n" +
	"\tSpellList\x121\n" +
	"\x06spells\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SpellR\x06spells\"D\n" +
	"\vCantripList\x125\n" +
	"\bcantrips\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SpellR\bcantrips\"B\n" +
	"\rExpertiseList\x121\n" +
	"\x06skills\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SkillR\x06skills\">\n" +
	"\tTraitList\x121\n" +
	"\x06traits\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.TraitR\x06traits\"E\n" +
	"\x13ToolProficiencyList\x12.\n" +
	...
	"\vClassChoice\x12/\n" +
	"\x05class\x18\x01 \x01(\x0e2\x19.dnd5e.api.v1alpha1.ClassR\x05class\"\x8f\x01\n" +
	"\x0fEquipmentChoice\x12\x1b\n" +
	"\tchoice_id\x18\x01 \x01(\tR\bchoiceId\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12=\n" +
	"\aoptions\x18\x03 \x03(\v2#.dnd5e.api.v1alpha1.EquipmentOptionR\aoptions\"\x8e\x01\n" +
	"\x0fEquipmentOption\x12\x1b\n" +
	"\toption_id\x18\x01 \x01(\tR\boptionId\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12<\n" +
	"\x05items\x18\x03 \x03(\v2&.dnd5e.api.v1alpha1.EquipmentSelectionR\x05items\"\xf8\x02\n" +
	"\x12EquipmentSelection\x124\n" +
	"\x06weapon\x18\x01 \x01(\x0e2\x1a.dnd5e.api.v1alpha1.WeaponH\x00R\x06weapon\x121\n" +
	"\x05armor\x18\x02 \x01(\x0e2\x19.dnd5e.api.v1alpha1.ArmorH\x00R\x05armor\x12.\n" +
	"\x04tool\x18\x03 \x01(\x0e2\x18.dnd5e.api.v1alpha1.ToolH\x00R\x04tool\x12.\n" +
	"\x04pack\x18\x04 \x01(\x0e2\x18.dnd5e.api.v1alpha1.PackH\x00R\x04pack\x12@\n" +
	...
	"\tequipment\"\xf4\x05\n" +
	"\x10ChoiceSubmission\x12>\n" +
	"\bcategory\x18\x01 \x01(\x0e2\".dnd5e.api.v1alpha1.ChoiceCategoryR\bcategory\x128\n" +
	"\x06source\x18\x02 \x01(\x0e2 .dnd5e.api.v1alpha1.ChoiceSourceR\x06source\x12\x1b\n" +
	"\tchoice_id\x18\x03 \x01(\tR\bchoiceId\x12\x1b\n" +
	"\toption_id\x18\x04 \x01(\tR\boptionId\x12<\n" +
	"\x06skills\x18\x05 \x01(\v2\".dnd5e.api.v1alpha1.SkillSelectionH\x00R\x06skills\x12E\n" +
	"\tlanguages\x18\x06 \x01(\v2%.dnd5e.api.v1alpha1.LanguageSelectionH\x00R\tlanguages\x12F\n" +
	"\tequipment\x18\a \x01(\v2&.dnd5e.api.v1alpha1.EquipmentSelectionH\x00R\tequipment\x12S\n" +
	"\x0efighting_style\x18\b \x01(\v2*.dnd5e.api.v1alpha1.FightingStyleSelectionH\x00R\rfightingStyle\x129\n" +
	"\x05tools\x18\t \x01(\v2!.dnd5e.api.v1alpha1.ToolSelectionH\x00R\x05tools\x12c\n" +
	"\x14weapon_proficiencies\x18\n" +
	" \x01(\v2..dnd5e.api.v1alpha1.WeaponProficiencySelectionH\x00R\x13weaponProficiencies\x12`\n" +
	"\x13armor_proficiencies\x18\v \x01(\v2-.dnd5e.api.v1alpha1.ArmorProficiencySelectionH\x00R\x12armorProficienciesB\b\n" +
	"\x06values\"C\n" +
	"\x0eSkillSelection\x121\n" +
	"\x06skills\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SkillR\x06skills\"O\n" +
	"\x11LanguageSelection\x12:\n" +
	"\tlanguages\x18\x01 \x03(\x0e2\x1c.dnd5e.api.v1alpha1.LanguageR\tlanguages\"Q\n" +
	"\x16FightingStyleSelection\x127\n" +
	"\x05style\x18\x01 \x01(\x0e2!.dnd5e.api.v1alpha1.FightingStyleR\x05style\"?\n" +
	"\rToolSelection\x12.\n" +
	"\x05tools\x18\x01 \x03(\x0e2\x18.dnd5e.api.v1alpha1.ToolR\x05tools\"\x95\x01\n" +
	"\x1aWeaponProficiencySelection\x124\n" +
	"\aweapons\x18\x01 \x03(\x0e2\x1a.dnd5e.api.v1alpha1.WeaponR\aweapons\x12A\n" +
	"\n" +
	"categories\x18\x02 \x03(\x0e2!.dnd5e.api.v1alpha1.EquipmentTypeR\n" +
	"categories\"\x91\x01\n" +
	"\x19ArmorProficiencySelection\x121\n" +
	"\x06armors\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.ArmorR\x06armors\x12A\n" +
	"\n" +
	"categories\x18\x02 \x03(\x0e2!.dnd5e.api.v1alpha1.EquipmentTypeR\n" +
	"categories\"\xa8\x01\n" +
	"\x15CharacterRequirements\x12<\n" +
	"\achoices\x18\x01 \x03(\v2\".dnd5e.api.v1alpha1.RequiredChoiceR\achoices\x12(\n" +
	"\x10all_choices_made\x18\x02 \x01(\bR\x0eallChoicesMade\x12'\n" +
	"\x0fmissing_choices\x18\x03 \x03(\tR\x0emissingChoices\"\x81\x05\n" +
	"\x0eRequiredChoice\x12\x1b\n" +
	"\tchoice_id\x18\x01 \x01(\tR\bchoiceId\x12>\n" +
	"\bcategory\x18\x02 \x01(\x0e2\".dnd5e.api.v1alpha1.ChoiceCategoryR\bcategory\x128\n" +
	"\x06source\x18\x03 \x01(\x0e2 .dnd5e.api.v1alpha1.ChoiceSourceR\x06source\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12\x14\n" +
	"\x05count\x18\x05 \x01(\x05R\x05count\x12G\n" +
	"\rskill_options\x18\x06 \x01(\v2 .dnd5e.api.v1alpha1.SkillOptionsH\x00R\fskillOptions\x12P\n" +
	"\x10language_options\x18\a \x01(\v2#.dnd5e.api.v1alpha1.LanguageOptionsH\x00R\x0flanguageOptions\x12R\n" +
	"\x11equipment_options\x18\b \x01(\v2#.dnd5e.api.v1alpha1.EquipmentChoiceH\x00R\x10equipmentOptions\x12`\n" +
	"\x16fighting_style_options\x18\t \x01(\v2(.dnd5e.api.v1alpha1.FightingStyleOptionsH\x00R\x14fightingStyleOptions\x12D\n" +
	"\ftool_options\x18\n" +
	" \x01(\v2\x1f.dnd5e.api.v1alpha1.ToolOptionsH\x00R\vtoolOptionsB\t\n" +
	"\aoptions\"G\n" +
	"\fSkillOptions\x127\n" +
	"\tavailable\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SkillR\tavailable\"M\n" +
	"\x0fLanguageOptions\x12:\n" +
	"\tavailable\x18\x01 \x03(\x0e2\x1c.dnd5e.api.v1alpha1.LanguageR\tavailable\"W\n" +
	"\x14FightingStyleOptions\x12?\n" +
	"\tavailable\x18\x01 \x03(\x0e2!.dnd5e.api.v1alpha1.FightingStyleR\tavailable\"E\n" +
	"\vToolOptions\x126\n" +
	"\tavailable\x18\x01 \x03(\x0e2\x18.dnd5e.api.v1alpha1.ToolR\tavailable\"\xa6\x01\n" +
	"\vSpellDamage\x12?\n" +
	"\vdamage_type\x18\x01 \x01(\x0e2\x1e.dnd5e.api.v1alpha1.DamageTypeR\n" +
	"damageType\x12V\n" +
	...
	"\x06spells\x18\x01 \x03(\x0e2\x19.dnd5e.api.v1alpha1.SpellR\x06spells\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	...
	"\x12RECHARGE_TYPE_NONE\x10\x04*\x8b\x02\n" +
	...
	"\x14CREATION_STEP_REVIEW\x10\b\x1a\x02\x18\x01*\x98\x01\n" +
	...
	"\x12\x17\n" +
	"\x13EQUIPMENT_SLOT_BELT\x10\v2\xf4\x1a\n" +
	...
	"\x11RollAbilityScores\x12,.dnd5e.api.v1alpha1.RollAbilityScoresRequest\x1a-.dnd5e.api.v1alpha1.RollAbilityScoresResponse\x12j\n" +
	"\x0fGetRequirements\x12*.dnd5e.api.v1alpha1.GetRequirementsRequest\x1a+.dnd5e.api.v1alpha1.GetRequirementsResponse\x12d\n" +
	"\rSubmitChoices\x12(.dnd5e.api.v1alpha1.SubmitChoicesRequest\x1a).dnd5e.api.v1alpha1.SubmitChoicesResponse\x12v\n" +
...
var file_dnd5e_api_v1alpha1_character_proto_msgTypes = make([]protoimpl.MessageInfo, 146)
var file_dnd5e_api_v1alpha1_character_proto_goTypes = []any{
	...
	(*ProficiencyGrants)(nil),             // 17: dnd5e.api.v1alpha1.ProficiencyGrants
	(*Proficiencies)(nil),                 // 18: dnd5e.api.v1alpha1.Proficiencies
	(*CharacterMetadata)(nil),             // 19: dnd5e.api.v1alpha1.CharacterMetadata
	(*GetCharacterRequest)(nil),           // 20: dnd5e.api.v1alpha1.GetCharacterRequest
	(*GetCharacterResponse)(nil),          // 21: dnd5e.api.v1alpha1.GetCharacterResponse
	(*ListCharactersRequest)(nil),         // 22: dnd5e.api.v1alpha1.ListCharactersRequest
	(*ListCharactersResponse)(nil),        // 23: dnd5e.api.v1alpha1.ListCharactersResponse
	(*UpdateCharacterRequest)(nil),        // 24: dnd5e.api.v1alpha1.UpdateCharacterRequest
	(*UpdateCharacterResponse)(nil),       // 25: dnd5e.api.v1alpha1.UpdateCharacterResponse
	(*DeleteCharacterRequest)(nil),        // 26: dnd5e.api.v1alpha1.DeleteCharacterRequest
	(*DeleteCharacterResponse)(nil),       // 27: dnd5e.api.v1alpha1.DeleteCharacterResponse
	(*CharacterDraftData)(nil),            // 28: dnd5e.api.v1alpha1.CharacterDraftData
	(*CreationProgress)(nil),              // 29: dnd5e.api.v1alpha1.CreationProgress
	(*DraftMetadata)(nil),                 // 30: dnd5e.api.v1alpha1.DraftMetadata
	(*CharacterDraft)(nil),                // 31: dnd5e.api.v1alpha1.CharacterDraft
	(*CreateDraftRequest)(nil),            // 32: dnd5e.api.v1alpha1.CreateDraftRequest
	(*CreateDraftResponse)(nil),           // 33: dnd5e.api.v1alpha1.CreateDraftResponse
	(*GetDraftRequest)(nil),               // 34: dnd5e.api.v1alpha1.GetDraftRequest
	(*GetDraftResponse)(nil),              // 35: dnd5e.api.v1alpha1.GetDraftResponse
	(*UpdateDraftRequest)(nil),            // 36: dnd5e.api.v1alpha1.UpdateDraftRequest
	(*UpdateDraftResponse)(nil),           // 37: dnd5e.api.v1alpha1.UpdateDraftResponse
	(*UpdateNameRequest)(nil),             // 38: dnd5e.api.v1alpha1.UpdateNameRequest
	(*UpdateRaceRequest)(nil),             // 39: dnd5e.api.v1alpha1.UpdateRaceRequest
	(*UpdateClassRequest)(nil),            // 40: dnd5e.api.v1alpha1.UpdateClassRequest
	(*UpdateBackgroundRequest)(nil),       // 41: dnd5e.api.v1alpha1.UpdateBackgroundRequest
	(*UpdateAbilityScoresRequest)(nil),    // 42: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	(*UpdateSkillsRequest)(nil),           // 43: dnd5e.api.v1alpha1.UpdateSkillsRequest
	(*UpdateNameResponse)(nil),            // 44: dnd5e.api.v1alpha1.UpdateNameResponse
	(*UpdateRaceResponse)(nil),            // 45: dnd5e.api.v1alpha1.UpdateRaceResponse
	(*UpdateClassResponse)(nil),           // 46: dnd5e.api.v1alpha1.UpdateClassResponse
	(*UpdateBackgroundResponse)(nil),      // 47: dnd5e.api.v1alpha1.UpdateBackgroundResponse
	(*UpdateAbilityScoresResponse)(nil),   // 48: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	(*UpdateSkillsResponse)(nil),          // 49: dnd5e.api.v1alpha1.UpdateSkillsResponse
	(*ListDraftsRequest)(nil),             // 50: dnd5e.api.v1alpha1.ListDraftsRequest
	(*ListDraftsResponse)(nil),            // 51: dnd5e.api.v1alpha1.ListDraftsResponse
	(*ValidateDraftRequest)(nil),          // 52: dnd5e.api.v1alpha1.ValidateDraftRequest
	(*ValidateDraftResponse)(nil),         // 53: dnd5e.api.v1alpha1.ValidateDraftResponse
	(*GetDraftPreviewRequest)(nil),        // 54: dnd5e.api.v1alpha1.GetDraftPreviewRequest
	(*GetDraftPreviewResponse)(nil),       // 55: dnd5e.api.v1alpha1.GetDraftPreviewResponse
	(*FinalizeDraftRequest)(nil),          // 56: dnd5e.api.v1alpha1.FinalizeDraftRequest
	(*FinalizeDraftResponse)(nil),         // 57: dnd5e.api.v1alpha1.FinalizeDraftResponse
	(*DeleteDraftRequest)(nil),            // 58: dnd5e.api.v1alpha1.DeleteDraftRequest
	(*DeleteDraftResponse)(nil),           // 59: dnd5e.api.v1alpha1.DeleteDraftResponse
	(*RaceInfo)(nil),                      // 60: dnd5e.api.v1alpha1.RaceInfo
	(*SubraceInfo)(nil),                   // 61: dnd5e.api.v1alpha1.SubraceInfo
	(*RacialTrait)(nil),                   // 62: dnd5e.api.v1alpha1.RacialTrait
	(*Choice)(nil),                        // 63: dnd5e.api.v1alpha1.Choice
	(*ExplicitOptions)(nil),               // 64: dnd5e.api.v1alpha1.ExplicitOptions
	(*CategoryReference)(nil),             // 65: dnd5e.api.v1alpha1.CategoryReference
	(*ChoiceOption)(nil),                  // 66: dnd5e.api.v1alpha1.ChoiceOption
	(*ItemReference)(nil),                 // 67: dnd5e.api.v1alpha1.ItemReference
	(*CountedItemReference)(nil),          // 68: dnd5e.api.v1alpha1.CountedItemReference
	(*ItemBundle)(nil),                    // 69: dnd5e.api.v1alpha1.ItemBundle
	(*BundleItem)(nil),                    // 70: dnd5e.api.v1alpha1.BundleItem
	(*NestedChoice)(nil),                  // 71: dnd5e.api.v1alpha1.NestedChoice
	(*ClassInfo)(nil),                     // 72: dnd5e.api.v1alpha1.ClassInfo
	(*SubclassInfo)(nil),                  // 73: dnd5e.api.v1alpha1.SubclassInfo
	(*SpellcastingInfo)(nil),              // 74: dnd5e.api.v1alpha1.SpellcastingInfo
	(*BackgroundInfo)(nil),                // 75: dnd5e.api.v1alpha1.BackgroundInfo
	(*FeatureInfo)(nil),                   // 76: dnd5e.api.v1alpha1.FeatureInfo
	(*SpellSelectionInfo)(nil),            // 77: dnd5e.api.v1alpha1.SpellSelectionInfo
	(*ListRacesRequest)(nil),              // 78: dnd5e.api.v1alpha1.ListRacesRequest
	(*ListRacesResponse)(nil),             // 79: dnd5e.api.v1alpha1.ListRacesResponse
	(*ListClassesRequest)(nil),            // 80: dnd5e.api.v1alpha1.ListClassesRequest
	(*ListClassesResponse)(nil),           // 81: dnd5e.api.v1alpha1.ListClassesResponse
	(*ListBackgroundsRequest)(nil),        // 82: dnd5e.api.v1alpha1.ListBackgroundsRequest
	(*ListBackgroundsResponse)(nil),       // 83: dnd5e.api.v1alpha1.ListBackgroundsResponse
	(*GetRaceDetailsRequest)(nil),         // 84: dnd5e.api.v1alpha1.GetRaceDetailsRequest
	(*GetRaceDetailsResponse)(nil),        // 85: dnd5e.api.v1alpha1.GetRaceDetailsResponse
	(*GetClassDetailsRequest)(nil),        // 86: dnd5e.api.v1alpha1.GetClassDetailsRequest
	(*GetClassDetailsResponse)(nil),       // 87: dnd5e.api.v1alpha1.GetClassDetailsResponse
	(*GetBackgroundDetailsRequest)(nil),   // 88: dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	(*GetBackgroundDetailsResponse)(nil),  // 89: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	(*GetFeatureRequest)(nil),             // 90: dnd5e.api.v1alpha1.GetFeatureRequest
	(*GetFeatureResponse)(nil),            // 91: dnd5e.api.v1alpha1.GetFeatureResponse
	(*RollAbilityScoresRequest)(nil),      // 92: dnd5e.api.v1alpha1.RollAbilityScoresRequest
	(*AbilityScoreRoll)(nil),              // 93: dnd5e.api.v1alpha1.AbilityScoreRoll
	(*RollAbilityScoresResponse)(nil),     // 94: dnd5e.api.v1alpha1.RollAbilityScoresResponse
	(*GetRequirementsRequest)(nil),        // 95: dnd5e.api.v1alpha1.GetRequirementsRequest
	(*GetRequirementsResponse)(nil),       // 96: dnd5e.api.v1alpha1.GetRequirementsResponse
	(*SubmitChoicesRequest)(nil),          // 97: dnd5e.api.v1alpha1.SubmitChoicesRequest
	(*SubmitChoicesResponse)(nil),         // 98: dnd5e.api.v1alpha1.SubmitChoicesResponse
	(*RollAssignments)(nil),               // 99: dnd5e.api.v1alpha1.RollAssignments
	(*Cost)(nil),                          // 100: dnd5e.api.v1alpha1.Cost
	(*Weight)(nil),                        // 101: dnd5e.api.v1alpha1.Weight
	(*Equipment)(nil),                     // 102: dnd5e.api.v1alpha1.Equipment
	(*WeaponData)(nil),                    // 103: dnd5e.api.v1alpha1.WeaponData
	(*ArmorData)(nil),                     // 104: dnd5e.api.v1alpha1.ArmorData
	(*GearData)(nil),                      // 105: dnd5e.api.v1alpha1.GearData
	(*EquipmentSlots)(nil),                // 106: dnd5e.api.v1alpha1.EquipmentSlots
	(*InventoryItem)(nil),                 // 107: dnd5e.api.v1alpha1.InventoryItem
	(*EncumbranceInfo)(nil),               // 108: dnd5e.api.v1alpha1.EncumbranceInfo
	(*ChoiceData)(nil),                    // 109: dnd5e.api.v1alpha1.ChoiceData
	(*SkillList)(nil),                     // 110: dnd5e.api.v1alpha1.SkillList
	(*LanguageList)(nil),                  // 111: dnd5e.api.v1alpha1.LanguageList
	(*EquipmentList)(nil),                 // 112: dnd5e.api.v1alpha1.EquipmentList
	(*SpellList)(nil),                     // 113: dnd5e.api.v1alpha1.SpellList
	(*CantripList)(nil),                   // 114: dnd5e.api.v1alpha1.CantripList
	(*ExpertiseList)(nil),                 // 115: dnd5e.api.v1alpha1.ExpertiseList
	(*TraitList)(nil),                     // 116: dnd5e.api.v1alpha1.TraitList
	(*ToolProficiencyList)(nil),           // 117: dnd5e.api.v1alpha1.ToolProficiencyList
	(*RaceChoice)(nil),                    // 118: dnd5e.api.v1alpha1.RaceChoice
	(*ClassChoice)(nil),                   // 119: dnd5e.api.v1alpha1.ClassChoice
	(*EquipmentChoice)(nil),               // 120: dnd5e.api.v1alpha1.EquipmentChoice
	(*EquipmentOption)(nil),               // 121: dnd5e.api.v1alpha1.EquipmentOption
	(*EquipmentSelection)(nil),            // 122: dnd5e.api.v1alpha1.EquipmentSelection
	(*ChoiceSubmission)(nil),              // 123: dnd5e.api.v1alpha1.ChoiceSubmission
	(*SkillSelection)(nil),                // 124: dnd5e.api.v1alpha1.SkillSelection
	(*LanguageSelection)(nil),             // 125: dnd5e.api.v1alpha1.LanguageSelection
	(*FightingStyleSelection)(nil),        // 126: dnd5e.api.v1alpha1.FightingStyleSelection
	(*ToolSelection)(nil),                 // 127: dnd5e.api.v1alpha1.ToolSelection
	(*WeaponProficiencySelection)(nil),    // 128: dnd5e.api.v1alpha1.WeaponProficiencySelection
	(*ArmorProficiencySelection)(nil),     // 129: dnd5e.api.v1alpha1.ArmorProficiencySelection
	(*CharacterRequirements)(nil),         // 130: dnd5e.api.v1alpha1.CharacterRequirements
	(*RequiredChoice)(nil),                // 131: dnd5e.api.v1alpha1.RequiredChoice
	(*SkillOptions)(nil),                  // 132: dnd5e.api.v1alpha1.SkillOptions
	(*LanguageOptions)(nil),               // 133: dnd5e.api.v1alpha1.LanguageOptions
	(*FightingStyleOptions)(nil),          // 134: dnd5e.api.v1alpha1.FightingStyleOptions
	(*ToolOptions)(nil),                   // 135: dnd5e.api.v1alpha1.ToolOptions
	(*SpellDamage)(nil),                   // 136: dnd5e.api.v1alpha1.SpellDamage
	(*DamageAtSlotLevel)(nil),             // 137: dnd5e.api.v1alpha1.DamageAtSlotLevel
	(*AreaOfEffect)(nil),                  // 138: dnd5e.api.v1alpha1.AreaOfEffect
	(*ListEquipmentByTypeRequest)(nil),    // 139: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	(*ListEquipmentByTypeResponse)(nil),   // 140: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	(*ListSpellsByLevelRequest)(nil),      // 141: dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	(*ListSpellsByLevelResponse)(nil),     // 142: dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	(*GetCharacterInventoryRequest)(nil),  // 143: dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	(*GetCharacterInventoryResponse)(nil), // 144: dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	(*EquipItemRequest)(nil),              // 145: dnd5e.api.v1alpha1.EquipItemRequest
	(*EquipItemResponse)(nil),             // 146: dnd5e.api.v1alpha1.EquipItemResponse
	(*UnequipItemRequest)(nil),            // 147: dnd5e.api.v1alpha1.UnequipItemRequest
	(*UnequipItemResponse)(nil),           // 148: dnd5e.api.v1alpha1.UnequipItemResponse
	(*AddToInventoryRequest)(nil),         // 149: dnd5e.api.v1alpha1.AddToInventoryRequest
	(*InventoryAddition)(nil),             // 150: dnd5e.api.v1alpha1.InventoryAddition
	(*AddToInventoryResponse)(nil),        // 151: dnd5e.api.v1alpha1.AddToInventoryResponse
	(*RemoveFromInventoryRequest)(nil),    // 152: dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	(*RemoveFromInventoryResponse)(nil),   // 153: dnd5e.api.v1alpha1.RemoveFromInventoryResponse
	nil,                                   // 154: dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	nil,                                   // 155: dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	(Race)(0),                             // 156: dnd5e.api.v1alpha1.Race
	(Subrace)(0),                          // 157: dnd5e.api.v1alpha1.Subrace
	(Class)(0),                            // 158: dnd5e.api.v1alpha1.Class
	(Background)(0),                       // 159: dnd5e.api.v1alpha1.Background
	(Alignment)(0),                        // 160: dnd5e.api.v1alpha1.Alignment
	(Language)(0),                         // 161: dnd5e.api.v1alpha1.Language
	(FightingStyle)(0),                    // 162: dnd5e.api.v1alpha1.FightingStyle
	(Armor)(0),                            // 163: dnd5e.api.v1alpha1.Armor
	(Weapon)(0),                           // 164: dnd5e.api.v1alpha1.Weapon
	(Tool)(0),                             // 165: dnd5e.api.v1alpha1.Tool
	(Skill)(0),                            // 166: dnd5e.api.v1alpha1.Skill
	(Ability)(0),                          // 167: dnd5e.api.v1alpha1.Ability
	(Subclass)(0),                         // 168: dnd5e.api.v1alpha1.Subclass
	(*ValidationResult)(nil),              // 169: dnd5e.api.v1alpha1.ValidationResult
	(*ValidationWarning)(nil),             // 170: dnd5e.api.v1alpha1.ValidationWarning
	(*ValidationError)(nil),               // 171: dnd5e.api.v1alpha1.ValidationError
	(Pack)(0),                             // 172: dnd5e.api.v1alpha1.Pack
	(Ammunition)(0),                       // 173: dnd5e.api.v1alpha1.Ammunition
	(ArmorProficiencyCategory)(0),         // 174: dnd5e.api.v1alpha1.ArmorProficiencyCategory
	(WeaponProficiencyCategory)(0),        // 175: dnd5e.api.v1alpha1.WeaponProficiencyCategory
	(EquipmentCategory)(0),                // 176: dnd5e.api.v1alpha1.EquipmentCategory
	(WeaponCategory)(0),                   // 177: dnd5e.api.v1alpha1.WeaponCategory
	(DamageType)(0),                       // 178: dnd5e.api.v1alpha1.DamageType
	(WeaponProperty)(0),                   // 179: dnd5e.api.v1alpha1.WeaponProperty
	(ArmorCategory)(0),                    // 180: dnd5e.api.v1alpha1.ArmorCategory
	(GearCategory)(0),                     // 181: dnd5e.api.v1alpha1.GearCategory
	(Spell)(0),                            // 182: dnd5e.api.v1alpha1.Spell
	(Trait)(0),                            // 183: dnd5e.api.v1alpha1.Trait
	(EquipmentType)(0),                    // 184: dnd5e.api.v1alpha1.EquipmentType
}
var file_dnd5e_api_v1alpha1_character_proto_depIdxs = []int32{
	...
	156, // 2: dnd5e.api.v1alpha1.Character.race:type_name -> dnd5e.api.v1alpha1.Race
	157, // 3: dnd5e.api.v1alpha1.Character.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	158, // 4: dnd5e.api.v1alpha1.Character.class:type_name -> dnd5e.api.v1alpha1.Class
	159, // 5: dnd5e.api.v1alpha1.Character.background:type_name -> dnd5e.api.v1alpha1.Background
	160, // 6: dnd5e.api.v1alpha1.Character.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	...
	18,  // 10: dnd5e.api.v1alpha1.Character.proficiencies:type_name -> dnd5e.api.v1alpha1.Proficiencies
	161, // 11: dnd5e.api.v1alpha1.Character.languages:type_name -> dnd5e.api.v1alpha1.Language
	19,  // 12: dnd5e.api.v1alpha1.Character.metadata:type_name -> dnd5e.api.v1alpha1.CharacterMetadata
	106, // 13: dnd5e.api.v1alpha1.Character.equipment_slots:type_name -> dnd5e.api.v1alpha1.EquipmentSlots
	107, // 14: dnd5e.api.v1alpha1.Character.inventory:type_name -> dnd5e.api.v1alpha1.InventoryItem
	108, // 15: dnd5e.api.v1alpha1.Character.encumbrance:type_name -> dnd5e.api.v1alpha1.EncumbranceInfo
	10,  // 16: dnd5e.api.v1alpha1.Character.features:type_name -> dnd5e.api.v1alpha1.CharacterFeature
	162, // 17: dnd5e.api.v1alpha1.Character.fighting_styles:type_name -> dnd5e.api.v1alpha1.FightingStyle
	10,  // 18: dnd5e.api.v1alpha1.Character.racial_traits:type_name -> dnd5e.api.v1alpha1.CharacterFeature
	10,  // 19: dnd5e.api.v1alpha1.Character.background_feature:type_name -> dnd5e.api.v1alpha1.CharacterFeature
	11,  // 20: dnd5e.api.v1alpha1.Character.class_resources:type_name -> dnd5e.api.v1alpha1.ClassResource
	12,  // 21: dnd5e.api.v1alpha1.Character.spell_slots:type_name -> dnd5e.api.v1alpha1.SpellSlots
	163, // 22: dnd5e.api.v1alpha1.ProficiencyGrants.armor:type_name -> dnd5e.api.v1alpha1.Armor
	164, // 23: dnd5e.api.v1alpha1.ProficiencyGrants.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	165, // 24: dnd5e.api.v1alpha1.ProficiencyGrants.tools:type_name -> dnd5e.api.v1alpha1.Tool
	166, // 25: dnd5e.api.v1alpha1.ProficiencyGrants.skills:type_name -> dnd5e.api.v1alpha1.Skill
	161, // 26: dnd5e.api.v1alpha1.ProficiencyGrants.languages:type_name -> dnd5e.api.v1alpha1.Language
	166, // 27: dnd5e.api.v1alpha1.Proficiencies.skills:type_name -> dnd5e.api.v1alpha1.Skill
	167, // 28: dnd5e.api.v1alpha1.Proficiencies.saving_throws:type_name -> dnd5e.api.v1alpha1.Ability
	163, // 29: dnd5e.api.v1alpha1.Proficiencies.armor:type_name -> dnd5e.api.v1alpha1.Armor
	164, // 30: dnd5e.api.v1alpha1.Proficiencies.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	165, // 31: dnd5e.api.v1alpha1.Proficiencies.tools:type_name -> dnd5e.api.v1alpha1.Tool
	14,  // 32: dnd5e.api.v1alpha1.GetCharacterResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	14,  // 33: dnd5e.api.v1alpha1.ListCharactersResponse.characters:type_name -> dnd5e.api.v1alpha1.Character
	14,  // 34: dnd5e.api.v1alpha1.UpdateCharacterRequest.character:type_name -> dnd5e.api.v1alpha1.Character
	14,  // 35: dnd5e.api.v1alpha1.UpdateCharacterResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	156, // 36: dnd5e.api.v1alpha1.CharacterDraftData.race:type_name -> dnd5e.api.v1alpha1.Race
	157, // 37: dnd5e.api.v1alpha1.CharacterDraftData.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	158, // 38: dnd5e.api.v1alpha1.CharacterDraftData.class:type_name -> dnd5e.api.v1alpha1.Class
	168, // 39: dnd5e.api.v1alpha1.CharacterDraftData.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	159, // 40: dnd5e.api.v1alpha1.CharacterDraftData.background:type_name -> dnd5e.api.v1alpha1.Background
	13,  // 41: dnd5e.api.v1alpha1.CharacterDraftData.base_ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	109, // 42: dnd5e.api.v1alpha1.CharacterDraftData.choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	29,  // 43: dnd5e.api.v1alpha1.CharacterDraftData.progress:type_name -> dnd5e.api.v1alpha1.CreationProgress
	2,   // 44: dnd5e.api.v1alpha1.CreationProgress.current_step:type_name -> dnd5e.api.v1alpha1.CreationStep
	156, // 45: dnd5e.api.v1alpha1.CharacterDraft.race:type_name -> dnd5e.api.v1alpha1.Race
	157, // 46: dnd5e.api.v1alpha1.CharacterDraft.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	158, // 47: dnd5e.api.v1alpha1.CharacterDraft.class:type_name -> dnd5e.api.v1alpha1.Class
	168, // 48: dnd5e.api.v1alpha1.CharacterDraft.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	159, // 49: dnd5e.api.v1alpha1.CharacterDraft.background:type_name -> dnd5e.api.v1alpha1.Background
	13,  // 50: dnd5e.api.v1alpha1.CharacterDraft.base_ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	109, // 51: dnd5e.api.v1alpha1.CharacterDraft.choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	29,  // 52: dnd5e.api.v1alpha1.CharacterDraft.progress:type_name -> dnd5e.api.v1alpha1.CreationProgress
	169, // 53: dnd5e.api.v1alpha1.CharacterDraft.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	60,  // 54: dnd5e.api.v1alpha1.CharacterDraft.race_info:type_name -> dnd5e.api.v1alpha1.RaceInfo
	61,  // 55: dnd5e.api.v1alpha1.CharacterDraft.subrace_info:type_name -> dnd5e.api.v1alpha1.SubraceInfo
	72,  // 56: dnd5e.api.v1alpha1.CharacterDraft.class_info:type_name -> dnd5e.api.v1alpha1.ClassInfo
	75,  // 57: dnd5e.api.v1alpha1.CharacterDraft.background_info:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	28,  // 58: dnd5e.api.v1alpha1.CreateDraftRequest.initial_data:type_name -> dnd5e.api.v1alpha1.CharacterDraftData
	31,  // 59: dnd5e.api.v1alpha1.CreateDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	31,  // 60: dnd5e.api.v1alpha1.GetDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	28,  // 61: dnd5e.api.v1alpha1.UpdateDraftRequest.updates:type_name -> dnd5e.api.v1alpha1.CharacterDraftData
	31,  // 62: dnd5e.api.v1alpha1.UpdateDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	170, // 63: dnd5e.api.v1alpha1.UpdateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	156, // 64: dnd5e.api.v1alpha1.UpdateRaceRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	157, // 65: dnd5e.api.v1alpha1.UpdateRaceRequest.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	109, // 66: dnd5e.api.v1alpha1.UpdateRaceRequest.race_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	158, // 67: dnd5e.api.v1alpha1.UpdateClassRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	109, // 68: dnd5e.api.v1alpha1.UpdateClassRequest.class_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	168, // 69: dnd5e.api.v1alpha1.UpdateClassRequest.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	159, // 70: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background:type_name -> dnd5e.api.v1alpha1.Background
	109, // 71: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	13,  // 72: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	99,  // 73: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.roll_assignments:type_name -> dnd5e.api.v1alpha1.RollAssignments
	166, // 74: dnd5e.api.v1alpha1.UpdateSkillsRequest.skills:type_name -> dnd5e.api.v1alpha1.Skill
	31,  // 75: dnd5e.api.v1alpha1.UpdateNameResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	170, // 76: dnd5e.api.v1alpha1.UpdateNameResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 77: dnd5e.api.v1alpha1.UpdateRaceResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	170, // 78: dnd5e.api.v1alpha1.UpdateRaceResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 79: dnd5e.api.v1alpha1.UpdateClassResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	170, // 80: dnd5e.api.v1alpha1.UpdateClassResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 81: dnd5e.api.v1alpha1.UpdateBackgroundResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	170, // 82: dnd5e.api.v1alpha1.UpdateBackgroundResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 83: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	170, // 84: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 85: dnd5e.api.v1alpha1.UpdateSkillsResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	170, // 86: dnd5e.api.v1alpha1.UpdateSkillsResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 87: dnd5e.api.v1alpha1.ListDraftsResponse.drafts:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	169, // 88: dnd5e.api.v1alpha1.ValidateDraftResponse.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	2,   // 89: dnd5e.api.v1alpha1.ValidateDraftResponse.missing_steps:type_name -> dnd5e.api.v1alpha1.CreationStep
	171, // 90: dnd5e.api.v1alpha1.ValidateDraftResponse.errors:type_name -> dnd5e.api.v1alpha1.ValidationError
	170, // 91: dnd5e.api.v1alpha1.ValidateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	31,  // 92: dnd5e.api.v1alpha1.GetDraftPreviewResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	14,  // 93: dnd5e.api.v1alpha1.GetDraftPreviewResponse.preview:type_name -> dnd5e.api.v1alpha1.Character
	170, // 94: dnd5e.api.v1alpha1.GetDraftPreviewResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	171, // 95: dnd5e.api.v1alpha1.GetDraftPreviewResponse.errors:type_name -> dnd5e.api.v1alpha1.ValidationError
	14,  // 96: dnd5e.api.v1alpha1.FinalizeDraftResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	169, // 97: dnd5e.api.v1alpha1.FinalizeDraftResponse.final_validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	156, // 98: dnd5e.api.v1alpha1.RaceInfo.race_id:type_name -> dnd5e.api.v1alpha1.Race
	5,   // 99: dnd5e.api.v1alpha1.RaceInfo.size:type_name -> dnd5e.api.v1alpha1.Size
	154, // 100: dnd5e.api.v1alpha1.RaceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	62,  // 101: dnd5e.api.v1alpha1.RaceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	61,  // 102: dnd5e.api.v1alpha1.RaceInfo.subraces:type_name -> dnd5e.api.v1alpha1.SubraceInfo
	17,  // 103: dnd5e.api.v1alpha1.RaceInfo.proficiency_grants:type_name -> dnd5e.api.v1alpha1.ProficiencyGrants
	161, // 104: dnd5e.api.v1alpha1.RaceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	63,  // 105: dnd5e.api.v1alpha1.RaceInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	157, // 106: dnd5e.api.v1alpha1.SubraceInfo.subrace_id:type_name -> dnd5e.api.v1alpha1.Subrace
	155, // 107: dnd5e.api.v1alpha1.SubraceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	62,  // 108: dnd5e.api.v1alpha1.SubraceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	161, // 109: dnd5e.api.v1alpha1.SubraceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	17,  // 110: dnd5e.api.v1alpha1.SubraceInfo.proficiency_grants:type_name -> dnd5e.api.v1alpha1.ProficiencyGrants
	4,   // 111: dnd5e.api.v1alpha1.Choice.choice_type:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	64,  // 112: dnd5e.api.v1alpha1.Choice.explicit_options:type_name -> dnd5e.api.v1alpha1.ExplicitOptions
	65,  // 113: dnd5e.api.v1alpha1.Choice.category_reference:type_name -> dnd5e.api.v1alpha1.CategoryReference
	66,  // 114: dnd5e.api.v1alpha1.ExplicitOptions.options:type_name -> dnd5e.api.v1alpha1.ChoiceOption
	67,  // 115: dnd5e.api.v1alpha1.ChoiceOption.item:type_name -> dnd5e.api.v1alpha1.ItemReference
	68,  // 116: dnd5e.api.v1alpha1.ChoiceOption.counted_item:type_name -> dnd5e.api.v1alpha1.CountedItemReference
	69,  // 117: dnd5e.api.v1alpha1.ChoiceOption.bundle:type_name -> dnd5e.api.v1alpha1.ItemBundle
	71,  // 118: dnd5e.api.v1alpha1.ChoiceOption.nested_choice:type_name -> dnd5e.api.v1alpha1.NestedChoice
	164, // 119: dnd5e.api.v1alpha1.ItemReference.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	163, // 120: dnd5e.api.v1alpha1.ItemReference.armor:type_name -> dnd5e.api.v1alpha1.Armor
	165, // 121: dnd5e.api.v1alpha1.ItemReference.tool:type_name -> dnd5e.api.v1alpha1.Tool
	172, // 122: dnd5e.api.v1alpha1.ItemReference.pack:type_name -> dnd5e.api.v1alpha1.Pack
	173, // 123: dnd5e.api.v1alpha1.ItemReference.ammunition:type_name -> dnd5e.api.v1alpha1.Ammunition
	164, // 124: dnd5e.api.v1alpha1.CountedItemReference.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	163, // 125: dnd5e.api.v1alpha1.CountedItemReference.armor:type_name -> dnd5e.api.v1alpha1.Armor
	165, // 126: dnd5e.api.v1alpha1.CountedItemReference.tool:type_name -> dnd5e.api.v1alpha1.Tool
	172, // 127: dnd5e.api.v1alpha1.CountedItemReference.pack:type_name -> dnd5e.api.v1alpha1.Pack
	173, // 128: dnd5e.api.v1alpha1.CountedItemReference.ammunition:type_name -> dnd5e.api.v1alpha1.Ammunition
	70,  // 129: dnd5e.api.v1alpha1.ItemBundle.items:type_name -> dnd5e.api.v1alpha1.BundleItem
	68,  // 130: dnd5e.api.v1alpha1.BundleItem.concrete_item:type_name -> dnd5e.api.v1alpha1.CountedItemReference
	71,  // 131: dnd5e.api.v1alpha1.BundleItem.choice_item:type_name -> dnd5e.api.v1alpha1.NestedChoice
	63,  // 132: dnd5e.api.v1alpha1.NestedChoice.choice:type_name -> dnd5e.api.v1alpha1.Choice
	158, // 133: dnd5e.api.v1alpha1.ClassInfo.class_id:type_name -> dnd5e.api.v1alpha1.Class
	167, // 134: dnd5e.api.v1alpha1.ClassInfo.primary_ability:type_name -> dnd5e.api.v1alpha1.Ability
	174, // 135: dnd5e.api.v1alpha1.ClassInfo.armor_proficiency_categories:type_name -> dnd5e.api.v1alpha1.ArmorProficiencyCategory
	175, // 136: dnd5e.api.v1alpha1.ClassInfo.weapon_proficiency_categories:type_name -> dnd5e.api.v1alpha1.WeaponProficiencyCategory
	164, // 137: dnd5e.api.v1alpha1.ClassInfo.specific_weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.Weapon
	165, // 138: dnd5e.api.v1alpha1.ClassInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	167, // 139: dnd5e.api.v1alpha1.ClassInfo.saving_throw_proficiencies:type_name -> dnd5e.api.v1alpha1.Ability
	166, // 140: dnd5e.api.v1alpha1.ClassInfo.available_skills:type_name -> dnd5e.api.v1alpha1.Skill
	63,  // 141: dnd5e.api.v1alpha1.ClassInfo.equipment_choices:type_name -> dnd5e.api.v1alpha1.Choice
	76,  // 142: dnd5e.api.v1alpha1.ClassInfo.level_1_features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	74,  // 143: dnd5e.api.v1alpha1.ClassInfo.spellcasting:type_name -> dnd5e.api.v1alpha1.SpellcastingInfo
	63,  // 144: dnd5e.api.v1alpha1.ClassInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	73,  // 145: dnd5e.api.v1alpha1.ClassInfo.subclasses:type_name -> dnd5e.api.v1alpha1.SubclassInfo
	168, // 146: dnd5e.api.v1alpha1.SubclassInfo.subclass_id:type_name -> dnd5e.api.v1alpha1.Subclass
	163, // 147: dnd5e.api.v1alpha1.SubclassInfo.armor_proficiencies:type_name -> dnd5e.api.v1alpha1.Armor
	164, // 148: dnd5e.api.v1alpha1.SubclassInfo.weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.Weapon
	165, // 149: dnd5e.api.v1alpha1.SubclassInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	63,  // 150: dnd5e.api.v1alpha1.SubclassInfo.additional_choices:type_name -> dnd5e.api.v1alpha1.Choice
	76,  // 151: dnd5e.api.v1alpha1.SubclassInfo.features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	159, // 152: dnd5e.api.v1alpha1.BackgroundInfo.background_id:type_name -> dnd5e.api.v1alpha1.Background
	166, // 153: dnd5e.api.v1alpha1.BackgroundInfo.skill_proficiencies:type_name -> dnd5e.api.v1alpha1.Skill
	165, // 154: dnd5e.api.v1alpha1.BackgroundInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	161, // 155: dnd5e.api.v1alpha1.BackgroundInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	122, // 156: dnd5e.api.v1alpha1.BackgroundInfo.starting_equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	63,  // 157: dnd5e.api.v1alpha1.FeatureInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	77,  // 158: dnd5e.api.v1alpha1.FeatureInfo.spell_selection:type_name -> dnd5e.api.v1alpha1.SpellSelectionInfo
	6,   // 159: dnd5e.api.v1alpha1.SpellSelectionInfo.selection_type:type_name -> dnd5e.api.v1alpha1.SpellSelectionType
	60,  // 160: dnd5e.api.v1alpha1.ListRacesResponse.races:type_name -> dnd5e.api.v1alpha1.RaceInfo
	72,  // 161: dnd5e.api.v1alpha1.ListClassesResponse.classes:type_name -> dnd5e.api.v1alpha1.ClassInfo
	75,  // 162: dnd5e.api.v1alpha1.ListBackgroundsResponse.backgrounds:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	60,  // 163: dnd5e.api.v1alpha1.GetRaceDetailsResponse.race:type_name -> dnd5e.api.v1alpha1.RaceInfo
	72,  // 164: dnd5e.api.v1alpha1.GetClassDetailsResponse.class:type_name -> dnd5e.api.v1alpha1.ClassInfo
	75,  // 165: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse.background:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	76,  // 166: dnd5e.api.v1alpha1.GetFeatureResponse.feature:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	93,  // 167: dnd5e.api.v1alpha1.RollAbilityScoresResponse.rolls:type_name -> dnd5e.api.v1alpha1.AbilityScoreRoll
	158, // 168: dnd5e.api.v1alpha1.GetRequirementsRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	156, // 169: dnd5e.api.v1alpha1.GetRequirementsRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	130, // 170: dnd5e.api.v1alpha1.GetRequirementsResponse.requirements:type_name -> dnd5e.api.v1alpha1.CharacterRequirements
	123, // 171: dnd5e.api.v1alpha1.SubmitChoicesRequest.submissions:type_name -> dnd5e.api.v1alpha1.ChoiceSubmission
	31,  // 172: dnd5e.api.v1alpha1.SubmitChoicesResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	169, // 173: dnd5e.api.v1alpha1.SubmitChoicesResponse.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	130, // 174: dnd5e.api.v1alpha1.SubmitChoicesResponse.remaining_requirements:type_name -> dnd5e.api.v1alpha1.CharacterRequirements
	176, // 175: dnd5e.api.v1alpha1.Equipment.category:type_name -> dnd5e.api.v1alpha1.EquipmentCategory
	100, // 176: dnd5e.api.v1alpha1.Equipment.cost:type_name -> dnd5e.api.v1alpha1.Cost
	101, // 177: dnd5e.api.v1alpha1.Equipment.weight:type_name -> dnd5e.api.v1alpha1.Weight
	103, // 178: dnd5e.api.v1alpha1.Equipment.weapon_data:type_name -> dnd5e.api.v1alpha1.WeaponData
	104, // 179: dnd5e.api.v1alpha1.Equipment.armor_data:type_name -> dnd5e.api.v1alpha1.ArmorData
	105, // 180: dnd5e.api.v1alpha1.Equipment.gear_data:type_name -> dnd5e.api.v1alpha1.GearData
	177, // 181: dnd5e.api.v1alpha1.WeaponData.weapon_category:type_name -> dnd5e.api.v1alpha1.WeaponCategory
	178, // 182: dnd5e.api.v1alpha1.WeaponData.damage_type:type_name -> dnd5e.api.v1alpha1.DamageType
	179, // 183: dnd5e.api.v1alpha1.WeaponData.properties:type_name -> dnd5e.api.v1alpha1.WeaponProperty
	180, // 184: dnd5e.api.v1alpha1.ArmorData.armor_category:type_name -> dnd5e.api.v1alpha1.ArmorCategory
	181, // 185: dnd5e.api.v1alpha1.GearData.gear_category:type_name -> dnd5e.api.v1alpha1.GearCategory
	107, // 186: dnd5e.api.v1alpha1.EquipmentSlots.main_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 187: dnd5e.api.v1alpha1.EquipmentSlots.off_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 188: dnd5e.api.v1alpha1.EquipmentSlots.armor:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 189: dnd5e.api.v1alpha1.EquipmentSlots.helmet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 190: dnd5e.api.v1alpha1.EquipmentSlots.boots:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 191: dnd5e.api.v1alpha1.EquipmentSlots.gloves:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 192: dnd5e.api.v1alpha1.EquipmentSlots.cloak:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 193: dnd5e.api.v1alpha1.EquipmentSlots.amulet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 194: dnd5e.api.v1alpha1.EquipmentSlots.ring_1:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 195: dnd5e.api.v1alpha1.EquipmentSlots.ring_2:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 196: dnd5e.api.v1alpha1.EquipmentSlots.belt:type_name -> dnd5e.api.v1alpha1.InventoryItem
	102, // 197: dnd5e.api.v1alpha1.InventoryItem.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	7,   // 198: dnd5e.api.v1alpha1.EncumbranceInfo.level:type_name -> dnd5e.api.v1alpha1.EncumbranceLevel
	4,   // 199: dnd5e.api.v1alpha1.ChoiceData.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 200: dnd5e.api.v1alpha1.ChoiceData.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	110, // 201: dnd5e.api.v1alpha1.ChoiceData.skills:type_name -> dnd5e.api.v1alpha1.SkillList
	111, // 202: dnd5e.api.v1alpha1.ChoiceData.languages:type_name -> dnd5e.api.v1alpha1.LanguageList
	13,  // 203: dnd5e.api.v1alpha1.ChoiceData.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	162, // 204: dnd5e.api.v1alpha1.ChoiceData.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyle
	112, // 205: dnd5e.api.v1alpha1.ChoiceData.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentList
	118, // 206: dnd5e.api.v1alpha1.ChoiceData.race:type_name -> dnd5e.api.v1alpha1.RaceChoice
	119, // 207: dnd5e.api.v1alpha1.ChoiceData.class:type_name -> dnd5e.api.v1alpha1.ClassChoice
	159, // 208: dnd5e.api.v1alpha1.ChoiceData.background:type_name -> dnd5e.api.v1alpha1.Background
	113, // 209: dnd5e.api.v1alpha1.ChoiceData.spells:type_name -> dnd5e.api.v1alpha1.SpellList
	114, // 210: dnd5e.api.v1alpha1.ChoiceData.cantrips:type_name -> dnd5e.api.v1alpha1.CantripList
	115, // 211: dnd5e.api.v1alpha1.ChoiceData.expertise:type_name -> dnd5e.api.v1alpha1.ExpertiseList
	116, // 212: dnd5e.api.v1alpha1.ChoiceData.traits:type_name -> dnd5e.api.v1alpha1.TraitList
	117, // 213: dnd5e.api.v1alpha1.ChoiceData.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.ToolProficiencyList
	166, // 214: dnd5e.api.v1alpha1.SkillList.skills:type_name -> dnd5e.api.v1alpha1.Skill
	161, // 215: dnd5e.api.v1alpha1.LanguageList.languages:type_name -> dnd5e.api.v1alpha1.Language
	122, // 216: dnd5e.api.v1alpha1.EquipmentList.items:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	182, // 217: dnd5e.api.v1alpha1.SpellList.spells:type_name -> dnd5e.api.v1alpha1.Spell
	182, // 218: dnd5e.api.v1alpha1.CantripList.cantrips:type_name -> dnd5e.api.v1alpha1.Spell
	166, // 219: dnd5e.api.v1alpha1.ExpertiseList.skills:type_name -> dnd5e.api.v1alpha1.Skill
	183, // 220: dnd5e.api.v1alpha1.TraitList.traits:type_name -> dnd5e.api.v1alpha1.Trait
	165, // 221: dnd5e.api.v1alpha1.ToolProficiencyList.tools:type_name -> dnd5e.api.v1alpha1.Tool
	156, // 222: dnd5e.api.v1alpha1.RaceChoice.race:type_name -> dnd5e.api.v1alpha1.Race
	157, // 223: dnd5e.api.v1alpha1.RaceChoice.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	158, // 224: dnd5e.api.v1alpha1.ClassChoice.class:type_name -> dnd5e.api.v1alpha1.Class
	121, // 225: dnd5e.api.v1alpha1.EquipmentChoice.options:type_name -> dnd5e.api.v1alpha1.EquipmentOption
	122, // 226: dnd5e.api.v1alpha1.EquipmentOption.items:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	164, // 227: dnd5e.api.v1alpha1.EquipmentSelection.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	163, // 228: dnd5e.api.v1alpha1.EquipmentSelection.armor:type_name -> dnd5e.api.v1alpha1.Armor
	165, // 229: dnd5e.api.v1alpha1.EquipmentSelection.tool:type_name -> dnd5e.api.v1alpha1.Tool
	172, // 230: dnd5e.api.v1alpha1.EquipmentSelection.pack:type_name -> dnd5e.api.v1alpha1.Pack
	173, // 231: dnd5e.api.v1alpha1.EquipmentSelection.ammunition:type_name -> dnd5e.api.v1alpha1.Ammunition
	4,   // 232: dnd5e.api.v1alpha1.ChoiceSubmission.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 233: dnd5e.api.v1alpha1.ChoiceSubmission.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	124, // 234: dnd5e.api.v1alpha1.ChoiceSubmission.skills:type_name -> dnd5e.api.v1alpha1.SkillSelection
	125, // 235: dnd5e.api.v1alpha1.ChoiceSubmission.languages:type_name -> dnd5e.api.v1alpha1.LanguageSelection
	122, // 236: dnd5e.api.v1alpha1.ChoiceSubmission.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	126, // 237: dnd5e.api.v1alpha1.ChoiceSubmission.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyleSelection
	127, // 238: dnd5e.api.v1alpha1.ChoiceSubmission.tools:type_name -> dnd5e.api.v1alpha1.ToolSelection
	128, // 239: dnd5e.api.v1alpha1.ChoiceSubmission.weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.WeaponProficiencySelection
	129, // 240: dnd5e.api.v1alpha1.ChoiceSubmission.armor_proficiencies:type_name -> dnd5e.api.v1alpha1.ArmorProficiencySelection
	166, // 241: dnd5e.api.v1alpha1.SkillSelection.skills:type_name -> dnd5e.api.v1alpha1.Skill
	161, // 242: dnd5e.api.v1alpha1.LanguageSelection.languages:type_name -> dnd5e.api.v1alpha1.Language
	162, // 243: dnd5e.api.v1alpha1.FightingStyleSelection.style:type_name -> dnd5e.api.v1alpha1.FightingStyle
	165, // 244: dnd5e.api.v1alpha1.ToolSelection.tools:type_name -> dnd5e.api.v1alpha1.Tool
	164, // 245: dnd5e.api.v1alpha1.WeaponProficiencySelection.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	184, // 246: dnd5e.api.v1alpha1.WeaponProficiencySelection.categories:type_name -> dnd5e.api.v1alpha1.EquipmentType
	163, // 247: dnd5e.api.v1alpha1.ArmorProficiencySelection.armors:type_name -> dnd5e.api.v1alpha1.Armor
	184, // 248: dnd5e.api.v1alpha1.ArmorProficiencySelection.categories:type_name -> dnd5e.api.v1alpha1.EquipmentType
	131, // 249: dnd5e.api.v1alpha1.CharacterRequirements.choices:type_name -> dnd5e.api.v1alpha1.RequiredChoice
	4,   // 250: dnd5e.api.v1alpha1.RequiredChoice.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 251: dnd5e.api.v1alpha1.RequiredChoice.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	132, // 252: dnd5e.api.v1alpha1.RequiredChoice.skill_options:type_name -> dnd5e.api.v1alpha1.SkillOptions
	133, // 253: dnd5e.api.v1alpha1.RequiredChoice.language_options:type_name -> dnd5e.api.v1alpha1.LanguageOptions
	120, // 254: dnd5e.api.v1alpha1.RequiredChoice.equipment_options:type_name -> dnd5e.api.v1alpha1.EquipmentChoice
	134, // 255: dnd5e.api.v1alpha1.RequiredChoice.fighting_style_options:type_name -> dnd5e.api.v1alpha1.FightingStyleOptions
	135, // 256: dnd5e.api.v1alpha1.RequiredChoice.tool_options:type_name -> dnd5e.api.v1alpha1.ToolOptions
	166, // 257: dnd5e.api.v1alpha1.SkillOptions.available:type_name -> dnd5e.api.v1alpha1.Skill
	161, // 258: dnd5e.api.v1alpha1.LanguageOptions.available:type_name -> dnd5e.api.v1alpha1.Language
	162, // 259: dnd5e.api.v1alpha1.FightingStyleOptions.available:type_name -> dnd5e.api.v1alpha1.FightingStyle
	165, // 260: dnd5e.api.v1alpha1.ToolOptions.available:type_name -> dnd5e.api.v1alpha1.Tool
	178, // 261: dnd5e.api.v1alpha1.SpellDamage.damage_type:type_name -> dnd5e.api.v1alpha1.DamageType
	137, // 262: dnd5e.api.v1alpha1.SpellDamage.damage_at_slot_level:type_name -> dnd5e.api.v1alpha1.DamageAtSlotLevel
	184, // 263: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest.equipment_type:type_name -> dnd5e.api.v1alpha1.EquipmentType
	102, // 264: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	158, // 265: dnd5e.api.v1alpha1.ListSpellsByLevelRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	182, // 266: dnd5e.api.v1alpha1.ListSpellsByLevelResponse.spells:type_name -> dnd5e.api.v1alpha1.Spell
	106, // 267: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.equipment_slots:type_name -> dnd5e.api.v1alpha1.EquipmentSlots
	107, // 268: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.inventory:type_name -> dnd5e.api.v1alpha1.InventoryItem
	108, // 269: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.encumbrance:type_name -> dnd5e.api.v1alpha1.EncumbranceInfo
	9,   // 270: dnd5e.api.v1alpha1.EquipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	14,  // 271: dnd5e.api.v1alpha1.EquipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	107, // 272: dnd5e.api.v1alpha1.EquipItemResponse.previously_equipped_item:type_name -> dnd5e.api.v1alpha1.InventoryItem
	9,   // 273: dnd5e.api.v1alpha1.UnequipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	14,  // 274: dnd5e.api.v1alpha1.UnequipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	150, // 275: dnd5e.api.v1alpha1.AddToInventoryRequest.items:type_name -> dnd5e.api.v1alpha1.InventoryAddition
	14,  // 276: dnd5e.api.v1alpha1.AddToInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	14,  // 277: dnd5e.api.v1alpha1.RemoveFromInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	32,  // 278: dnd5e.api.v1alpha1.CharacterService.CreateDraft:input_type -> dnd5e.api.v1alpha1.CreateDraftRequest
	34,  // 279: dnd5e.api.v1alpha1.CharacterService.GetDraft:input_type -> dnd5e.api.v1alpha1.GetDraftRequest
	50,  // 280: dnd5e.api.v1alpha1.CharacterService.ListDrafts:input_type -> dnd5e.api.v1alpha1.ListDraftsRequest
	58,  // 281: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:input_type -> dnd5e.api.v1alpha1.DeleteDraftRequest
	38,  // 282: dnd5e.api.v1alpha1.CharacterService.UpdateName:input_type -> dnd5e.api.v1alpha1.UpdateNameRequest
	39,  // 283: dnd5e.api.v1alpha1.CharacterService.UpdateRace:input_type -> dnd5e.api.v1alpha1.UpdateRaceRequest
	40,  // 284: dnd5e.api.v1alpha1.CharacterService.UpdateClass:input_type -> dnd5e.api.v1alpha1.UpdateClassRequest
	41,  // 285: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:input_type -> dnd5e.api.v1alpha1.UpdateBackgroundRequest
	42,  // 286: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:input_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	43,  // 287: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:input_type -> dnd5e.api.v1alpha1.UpdateSkillsRequest
	52,  // 288: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:input_type -> dnd5e.api.v1alpha1.ValidateDraftRequest
	54,  // 289: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:input_type -> dnd5e.api.v1alpha1.GetDraftPreviewRequest
	56,  // 290: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:input_type -> dnd5e.api.v1alpha1.FinalizeDraftRequest
	20,  // 291: dnd5e.api.v1alpha1.CharacterService.GetCharacter:input_type -> dnd5e.api.v1alpha1.GetCharacterRequest
	22,  // 292: dnd5e.api.v1alpha1.CharacterService.ListCharacters:input_type -> dnd5e.api.v1alpha1.ListCharactersRequest
	26,  // 293: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:input_type -> dnd5e.api.v1alpha1.DeleteCharacterRequest
	78,  // 294: dnd5e.api.v1alpha1.CharacterService.ListRaces:input_type -> dnd5e.api.v1alpha1.ListRacesRequest
	80,  // 295: dnd5e.api.v1alpha1.CharacterService.ListClasses:input_type -> dnd5e.api.v1alpha1.ListClassesRequest
	82,  // 296: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:input_type -> dnd5e.api.v1alpha1.ListBackgroundsRequest
	84,  // 297: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:input_type -> dnd5e.api.v1alpha1.GetRaceDetailsRequest
	86,  // 298: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:input_type -> dnd5e.api.v1alpha1.GetClassDetailsRequest
	88,  // 299: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:input_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	90,  // 300: dnd5e.api.v1alpha1.CharacterService.GetFeature:input_type -> dnd5e.api.v1alpha1.GetFeatureRequest
	92,  // 301: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:input_type -> dnd5e.api.v1alpha1.RollAbilityScoresRequest
	95,  // 302: dnd5e.api.v1alpha1.CharacterService.GetRequirements:input_type -> dnd5e.api.v1alpha1.GetRequirementsRequest
	97,  // 303: dnd5e.api.v1alpha1.CharacterService.SubmitChoices:input_type -> dnd5e.api.v1alpha1.SubmitChoicesRequest
	139, // 304: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:input_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	141, // 305: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:input_type -> dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	143, // 306: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:input_type -> dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	145, // 307: dnd5e.api.v1alpha1.CharacterService.EquipItem:input_type -> dnd5e.api.v1alpha1.EquipItemRequest
	147, // 308: dnd5e.api.v1alpha1.CharacterService.UnequipItem:input_type -> dnd5e.api.v1alpha1.UnequipItemRequest
	149, // 309: dnd5e.api.v1alpha1.CharacterService.AddToInventory:input_type -> dnd5e.api.v1alpha1.AddToInventoryRequest
	152, // 310: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:input_type -> dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	33,  // 311: dnd5e.api.v1alpha1.CharacterService.CreateDraft:output_type -> dnd5e.api.v1alpha1.CreateDraftResponse
	35,  // 312: dnd5e.api.v1alpha1.CharacterService.GetDraft:output_type -> dnd5e.api.v1alpha1.GetDraftResponse
	51,  // 313: dnd5e.api.v1alpha1.CharacterService.ListDrafts:output_type -> dnd5e.api.v1alpha1.ListDraftsResponse
	59,  // 314: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:output_type -> dnd5e.api.v1alpha1.DeleteDraftResponse
	44,  // 315: dnd5e.api.v1alpha1.CharacterService.UpdateName:output_type -> dnd5e.api.v1alpha1.UpdateNameResponse
	45,  // 316: dnd5e.api.v1alpha1.CharacterService.UpdateRace:output_type -> dnd5e.api.v1alpha1.UpdateRaceResponse
	46,  // 317: dnd5e.api.v1alpha1.CharacterService.UpdateClass:output_type -> dnd5e.api.v1alpha1.UpdateClassResponse
	47,  // 318: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:output_type -> dnd5e.api.v1alpha1.UpdateBackgroundResponse
	48,  // 319: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:output_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	49,  // 320: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:output_type -> dnd5e.api.v1alpha1.UpdateSkillsResponse
	53,  // 321: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:output_type -> dnd5e.api.v1alpha1.ValidateDraftResponse
	55,  // 322: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:output_type -> dnd5e.api.v1alpha1.GetDraftPreviewResponse
	57,  // 323: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:output_type -> dnd5e.api.v1alpha1.FinalizeDraftResponse
	21,  // 324: dnd5e.api.v1alpha1.CharacterService.GetCharacter:output_type -> dnd5e.api.v1alpha1.GetCharacterResponse
	23,  // 325: dnd5e.api.v1alpha1.CharacterService.ListCharacters:output_type -> dnd5e.api.v1alpha1.ListCharactersResponse
	27,  // 326: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:output_type -> dnd5e.api.v1alpha1.DeleteCharacterResponse
	79,  // 327: dnd5e.api.v1alpha1.CharacterService.ListRaces:output_type -> dnd5e.api.v1alpha1.ListRacesResponse
	81,  // 328: dnd5e.api.v1alpha1.CharacterService.ListClasses:output_type -> dnd5e.api.v1alpha1.ListClassesResponse
	83,  // 329: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:output_type -> dnd5e.api.v1alpha1.ListBackgroundsResponse
	85,  // 330: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:output_type -> dnd5e.api.v1alpha1.GetRaceDetailsResponse
	87,  // 331: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:output_type -> dnd5e.api.v1alpha1.GetClassDetailsResponse
	89,  // 332: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:output_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	91,  // 333: dnd5e.api.v1alpha1.CharacterService.GetFeature:output_type -> dnd5e.api.v1alpha1.GetFeatureResponse
	94,  // 334: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:output_type -> dnd5e.api.v1alpha1.RollAbilityScoresResponse
	96,  // 335: dnd5e.api.v1alpha1.CharacterService.GetRequirements:output_type -> dnd5e.api.v1alpha1.GetRequirementsResponse
	98,  // 336: dnd5e.api.v1alpha1.CharacterService.SubmitChoices:output_type -> dnd5e.api.v1alpha1.SubmitChoicesResponse
	140, // 337: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:output_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	142, // 338: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:output_type -> dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	144, // 339: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:output_type -> dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	146, // 340: dnd5e.api.v1alpha1.CharacterService.EquipItem:output_type -> dnd5e.api.v1alpha1.EquipItemResponse
	148, // 341: dnd5e.api.v1alpha1.CharacterService.UnequipItem:output_type -> dnd5e.api.v1alpha1.UnequipItemResponse
	151, // 342: dnd5e.api.v1alpha1.CharacterService.AddToInventory:output_type -> dnd5e.api.v1alpha1.AddToInventoryResponse
	153, // 343: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:output_type -> dnd5e.api.v1alpha1.RemoveFromInventoryResponse
	311, // [311:344] is the sub-list for method output_type
	278, // [278:311] is the sub-list for method input_type
...
func file_dnd5e_api_v1alpha1_character_proto_init() {
	...
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[32].OneofWrappers = []any{
	...
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[56].OneofWrappers = []any{
		(*ChoiceOption_Item)(nil),
		(*ChoiceOption_CountedItem)(nil),
		(*ChoiceOption_Bundle)(nil),
		(*ChoiceOption_NestedChoice)(nil),
	}
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[57].OneofWrappers = []any{
		(*ItemReference_Weapon)(nil),
		(*ItemReference_Armor)(nil),
		(*ItemReference_Tool)(nil),
		(*ItemReference_Pack)(nil),
		(*ItemReference_Ammunition)(nil),
		(*ItemReference_OtherItemId)(nil),
	}
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[58].OneofWrappers = []any{
		(*CountedItemReference_Weapon)(nil),
		(*CountedItemReference_Armor)(nil),
		(*CountedItemReference_Tool)(nil),
		(*CountedItemReference_Pack)(nil),
		(*CountedItemReference_Ammunition)(nil),
		(*CountedItemReference_OtherItemId)(nil),
	}
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[60].OneofWrappers = []any{
		(*BundleItem_ConcreteItem)(nil),
		(*BundleItem_ChoiceItem)(nil),
	}
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[92].OneofWrappers = []any{
		(*Equipment_WeaponData)(nil),
		(*Equipment_ArmorData)(nil),
		(*Equipment_GearData)(nil),
	}
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[99].OneofWrappers = []any{
		(*ChoiceData_Name)(nil),
	...
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[112].OneofWrappers = []any{
		(*EquipmentSelection_Weapon)(nil),
		(*EquipmentSelection_Armor)(nil),
		(*EquipmentSelection_Tool)(nil),
		(*EquipmentSelection_Pack)(nil),
		(*EquipmentSelection_Ammunition)(nil),
		(*EquipmentSelection_OtherEquipmentId)(nil),
	}
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[113].OneofWrappers = []any{
		...
		(*ChoiceSubmission_WeaponProficiencies)(nil),
		(*ChoiceSubmission_ArmorProficiencies)(nil),
	}
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[121].OneofWrappers = []any{
		(*RequiredChoice_SkillOptions)(nil),
		(*RequiredChoice_LanguageOptions)(nil),
		(*RequiredChoice_EquipmentOptions)(nil),
		(*RequiredChoice_FightingStyleOptions)(nil),
		(*RequiredChoice_ToolOptions)(nil),
	}
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[142].OneofWrappers = []any{
