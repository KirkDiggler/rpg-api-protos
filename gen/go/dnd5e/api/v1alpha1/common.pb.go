...
// PlacementOffset is an optional cosmetic translation relative to a placement's
// canonical game-world origin. Its x, y, and z components are canonical
// game-world-axis values and MUST each be finite. Facing never rotates or
// reinterprets this vector. Message presence distinguishes omission from an
// explicitly authored [0,0,0]. Shape and finiteness are validated by the
// dungeonspec provider before this transport is produced.
//
// This is deliberately a placement offset, not a generic transform: it carries
// no facing, scale, matrix, quaternion, catalog identity, anchor, or gameplay
// meaning.
...
func (x *PlacementOffset) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlacementOffset) ProtoMessage() {}

func (x *PlacementOffset) ProtoReflect() protoreflect.Message {
	mi := &file_dnd5e_api_v1alpha1_common_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlacementOffset.ProtoReflect.Descriptor instead.
func (*PlacementOffset) Descriptor() ([]byte, []int) {
	return file_dnd5e_api_v1alpha1_common_proto_rawDescGZIP(), []int{1}
}

func (x *PlacementOffset) GetX() float64 {
	if x != nil {
		return x.X
	}
	return 0
...
func (x *PlacementOffset) GetY() float64 {
	if x != nil {
		return x.Y
	}
	return 0
...
func (x *PlacementOffset) GetZ() float64 {
	if x != nil {
		return x.Z
	}
	return 0
...
const file_dnd5e_api_v1alpha1_common_proto_rawDesc = "" +
	...
	"\bcharisma\x18\x06 \x01(\x05R\bcharisma\";\n" +
	"\x0fPlacementOffset\x12\f\n" +
...
var file_dnd5e_api_v1alpha1_common_proto_goTypes = []any{
	...
	(*PlacementOffset)(nil),        // 4: dnd5e.api.v1alpha1.PlacementOffset
	(*ValidationError)(nil),        // 5: dnd5e.api.v1alpha1.ValidationError
