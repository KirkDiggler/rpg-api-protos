...
var file_dnd5e_api_v1alpha1_encounter_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_dnd5e_api_v1alpha1_encounter_proto_goTypes = []any{
	...
	nil,                            // 22: dnd5e.api.v1alpha1.Room.EntitiesEntry
	nil,                            // 23: dnd5e.api.v1alpha1.MovementError.DetailsEntry
	(*v1alpha1.Position)(nil),      // 24: api.v1alpha1.Position
	(v1alpha1.GridType)(0),         // 25: api.v1alpha1.GridType
}
var file_dnd5e_api_v1alpha1_encounter_proto_depIdxs = []int32{
	24, // 0: dnd5e.api.v1alpha1.EntityPlacement.position:type_name -> api.v1alpha1.Position
	25, // 1: dnd5e.api.v1alpha1.Room.grid_type:type_name -> api.v1alpha1.GridType
	22, // 2: dnd5e.api.v1alpha1.Room.entities:type_name -> dnd5e.api.v1alpha1.Room.EntitiesEntry
	...
	24, // 5: dnd5e.api.v1alpha1.TurnState.position:type_name -> api.v1alpha1.Position
	...
	24, // 10: dnd5e.api.v1alpha1.MoveCharacterRequest.path:type_name -> api.v1alpha1.Position
	0,  // 11: dnd5e.api.v1alpha1.MovementError.code:type_name -> dnd5e.api.v1alpha1.MovementError.ErrorCode
	23, // 12: dnd5e.api.v1alpha1.MovementError.details:type_name -> dnd5e.api.v1alpha1.MovementError.DetailsEntry
	11, // 13: dnd5e.api.v1alpha1.MoveCharacterResponse.error:type_name -> dnd5e.api.v1alpha1.MovementError
	24, // 14: dnd5e.api.v1alpha1.MoveCharacterResponse.final_position:type_name -> api.v1alpha1.Position
	...
	1,  // 24: dnd5e.api.v1alpha1.Room.EntitiesEntry.value:type_name -> dnd5e.api.v1alpha1.EntityPlacement
	3,  // 25: dnd5e.api.v1alpha1.EncounterService.DungeonStart:input_type -> dnd5e.api.v1alpha1.DungeonStartRequest
	8,  // 26: dnd5e.api.v1alpha1.EncounterService.GetCombatState:input_type -> dnd5e.api.v1alpha1.GetCombatStateRequest
	10, // 27: dnd5e.api.v1alpha1.EncounterService.MoveCharacter:input_type -> dnd5e.api.v1alpha1.MoveCharacterRequest
	13, // 28: dnd5e.api.v1alpha1.EncounterService.EndTurn:input_type -> dnd5e.api.v1alpha1.EndTurnRequest
	16, // 29: dnd5e.api.v1alpha1.EncounterService.Attack:input_type -> dnd5e.api.v1alpha1.AttackRequest
	4,  // 30: dnd5e.api.v1alpha1.EncounterService.DungeonStart:output_type -> dnd5e.api.v1alpha1.DungeonStartResponse
	9,  // 31: dnd5e.api.v1alpha1.EncounterService.GetCombatState:output_type -> dnd5e.api.v1alpha1.GetCombatStateResponse
	12, // 32: dnd5e.api.v1alpha1.EncounterService.MoveCharacter:output_type -> dnd5e.api.v1alpha1.MoveCharacterResponse
	15, // 33: dnd5e.api.v1alpha1.EncounterService.EndTurn:output_type -> dnd5e.api.v1alpha1.EndTurnResponse
	21, // 34: dnd5e.api.v1alpha1.EncounterService.Attack:output_type -> dnd5e.api.v1alpha1.AttackResponse
