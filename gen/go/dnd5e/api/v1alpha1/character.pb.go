...
const file_dnd5e_api_v1alpha1_character_proto_rawDesc = "" +
	...
	"\tlanguages\x18\x05 \x03(\x0e2\x1c.dnd5e.api.v1alpha1.LanguageR\tlanguages\"\x9f\x04\n" +
	"\rProficiencies\x121\n" +
...
var file_dnd5e_api_v1alpha1_character_proto_depIdxs = []int32{
	...
	136, // 33: dnd5e.api.v1alpha1.Proficiencies.skills:type_name -> dnd5e.api.v1alpha1.Skill
	137, // 34: dnd5e.api.v1alpha1.Proficiencies.saving_throws:type_name -> dnd5e.api.v1alpha1.Ability
	138, // 35: dnd5e.api.v1alpha1.Proficiencies.armor_categories:type_name -> dnd5e.api.v1alpha1.ArmorProficiencyCategory
	139, // 36: dnd5e.api.v1alpha1.Proficiencies.weapon_categories:type_name -> dnd5e.api.v1alpha1.WeaponProficiencyCategory
	134, // 37: dnd5e.api.v1alpha1.Proficiencies.specific_weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	135, // 38: dnd5e.api.v1alpha1.Proficiencies.tools:type_name -> dnd5e.api.v1alpha1.Tool
	133, // 39: dnd5e.api.v1alpha1.Proficiencies.armor:type_name -> dnd5e.api.v1alpha1.Armor
	134, // 40: dnd5e.api.v1alpha1.Proficiencies.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	10,  // 41: dnd5e.api.v1alpha1.GetCharacterResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	10,  // 42: dnd5e.api.v1alpha1.ListCharactersResponse.characters:type_name -> dnd5e.api.v1alpha1.Character
	10,  // 43: dnd5e.api.v1alpha1.UpdateCharacterRequest.character:type_name -> dnd5e.api.v1alpha1.Character
	10,  // 44: dnd5e.api.v1alpha1.UpdateCharacterResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	124, // 45: dnd5e.api.v1alpha1.GetNextLevelResponse.class:type_name -> dnd5e.api.v1alpha1.Class
	140, // 46: dnd5e.api.v1alpha1.GetNextLevelResponse.choices:type_name -> dnd5e.api.v1alpha1.Choice
	73,  // 47: dnd5e.api.v1alpha1.GetNextLevelResponse.features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	2,   // 48: dnd5e.api.v1alpha1.LevelUpRequest.hit_point_method:type_name -> dnd5e.api.v1alpha1.HitPointMethod
	141, // 49: dnd5e.api.v1alpha1.LevelUpRequest.choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	10,  // 50: dnd5e.api.v1alpha1.LevelUpResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	29,  // 51: dnd5e.api.v1alpha1.LevelUpResponse.gained:type_name -> dnd5e.api.v1alpha1.LevelGained
	73,  // 52: dnd5e.api.v1alpha1.LevelGained.features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	30,  // 53: dnd5e.api.v1alpha1.LevelGained.resource_changes:type_name -> dnd5e.api.v1alpha1.ResourceMaximumChange
	122, // 54: dnd5e.api.v1alpha1.CharacterDraftData.race:type_name -> dnd5e.api.v1alpha1.Race
	123, // 55: dnd5e.api.v1alpha1.CharacterDraftData.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	124, // 56: dnd5e.api.v1alpha1.CharacterDraftData.class:type_name -> dnd5e.api.v1alpha1.Class
	142, // 57: dnd5e.api.v1alpha1.CharacterDraftData.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	125, // 58: dnd5e.api.v1alpha1.CharacterDraftData.background:type_name -> dnd5e.api.v1alpha1.Background
	127, // 59: dnd5e.api.v1alpha1.CharacterDraftData.base_ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	141, // 60: dnd5e.api.v1alpha1.CharacterDraftData.choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	32,  // 61: dnd5e.api.v1alpha1.CharacterDraftData.progress:type_name -> dnd5e.api.v1alpha1.CreationProgress
	11,  // 62: dnd5e.api.v1alpha1.CharacterDraftData.appearance:type_name -> dnd5e.api.v1alpha1.Appearance
	122, // 63: dnd5e.api.v1alpha1.CharacterDraft.race:type_name -> dnd5e.api.v1alpha1.Race
	123, // 64: dnd5e.api.v1alpha1.CharacterDraft.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	124, // 65: dnd5e.api.v1alpha1.CharacterDraft.class:type_name -> dnd5e.api.v1alpha1.Class
	142, // 66: dnd5e.api.v1alpha1.CharacterDraft.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	125, // 67: dnd5e.api.v1alpha1.CharacterDraft.background:type_name -> dnd5e.api.v1alpha1.Background
	127, // 68: dnd5e.api.v1alpha1.CharacterDraft.base_ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	141, // 69: dnd5e.api.v1alpha1.CharacterDraft.choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	32,  // 70: dnd5e.api.v1alpha1.CharacterDraft.progress:type_name -> dnd5e.api.v1alpha1.CreationProgress
	143, // 71: dnd5e.api.v1alpha1.CharacterDraft.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	65,  // 72: dnd5e.api.v1alpha1.CharacterDraft.race_info:type_name -> dnd5e.api.v1alpha1.RaceInfo
	66,  // 73: dnd5e.api.v1alpha1.CharacterDraft.subrace_info:type_name -> dnd5e.api.v1alpha1.SubraceInfo
	68,  // 74: dnd5e.api.v1alpha1.CharacterDraft.class_info:type_name -> dnd5e.api.v1alpha1.ClassInfo
	72,  // 75: dnd5e.api.v1alpha1.CharacterDraft.background_info:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	11,  // 76: dnd5e.api.v1alpha1.CharacterDraft.appearance:type_name -> dnd5e.api.v1alpha1.Appearance
	31,  // 77: dnd5e.api.v1alpha1.CreateDraftRequest.initial_data:type_name -> dnd5e.api.v1alpha1.CharacterDraftData
	34,  // 78: dnd5e.api.v1alpha1.CreateDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	34,  // 79: dnd5e.api.v1alpha1.GetDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	31,  // 80: dnd5e.api.v1alpha1.UpdateDraftRequest.updates:type_name -> dnd5e.api.v1alpha1.CharacterDraftData
	34,  // 81: dnd5e.api.v1alpha1.UpdateDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	122, // 82: dnd5e.api.v1alpha1.UpdateRaceRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	123, // 83: dnd5e.api.v1alpha1.UpdateRaceRequest.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	141, // 84: dnd5e.api.v1alpha1.UpdateRaceRequest.race_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	124, // 85: dnd5e.api.v1alpha1.UpdateClassRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	141, // 86: dnd5e.api.v1alpha1.UpdateClassRequest.class_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	142, // 87: dnd5e.api.v1alpha1.UpdateClassRequest.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	125, // 88: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background:type_name -> dnd5e.api.v1alpha1.Background
	141, // 89: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	127, // 90: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	96,  // 91: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.roll_assignments:type_name -> dnd5e.api.v1alpha1.RollAssignments
	136, // 92: dnd5e.api.v1alpha1.UpdateSkillsRequest.skills:type_name -> dnd5e.api.v1alpha1.Skill
	34,  // 93: dnd5e.api.v1alpha1.UpdateNameResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	34,  // 94: dnd5e.api.v1alpha1.UpdateRaceResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	34,  // 95: dnd5e.api.v1alpha1.UpdateClassResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	34,  // 96: dnd5e.api.v1alpha1.UpdateBackgroundResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	34,  // 97: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	34,  // 98: dnd5e.api.v1alpha1.UpdateSkillsResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	11,  // 99: dnd5e.api.v1alpha1.UpdateAppearanceRequest.appearance:type_name -> dnd5e.api.v1alpha1.Appearance
	34,  // 100: dnd5e.api.v1alpha1.UpdateAppearanceResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	34,  // 101: dnd5e.api.v1alpha1.ListDraftsResponse.drafts:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	143, // 102: dnd5e.api.v1alpha1.ValidateDraftResponse.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	34,  // 103: dnd5e.api.v1alpha1.GetDraftPreviewResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	10,  // 104: dnd5e.api.v1alpha1.GetDraftPreviewResponse.preview:type_name -> dnd5e.api.v1alpha1.Character
	10,  // 105: dnd5e.api.v1alpha1.FinalizeDraftResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	143, // 106: dnd5e.api.v1alpha1.FinalizeDraftResponse.final_validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	122, // 107: dnd5e.api.v1alpha1.RaceInfo.race_id:type_name -> dnd5e.api.v1alpha1.Race
	4,   // 108: dnd5e.api.v1alpha1.RaceInfo.size:type_name -> dnd5e.api.v1alpha1.Size
	118, // 109: dnd5e.api.v1alpha1.RaceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	67,  // 110: dnd5e.api.v1alpha1.RaceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	66,  // 111: dnd5e.api.v1alpha1.RaceInfo.subraces:type_name -> dnd5e.api.v1alpha1.SubraceInfo
	14,  // 112: dnd5e.api.v1alpha1.RaceInfo.proficiency_grants:type_name -> dnd5e.api.v1alpha1.ProficiencyGrants
	128, // 113: dnd5e.api.v1alpha1.RaceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	140, // 114: dnd5e.api.v1alpha1.RaceInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	123, // 115: dnd5e.api.v1alpha1.SubraceInfo.subrace_id:type_name -> dnd5e.api.v1alpha1.Subrace
	119, // 116: dnd5e.api.v1alpha1.SubraceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	67,  // 117: dnd5e.api.v1alpha1.SubraceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	128, // 118: dnd5e.api.v1alpha1.SubraceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	14,  // 119: dnd5e.api.v1alpha1.SubraceInfo.proficiency_grants:type_name -> dnd5e.api.v1alpha1.ProficiencyGrants
	124, // 120: dnd5e.api.v1alpha1.ClassInfo.class_id:type_name -> dnd5e.api.v1alpha1.Class
	137, // 121: dnd5e.api.v1alpha1.ClassInfo.primary_ability:type_name -> dnd5e.api.v1alpha1.Ability
	138, // 122: dnd5e.api.v1alpha1.ClassInfo.armor_proficiency_categories:type_name -> dnd5e.api.v1alpha1.ArmorProficiencyCategory
	139, // 123: dnd5e.api.v1alpha1.ClassInfo.weapon_proficiency_categories:type_name -> dnd5e.api.v1alpha1.WeaponProficiencyCategory
	134, // 124: dnd5e.api.v1alpha1.ClassInfo.specific_weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.Weapon
	135, // 125: dnd5e.api.v1alpha1.ClassInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	137, // 126: dnd5e.api.v1alpha1.ClassInfo.saving_throw_proficiencies:type_name -> dnd5e.api.v1alpha1.Ability
	73,  // 127: dnd5e.api.v1alpha1.ClassInfo.level_1_features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	70,  // 128: dnd5e.api.v1alpha1.ClassInfo.spellcasting:type_name -> dnd5e.api.v1alpha1.SpellcastingInfo
	140, // 129: dnd5e.api.v1alpha1.ClassInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	69,  // 130: dnd5e.api.v1alpha1.ClassInfo.subclasses:type_name -> dnd5e.api.v1alpha1.SubclassInfo
	142, // 131: dnd5e.api.v1alpha1.SubclassInfo.subclass_id:type_name -> dnd5e.api.v1alpha1.Subclass
	133, // 132: dnd5e.api.v1alpha1.SubclassInfo.armor_proficiencies:type_name -> dnd5e.api.v1alpha1.Armor
	134, // 133: dnd5e.api.v1alpha1.SubclassInfo.weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.Weapon
	135, // 134: dnd5e.api.v1alpha1.SubclassInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	140, // 135: dnd5e.api.v1alpha1.SubclassInfo.additional_choices:type_name -> dnd5e.api.v1alpha1.Choice
	73,  // 136: dnd5e.api.v1alpha1.SubclassInfo.features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	144, // 137: dnd5e.api.v1alpha1.SpellInfo.spell_id:type_name -> dnd5e.api.v1alpha1.Spell
	125, // 138: dnd5e.api.v1alpha1.BackgroundInfo.background_id:type_name -> dnd5e.api.v1alpha1.Background
	136, // 139: dnd5e.api.v1alpha1.BackgroundInfo.skill_proficiencies:type_name -> dnd5e.api.v1alpha1.Skill
	135, // 140: dnd5e.api.v1alpha1.BackgroundInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	128, // 141: dnd5e.api.v1alpha1.BackgroundInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	145, // 142: dnd5e.api.v1alpha1.BackgroundInfo.starting_equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	140, // 143: dnd5e.api.v1alpha1.BackgroundInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	140, // 144: dnd5e.api.v1alpha1.FeatureInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	74,  // 145: dnd5e.api.v1alpha1.FeatureInfo.spell_selection:type_name -> dnd5e.api.v1alpha1.SpellSelectionInfo
	146, // 146: dnd5e.api.v1alpha1.SpellSelectionInfo.selection_type:type_name -> dnd5e.api.v1alpha1.SpellSelectionType
	65,  // 147: dnd5e.api.v1alpha1.ListRacesResponse.races:type_name -> dnd5e.api.v1alpha1.RaceInfo
	68,  // 148: dnd5e.api.v1alpha1.ListClassesResponse.classes:type_name -> dnd5e.api.v1alpha1.ClassInfo
	72,  // 149: dnd5e.api.v1alpha1.ListBackgroundsResponse.backgrounds:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	65,  // 150: dnd5e.api.v1alpha1.GetRaceDetailsResponse.race:type_name -> dnd5e.api.v1alpha1.RaceInfo
	68,  // 151: dnd5e.api.v1alpha1.GetClassDetailsResponse.class:type_name -> dnd5e.api.v1alpha1.ClassInfo
	72,  // 152: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse.background:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	73,  // 153: dnd5e.api.v1alpha1.GetFeatureResponse.feature:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	90,  // 154: dnd5e.api.v1alpha1.RollAbilityScoresResponse.rolls:type_name -> dnd5e.api.v1alpha1.AbilityScoreRoll
	124, // 155: dnd5e.api.v1alpha1.GetRequirementsRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	122, // 156: dnd5e.api.v1alpha1.GetRequirementsRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	140, // 157: dnd5e.api.v1alpha1.GetRequirementsResponse.requirements:type_name -> dnd5e.api.v1alpha1.Choice
	147, // 158: dnd5e.api.v1alpha1.SubmitChoicesRequest.submissions:type_name -> dnd5e.api.v1alpha1.ChoiceSubmission
	34,  // 159: dnd5e.api.v1alpha1.SubmitChoicesResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	143, // 160: dnd5e.api.v1alpha1.SubmitChoicesResponse.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	140, // 161: dnd5e.api.v1alpha1.SubmitChoicesResponse.remaining_requirements:type_name -> dnd5e.api.v1alpha1.Choice
	98,  // 162: dnd5e.api.v1alpha1.EquipmentSlots.main_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	98,  // 163: dnd5e.api.v1alpha1.EquipmentSlots.off_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	98,  // 164: dnd5e.api.v1alpha1.EquipmentSlots.armor:type_name -> dnd5e.api.v1alpha1.InventoryItem
	98,  // 165: dnd5e.api.v1alpha1.EquipmentSlots.helmet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	98,  // 166: dnd5e.api.v1alpha1.EquipmentSlots.boots:type_name -> dnd5e.api.v1alpha1.InventoryItem
	98,  // 167: dnd5e.api.v1alpha1.EquipmentSlots.gloves:type_name -> dnd5e.api.v1alpha1.InventoryItem
	98,  // 168: dnd5e.api.v1alpha1.EquipmentSlots.cloak:type_name -> dnd5e.api.v1alpha1.InventoryItem
	98,  // 169: dnd5e.api.v1alpha1.EquipmentSlots.amulet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	98,  // 170: dnd5e.api.v1alpha1.EquipmentSlots.ring_1:type_name -> dnd5e.api.v1alpha1.InventoryItem
	98,  // 171: dnd5e.api.v1alpha1.EquipmentSlots.ring_2:type_name -> dnd5e.api.v1alpha1.InventoryItem
	98,  // 172: dnd5e.api.v1alpha1.EquipmentSlots.belt:type_name -> dnd5e.api.v1alpha1.InventoryItem
	148, // 173: dnd5e.api.v1alpha1.InventoryItem.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	5,   // 174: dnd5e.api.v1alpha1.EncumbranceInfo.level:type_name -> dnd5e.api.v1alpha1.EncumbranceLevel
	149, // 175: dnd5e.api.v1alpha1.SpellDamage.damage_type:type_name -> dnd5e.api.v1alpha1.DamageType
	101, // 176: dnd5e.api.v1alpha1.SpellDamage.damage_at_slot_level:type_name -> dnd5e.api.v1alpha1.DamageAtSlotLevel
	150, // 177: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest.equipment_type:type_name -> dnd5e.api.v1alpha1.EquipmentType
	148, // 178: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	124, // 179: dnd5e.api.v1alpha1.ListSpellsByLevelRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	71,  // 180: dnd5e.api.v1alpha1.ListSpellsByLevelResponse.spells:type_name -> dnd5e.api.v1alpha1.SpellInfo
	97,  // 181: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.equipment_slots:type_name -> dnd5e.api.v1alpha1.EquipmentSlots
	98,  // 182: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.inventory:type_name -> dnd5e.api.v1alpha1.InventoryItem
	99,  // 183: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.encumbrance:type_name -> dnd5e.api.v1alpha1.EncumbranceInfo
	6,   // 184: dnd5e.api.v1alpha1.EquipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	10,  // 185: dnd5e.api.v1alpha1.EquipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	98,  // 186: dnd5e.api.v1alpha1.EquipItemResponse.previously_equipped_item:type_name -> dnd5e.api.v1alpha1.InventoryItem
	6,   // 187: dnd5e.api.v1alpha1.UnequipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	10,  // 188: dnd5e.api.v1alpha1.UnequipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	114, // 189: dnd5e.api.v1alpha1.AddToInventoryRequest.items:type_name -> dnd5e.api.v1alpha1.InventoryAddition
	10,  // 190: dnd5e.api.v1alpha1.AddToInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	10,  // 191: dnd5e.api.v1alpha1.RemoveFromInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	35,  // 192: dnd5e.api.v1alpha1.CharacterService.CreateDraft:input_type -> dnd5e.api.v1alpha1.CreateDraftRequest
	37,  // 193: dnd5e.api.v1alpha1.CharacterService.GetDraft:input_type -> dnd5e.api.v1alpha1.GetDraftRequest
	55,  // 194: dnd5e.api.v1alpha1.CharacterService.ListDrafts:input_type -> dnd5e.api.v1alpha1.ListDraftsRequest
	63,  // 195: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:input_type -> dnd5e.api.v1alpha1.DeleteDraftRequest
	41,  // 196: dnd5e.api.v1alpha1.CharacterService.UpdateName:input_type -> dnd5e.api.v1alpha1.UpdateNameRequest
	42,  // 197: dnd5e.api.v1alpha1.CharacterService.UpdateRace:input_type -> dnd5e.api.v1alpha1.UpdateRaceRequest
	43,  // 198: dnd5e.api.v1alpha1.CharacterService.UpdateClass:input_type -> dnd5e.api.v1alpha1.UpdateClassRequest
	44,  // 199: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:input_type -> dnd5e.api.v1alpha1.UpdateBackgroundRequest
	45,  // 200: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:input_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	46,  // 201: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:input_type -> dnd5e.api.v1alpha1.UpdateSkillsRequest
	53,  // 202: dnd5e.api.v1alpha1.CharacterService.UpdateAppearance:input_type -> dnd5e.api.v1alpha1.UpdateAppearanceRequest
	57,  // 203: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:input_type -> dnd5e.api.v1alpha1.ValidateDraftRequest
	59,  // 204: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:input_type -> dnd5e.api.v1alpha1.GetDraftPreviewRequest
	61,  // 205: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:input_type -> dnd5e.api.v1alpha1.FinalizeDraftRequest
	17,  // 206: dnd5e.api.v1alpha1.CharacterService.GetCharacter:input_type -> dnd5e.api.v1alpha1.GetCharacterRequest
	19,  // 207: dnd5e.api.v1alpha1.CharacterService.ListCharacters:input_type -> dnd5e.api.v1alpha1.ListCharactersRequest
	23,  // 208: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:input_type -> dnd5e.api.v1alpha1.DeleteCharacterRequest
	25,  // 209: dnd5e.api.v1alpha1.CharacterService.GetNextLevel:input_type -> dnd5e.api.v1alpha1.GetNextLevelRequest
	27,  // 210: dnd5e.api.v1alpha1.CharacterService.LevelUp:input_type -> dnd5e.api.v1alpha1.LevelUpRequest
	75,  // 211: dnd5e.api.v1alpha1.CharacterService.ListRaces:input_type -> dnd5e.api.v1alpha1.ListRacesRequest
	77,  // 212: dnd5e.api.v1alpha1.CharacterService.ListClasses:input_type -> dnd5e.api.v1alpha1.ListClassesRequest
	79,  // 213: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:input_type -> dnd5e.api.v1alpha1.ListBackgroundsRequest
	81,  // 214: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:input_type -> dnd5e.api.v1alpha1.GetRaceDetailsRequest
	83,  // 215: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:input_type -> dnd5e.api.v1alpha1.GetClassDetailsRequest
	85,  // 216: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:input_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	87,  // 217: dnd5e.api.v1alpha1.CharacterService.GetFeature:input_type -> dnd5e.api.v1alpha1.GetFeatureRequest
	89,  // 218: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:input_type -> dnd5e.api.v1alpha1.RollAbilityScoresRequest
	92,  // 219: dnd5e.api.v1alpha1.CharacterService.GetRequirements:input_type -> dnd5e.api.v1alpha1.GetRequirementsRequest
	94,  // 220: dnd5e.api.v1alpha1.CharacterService.SubmitChoices:input_type -> dnd5e.api.v1alpha1.SubmitChoicesRequest
	103, // 221: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:input_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	105, // 222: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:input_type -> dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	107, // 223: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:input_type -> dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	109, // 224: dnd5e.api.v1alpha1.CharacterService.EquipItem:input_type -> dnd5e.api.v1alpha1.EquipItemRequest
	111, // 225: dnd5e.api.v1alpha1.CharacterService.UnequipItem:input_type -> dnd5e.api.v1alpha1.UnequipItemRequest
	113, // 226: dnd5e.api.v1alpha1.CharacterService.AddToInventory:input_type -> dnd5e.api.v1alpha1.AddToInventoryRequest
	116, // 227: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:input_type -> dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	36,  // 228: dnd5e.api.v1alpha1.CharacterService.CreateDraft:output_type -> dnd5e.api.v1alpha1.CreateDraftResponse
	38,  // 229: dnd5e.api.v1alpha1.CharacterService.GetDraft:output_type -> dnd5e.api.v1alpha1.GetDraftResponse
	56,  // 230: dnd5e.api.v1alpha1.CharacterService.ListDrafts:output_type -> dnd5e.api.v1alpha1.ListDraftsResponse
	64,  // 231: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:output_type -> dnd5e.api.v1alpha1.DeleteDraftResponse
	47,  // 232: dnd5e.api.v1alpha1.CharacterService.UpdateName:output_type -> dnd5e.api.v1alpha1.UpdateNameResponse
	48,  // 233: dnd5e.api.v1alpha1.CharacterService.UpdateRace:output_type -> dnd5e.api.v1alpha1.UpdateRaceResponse
	49,  // 234: dnd5e.api.v1alpha1.CharacterService.UpdateClass:output_type -> dnd5e.api.v1alpha1.UpdateClassResponse
	50,  // 235: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:output_type -> dnd5e.api.v1alpha1.UpdateBackgroundResponse
	51,  // 236: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:output_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	52,  // 237: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:output_type -> dnd5e.api.v1alpha1.UpdateSkillsResponse
	54,  // 238: dnd5e.api.v1alpha1.CharacterService.UpdateAppearance:output_type -> dnd5e.api.v1alpha1.UpdateAppearanceResponse
	58,  // 239: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:output_type -> dnd5e.api.v1alpha1.ValidateDraftResponse
	60,  // 240: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:output_type -> dnd5e.api.v1alpha1.GetDraftPreviewResponse
	62,  // 241: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:output_type -> dnd5e.api.v1alpha1.FinalizeDraftResponse
	18,  // 242: dnd5e.api.v1alpha1.CharacterService.GetCharacter:output_type -> dnd5e.api.v1alpha1.GetCharacterResponse
	20,  // 243: dnd5e.api.v1alpha1.CharacterService.ListCharacters:output_type -> dnd5e.api.v1alpha1.ListCharactersResponse
	24,  // 244: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:output_type -> dnd5e.api.v1alpha1.DeleteCharacterResponse
	26,  // 245: dnd5e.api.v1alpha1.CharacterService.GetNextLevel:output_type -> dnd5e.api.v1alpha1.GetNextLevelResponse
	28,  // 246: dnd5e.api.v1alpha1.CharacterService.LevelUp:output_type -> dnd5e.api.v1alpha1.LevelUpResponse
	76,  // 247: dnd5e.api.v1alpha1.CharacterService.ListRaces:output_type -> dnd5e.api.v1alpha1.ListRacesResponse
	78,  // 248: dnd5e.api.v1alpha1.CharacterService.ListClasses:output_type -> dnd5e.api.v1alpha1.ListClassesResponse
	80,  // 249: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:output_type -> dnd5e.api.v1alpha1.ListBackgroundsResponse
	82,  // 250: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:output_type -> dnd5e.api.v1alpha1.GetRaceDetailsResponse
	84,  // 251: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:output_type -> dnd5e.api.v1alpha1.GetClassDetailsResponse
	86,  // 252: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:output_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	88,  // 253: dnd5e.api.v1alpha1.CharacterService.GetFeature:output_type -> dnd5e.api.v1alpha1.GetFeatureResponse
	91,  // 254: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:output_type -> dnd5e.api.v1alpha1.RollAbilityScoresResponse
	93,  // 255: dnd5e.api.v1alpha1.CharacterService.GetRequirements:output_type -> dnd5e.api.v1alpha1.GetRequirementsResponse
	95,  // 256: dnd5e.api.v1alpha1.CharacterService.SubmitChoices:output_type -> dnd5e.api.v1alpha1.SubmitChoicesResponse
	104, // 257: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:output_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	106, // 258: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:output_type -> dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	108, // 259: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:output_type -> dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	110, // 260: dnd5e.api.v1alpha1.CharacterService.EquipItem:output_type -> dnd5e.api.v1alpha1.EquipItemResponse
	112, // 261: dnd5e.api.v1alpha1.CharacterService.UnequipItem:output_type -> dnd5e.api.v1alpha1.UnequipItemResponse
	115, // 262: dnd5e.api.v1alpha1.CharacterService.AddToInventory:output_type -> dnd5e.api.v1alpha1.AddToInventoryResponse
	117, // 263: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:output_type -> dnd5e.api.v1alpha1.RemoveFromInventoryResponse
	228, // [228:264] is the sub-list for method output_type
	192, // [192:228] is the sub-list for method input_type
