...
const (
	...
	EncounterService_ActivateCombatAbility_FullMethodName = "/dnd5e.api.v1alpha1.EncounterService/ActivateCombatAbility"
	EncounterService_ExecuteAction_FullMethodName         = "/dnd5e.api.v1alpha1.EncounterService/ExecuteAction"
	EncounterService_ShortRest_FullMethodName             = "/dnd5e.api.v1alpha1.EncounterService/ShortRest"
	EncounterService_LongRest_FullMethodName              = "/dnd5e.api.v1alpha1.EncounterService/LongRest"
)
...
type EncounterServiceClient interface {
	...
	ActivateCombatAbility(ctx context.Context, in *ActivateCombatAbilityRequest, opts ...grpc.CallOption) (*ActivateCombatAbilityResponse, error)
	...
	ShortRest(ctx context.Context, in *ShortRestRequest, opts ...grpc.CallOption) (*ShortRestResponse, error)
	// LongRest performs a long rest for the party
	LongRest(ctx context.Context, in *LongRestRequest, opts ...grpc.CallOption) (*LongRestResponse, error)
}
...
func (c *encounterServiceClient) ActivateCombatAbility(ctx context.Context, in *ActivateCombatAbilityRequest, opts ...grpc.CallOption) (*ActivateCombatAbilityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ActivateCombatAbilityResponse)
	err := c.cc.Invoke(ctx, EncounterService_ActivateCombatAbility_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *encounterServiceClient) ExecuteAction(ctx context.Context, in *ExecuteActionRequest, opts ...grpc.CallOption) (*ExecuteActionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExecuteActionResponse)
	err := c.cc.Invoke(ctx, EncounterService_ExecuteAction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *encounterServiceClient) ShortRest(ctx context.Context, in *ShortRestRequest, opts ...grpc.CallOption) (*ShortRestResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShortRestResponse)
	err := c.cc.Invoke(ctx, EncounterService_ShortRest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *encounterServiceClient) LongRest(ctx context.Context, in *LongRestRequest, opts ...grpc.CallOption) (*LongRestResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LongRestResponse)
	err := c.cc.Invoke(ctx, EncounterService_LongRest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EncounterServiceServer interface {
	...
	// ActivateCombatAbility activates a combat ability (ATTACK, DASH, DODGE, etc.)
	// This consumes action economy resources and grants capacity to execute actions
	ActivateCombatAbility(context.Context, *ActivateCombatAbilityRequest) (*ActivateCombatAbilityResponse, error)
	// ExecuteAction executes an action that consumes granted capacity
	// Use after ActivateCombatAbility to perform strikes, moves, etc.
	ExecuteAction(context.Context, *ExecuteActionRequest) (*ExecuteActionResponse, error)
	// ShortRest performs a short rest for the party between rooms
	ShortRest(context.Context, *ShortRestRequest) (*ShortRestResponse, error)
	// LongRest performs a long rest for the party
	LongRest(context.Context, *LongRestRequest) (*LongRestResponse, error)
}
...
func (UnimplementedEncounterServiceServer) ActivateCombatAbility(context.Context, *ActivateCombatAbilityRequest) (*ActivateCombatAbilityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ActivateCombatAbility not implemented")
}
func (UnimplementedEncounterServiceServer) ExecuteAction(context.Context, *ExecuteActionRequest) (*ExecuteActionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExecuteAction not implemented")
}
func (UnimplementedEncounterServiceServer) ShortRest(context.Context, *ShortRestRequest) (*ShortRestResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ShortRest not implemented")
}
func (UnimplementedEncounterServiceServer) LongRest(context.Context, *LongRestRequest) (*LongRestResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method LongRest not implemented")
}
...
func _EncounterService_ActivateCombatAbility_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ActivateCombatAbilityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EncounterServiceServer).ActivateCombatAbility(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EncounterService_ActivateCombatAbility_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EncounterServiceServer).ActivateCombatAbility(ctx, req.(*ActivateCombatAbilityRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EncounterService_ExecuteAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecuteActionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EncounterServiceServer).ExecuteAction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EncounterService_ExecuteAction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EncounterServiceServer).ExecuteAction(ctx, req.(*ExecuteActionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EncounterService_ShortRest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShortRestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EncounterServiceServer).ShortRest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EncounterService_ShortRest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EncounterServiceServer).ShortRest(ctx, req.(*ShortRestRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EncounterService_LongRest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LongRestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EncounterServiceServer).LongRest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EncounterService_LongRest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EncounterServiceServer).LongRest(ctx, req.(*LongRestRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EncounterService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ActivateCombatAbility",
			Handler:    _EncounterService_ActivateCombatAbility_Handler,
		},
		{
			MethodName: "ExecuteAction",
			Handler:    _EncounterService_ExecuteAction_Handler,
		},
		{
			MethodName: "ShortRest",
			Handler:    _EncounterService_ShortRest_Handler,
		},
		{
			MethodName: "LongRest",
			Handler:    _EncounterService_LongRest_Handler,
		},
	},
