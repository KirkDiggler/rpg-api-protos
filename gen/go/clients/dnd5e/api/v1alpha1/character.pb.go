...
type ClassInfo struct {
	...
	Level_1Features []*FeatureInfo `protobuf:"bytes,14,rep,name=level_1_features,json=level1Features,proto3" json:"level_1_features,omitempty"`
...
const file_dnd5e_api_v1alpha1_character_proto_rawDesc = "" +
	...
	"\x04from\x18\x04 \x01(\tR\x04from\"\xa6\x06\n" +
	"\tClassInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	...
	"\x11equipment_choices\x18\r \x03(\v2#.dnd5e.api.v1alpha1.EquipmentChoiceR\x10equipmentChoices\x12I\n" +
	"\x10level_1_features\x18\x0e \x03(\v2\x1f.dnd5e.api.v1alpha1.FeatureInfoR\x0elevel1Features\x12H\n" +
	...
	"\fchoose_count\x18\x03 \x01(\x05R\vchooseCount\"\x94\x02\n" +
...
var file_dnd5e_api_v1alpha1_character_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_dnd5e_api_v1alpha1_character_proto_msgTypes = make([]protoimpl.MessageInfo, 87)
var file_dnd5e_api_v1alpha1_character_proto_goTypes = []any{
	...
	(SpellSelectionType)(0),              // 3: dnd5e.api.v1alpha1.SpellSelectionType
	(*AbilityScores)(nil),                // 4: dnd5e.api.v1alpha1.AbilityScores
	(*Character)(nil),                    // 5: dnd5e.api.v1alpha1.Character
	(*AbilityModifiers)(nil),             // 6: dnd5e.api.v1alpha1.AbilityModifiers
	(*CombatStats)(nil),                  // 7: dnd5e.api.v1alpha1.CombatStats
	(*Proficiencies)(nil),                // 8: dnd5e.api.v1alpha1.Proficiencies
	(*CharacterMetadata)(nil),            // 9: dnd5e.api.v1alpha1.CharacterMetadata
	(*GetCharacterRequest)(nil),          // 10: dnd5e.api.v1alpha1.GetCharacterRequest
	(*GetCharacterResponse)(nil),         // 11: dnd5e.api.v1alpha1.GetCharacterResponse
	(*ListCharactersRequest)(nil),        // 12: dnd5e.api.v1alpha1.ListCharactersRequest
	(*ListCharactersResponse)(nil),       // 13: dnd5e.api.v1alpha1.ListCharactersResponse
	(*UpdateCharacterRequest)(nil),       // 14: dnd5e.api.v1alpha1.UpdateCharacterRequest
	(*UpdateCharacterResponse)(nil),      // 15: dnd5e.api.v1alpha1.UpdateCharacterResponse
	(*DeleteCharacterRequest)(nil),       // 16: dnd5e.api.v1alpha1.DeleteCharacterRequest
	(*DeleteCharacterResponse)(nil),      // 17: dnd5e.api.v1alpha1.DeleteCharacterResponse
	(*CharacterDraft)(nil),               // 18: dnd5e.api.v1alpha1.CharacterDraft
	(*CreationProgress)(nil),             // 19: dnd5e.api.v1alpha1.CreationProgress
	(*DraftMetadata)(nil),                // 20: dnd5e.api.v1alpha1.DraftMetadata
	(*CreateDraftRequest)(nil),           // 21: dnd5e.api.v1alpha1.CreateDraftRequest
	(*CreateDraftResponse)(nil),          // 22: dnd5e.api.v1alpha1.CreateDraftResponse
	(*GetDraftRequest)(nil),              // 23: dnd5e.api.v1alpha1.GetDraftRequest
	(*GetDraftResponse)(nil),             // 24: dnd5e.api.v1alpha1.GetDraftResponse
	(*UpdateDraftRequest)(nil),           // 25: dnd5e.api.v1alpha1.UpdateDraftRequest
	(*UpdateDraftResponse)(nil),          // 26: dnd5e.api.v1alpha1.UpdateDraftResponse
	(*UpdateNameRequest)(nil),            // 27: dnd5e.api.v1alpha1.UpdateNameRequest
	(*UpdateRaceRequest)(nil),            // 28: dnd5e.api.v1alpha1.UpdateRaceRequest
	(*UpdateClassRequest)(nil),           // 29: dnd5e.api.v1alpha1.UpdateClassRequest
	(*UpdateBackgroundRequest)(nil),      // 30: dnd5e.api.v1alpha1.UpdateBackgroundRequest
	(*UpdateAbilityScoresRequest)(nil),   // 31: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	(*UpdateSkillsRequest)(nil),          // 32: dnd5e.api.v1alpha1.UpdateSkillsRequest
	(*UpdateNameResponse)(nil),           // 33: dnd5e.api.v1alpha1.UpdateNameResponse
	(*UpdateRaceResponse)(nil),           // 34: dnd5e.api.v1alpha1.UpdateRaceResponse
	(*UpdateClassResponse)(nil),          // 35: dnd5e.api.v1alpha1.UpdateClassResponse
	(*UpdateBackgroundResponse)(nil),     // 36: dnd5e.api.v1alpha1.UpdateBackgroundResponse
	(*UpdateAbilityScoresResponse)(nil),  // 37: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	(*UpdateSkillsResponse)(nil),         // 38: dnd5e.api.v1alpha1.UpdateSkillsResponse
	(*ListDraftsRequest)(nil),            // 39: dnd5e.api.v1alpha1.ListDraftsRequest
	(*ListDraftsResponse)(nil),           // 40: dnd5e.api.v1alpha1.ListDraftsResponse
	(*ValidateDraftRequest)(nil),         // 41: dnd5e.api.v1alpha1.ValidateDraftRequest
	(*ValidateDraftResponse)(nil),        // 42: dnd5e.api.v1alpha1.ValidateDraftResponse
	(*FinalizeDraftRequest)(nil),         // 43: dnd5e.api.v1alpha1.FinalizeDraftRequest
	(*FinalizeDraftResponse)(nil),        // 44: dnd5e.api.v1alpha1.FinalizeDraftResponse
	(*DeleteDraftRequest)(nil),           // 45: dnd5e.api.v1alpha1.DeleteDraftRequest
	(*DeleteDraftResponse)(nil),          // 46: dnd5e.api.v1alpha1.DeleteDraftResponse
	(*RaceInfo)(nil),                     // 47: dnd5e.api.v1alpha1.RaceInfo
	(*SubraceInfo)(nil),                  // 48: dnd5e.api.v1alpha1.SubraceInfo
	(*RacialTrait)(nil),                  // 49: dnd5e.api.v1alpha1.RacialTrait
	(*Choice)(nil),                       // 50: dnd5e.api.v1alpha1.Choice
	(*ClassInfo)(nil),                    // 51: dnd5e.api.v1alpha1.ClassInfo
	(*EquipmentChoice)(nil),              // 52: dnd5e.api.v1alpha1.EquipmentChoice
	(*SpellcastingInfo)(nil),             // 53: dnd5e.api.v1alpha1.SpellcastingInfo
	(*BackgroundInfo)(nil),               // 54: dnd5e.api.v1alpha1.BackgroundInfo
	(*FeatureInfo)(nil),                  // 55: dnd5e.api.v1alpha1.FeatureInfo
	(*SpellSelectionInfo)(nil),           // 56: dnd5e.api.v1alpha1.SpellSelectionInfo
	(*ListRacesRequest)(nil),             // 57: dnd5e.api.v1alpha1.ListRacesRequest
	(*ListRacesResponse)(nil),            // 58: dnd5e.api.v1alpha1.ListRacesResponse
	(*ListClassesRequest)(nil),           // 59: dnd5e.api.v1alpha1.ListClassesRequest
	(*ListClassesResponse)(nil),          // 60: dnd5e.api.v1alpha1.ListClassesResponse
	(*ListBackgroundsRequest)(nil),       // 61: dnd5e.api.v1alpha1.ListBackgroundsRequest
	(*ListBackgroundsResponse)(nil),      // 62: dnd5e.api.v1alpha1.ListBackgroundsResponse
	(*GetRaceDetailsRequest)(nil),        // 63: dnd5e.api.v1alpha1.GetRaceDetailsRequest
	(*GetRaceDetailsResponse)(nil),       // 64: dnd5e.api.v1alpha1.GetRaceDetailsResponse
	(*GetClassDetailsRequest)(nil),       // 65: dnd5e.api.v1alpha1.GetClassDetailsRequest
	(*GetClassDetailsResponse)(nil),      // 66: dnd5e.api.v1alpha1.GetClassDetailsResponse
	(*GetBackgroundDetailsRequest)(nil),  // 67: dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	(*GetBackgroundDetailsResponse)(nil), // 68: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	(*GetFeatureRequest)(nil),            // 69: dnd5e.api.v1alpha1.GetFeatureRequest
	(*GetFeatureResponse)(nil),           // 70: dnd5e.api.v1alpha1.GetFeatureResponse
	(*RollAbilityScoresRequest)(nil),     // 71: dnd5e.api.v1alpha1.RollAbilityScoresRequest
	(*AbilityScoreRoll)(nil),             // 72: dnd5e.api.v1alpha1.AbilityScoreRoll
	(*RollAbilityScoresResponse)(nil),    // 73: dnd5e.api.v1alpha1.RollAbilityScoresResponse
	(*RollAssignments)(nil),              // 74: dnd5e.api.v1alpha1.RollAssignments
	(*Cost)(nil),                         // 75: dnd5e.api.v1alpha1.Cost
	(*Weight)(nil),                       // 76: dnd5e.api.v1alpha1.Weight
	(*Equipment)(nil),                    // 77: dnd5e.api.v1alpha1.Equipment
	(*WeaponData)(nil),                   // 78: dnd5e.api.v1alpha1.WeaponData
	(*ArmorData)(nil),                    // 79: dnd5e.api.v1alpha1.ArmorData
	(*GearData)(nil),                     // 80: dnd5e.api.v1alpha1.GearData
	(*Spell)(nil),                        // 81: dnd5e.api.v1alpha1.Spell
	(*SpellDamage)(nil),                  // 82: dnd5e.api.v1alpha1.SpellDamage
	(*DamageAtSlotLevel)(nil),            // 83: dnd5e.api.v1alpha1.DamageAtSlotLevel
	(*AreaOfEffect)(nil),                 // 84: dnd5e.api.v1alpha1.AreaOfEffect
	(*ListEquipmentByTypeRequest)(nil),   // 85: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	(*ListEquipmentByTypeResponse)(nil),  // 86: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	(*ListSpellsByLevelRequest)(nil),     // 87: dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	(*ListSpellsByLevelResponse)(nil),    // 88: dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	nil,                                  // 89: dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	nil,                                  // 90: dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	(Race)(0),                            // 91: dnd5e.api.v1alpha1.Race
	(Subrace)(0),                         // 92: dnd5e.api.v1alpha1.Subrace
	(Class)(0),                           // 93: dnd5e.api.v1alpha1.Class
	(Background)(0),                      // 94: dnd5e.api.v1alpha1.Background
	(Alignment)(0),                       // 95: dnd5e.api.v1alpha1.Alignment
	(Language)(0),                        // 96: dnd5e.api.v1alpha1.Language
	(Skill)(0),                           // 97: dnd5e.api.v1alpha1.Skill
	(Ability)(0),                         // 98: dnd5e.api.v1alpha1.Ability
	(*ValidationWarning)(nil),            // 99: dnd5e.api.v1alpha1.ValidationWarning
	(*ValidationError)(nil),              // 100: dnd5e.api.v1alpha1.ValidationError
	(EquipmentType)(0),                   // 101: dnd5e.api.v1alpha1.EquipmentType
}
var file_dnd5e_api_v1alpha1_character_proto_depIdxs = []int32{
	91,  // 0: dnd5e.api.v1alpha1.Character.race:type_name -> dnd5e.api.v1alpha1.Race
	92,  // 1: dnd5e.api.v1alpha1.Character.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	93,  // 2: dnd5e.api.v1alpha1.Character.class:type_name -> dnd5e.api.v1alpha1.Class
	94,  // 3: dnd5e.api.v1alpha1.Character.background:type_name -> dnd5e.api.v1alpha1.Background
	95,  // 4: dnd5e.api.v1alpha1.Character.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	4,   // 5: dnd5e.api.v1alpha1.Character.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	6,   // 6: dnd5e.api.v1alpha1.Character.ability_modifiers:type_name -> dnd5e.api.v1alpha1.AbilityModifiers
	7,   // 7: dnd5e.api.v1alpha1.Character.combat_stats:type_name -> dnd5e.api.v1alpha1.CombatStats
	8,   // 8: dnd5e.api.v1alpha1.Character.proficiencies:type_name -> dnd5e.api.v1alpha1.Proficiencies
	96,  // 9: dnd5e.api.v1alpha1.Character.languages:type_name -> dnd5e.api.v1alpha1.Language
	9,   // 10: dnd5e.api.v1alpha1.Character.metadata:type_name -> dnd5e.api.v1alpha1.CharacterMetadata
	97,  // 11: dnd5e.api.v1alpha1.Proficiencies.skills:type_name -> dnd5e.api.v1alpha1.Skill
	98,  // 12: dnd5e.api.v1alpha1.Proficiencies.saving_throws:type_name -> dnd5e.api.v1alpha1.Ability
	5,   // 13: dnd5e.api.v1alpha1.GetCharacterResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	5,   // 14: dnd5e.api.v1alpha1.ListCharactersResponse.characters:type_name -> dnd5e.api.v1alpha1.Character
	5,   // 15: dnd5e.api.v1alpha1.UpdateCharacterRequest.character:type_name -> dnd5e.api.v1alpha1.Character
	5,   // 16: dnd5e.api.v1alpha1.UpdateCharacterResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	91,  // 17: dnd5e.api.v1alpha1.CharacterDraft.race:type_name -> dnd5e.api.v1alpha1.Race
	92,  // 18: dnd5e.api.v1alpha1.CharacterDraft.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	93,  // 19: dnd5e.api.v1alpha1.CharacterDraft.class:type_name -> dnd5e.api.v1alpha1.Class
	94,  // 20: dnd5e.api.v1alpha1.CharacterDraft.background:type_name -> dnd5e.api.v1alpha1.Background
	4,   // 21: dnd5e.api.v1alpha1.CharacterDraft.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	95,  // 22: dnd5e.api.v1alpha1.CharacterDraft.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	97,  // 23: dnd5e.api.v1alpha1.CharacterDraft.starting_skills:type_name -> dnd5e.api.v1alpha1.Skill
	96,  // 24: dnd5e.api.v1alpha1.CharacterDraft.additional_languages:type_name -> dnd5e.api.v1alpha1.Language
	19,  // 25: dnd5e.api.v1alpha1.CharacterDraft.progress:type_name -> dnd5e.api.v1alpha1.CreationProgress
	20,  // 26: dnd5e.api.v1alpha1.CharacterDraft.metadata:type_name -> dnd5e.api.v1alpha1.DraftMetadata
	0,   // 27: dnd5e.api.v1alpha1.CreationProgress.current_step:type_name -> dnd5e.api.v1alpha1.CreationStep
	18,  // 28: dnd5e.api.v1alpha1.CreateDraftRequest.initial_data:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	18,  // 29: dnd5e.api.v1alpha1.CreateDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	18,  // 30: dnd5e.api.v1alpha1.GetDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	18,  // 31: dnd5e.api.v1alpha1.UpdateDraftRequest.updates:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	18,  // 32: dnd5e.api.v1alpha1.UpdateDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	99,  // 33: dnd5e.api.v1alpha1.UpdateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	91,  // 34: dnd5e.api.v1alpha1.UpdateRaceRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	92,  // 35: dnd5e.api.v1alpha1.UpdateRaceRequest.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	93,  // 36: dnd5e.api.v1alpha1.UpdateClassRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	94,  // 37: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background:type_name -> dnd5e.api.v1alpha1.Background
	4,   // 38: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	74,  // 39: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.roll_assignments:type_name -> dnd5e.api.v1alpha1.RollAssignments
	97,  // 40: dnd5e.api.v1alpha1.UpdateSkillsRequest.skills:type_name -> dnd5e.api.v1alpha1.Skill
	18,  // 41: dnd5e.api.v1alpha1.UpdateNameResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	99,  // 42: dnd5e.api.v1alpha1.UpdateNameResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	18,  // 43: dnd5e.api.v1alpha1.UpdateRaceResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	99,  // 44: dnd5e.api.v1alpha1.UpdateRaceResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	18,  // 45: dnd5e.api.v1alpha1.UpdateClassResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	99,  // 46: dnd5e.api.v1alpha1.UpdateClassResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	18,  // 47: dnd5e.api.v1alpha1.UpdateBackgroundResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	99,  // 48: dnd5e.api.v1alpha1.UpdateBackgroundResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	18,  // 49: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	99,  // 50: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	18,  // 51: dnd5e.api.v1alpha1.UpdateSkillsResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	99,  // 52: dnd5e.api.v1alpha1.UpdateSkillsResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	18,  // 53: dnd5e.api.v1alpha1.ListDraftsResponse.drafts:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	100, // 54: dnd5e.api.v1alpha1.ValidateDraftResponse.errors:type_name -> dnd5e.api.v1alpha1.ValidationError
	99,  // 55: dnd5e.api.v1alpha1.ValidateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	0,   // 56: dnd5e.api.v1alpha1.ValidateDraftResponse.missing_steps:type_name -> dnd5e.api.v1alpha1.CreationStep
	5,   // 57: dnd5e.api.v1alpha1.FinalizeDraftResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	2,   // 58: dnd5e.api.v1alpha1.RaceInfo.size:type_name -> dnd5e.api.v1alpha1.Size
	89,  // 59: dnd5e.api.v1alpha1.RaceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	49,  // 60: dnd5e.api.v1alpha1.RaceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	48,  // 61: dnd5e.api.v1alpha1.RaceInfo.subraces:type_name -> dnd5e.api.v1alpha1.SubraceInfo
	96,  // 62: dnd5e.api.v1alpha1.RaceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	50,  // 63: dnd5e.api.v1alpha1.RaceInfo.language_options:type_name -> dnd5e.api.v1alpha1.Choice
	50,  // 64: dnd5e.api.v1alpha1.RaceInfo.proficiency_options:type_name -> dnd5e.api.v1alpha1.Choice
	90,  // 65: dnd5e.api.v1alpha1.SubraceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	49,  // 66: dnd5e.api.v1alpha1.SubraceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	96,  // 67: dnd5e.api.v1alpha1.SubraceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	52,  // 68: dnd5e.api.v1alpha1.ClassInfo.equipment_choices:type_name -> dnd5e.api.v1alpha1.EquipmentChoice
	55,  // 69: dnd5e.api.v1alpha1.ClassInfo.level_1_features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	53,  // 70: dnd5e.api.v1alpha1.ClassInfo.spellcasting:type_name -> dnd5e.api.v1alpha1.SpellcastingInfo
	50,  // 71: dnd5e.api.v1alpha1.ClassInfo.proficiency_choices:type_name -> dnd5e.api.v1alpha1.Choice
	96,  // 72: dnd5e.api.v1alpha1.BackgroundInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	50,  // 73: dnd5e.api.v1alpha1.FeatureInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	56,  // 74: dnd5e.api.v1alpha1.FeatureInfo.spell_selection:type_name -> dnd5e.api.v1alpha1.SpellSelectionInfo
	3,   // 75: dnd5e.api.v1alpha1.SpellSelectionInfo.selection_type:type_name -> dnd5e.api.v1alpha1.SpellSelectionType
	47,  // 76: dnd5e.api.v1alpha1.ListRacesResponse.races:type_name -> dnd5e.api.v1alpha1.RaceInfo
	51,  // 77: dnd5e.api.v1alpha1.ListClassesResponse.classes:type_name -> dnd5e.api.v1alpha1.ClassInfo
	54,  // 78: dnd5e.api.v1alpha1.ListBackgroundsResponse.backgrounds:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	47,  // 79: dnd5e.api.v1alpha1.GetRaceDetailsResponse.race:type_name -> dnd5e.api.v1alpha1.RaceInfo
	51,  // 80: dnd5e.api.v1alpha1.GetClassDetailsResponse.class:type_name -> dnd5e.api.v1alpha1.ClassInfo
	54,  // 81: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse.background:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	55,  // 82: dnd5e.api.v1alpha1.GetFeatureResponse.feature:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	72,  // 83: dnd5e.api.v1alpha1.RollAbilityScoresResponse.rolls:type_name -> dnd5e.api.v1alpha1.AbilityScoreRoll
	75,  // 84: dnd5e.api.v1alpha1.Equipment.cost:type_name -> dnd5e.api.v1alpha1.Cost
	76,  // 85: dnd5e.api.v1alpha1.Equipment.weight:type_name -> dnd5e.api.v1alpha1.Weight
	78,  // 86: dnd5e.api.v1alpha1.Equipment.weapon_data:type_name -> dnd5e.api.v1alpha1.WeaponData
	79,  // 87: dnd5e.api.v1alpha1.Equipment.armor_data:type_name -> dnd5e.api.v1alpha1.ArmorData
	80,  // 88: dnd5e.api.v1alpha1.Equipment.gear_data:type_name -> dnd5e.api.v1alpha1.GearData
	82,  // 89: dnd5e.api.v1alpha1.Spell.damage:type_name -> dnd5e.api.v1alpha1.SpellDamage
	84,  // 90: dnd5e.api.v1alpha1.Spell.area_of_effect:type_name -> dnd5e.api.v1alpha1.AreaOfEffect
	83,  // 91: dnd5e.api.v1alpha1.SpellDamage.damage_at_slot_level:type_name -> dnd5e.api.v1alpha1.DamageAtSlotLevel
	101, // 92: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest.equipment_type:type_name -> dnd5e.api.v1alpha1.EquipmentType
	77,  // 93: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	93,  // 94: dnd5e.api.v1alpha1.ListSpellsByLevelRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	81,  // 95: dnd5e.api.v1alpha1.ListSpellsByLevelResponse.spells:type_name -> dnd5e.api.v1alpha1.Spell
	21,  // 96: dnd5e.api.v1alpha1.CharacterService.CreateDraft:input_type -> dnd5e.api.v1alpha1.CreateDraftRequest
	23,  // 97: dnd5e.api.v1alpha1.CharacterService.GetDraft:input_type -> dnd5e.api.v1alpha1.GetDraftRequest
	39,  // 98: dnd5e.api.v1alpha1.CharacterService.ListDrafts:input_type -> dnd5e.api.v1alpha1.ListDraftsRequest
	45,  // 99: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:input_type -> dnd5e.api.v1alpha1.DeleteDraftRequest
	27,  // 100: dnd5e.api.v1alpha1.CharacterService.UpdateName:input_type -> dnd5e.api.v1alpha1.UpdateNameRequest
	28,  // 101: dnd5e.api.v1alpha1.CharacterService.UpdateRace:input_type -> dnd5e.api.v1alpha1.UpdateRaceRequest
	29,  // 102: dnd5e.api.v1alpha1.CharacterService.UpdateClass:input_type -> dnd5e.api.v1alpha1.UpdateClassRequest
	30,  // 103: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:input_type -> dnd5e.api.v1alpha1.UpdateBackgroundRequest
	31,  // 104: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:input_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	32,  // 105: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:input_type -> dnd5e.api.v1alpha1.UpdateSkillsRequest
	41,  // 106: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:input_type -> dnd5e.api.v1alpha1.ValidateDraftRequest
	43,  // 107: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:input_type -> dnd5e.api.v1alpha1.FinalizeDraftRequest
	10,  // 108: dnd5e.api.v1alpha1.CharacterService.GetCharacter:input_type -> dnd5e.api.v1alpha1.GetCharacterRequest
	12,  // 109: dnd5e.api.v1alpha1.CharacterService.ListCharacters:input_type -> dnd5e.api.v1alpha1.ListCharactersRequest
	16,  // 110: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:input_type -> dnd5e.api.v1alpha1.DeleteCharacterRequest
	57,  // 111: dnd5e.api.v1alpha1.CharacterService.ListRaces:input_type -> dnd5e.api.v1alpha1.ListRacesRequest
	59,  // 112: dnd5e.api.v1alpha1.CharacterService.ListClasses:input_type -> dnd5e.api.v1alpha1.ListClassesRequest
	61,  // 113: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:input_type -> dnd5e.api.v1alpha1.ListBackgroundsRequest
	63,  // 114: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:input_type -> dnd5e.api.v1alpha1.GetRaceDetailsRequest
	65,  // 115: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:input_type -> dnd5e.api.v1alpha1.GetClassDetailsRequest
	67,  // 116: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:input_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	69,  // 117: dnd5e.api.v1alpha1.CharacterService.GetFeature:input_type -> dnd5e.api.v1alpha1.GetFeatureRequest
	71,  // 118: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:input_type -> dnd5e.api.v1alpha1.RollAbilityScoresRequest
	85,  // 119: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:input_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	87,  // 120: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:input_type -> dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	22,  // 121: dnd5e.api.v1alpha1.CharacterService.CreateDraft:output_type -> dnd5e.api.v1alpha1.CreateDraftResponse
	24,  // 122: dnd5e.api.v1alpha1.CharacterService.GetDraft:output_type -> dnd5e.api.v1alpha1.GetDraftResponse
	40,  // 123: dnd5e.api.v1alpha1.CharacterService.ListDrafts:output_type -> dnd5e.api.v1alpha1.ListDraftsResponse
	46,  // 124: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:output_type -> dnd5e.api.v1alpha1.DeleteDraftResponse
	33,  // 125: dnd5e.api.v1alpha1.CharacterService.UpdateName:output_type -> dnd5e.api.v1alpha1.UpdateNameResponse
	34,  // 126: dnd5e.api.v1alpha1.CharacterService.UpdateRace:output_type -> dnd5e.api.v1alpha1.UpdateRaceResponse
	35,  // 127: dnd5e.api.v1alpha1.CharacterService.UpdateClass:output_type -> dnd5e.api.v1alpha1.UpdateClassResponse
	36,  // 128: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:output_type -> dnd5e.api.v1alpha1.UpdateBackgroundResponse
	37,  // 129: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:output_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	38,  // 130: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:output_type -> dnd5e.api.v1alpha1.UpdateSkillsResponse
	42,  // 131: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:output_type -> dnd5e.api.v1alpha1.ValidateDraftResponse
	44,  // 132: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:output_type -> dnd5e.api.v1alpha1.FinalizeDraftResponse
	11,  // 133: dnd5e.api.v1alpha1.CharacterService.GetCharacter:output_type -> dnd5e.api.v1alpha1.GetCharacterResponse
	13,  // 134: dnd5e.api.v1alpha1.CharacterService.ListCharacters:output_type -> dnd5e.api.v1alpha1.ListCharactersResponse
	17,  // 135: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:output_type -> dnd5e.api.v1alpha1.DeleteCharacterResponse
	58,  // 136: dnd5e.api.v1alpha1.CharacterService.ListRaces:output_type -> dnd5e.api.v1alpha1.ListRacesResponse
	60,  // 137: dnd5e.api.v1alpha1.CharacterService.ListClasses:output_type -> dnd5e.api.v1alpha1.ListClassesResponse
	62,  // 138: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:output_type -> dnd5e.api.v1alpha1.ListBackgroundsResponse
	64,  // 139: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:output_type -> dnd5e.api.v1alpha1.GetRaceDetailsResponse
	66,  // 140: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:output_type -> dnd5e.api.v1alpha1.GetClassDetailsResponse
	68,  // 141: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:output_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	70,  // 142: dnd5e.api.v1alpha1.CharacterService.GetFeature:output_type -> dnd5e.api.v1alpha1.GetFeatureResponse
	73,  // 143: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:output_type -> dnd5e.api.v1alpha1.RollAbilityScoresResponse
	86,  // 144: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:output_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	88,  // 145: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:output_type -> dnd5e.api.v1alpha1.ListSpellsByLevelResponse
...
func file_dnd5e_api_v1alpha1_character_proto_init() {
	...
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[73].OneofWrappers = []any{
