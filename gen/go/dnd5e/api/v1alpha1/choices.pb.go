...
const file_dnd5e_api_v1alpha1_choices_proto_rawDesc = "" +
	...
	"\tavailable\x18\x01 \x03(\x0e2!.dnd5e.api.v1alpha1.FightingStyleR\tavailable\"\xe2\x01\n" +
	"\fSpellOptions\x12;\n" +
	...
	"\x0eavailable_refs\x18\x04 \x03(\tR\ravailableRefs\"\x9b\x01\n" +
...
var file_dnd5e_api_v1alpha1_choices_proto_goTypes = []any{
	...
	(*Equipment)(nil),               // 30: dnd5e.api.v1alpha1.Equipment
	(WeaponCategory)(0),             // 31: dnd5e.api.v1alpha1.WeaponCategory
	(ArmorCategory)(0),              // 32: dnd5e.api.v1alpha1.ArmorCategory
	(ToolCategory)(0),               // 33: dnd5e.api.v1alpha1.ToolCategory
	(Language)(0),                   // 34: dnd5e.api.v1alpha1.Language
	(FightingStyle)(0),              // 35: dnd5e.api.v1alpha1.FightingStyle
	(Spell)(0),                      // 36: dnd5e.api.v1alpha1.Spell
	(*AbilityScores)(nil),           // 37: dnd5e.api.v1alpha1.AbilityScores
	(Background)(0),                 // 38: dnd5e.api.v1alpha1.Background
}
var file_dnd5e_api_v1alpha1_choices_proto_depIdxs = []int32{
	...
	30, // 17: dnd5e.api.v1alpha1.EquipmentItem.equipment_detail:type_name -> dnd5e.api.v1alpha1.Equipment
	31, // 18: dnd5e.api.v1alpha1.EquipmentCategoryChoice.weapon_categories:type_name -> dnd5e.api.v1alpha1.WeaponCategory
	32, // 19: dnd5e.api.v1alpha1.EquipmentCategoryChoice.armor_categories:type_name -> dnd5e.api.v1alpha1.ArmorCategory
	33, // 20: dnd5e.api.v1alpha1.EquipmentCategoryChoice.tool_categories:type_name -> dnd5e.api.v1alpha1.ToolCategory
	7,  // 21: dnd5e.api.v1alpha1.EquipmentCategoryChoice.options:type_name -> dnd5e.api.v1alpha1.EquipmentItem
	34, // 22: dnd5e.api.v1alpha1.LanguageOptions.available:type_name -> dnd5e.api.v1alpha1.Language
	27, // 23: dnd5e.api.v1alpha1.ToolOptions.available:type_name -> dnd5e.api.v1alpha1.Tool
	35, // 24: dnd5e.api.v1alpha1.FightingStyleOptions.available:type_name -> dnd5e.api.v1alpha1.FightingStyle
	36, // 25: dnd5e.api.v1alpha1.SpellOptions.available:type_name -> dnd5e.api.v1alpha1.Spell
	0,  // 26: dnd5e.api.v1alpha1.SpellOptions.selection_type:type_name -> dnd5e.api.v1alpha1.SpellSelectionType
	24, // 27: dnd5e.api.v1alpha1.ExpertiseOptions.available_skills:type_name -> dnd5e.api.v1alpha1.Skill
	27, // 28: dnd5e.api.v1alpha1.ExpertiseOptions.available_tools:type_name -> dnd5e.api.v1alpha1.Tool
	2,  // 29: dnd5e.api.v1alpha1.ChoiceSubmission.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	1,  // 30: dnd5e.api.v1alpha1.ChoiceSubmission.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	15, // 31: dnd5e.api.v1alpha1.ChoiceSubmission.skills:type_name -> dnd5e.api.v1alpha1.SkillSelection
	16, // 32: dnd5e.api.v1alpha1.ChoiceSubmission.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	18, // 33: dnd5e.api.v1alpha1.ChoiceSubmission.languages:type_name -> dnd5e.api.v1alpha1.LanguageSelection
	19, // 34: dnd5e.api.v1alpha1.ChoiceSubmission.tools:type_name -> dnd5e.api.v1alpha1.ToolSelection
	20, // 35: dnd5e.api.v1alpha1.ChoiceSubmission.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyleSelection
	21, // 36: dnd5e.api.v1alpha1.ChoiceSubmission.spells:type_name -> dnd5e.api.v1alpha1.SpellSelection
	22, // 37: dnd5e.api.v1alpha1.ChoiceSubmission.expertise:type_name -> dnd5e.api.v1alpha1.ExpertiseSelection
	24, // 38: dnd5e.api.v1alpha1.SkillSelection.skills:type_name -> dnd5e.api.v1alpha1.Skill
	17, // 39: dnd5e.api.v1alpha1.EquipmentSelection.items:type_name -> dnd5e.api.v1alpha1.EquipmentSelectionItem
	25, // 40: dnd5e.api.v1alpha1.EquipmentSelectionItem.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	26, // 41: dnd5e.api.v1alpha1.EquipmentSelectionItem.armor:type_name -> dnd5e.api.v1alpha1.Armor
	27, // 42: dnd5e.api.v1alpha1.EquipmentSelectionItem.tool:type_name -> dnd5e.api.v1alpha1.Tool
	28, // 43: dnd5e.api.v1alpha1.EquipmentSelectionItem.pack:type_name -> dnd5e.api.v1alpha1.Pack
	29, // 44: dnd5e.api.v1alpha1.EquipmentSelectionItem.ammunition:type_name -> dnd5e.api.v1alpha1.Ammunition
	34, // 45: dnd5e.api.v1alpha1.LanguageSelection.languages:type_name -> dnd5e.api.v1alpha1.Language
	27, // 46: dnd5e.api.v1alpha1.ToolSelection.tools:type_name -> dnd5e.api.v1alpha1.Tool
	35, // 47: dnd5e.api.v1alpha1.FightingStyleSelection.style:type_name -> dnd5e.api.v1alpha1.FightingStyle
	36, // 48: dnd5e.api.v1alpha1.SpellSelection.spells:type_name -> dnd5e.api.v1alpha1.Spell
	24, // 49: dnd5e.api.v1alpha1.ExpertiseSelection.skills:type_name -> dnd5e.api.v1alpha1.Skill
	27, // 50: dnd5e.api.v1alpha1.ExpertiseSelection.tools:type_name -> dnd5e.api.v1alpha1.Tool
	2,  // 51: dnd5e.api.v1alpha1.ChoiceData.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	1,  // 52: dnd5e.api.v1alpha1.ChoiceData.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	15, // 53: dnd5e.api.v1alpha1.ChoiceData.skills:type_name -> dnd5e.api.v1alpha1.SkillSelection
	18, // 54: dnd5e.api.v1alpha1.ChoiceData.languages:type_name -> dnd5e.api.v1alpha1.LanguageSelection
	37, // 55: dnd5e.api.v1alpha1.ChoiceData.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	20, // 56: dnd5e.api.v1alpha1.ChoiceData.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyleSelection
	16, // 57: dnd5e.api.v1alpha1.ChoiceData.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	38, // 58: dnd5e.api.v1alpha1.ChoiceData.background:type_name -> dnd5e.api.v1alpha1.Background
	21, // 59: dnd5e.api.v1alpha1.ChoiceData.spells:type_name -> dnd5e.api.v1alpha1.SpellSelection
	19, // 60: dnd5e.api.v1alpha1.ChoiceData.tools:type_name -> dnd5e.api.v1alpha1.ToolSelection
	22, // 61: dnd5e.api.v1alpha1.ChoiceData.expertise:type_name -> dnd5e.api.v1alpha1.ExpertiseSelection
