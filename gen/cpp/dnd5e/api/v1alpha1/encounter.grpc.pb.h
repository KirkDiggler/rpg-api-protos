...
class EncounterService final {
 public:
  ...
  typedef WithAsyncMethod_DungeonStart<WithAsyncMethod_GetCombatState<WithAsyncMethod_MoveCharacter<WithAsyncMethod_EndTurn<WithAsyncMethod_Attack<WithAsyncMethod_ActivateFeature<Service > > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_DungeonStart<WithCallbackMethod_GetCombatState<WithCallbackMethod_MoveCharacter<WithCallbackMethod_EndTurn<WithCallbackMethod_Attack<WithCallbackMethod_ActivateFeature<Service > > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_DungeonStart<WithStreamedUnaryMethod_GetCombatState<WithStreamedUnaryMethod_MoveCharacter<WithStreamedUnaryMethod_EndTurn<WithStreamedUnaryMethod_Attack<WithStreamedUnaryMethod_ActivateFeature<Service > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_DungeonStart<WithStreamedUnaryMethod_GetCombatState<WithStreamedUnaryMethod_MoveCharacter<WithStreamedUnaryMethod_EndTurn<WithStreamedUnaryMethod_Attack<WithStreamedUnaryMethod_ActivateFeature<Service > > > > > > StreamedService;
};
