...
const file_dnd5e_api_v1alpha1_character_proto_rawDesc = "" +
	...
	"\x13spell_slots_level_1\x18\x06 \x01(\x05R\x10spellSlotsLevel1\"\xa8\x06\n" +
...
var file_dnd5e_api_v1alpha1_character_proto_goTypes = []any{
	...
	(EquipmentCategory)(0),                // 172: dnd5e.api.v1alpha1.EquipmentCategory
	(WeaponCategory)(0),                   // 173: dnd5e.api.v1alpha1.WeaponCategory
	(DamageType)(0),                       // 174: dnd5e.api.v1alpha1.DamageType
	(ArmorCategory)(0),                    // 175: dnd5e.api.v1alpha1.ArmorCategory
	(GearCategory)(0),                     // 176: dnd5e.api.v1alpha1.GearCategory
	(Spell)(0),                            // 177: dnd5e.api.v1alpha1.Spell
	(Trait)(0),                            // 178: dnd5e.api.v1alpha1.Trait
	(Pack)(0),                             // 179: dnd5e.api.v1alpha1.Pack
	(Ammunition)(0),                       // 180: dnd5e.api.v1alpha1.Ammunition
	(EquipmentType)(0),                    // 181: dnd5e.api.v1alpha1.EquipmentType
}
var file_dnd5e_api_v1alpha1_character_proto_depIdxs = []int32{
	...
	70,  // 119: dnd5e.api.v1alpha1.ItemBundle.items:type_name -> dnd5e.api.v1alpha1.BundleItem
	68,  // 120: dnd5e.api.v1alpha1.BundleItem.concrete_item:type_name -> dnd5e.api.v1alpha1.CountedItemReference
	71,  // 121: dnd5e.api.v1alpha1.BundleItem.choice_item:type_name -> dnd5e.api.v1alpha1.NestedChoice
	63,  // 122: dnd5e.api.v1alpha1.NestedChoice.choice:type_name -> dnd5e.api.v1alpha1.Choice
	158, // 123: dnd5e.api.v1alpha1.ClassInfo.class_id:type_name -> dnd5e.api.v1alpha1.Class
	167, // 124: dnd5e.api.v1alpha1.ClassInfo.primary_ability:type_name -> dnd5e.api.v1alpha1.Ability
	163, // 125: dnd5e.api.v1alpha1.ClassInfo.armor_proficiencies:type_name -> dnd5e.api.v1alpha1.Armor
	164, // 126: dnd5e.api.v1alpha1.ClassInfo.weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.Weapon
	165, // 127: dnd5e.api.v1alpha1.ClassInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	167, // 128: dnd5e.api.v1alpha1.ClassInfo.saving_throw_proficiencies:type_name -> dnd5e.api.v1alpha1.Ability
	166, // 129: dnd5e.api.v1alpha1.ClassInfo.available_skills:type_name -> dnd5e.api.v1alpha1.Skill
	63,  // 130: dnd5e.api.v1alpha1.ClassInfo.equipment_choices:type_name -> dnd5e.api.v1alpha1.Choice
	76,  // 131: dnd5e.api.v1alpha1.ClassInfo.level_1_features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	74,  // 132: dnd5e.api.v1alpha1.ClassInfo.spellcasting:type_name -> dnd5e.api.v1alpha1.SpellcastingInfo
	63,  // 133: dnd5e.api.v1alpha1.ClassInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	73,  // 134: dnd5e.api.v1alpha1.ClassInfo.subclasses:type_name -> dnd5e.api.v1alpha1.SubclassInfo
	168, // 135: dnd5e.api.v1alpha1.SubclassInfo.subclass_id:type_name -> dnd5e.api.v1alpha1.Subclass
	163, // 136: dnd5e.api.v1alpha1.SubclassInfo.armor_proficiencies:type_name -> dnd5e.api.v1alpha1.Armor
	164, // 137: dnd5e.api.v1alpha1.SubclassInfo.weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.Weapon
	165, // 138: dnd5e.api.v1alpha1.SubclassInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	63,  // 139: dnd5e.api.v1alpha1.SubclassInfo.additional_choices:type_name -> dnd5e.api.v1alpha1.Choice
	76,  // 140: dnd5e.api.v1alpha1.SubclassInfo.features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	159, // 141: dnd5e.api.v1alpha1.BackgroundInfo.background_id:type_name -> dnd5e.api.v1alpha1.Background
	166, // 142: dnd5e.api.v1alpha1.BackgroundInfo.skill_proficiencies:type_name -> dnd5e.api.v1alpha1.Skill
	165, // 143: dnd5e.api.v1alpha1.BackgroundInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	161, // 144: dnd5e.api.v1alpha1.BackgroundInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	63,  // 145: dnd5e.api.v1alpha1.FeatureInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	77,  // 146: dnd5e.api.v1alpha1.FeatureInfo.spell_selection:type_name -> dnd5e.api.v1alpha1.SpellSelectionInfo
	6,   // 147: dnd5e.api.v1alpha1.SpellSelectionInfo.selection_type:type_name -> dnd5e.api.v1alpha1.SpellSelectionType
	60,  // 148: dnd5e.api.v1alpha1.ListRacesResponse.races:type_name -> dnd5e.api.v1alpha1.RaceInfo
	72,  // 149: dnd5e.api.v1alpha1.ListClassesResponse.classes:type_name -> dnd5e.api.v1alpha1.ClassInfo
	75,  // 150: dnd5e.api.v1alpha1.ListBackgroundsResponse.backgrounds:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	60,  // 151: dnd5e.api.v1alpha1.GetRaceDetailsResponse.race:type_name -> dnd5e.api.v1alpha1.RaceInfo
	72,  // 152: dnd5e.api.v1alpha1.GetClassDetailsResponse.class:type_name -> dnd5e.api.v1alpha1.ClassInfo
	75,  // 153: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse.background:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	76,  // 154: dnd5e.api.v1alpha1.GetFeatureResponse.feature:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	93,  // 155: dnd5e.api.v1alpha1.RollAbilityScoresResponse.rolls:type_name -> dnd5e.api.v1alpha1.AbilityScoreRoll
	158, // 156: dnd5e.api.v1alpha1.GetRequirementsRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	156, // 157: dnd5e.api.v1alpha1.GetRequirementsRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	130, // 158: dnd5e.api.v1alpha1.GetRequirementsResponse.requirements:type_name -> dnd5e.api.v1alpha1.CharacterRequirements
	123, // 159: dnd5e.api.v1alpha1.SubmitChoicesRequest.submissions:type_name -> dnd5e.api.v1alpha1.ChoiceSubmission
	31,  // 160: dnd5e.api.v1alpha1.SubmitChoicesResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	169, // 161: dnd5e.api.v1alpha1.SubmitChoicesResponse.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	130, // 162: dnd5e.api.v1alpha1.SubmitChoicesResponse.remaining_requirements:type_name -> dnd5e.api.v1alpha1.CharacterRequirements
	172, // 163: dnd5e.api.v1alpha1.Equipment.category:type_name -> dnd5e.api.v1alpha1.EquipmentCategory
	100, // 164: dnd5e.api.v1alpha1.Equipment.cost:type_name -> dnd5e.api.v1alpha1.Cost
	101, // 165: dnd5e.api.v1alpha1.Equipment.weight:type_name -> dnd5e.api.v1alpha1.Weight
	103, // 166: dnd5e.api.v1alpha1.Equipment.weapon_data:type_name -> dnd5e.api.v1alpha1.WeaponData
	104, // 167: dnd5e.api.v1alpha1.Equipment.armor_data:type_name -> dnd5e.api.v1alpha1.ArmorData
	105, // 168: dnd5e.api.v1alpha1.Equipment.gear_data:type_name -> dnd5e.api.v1alpha1.GearData
	173, // 169: dnd5e.api.v1alpha1.WeaponData.weapon_category:type_name -> dnd5e.api.v1alpha1.WeaponCategory
	174, // 170: dnd5e.api.v1alpha1.WeaponData.damage_type:type_name -> dnd5e.api.v1alpha1.DamageType
	175, // 171: dnd5e.api.v1alpha1.ArmorData.armor_category:type_name -> dnd5e.api.v1alpha1.ArmorCategory
	176, // 172: dnd5e.api.v1alpha1.GearData.gear_category:type_name -> dnd5e.api.v1alpha1.GearCategory
	107, // 173: dnd5e.api.v1alpha1.EquipmentSlots.main_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 174: dnd5e.api.v1alpha1.EquipmentSlots.off_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 175: dnd5e.api.v1alpha1.EquipmentSlots.armor:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 176: dnd5e.api.v1alpha1.EquipmentSlots.helmet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 177: dnd5e.api.v1alpha1.EquipmentSlots.boots:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 178: dnd5e.api.v1alpha1.EquipmentSlots.gloves:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 179: dnd5e.api.v1alpha1.EquipmentSlots.cloak:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 180: dnd5e.api.v1alpha1.EquipmentSlots.amulet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 181: dnd5e.api.v1alpha1.EquipmentSlots.ring_1:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 182: dnd5e.api.v1alpha1.EquipmentSlots.ring_2:type_name -> dnd5e.api.v1alpha1.InventoryItem
	107, // 183: dnd5e.api.v1alpha1.EquipmentSlots.belt:type_name -> dnd5e.api.v1alpha1.InventoryItem
	102, // 184: dnd5e.api.v1alpha1.InventoryItem.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	7,   // 185: dnd5e.api.v1alpha1.EncumbranceInfo.level:type_name -> dnd5e.api.v1alpha1.EncumbranceLevel
	4,   // 186: dnd5e.api.v1alpha1.ChoiceData.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 187: dnd5e.api.v1alpha1.ChoiceData.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	110, // 188: dnd5e.api.v1alpha1.ChoiceData.skills:type_name -> dnd5e.api.v1alpha1.SkillList
	111, // 189: dnd5e.api.v1alpha1.ChoiceData.languages:type_name -> dnd5e.api.v1alpha1.LanguageList
	13,  // 190: dnd5e.api.v1alpha1.ChoiceData.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	162, // 191: dnd5e.api.v1alpha1.ChoiceData.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyle
	112, // 192: dnd5e.api.v1alpha1.ChoiceData.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentList
	118, // 193: dnd5e.api.v1alpha1.ChoiceData.race:type_name -> dnd5e.api.v1alpha1.RaceChoice
	119, // 194: dnd5e.api.v1alpha1.ChoiceData.class:type_name -> dnd5e.api.v1alpha1.ClassChoice
	159, // 195: dnd5e.api.v1alpha1.ChoiceData.background:type_name -> dnd5e.api.v1alpha1.Background
	113, // 196: dnd5e.api.v1alpha1.ChoiceData.spells:type_name -> dnd5e.api.v1alpha1.SpellList
	114, // 197: dnd5e.api.v1alpha1.ChoiceData.cantrips:type_name -> dnd5e.api.v1alpha1.CantripList
	115, // 198: dnd5e.api.v1alpha1.ChoiceData.expertise:type_name -> dnd5e.api.v1alpha1.ExpertiseList
	116, // 199: dnd5e.api.v1alpha1.ChoiceData.traits:type_name -> dnd5e.api.v1alpha1.TraitList
	117, // 200: dnd5e.api.v1alpha1.ChoiceData.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.ToolProficiencyList
	166, // 201: dnd5e.api.v1alpha1.SkillList.skills:type_name -> dnd5e.api.v1alpha1.Skill
	161, // 202: dnd5e.api.v1alpha1.LanguageList.languages:type_name -> dnd5e.api.v1alpha1.Language
	122, // 203: dnd5e.api.v1alpha1.EquipmentList.items:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	177, // 204: dnd5e.api.v1alpha1.SpellList.spells:type_name -> dnd5e.api.v1alpha1.Spell
	177, // 205: dnd5e.api.v1alpha1.CantripList.cantrips:type_name -> dnd5e.api.v1alpha1.Spell
	166, // 206: dnd5e.api.v1alpha1.ExpertiseList.skills:type_name -> dnd5e.api.v1alpha1.Skill
	178, // 207: dnd5e.api.v1alpha1.TraitList.traits:type_name -> dnd5e.api.v1alpha1.Trait
	165, // 208: dnd5e.api.v1alpha1.ToolProficiencyList.tools:type_name -> dnd5e.api.v1alpha1.Tool
	156, // 209: dnd5e.api.v1alpha1.RaceChoice.race:type_name -> dnd5e.api.v1alpha1.Race
	157, // 210: dnd5e.api.v1alpha1.RaceChoice.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	158, // 211: dnd5e.api.v1alpha1.ClassChoice.class:type_name -> dnd5e.api.v1alpha1.Class
	121, // 212: dnd5e.api.v1alpha1.EquipmentChoice.options:type_name -> dnd5e.api.v1alpha1.EquipmentOption
	122, // 213: dnd5e.api.v1alpha1.EquipmentOption.items:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	164, // 214: dnd5e.api.v1alpha1.EquipmentSelection.weapon:type_name -> dnd5e.api.v1alpha1.Weapon
	163, // 215: dnd5e.api.v1alpha1.EquipmentSelection.armor:type_name -> dnd5e.api.v1alpha1.Armor
	165, // 216: dnd5e.api.v1alpha1.EquipmentSelection.tool:type_name -> dnd5e.api.v1alpha1.Tool
	179, // 217: dnd5e.api.v1alpha1.EquipmentSelection.pack:type_name -> dnd5e.api.v1alpha1.Pack
	180, // 218: dnd5e.api.v1alpha1.EquipmentSelection.ammunition:type_name -> dnd5e.api.v1alpha1.Ammunition
	4,   // 219: dnd5e.api.v1alpha1.ChoiceSubmission.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 220: dnd5e.api.v1alpha1.ChoiceSubmission.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	124, // 221: dnd5e.api.v1alpha1.ChoiceSubmission.skills:type_name -> dnd5e.api.v1alpha1.SkillSelection
	125, // 222: dnd5e.api.v1alpha1.ChoiceSubmission.languages:type_name -> dnd5e.api.v1alpha1.LanguageSelection
	122, // 223: dnd5e.api.v1alpha1.ChoiceSubmission.equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	126, // 224: dnd5e.api.v1alpha1.ChoiceSubmission.fighting_style:type_name -> dnd5e.api.v1alpha1.FightingStyleSelection
	127, // 225: dnd5e.api.v1alpha1.ChoiceSubmission.tools:type_name -> dnd5e.api.v1alpha1.ToolSelection
	128, // 226: dnd5e.api.v1alpha1.ChoiceSubmission.weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.WeaponProficiencySelection
	129, // 227: dnd5e.api.v1alpha1.ChoiceSubmission.armor_proficiencies:type_name -> dnd5e.api.v1alpha1.ArmorProficiencySelection
	166, // 228: dnd5e.api.v1alpha1.SkillSelection.skills:type_name -> dnd5e.api.v1alpha1.Skill
	161, // 229: dnd5e.api.v1alpha1.LanguageSelection.languages:type_name -> dnd5e.api.v1alpha1.Language
	162, // 230: dnd5e.api.v1alpha1.FightingStyleSelection.style:type_name -> dnd5e.api.v1alpha1.FightingStyle
	165, // 231: dnd5e.api.v1alpha1.ToolSelection.tools:type_name -> dnd5e.api.v1alpha1.Tool
	164, // 232: dnd5e.api.v1alpha1.WeaponProficiencySelection.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	181, // 233: dnd5e.api.v1alpha1.WeaponProficiencySelection.categories:type_name -> dnd5e.api.v1alpha1.EquipmentType
	163, // 234: dnd5e.api.v1alpha1.ArmorProficiencySelection.armors:type_name -> dnd5e.api.v1alpha1.Armor
	181, // 235: dnd5e.api.v1alpha1.ArmorProficiencySelection.categories:type_name -> dnd5e.api.v1alpha1.EquipmentType
	131, // 236: dnd5e.api.v1alpha1.CharacterRequirements.choices:type_name -> dnd5e.api.v1alpha1.RequiredChoice
	4,   // 237: dnd5e.api.v1alpha1.RequiredChoice.category:type_name -> dnd5e.api.v1alpha1.ChoiceCategory
	8,   // 238: dnd5e.api.v1alpha1.RequiredChoice.source:type_name -> dnd5e.api.v1alpha1.ChoiceSource
	132, // 239: dnd5e.api.v1alpha1.RequiredChoice.skill_options:type_name -> dnd5e.api.v1alpha1.SkillOptions
	133, // 240: dnd5e.api.v1alpha1.RequiredChoice.language_options:type_name -> dnd5e.api.v1alpha1.LanguageOptions
	120, // 241: dnd5e.api.v1alpha1.RequiredChoice.equipment_options:type_name -> dnd5e.api.v1alpha1.EquipmentChoice
	134, // 242: dnd5e.api.v1alpha1.RequiredChoice.fighting_style_options:type_name -> dnd5e.api.v1alpha1.FightingStyleOptions
	135, // 243: dnd5e.api.v1alpha1.RequiredChoice.tool_options:type_name -> dnd5e.api.v1alpha1.ToolOptions
	166, // 244: dnd5e.api.v1alpha1.SkillOptions.available:type_name -> dnd5e.api.v1alpha1.Skill
	161, // 245: dnd5e.api.v1alpha1.LanguageOptions.available:type_name -> dnd5e.api.v1alpha1.Language
	162, // 246: dnd5e.api.v1alpha1.FightingStyleOptions.available:type_name -> dnd5e.api.v1alpha1.FightingStyle
	165, // 247: dnd5e.api.v1alpha1.ToolOptions.available:type_name -> dnd5e.api.v1alpha1.Tool
	174, // 248: dnd5e.api.v1alpha1.SpellDamage.damage_type:type_name -> dnd5e.api.v1alpha1.DamageType
	137, // 249: dnd5e.api.v1alpha1.SpellDamage.damage_at_slot_level:type_name -> dnd5e.api.v1alpha1.DamageAtSlotLevel
	181, // 250: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest.equipment_type:type_name -> dnd5e.api.v1alpha1.EquipmentType
	102, // 251: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	158, // 252: dnd5e.api.v1alpha1.ListSpellsByLevelRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	177, // 253: dnd5e.api.v1alpha1.ListSpellsByLevelResponse.spells:type_name -> dnd5e.api.v1alpha1.Spell
	106, // 254: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.equipment_slots:type_name -> dnd5e.api.v1alpha1.EquipmentSlots
	107, // 255: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.inventory:type_name -> dnd5e.api.v1alpha1.InventoryItem
	108, // 256: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.encumbrance:type_name -> dnd5e.api.v1alpha1.EncumbranceInfo
	9,   // 257: dnd5e.api.v1alpha1.EquipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	14,  // 258: dnd5e.api.v1alpha1.EquipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	107, // 259: dnd5e.api.v1alpha1.EquipItemResponse.previously_equipped_item:type_name -> dnd5e.api.v1alpha1.InventoryItem
	9,   // 260: dnd5e.api.v1alpha1.UnequipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	14,  // 261: dnd5e.api.v1alpha1.UnequipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	150, // 262: dnd5e.api.v1alpha1.AddToInventoryRequest.items:type_name -> dnd5e.api.v1alpha1.InventoryAddition
	14,  // 263: dnd5e.api.v1alpha1.AddToInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	14,  // 264: dnd5e.api.v1alpha1.RemoveFromInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	32,  // 265: dnd5e.api.v1alpha1.CharacterService.CreateDraft:input_type -> dnd5e.api.v1alpha1.CreateDraftRequest
	34,  // 266: dnd5e.api.v1alpha1.CharacterService.GetDraft:input_type -> dnd5e.api.v1alpha1.GetDraftRequest
	50,  // 267: dnd5e.api.v1alpha1.CharacterService.ListDrafts:input_type -> dnd5e.api.v1alpha1.ListDraftsRequest
	58,  // 268: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:input_type -> dnd5e.api.v1alpha1.DeleteDraftRequest
	38,  // 269: dnd5e.api.v1alpha1.CharacterService.UpdateName:input_type -> dnd5e.api.v1alpha1.UpdateNameRequest
	39,  // 270: dnd5e.api.v1alpha1.CharacterService.UpdateRace:input_type -> dnd5e.api.v1alpha1.UpdateRaceRequest
	40,  // 271: dnd5e.api.v1alpha1.CharacterService.UpdateClass:input_type -> dnd5e.api.v1alpha1.UpdateClassRequest
	41,  // 272: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:input_type -> dnd5e.api.v1alpha1.UpdateBackgroundRequest
	42,  // 273: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:input_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	43,  // 274: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:input_type -> dnd5e.api.v1alpha1.UpdateSkillsRequest
	52,  // 275: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:input_type -> dnd5e.api.v1alpha1.ValidateDraftRequest
	54,  // 276: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:input_type -> dnd5e.api.v1alpha1.GetDraftPreviewRequest
	56,  // 277: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:input_type -> dnd5e.api.v1alpha1.FinalizeDraftRequest
	20,  // 278: dnd5e.api.v1alpha1.CharacterService.GetCharacter:input_type -> dnd5e.api.v1alpha1.GetCharacterRequest
	22,  // 279: dnd5e.api.v1alpha1.CharacterService.ListCharacters:input_type -> dnd5e.api.v1alpha1.ListCharactersRequest
	26,  // 280: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:input_type -> dnd5e.api.v1alpha1.DeleteCharacterRequest
	78,  // 281: dnd5e.api.v1alpha1.CharacterService.ListRaces:input_type -> dnd5e.api.v1alpha1.ListRacesRequest
	80,  // 282: dnd5e.api.v1alpha1.CharacterService.ListClasses:input_type -> dnd5e.api.v1alpha1.ListClassesRequest
	82,  // 283: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:input_type -> dnd5e.api.v1alpha1.ListBackgroundsRequest
	84,  // 284: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:input_type -> dnd5e.api.v1alpha1.GetRaceDetailsRequest
	86,  // 285: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:input_type -> dnd5e.api.v1alpha1.GetClassDetailsRequest
	88,  // 286: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:input_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	90,  // 287: dnd5e.api.v1alpha1.CharacterService.GetFeature:input_type -> dnd5e.api.v1alpha1.GetFeatureRequest
	92,  // 288: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:input_type -> dnd5e.api.v1alpha1.RollAbilityScoresRequest
	95,  // 289: dnd5e.api.v1alpha1.CharacterService.GetRequirements:input_type -> dnd5e.api.v1alpha1.GetRequirementsRequest
	97,  // 290: dnd5e.api.v1alpha1.CharacterService.SubmitChoices:input_type -> dnd5e.api.v1alpha1.SubmitChoicesRequest
	139, // 291: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:input_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	141, // 292: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:input_type -> dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	143, // 293: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:input_type -> dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	145, // 294: dnd5e.api.v1alpha1.CharacterService.EquipItem:input_type -> dnd5e.api.v1alpha1.EquipItemRequest
	147, // 295: dnd5e.api.v1alpha1.CharacterService.UnequipItem:input_type -> dnd5e.api.v1alpha1.UnequipItemRequest
	149, // 296: dnd5e.api.v1alpha1.CharacterService.AddToInventory:input_type -> dnd5e.api.v1alpha1.AddToInventoryRequest
	152, // 297: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:input_type -> dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	33,  // 298: dnd5e.api.v1alpha1.CharacterService.CreateDraft:output_type -> dnd5e.api.v1alpha1.CreateDraftResponse
	35,  // 299: dnd5e.api.v1alpha1.CharacterService.GetDraft:output_type -> dnd5e.api.v1alpha1.GetDraftResponse
	51,  // 300: dnd5e.api.v1alpha1.CharacterService.ListDrafts:output_type -> dnd5e.api.v1alpha1.ListDraftsResponse
	59,  // 301: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:output_type -> dnd5e.api.v1alpha1.DeleteDraftResponse
	44,  // 302: dnd5e.api.v1alpha1.CharacterService.UpdateName:output_type -> dnd5e.api.v1alpha1.UpdateNameResponse
	45,  // 303: dnd5e.api.v1alpha1.CharacterService.UpdateRace:output_type -> dnd5e.api.v1alpha1.UpdateRaceResponse
	46,  // 304: dnd5e.api.v1alpha1.CharacterService.UpdateClass:output_type -> dnd5e.api.v1alpha1.UpdateClassResponse
	47,  // 305: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:output_type -> dnd5e.api.v1alpha1.UpdateBackgroundResponse
	48,  // 306: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:output_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	49,  // 307: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:output_type -> dnd5e.api.v1alpha1.UpdateSkillsResponse
	53,  // 308: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:output_type -> dnd5e.api.v1alpha1.ValidateDraftResponse
	55,  // 309: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:output_type -> dnd5e.api.v1alpha1.GetDraftPreviewResponse
	57,  // 310: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:output_type -> dnd5e.api.v1alpha1.FinalizeDraftResponse
	21,  // 311: dnd5e.api.v1alpha1.CharacterService.GetCharacter:output_type -> dnd5e.api.v1alpha1.GetCharacterResponse
	23,  // 312: dnd5e.api.v1alpha1.CharacterService.ListCharacters:output_type -> dnd5e.api.v1alpha1.ListCharactersResponse
	27,  // 313: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:output_type -> dnd5e.api.v1alpha1.DeleteCharacterResponse
	79,  // 314: dnd5e.api.v1alpha1.CharacterService.ListRaces:output_type -> dnd5e.api.v1alpha1.ListRacesResponse
	81,  // 315: dnd5e.api.v1alpha1.CharacterService.ListClasses:output_type -> dnd5e.api.v1alpha1.ListClassesResponse
	83,  // 316: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:output_type -> dnd5e.api.v1alpha1.ListBackgroundsResponse
	85,  // 317: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:output_type -> dnd5e.api.v1alpha1.GetRaceDetailsResponse
	87,  // 318: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:output_type -> dnd5e.api.v1alpha1.GetClassDetailsResponse
	89,  // 319: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:output_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	91,  // 320: dnd5e.api.v1alpha1.CharacterService.GetFeature:output_type -> dnd5e.api.v1alpha1.GetFeatureResponse
	94,  // 321: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:output_type -> dnd5e.api.v1alpha1.RollAbilityScoresResponse
	96,  // 322: dnd5e.api.v1alpha1.CharacterService.GetRequirements:output_type -> dnd5e.api.v1alpha1.GetRequirementsResponse
	98,  // 323: dnd5e.api.v1alpha1.CharacterService.SubmitChoices:output_type -> dnd5e.api.v1alpha1.SubmitChoicesResponse
	140, // 324: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:output_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	142, // 325: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:output_type -> dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	144, // 326: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:output_type -> dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	146, // 327: dnd5e.api.v1alpha1.CharacterService.EquipItem:output_type -> dnd5e.api.v1alpha1.EquipItemResponse
	148, // 328: dnd5e.api.v1alpha1.CharacterService.UnequipItem:output_type -> dnd5e.api.v1alpha1.UnequipItemResponse
	151, // 329: dnd5e.api.v1alpha1.CharacterService.AddToInventory:output_type -> dnd5e.api.v1alpha1.AddToInventoryResponse
	153, // 330: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:output_type -> dnd5e.api.v1alpha1.RemoveFromInventoryResponse
	298, // [298:331] is the sub-list for method output_type
	265, // [265:298] is the sub-list for method input_type
