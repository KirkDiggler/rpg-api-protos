...
inline constexpr CombatAbilityId CombatAbilityId_MAX =
    static_cast<CombatAbilityId>(11);
inline bool CombatAbilityId_IsValid(int value) {
  return 0 <= value && value <= 11 && ((3327u >> value) & 1) != 0;
}
inline constexpr int CombatAbilityId_ARRAYSIZE = 11 + 1;
const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL CombatAbilityId_descriptor();
template <typename T>
const ::std::string& CombatAbilityId_Name(T value) {
...
template <>
inline const ::std::string& CombatAbilityId_Name(CombatAbilityId value) {
  return ::google::protobuf::internal::NameOfDenseEnum<CombatAbilityId_descriptor, 0, 11>(
      static_cast<int>(value));
}
inline bool CombatAbilityId_Parse(
...
template <>
inline const ::std::string& ActionId_Name(ActionId value) {
  return ::google::protobuf::internal::NameOfDenseEnum<ActionId_descriptor, 0, 5>(
      static_cast<int>(value));
}
inline bool ActionId_Parse(
