...
type RaceInfo struct {
	...
	LanguageOptions *Choice `protobuf:"bytes,14,opt,name=language_options,json=languageOptions,proto3" json:"language_options,omitempty"`
	// Proficiency choices (e.g., "choose 2 skills from...")
	ProficiencyOptions []*Choice `protobuf:"bytes,15,rep,name=proficiency_options,json=proficiencyOptions,proto3" json:"proficiency_options,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *RaceInfo) GetLanguageOptions() *Choice {
	if x != nil {
...
func (x *RaceInfo) GetProficiencyOptions() []*Choice {
	if x != nil {
		return x.ProficiencyOptions
	}
	return nil
}
...
type Choice struct {
	...
	// How many to choose
	Choose int32 `protobuf:"varint,2,opt,name=choose,proto3" json:"choose,omitempty"`
	// Available options
...
type ClassInfo struct {
	...
	ProficiencyChoices []*Choice `protobuf:"bytes,16,rep,name=proficiency_choices,json=proficiencyChoices,proto3" json:"proficiency_choices,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *ClassInfo) GetProficiencyChoices() []*Choice {
	if x != nil {
...
func (x *Equipment) GetWeight() float32 {
	if x != nil {
		return x.Weight
	}
	return 0
...
type ArmorData struct {
	...
	MaxDexBonus         int32                  `protobuf:"varint,4,opt,name=max_dex_bonus,json=maxDexBonus,proto3" json:"max_dex_bonus,omitempty"` // -1 for no limit
	StrMinimum          int32                  `protobuf:"varint,5,opt,name=str_minimum,json=strMinimum,proto3" json:"str_minimum,omitempty"`
	StealthDisadvantage bool                   `protobuf:"varint,6,opt,name=stealth_disadvantage,json=stealthDisadvantage,proto3" json:"stealth_disadvantage,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type SpellDamage struct {
	...
	DamageAtSlotLevel map[int32]string       `protobuf:"bytes,2,rep,name=damage_at_slot_level,json=damageAtSlotLevel,proto3" json:"damage_at_slot_level,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // slot level -> damage dice
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *SpellDamage) GetDamageAtSlotLevel() map[int32]string {
	if x != nil {
...
type ListEquipmentByTypeRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	EquipmentType string                 `protobuf:"bytes,1,opt,name=equipment_type,json=equipmentType,proto3" json:"equipment_type,omitempty"` // "simple-weapon", "martial-weapon", etc.
...
func (x *ListEquipmentByTypeRequest) GetEquipmentType() string {
	if x != nil {
...
type ListSpellsByLevelRequest struct {
	...
	Class         string                 `protobuf:"bytes,2,opt,name=class,proto3" json:"class,omitempty"`  // Optional: filter by class
	PageSize      int32                  `protobuf:"varint,3,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`
	PageToken     string                 `protobuf:"bytes,4,opt,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ListSpellsByLevelRequest) GetClass() string {
	if x != nil {
		return x.Class
	}
	return ""
...
const file_dnd5e_api_v1alpha1_character_proto_rawDesc = "" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage\"\xa7\x06\n" +
	"\bRaceInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	...
	"\x10size_description\x18\r \x01(\tR\x0fsizeDescription\x12E\n" +
	"\x10language_options\x18\x0e \x01(\v2\x1a.dnd5e.api.v1alpha1.ChoiceR\x0flanguageOptions\x12K\n" +
	"\x13proficiency_options\x18\x0f \x03(\v2\x1a.dnd5e.api.v1alpha1.ChoiceR\x12proficiencyOptions\x1aA\n" +
	...
	"\x06choose\x18\x02 \x01(\x05R\x06choose\x12\x18\n" +
	"\aoptions\x18\x03 \x03(\tR\aoptions\x12\x12\n" +
	"\x04from\x18\x04 \x01(\tR\x04from\"\xa7\x06\n" +
	"\tClassInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	...
	"\fspellcasting\x18\x0f \x01(\v2$.dnd5e.api.v1alpha1.SpellcastingInfoR\fspellcasting\x12K\n" +
	"\x13proficiency_choices\x18\x10 \x03(\v2\x1a.dnd5e.api.v1alpha1.ChoiceR\x12proficiencyChoices\"p\n" +
	...
	"\x04unit\x18\x02 \x01(\tR\x04unit\"\x85\x03\n" +
	"\tEquipment\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1a\n" +
	"\bcategory\x18\x03 \x01(\tR\bcategory\x12,\n" +
	"\x04cost\x18\x04 \x01(\v2\x18.dnd5e.api.v1alpha1.CostR\x04cost\x12\x16\n" +
	...
	"\n" +
	"long_range\x18\a \x01(\x05R\tlongRange\"\xe0\x01\n" +
	"\tArmorData\x12%\n" +
	...
	"\rmax_dex_bonus\x18\x04 \x01(\x05R\vmaxDexBonus\x12\x1f\n" +
	"\vstr_minimum\x18\x05 \x01(\x05R\n" +
	"strMinimum\x121\n" +
	"\x14stealth_disadvantage\x18\x06 \x01(\bR\x13stealthDisadvantage\"O\n" +
	"\bGearData\x12#\n" +
	...
	"\x0earea_of_effect\x18\x0e \x01(\v2 .dnd5e.api.v1alpha1.AreaOfEffectR\fareaOfEffect\"\xdd\x01\n" +
	"\vSpellDamage\x12\x1f\n" +
	"\vdamage_type\x18\x01 \x01(\tR\n" +
	"damageType\x12g\n" +
	"\x14damage_at_slot_level\x18\x02 \x03(\v26.dnd5e.api.v1alpha1.SpellDamage.DamageAtSlotLevelEntryR\x11damageAtSlotLevel\x1aD\n" +
	"\x16DamageAtSlotLevelEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"6\n" +
	"\fAreaOfEffect\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x12\n" +
	"\x04size\x18\x02 \x01(\x05R\x04size\"\x7f\n" +
	"\x1aListEquipmentByTypeRequest\x12%\n" +
	"\x0eequipment_type\x18\x01 \x01(\tR\requipmentType\x12\x1b\n" +
	...
	"\x0fSIZE_GARGANTUAN\x10\x062\xc0\x13\n" +
	...
	"\x14GetBackgroundDetails\x12/.dnd5e.api.v1alpha1.GetBackgroundDetailsRequest\x1a0.dnd5e.api.v1alpha1.GetBackgroundDetailsResponse\x12p\n" +
...
var file_dnd5e_api_v1alpha1_character_proto_msgTypes = make([]protoimpl.MessageInfo, 83)
var file_dnd5e_api_v1alpha1_character_proto_goTypes = []any{
	...
	(*Choice)(nil),                       // 49: dnd5e.api.v1alpha1.Choice
	(*ClassInfo)(nil),                    // 50: dnd5e.api.v1alpha1.ClassInfo
	(*EquipmentChoice)(nil),              // 51: dnd5e.api.v1alpha1.EquipmentChoice
	(*ClassFeature)(nil),                 // 52: dnd5e.api.v1alpha1.ClassFeature
	(*SpellcastingInfo)(nil),             // 53: dnd5e.api.v1alpha1.SpellcastingInfo
	(*BackgroundInfo)(nil),               // 54: dnd5e.api.v1alpha1.BackgroundInfo
	(*ListRacesRequest)(nil),             // 55: dnd5e.api.v1alpha1.ListRacesRequest
	(*ListRacesResponse)(nil),            // 56: dnd5e.api.v1alpha1.ListRacesResponse
	(*ListClassesRequest)(nil),           // 57: dnd5e.api.v1alpha1.ListClassesRequest
	(*ListClassesResponse)(nil),          // 58: dnd5e.api.v1alpha1.ListClassesResponse
	(*ListBackgroundsRequest)(nil),       // 59: dnd5e.api.v1alpha1.ListBackgroundsRequest
	(*ListBackgroundsResponse)(nil),      // 60: dnd5e.api.v1alpha1.ListBackgroundsResponse
	(*GetRaceDetailsRequest)(nil),        // 61: dnd5e.api.v1alpha1.GetRaceDetailsRequest
	(*GetRaceDetailsResponse)(nil),       // 62: dnd5e.api.v1alpha1.GetRaceDetailsResponse
	(*GetClassDetailsRequest)(nil),       // 63: dnd5e.api.v1alpha1.GetClassDetailsRequest
	(*GetClassDetailsResponse)(nil),      // 64: dnd5e.api.v1alpha1.GetClassDetailsResponse
	(*GetBackgroundDetailsRequest)(nil),  // 65: dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	(*GetBackgroundDetailsResponse)(nil), // 66: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	(*RollAbilityScoresRequest)(nil),     // 67: dnd5e.api.v1alpha1.RollAbilityScoresRequest
	(*AbilityScoreRoll)(nil),             // 68: dnd5e.api.v1alpha1.AbilityScoreRoll
	(*RollAbilityScoresResponse)(nil),    // 69: dnd5e.api.v1alpha1.RollAbilityScoresResponse
	(*RollAssignments)(nil),              // 70: dnd5e.api.v1alpha1.RollAssignments
	(*Cost)(nil),                         // 71: dnd5e.api.v1alpha1.Cost
	(*Equipment)(nil),                    // 72: dnd5e.api.v1alpha1.Equipment
	(*WeaponData)(nil),                   // 73: dnd5e.api.v1alpha1.WeaponData
	(*ArmorData)(nil),                    // 74: dnd5e.api.v1alpha1.ArmorData
	(*GearData)(nil),                     // 75: dnd5e.api.v1alpha1.GearData
	(*Spell)(nil),                        // 76: dnd5e.api.v1alpha1.Spell
	(*SpellDamage)(nil),                  // 77: dnd5e.api.v1alpha1.SpellDamage
	(*AreaOfEffect)(nil),                 // 78: dnd5e.api.v1alpha1.AreaOfEffect
	(*ListEquipmentByTypeRequest)(nil),   // 79: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	(*ListEquipmentByTypeResponse)(nil),  // 80: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	(*ListSpellsByLevelRequest)(nil),     // 81: dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	(*ListSpellsByLevelResponse)(nil),    // 82: dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	nil,                                  // 83: dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	nil,                                  // 84: dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	nil,                                  // 85: dnd5e.api.v1alpha1.SpellDamage.DamageAtSlotLevelEntry
	(Race)(0),                            // 86: dnd5e.api.v1alpha1.Race
	(Subrace)(0),                         // 87: dnd5e.api.v1alpha1.Subrace
	(Class)(0),                           // 88: dnd5e.api.v1alpha1.Class
	(Background)(0),                      // 89: dnd5e.api.v1alpha1.Background
	(Alignment)(0),                       // 90: dnd5e.api.v1alpha1.Alignment
	(Language)(0),                        // 91: dnd5e.api.v1alpha1.Language
	(Skill)(0),                           // 92: dnd5e.api.v1alpha1.Skill
	(Ability)(0),                         // 93: dnd5e.api.v1alpha1.Ability
	(*ValidationWarning)(nil),            // 94: dnd5e.api.v1alpha1.ValidationWarning
	(*ValidationError)(nil),              // 95: dnd5e.api.v1alpha1.ValidationError
}
var file_dnd5e_api_v1alpha1_character_proto_depIdxs = []int32{
	86,  // 0: dnd5e.api.v1alpha1.Character.race:type_name -> dnd5e.api.v1alpha1.Race
	87,  // 1: dnd5e.api.v1alpha1.Character.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	88,  // 2: dnd5e.api.v1alpha1.Character.class:type_name -> dnd5e.api.v1alpha1.Class
	89,  // 3: dnd5e.api.v1alpha1.Character.background:type_name -> dnd5e.api.v1alpha1.Background
	90,  // 4: dnd5e.api.v1alpha1.Character.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	...
	91,  // 9: dnd5e.api.v1alpha1.Character.languages:type_name -> dnd5e.api.v1alpha1.Language
	8,   // 10: dnd5e.api.v1alpha1.Character.metadata:type_name -> dnd5e.api.v1alpha1.CharacterMetadata
	92,  // 11: dnd5e.api.v1alpha1.Proficiencies.skills:type_name -> dnd5e.api.v1alpha1.Skill
	93,  // 12: dnd5e.api.v1alpha1.Proficiencies.saving_throws:type_name -> dnd5e.api.v1alpha1.Ability
	...
	86,  // 17: dnd5e.api.v1alpha1.CharacterDraft.race:type_name -> dnd5e.api.v1alpha1.Race
	87,  // 18: dnd5e.api.v1alpha1.CharacterDraft.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	88,  // 19: dnd5e.api.v1alpha1.CharacterDraft.class:type_name -> dnd5e.api.v1alpha1.Class
	89,  // 20: dnd5e.api.v1alpha1.CharacterDraft.background:type_name -> dnd5e.api.v1alpha1.Background
	3,   // 21: dnd5e.api.v1alpha1.CharacterDraft.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	90,  // 22: dnd5e.api.v1alpha1.CharacterDraft.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	92,  // 23: dnd5e.api.v1alpha1.CharacterDraft.starting_skills:type_name -> dnd5e.api.v1alpha1.Skill
	91,  // 24: dnd5e.api.v1alpha1.CharacterDraft.additional_languages:type_name -> dnd5e.api.v1alpha1.Language
	...
	94,  // 33: dnd5e.api.v1alpha1.UpdateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	86,  // 34: dnd5e.api.v1alpha1.UpdateRaceRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	87,  // 35: dnd5e.api.v1alpha1.UpdateRaceRequest.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	88,  // 36: dnd5e.api.v1alpha1.UpdateClassRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	89,  // 37: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background:type_name -> dnd5e.api.v1alpha1.Background
	3,   // 38: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	70,  // 39: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.roll_assignments:type_name -> dnd5e.api.v1alpha1.RollAssignments
	92,  // 40: dnd5e.api.v1alpha1.UpdateSkillsRequest.skills:type_name -> dnd5e.api.v1alpha1.Skill
	17,  // 41: dnd5e.api.v1alpha1.UpdateNameResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	94,  // 42: dnd5e.api.v1alpha1.UpdateNameResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	17,  // 43: dnd5e.api.v1alpha1.UpdateRaceResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	94,  // 44: dnd5e.api.v1alpha1.UpdateRaceResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	17,  // 45: dnd5e.api.v1alpha1.UpdateClassResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	94,  // 46: dnd5e.api.v1alpha1.UpdateClassResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	17,  // 47: dnd5e.api.v1alpha1.UpdateBackgroundResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	94,  // 48: dnd5e.api.v1alpha1.UpdateBackgroundResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	17,  // 49: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	94,  // 50: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	17,  // 51: dnd5e.api.v1alpha1.UpdateSkillsResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	94,  // 52: dnd5e.api.v1alpha1.UpdateSkillsResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	17,  // 53: dnd5e.api.v1alpha1.ListDraftsResponse.drafts:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	95,  // 54: dnd5e.api.v1alpha1.ValidateDraftResponse.errors:type_name -> dnd5e.api.v1alpha1.ValidationError
	94,  // 55: dnd5e.api.v1alpha1.ValidateDraftResponse.warnings:type_name -> dnd5e.api.v1alpha1.ValidationWarning
	0,   // 56: dnd5e.api.v1alpha1.ValidateDraftResponse.missing_steps:type_name -> dnd5e.api.v1alpha1.CreationStep
	4,   // 57: dnd5e.api.v1alpha1.FinalizeDraftResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	2,   // 58: dnd5e.api.v1alpha1.RaceInfo.size:type_name -> dnd5e.api.v1alpha1.Size
	83,  // 59: dnd5e.api.v1alpha1.RaceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	48,  // 60: dnd5e.api.v1alpha1.RaceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	47,  // 61: dnd5e.api.v1alpha1.RaceInfo.subraces:type_name -> dnd5e.api.v1alpha1.SubraceInfo
	91,  // 62: dnd5e.api.v1alpha1.RaceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	49,  // 63: dnd5e.api.v1alpha1.RaceInfo.language_options:type_name -> dnd5e.api.v1alpha1.Choice
	49,  // 64: dnd5e.api.v1alpha1.RaceInfo.proficiency_options:type_name -> dnd5e.api.v1alpha1.Choice
	84,  // 65: dnd5e.api.v1alpha1.SubraceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	48,  // 66: dnd5e.api.v1alpha1.SubraceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	91,  // 67: dnd5e.api.v1alpha1.SubraceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	51,  // 68: dnd5e.api.v1alpha1.ClassInfo.equipment_choices:type_name -> dnd5e.api.v1alpha1.EquipmentChoice
	52,  // 69: dnd5e.api.v1alpha1.ClassInfo.level_1_features:type_name -> dnd5e.api.v1alpha1.ClassFeature
	53,  // 70: dnd5e.api.v1alpha1.ClassInfo.spellcasting:type_name -> dnd5e.api.v1alpha1.SpellcastingInfo
	49,  // 71: dnd5e.api.v1alpha1.ClassInfo.proficiency_choices:type_name -> dnd5e.api.v1alpha1.Choice
	91,  // 72: dnd5e.api.v1alpha1.BackgroundInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	46,  // 73: dnd5e.api.v1alpha1.ListRacesResponse.races:type_name -> dnd5e.api.v1alpha1.RaceInfo
	50,  // 74: dnd5e.api.v1alpha1.ListClassesResponse.classes:type_name -> dnd5e.api.v1alpha1.ClassInfo
	54,  // 75: dnd5e.api.v1alpha1.ListBackgroundsResponse.backgrounds:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	46,  // 76: dnd5e.api.v1alpha1.GetRaceDetailsResponse.race:type_name -> dnd5e.api.v1alpha1.RaceInfo
	50,  // 77: dnd5e.api.v1alpha1.GetClassDetailsResponse.class:type_name -> dnd5e.api.v1alpha1.ClassInfo
	54,  // 78: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse.background:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	68,  // 79: dnd5e.api.v1alpha1.RollAbilityScoresResponse.rolls:type_name -> dnd5e.api.v1alpha1.AbilityScoreRoll
	71,  // 80: dnd5e.api.v1alpha1.Equipment.cost:type_name -> dnd5e.api.v1alpha1.Cost
	73,  // 81: dnd5e.api.v1alpha1.Equipment.weapon_data:type_name -> dnd5e.api.v1alpha1.WeaponData
	74,  // 82: dnd5e.api.v1alpha1.Equipment.armor_data:type_name -> dnd5e.api.v1alpha1.ArmorData
	75,  // 83: dnd5e.api.v1alpha1.Equipment.gear_data:type_name -> dnd5e.api.v1alpha1.GearData
	77,  // 84: dnd5e.api.v1alpha1.Spell.damage:type_name -> dnd5e.api.v1alpha1.SpellDamage
	78,  // 85: dnd5e.api.v1alpha1.Spell.area_of_effect:type_name -> dnd5e.api.v1alpha1.AreaOfEffect
	85,  // 86: dnd5e.api.v1alpha1.SpellDamage.damage_at_slot_level:type_name -> dnd5e.api.v1alpha1.SpellDamage.DamageAtSlotLevelEntry
	72,  // 87: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	76,  // 88: dnd5e.api.v1alpha1.ListSpellsByLevelResponse.spells:type_name -> dnd5e.api.v1alpha1.Spell
	20,  // 89: dnd5e.api.v1alpha1.CharacterService.CreateDraft:input_type -> dnd5e.api.v1alpha1.CreateDraftRequest
	22,  // 90: dnd5e.api.v1alpha1.CharacterService.GetDraft:input_type -> dnd5e.api.v1alpha1.GetDraftRequest
	38,  // 91: dnd5e.api.v1alpha1.CharacterService.ListDrafts:input_type -> dnd5e.api.v1alpha1.ListDraftsRequest
	44,  // 92: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:input_type -> dnd5e.api.v1alpha1.DeleteDraftRequest
	26,  // 93: dnd5e.api.v1alpha1.CharacterService.UpdateName:input_type -> dnd5e.api.v1alpha1.UpdateNameRequest
	27,  // 94: dnd5e.api.v1alpha1.CharacterService.UpdateRace:input_type -> dnd5e.api.v1alpha1.UpdateRaceRequest
	28,  // 95: dnd5e.api.v1alpha1.CharacterService.UpdateClass:input_type -> dnd5e.api.v1alpha1.UpdateClassRequest
	29,  // 96: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:input_type -> dnd5e.api.v1alpha1.UpdateBackgroundRequest
	30,  // 97: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:input_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	31,  // 98: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:input_type -> dnd5e.api.v1alpha1.UpdateSkillsRequest
	40,  // 99: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:input_type -> dnd5e.api.v1alpha1.ValidateDraftRequest
	42,  // 100: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:input_type -> dnd5e.api.v1alpha1.FinalizeDraftRequest
	9,   // 101: dnd5e.api.v1alpha1.CharacterService.GetCharacter:input_type -> dnd5e.api.v1alpha1.GetCharacterRequest
	11,  // 102: dnd5e.api.v1alpha1.CharacterService.ListCharacters:input_type -> dnd5e.api.v1alpha1.ListCharactersRequest
	15,  // 103: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:input_type -> dnd5e.api.v1alpha1.DeleteCharacterRequest
	55,  // 104: dnd5e.api.v1alpha1.CharacterService.ListRaces:input_type -> dnd5e.api.v1alpha1.ListRacesRequest
	57,  // 105: dnd5e.api.v1alpha1.CharacterService.ListClasses:input_type -> dnd5e.api.v1alpha1.ListClassesRequest
	59,  // 106: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:input_type -> dnd5e.api.v1alpha1.ListBackgroundsRequest
	61,  // 107: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:input_type -> dnd5e.api.v1alpha1.GetRaceDetailsRequest
	63,  // 108: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:input_type -> dnd5e.api.v1alpha1.GetClassDetailsRequest
	65,  // 109: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:input_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	67,  // 110: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:input_type -> dnd5e.api.v1alpha1.RollAbilityScoresRequest
	79,  // 111: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:input_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	81,  // 112: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:input_type -> dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	21,  // 113: dnd5e.api.v1alpha1.CharacterService.CreateDraft:output_type -> dnd5e.api.v1alpha1.CreateDraftResponse
	23,  // 114: dnd5e.api.v1alpha1.CharacterService.GetDraft:output_type -> dnd5e.api.v1alpha1.GetDraftResponse
	39,  // 115: dnd5e.api.v1alpha1.CharacterService.ListDrafts:output_type -> dnd5e.api.v1alpha1.ListDraftsResponse
	45,  // 116: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:output_type -> dnd5e.api.v1alpha1.DeleteDraftResponse
	32,  // 117: dnd5e.api.v1alpha1.CharacterService.UpdateName:output_type -> dnd5e.api.v1alpha1.UpdateNameResponse
	33,  // 118: dnd5e.api.v1alpha1.CharacterService.UpdateRace:output_type -> dnd5e.api.v1alpha1.UpdateRaceResponse
	34,  // 119: dnd5e.api.v1alpha1.CharacterService.UpdateClass:output_type -> dnd5e.api.v1alpha1.UpdateClassResponse
	35,  // 120: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:output_type -> dnd5e.api.v1alpha1.UpdateBackgroundResponse
	36,  // 121: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:output_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	37,  // 122: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:output_type -> dnd5e.api.v1alpha1.UpdateSkillsResponse
	41,  // 123: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:output_type -> dnd5e.api.v1alpha1.ValidateDraftResponse
	43,  // 124: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:output_type -> dnd5e.api.v1alpha1.FinalizeDraftResponse
	10,  // 125: dnd5e.api.v1alpha1.CharacterService.GetCharacter:output_type -> dnd5e.api.v1alpha1.GetCharacterResponse
	12,  // 126: dnd5e.api.v1alpha1.CharacterService.ListCharacters:output_type -> dnd5e.api.v1alpha1.ListCharactersResponse
	16,  // 127: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:output_type -> dnd5e.api.v1alpha1.DeleteCharacterResponse
	56,  // 128: dnd5e.api.v1alpha1.CharacterService.ListRaces:output_type -> dnd5e.api.v1alpha1.ListRacesResponse
	58,  // 129: dnd5e.api.v1alpha1.CharacterService.ListClasses:output_type -> dnd5e.api.v1alpha1.ListClassesResponse
	60,  // 130: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:output_type -> dnd5e.api.v1alpha1.ListBackgroundsResponse
	62,  // 131: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:output_type -> dnd5e.api.v1alpha1.GetRaceDetailsResponse
	64,  // 132: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:output_type -> dnd5e.api.v1alpha1.GetClassDetailsResponse
	66,  // 133: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:output_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	69,  // 134: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:output_type -> dnd5e.api.v1alpha1.RollAbilityScoresResponse
	80,  // 135: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:output_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	82,  // 136: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:output_type -> dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	113, // [113:137] is the sub-list for method output_type
	89,  // [89:113] is the sub-list for method input_type
...
func file_dnd5e_api_v1alpha1_character_proto_init() {
	...
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[69].OneofWrappers = []any{
