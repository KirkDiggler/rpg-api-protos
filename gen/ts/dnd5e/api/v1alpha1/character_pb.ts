...
export type ArmorData = Message<"dnd5e.api.v1alpha1.ArmorData"> & {
   ...
   * -1 for no limit
   *
   * @generated from field: int32 max_dex_bonus = 4;
   */
  maxDexBonus: number;

  /**
   * @generated from field: int32 str_minimum = 5;
   */
  strMinimum: number;

  /**
   * @generated from field: bool stealth_disadvantage = 6;
   */
...
export type SpellDamage = Message<"dnd5e.api.v1alpha1.SpellDamage"> & {
  ...
  /**
   * slot level -> damage dice
   *
   * @generated from field: map<int32, string> damage_at_slot_level = 2;
   */
