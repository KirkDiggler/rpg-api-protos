...
const file_dnd5e_api_v1alpha1_encounter_proto_rawDesc = "" +
	"\n" +
	"\"dnd5e/api/v1alpha1/encounter.proto\x12\x12dnd5e.api.v1alpha1\x1a\x1eapi/v1alpha1/room_common.proto\x1a\"dnd5e/api/v1alpha1/character.proto\"\xf1\x01\n" +
...
var file_dnd5e_api_v1alpha1_encounter_proto_goTypes = []any{
	...
	(*Character)(nil),               // 28: dnd5e.api.v1alpha1.Character
}
var file_dnd5e_api_v1alpha1_encounter_proto_depIdxs = []int32{
	...
	18, // 19: dnd5e.api.v1alpha1.DamageBreakdown.components:type_name -> dnd5e.api.v1alpha1.DamageComponent
	19, // 20: dnd5e.api.v1alpha1.AttackResult.damage_breakdown:type_name -> dnd5e.api.v1alpha1.DamageBreakdown
	20, // 21: dnd5e.api.v1alpha1.AttackResponse.result:type_name -> dnd5e.api.v1alpha1.AttackResult
	7,  // 22: dnd5e.api.v1alpha1.AttackResponse.combat_state:type_name -> dnd5e.api.v1alpha1.CombatState
	2,  // 23: dnd5e.api.v1alpha1.AttackResponse.updated_room:type_name -> dnd5e.api.v1alpha1.Room
	28, // 24: dnd5e.api.v1alpha1.ActivateFeatureResponse.updated_character:type_name -> dnd5e.api.v1alpha1.Character
	7,  // 25: dnd5e.api.v1alpha1.ActivateFeatureResponse.updated_combat_state:type_name -> dnd5e.api.v1alpha1.CombatState
	1,  // 26: dnd5e.api.v1alpha1.Room.EntitiesEntry.value:type_name -> dnd5e.api.v1alpha1.EntityPlacement
	3,  // 27: dnd5e.api.v1alpha1.EncounterService.DungeonStart:input_type -> dnd5e.api.v1alpha1.DungeonStartRequest
	8,  // 28: dnd5e.api.v1alpha1.EncounterService.GetCombatState:input_type -> dnd5e.api.v1alpha1.GetCombatStateRequest
	10, // 29: dnd5e.api.v1alpha1.EncounterService.MoveCharacter:input_type -> dnd5e.api.v1alpha1.MoveCharacterRequest
	13, // 30: dnd5e.api.v1alpha1.EncounterService.EndTurn:input_type -> dnd5e.api.v1alpha1.EndTurnRequest
	16, // 31: dnd5e.api.v1alpha1.EncounterService.Attack:input_type -> dnd5e.api.v1alpha1.AttackRequest
	22, // 32: dnd5e.api.v1alpha1.EncounterService.ActivateFeature:input_type -> dnd5e.api.v1alpha1.ActivateFeatureRequest
	4,  // 33: dnd5e.api.v1alpha1.EncounterService.DungeonStart:output_type -> dnd5e.api.v1alpha1.DungeonStartResponse
	9,  // 34: dnd5e.api.v1alpha1.EncounterService.GetCombatState:output_type -> dnd5e.api.v1alpha1.GetCombatStateResponse
	12, // 35: dnd5e.api.v1alpha1.EncounterService.MoveCharacter:output_type -> dnd5e.api.v1alpha1.MoveCharacterResponse
	15, // 36: dnd5e.api.v1alpha1.EncounterService.EndTurn:output_type -> dnd5e.api.v1alpha1.EndTurnResponse
	21, // 37: dnd5e.api.v1alpha1.EncounterService.Attack:output_type -> dnd5e.api.v1alpha1.AttackResponse
	23, // 38: dnd5e.api.v1alpha1.EncounterService.ActivateFeature:output_type -> dnd5e.api.v1alpha1.ActivateFeatureResponse
