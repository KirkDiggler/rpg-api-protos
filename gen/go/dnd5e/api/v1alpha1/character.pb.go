...
const file_dnd5e_api_v1alpha1_character_proto_rawDesc = "" +
	...
	"\alevel_9\x18\t \x01(\x05R\x06level9\"\x89\r\n" +
	"\tCharacter\x12\x0e\n" +
	...
	"spellSlots\x12J\n" +
	"\x11active_conditions\x18\x1c \x03(\v2\x1d.dnd5e.api.v1alpha1.ConditionR\x10activeConditions\"\xc8\x01\n" +
	...
	"\bprogress\x18\f \x01(\v2$.dnd5e.api.v1alpha1.CreationProgressR\bprogress\"\xef\x01\n" +
...
var file_dnd5e_api_v1alpha1_character_proto_msgTypes = make([]protoimpl.MessageInfo, 110)
var file_dnd5e_api_v1alpha1_character_proto_goTypes = []any{
	...
	(*AbilityModifiers)(nil),              // 10: dnd5e.api.v1alpha1.AbilityModifiers
	(*CombatStats)(nil),                   // 11: dnd5e.api.v1alpha1.CombatStats
	(*ProficiencyGrants)(nil),             // 12: dnd5e.api.v1alpha1.ProficiencyGrants
	(*Proficiencies)(nil),                 // 13: dnd5e.api.v1alpha1.Proficiencies
	(*CharacterMetadata)(nil),             // 14: dnd5e.api.v1alpha1.CharacterMetadata
	(*GetCharacterRequest)(nil),           // 15: dnd5e.api.v1alpha1.GetCharacterRequest
	(*GetCharacterResponse)(nil),          // 16: dnd5e.api.v1alpha1.GetCharacterResponse
	(*ListCharactersRequest)(nil),         // 17: dnd5e.api.v1alpha1.ListCharactersRequest
	(*ListCharactersResponse)(nil),        // 18: dnd5e.api.v1alpha1.ListCharactersResponse
	(*UpdateCharacterRequest)(nil),        // 19: dnd5e.api.v1alpha1.UpdateCharacterRequest
	(*UpdateCharacterResponse)(nil),       // 20: dnd5e.api.v1alpha1.UpdateCharacterResponse
	(*DeleteCharacterRequest)(nil),        // 21: dnd5e.api.v1alpha1.DeleteCharacterRequest
	(*DeleteCharacterResponse)(nil),       // 22: dnd5e.api.v1alpha1.DeleteCharacterResponse
	(*CharacterDraftData)(nil),            // 23: dnd5e.api.v1alpha1.CharacterDraftData
	(*CreationProgress)(nil),              // 24: dnd5e.api.v1alpha1.CreationProgress
	(*DraftMetadata)(nil),                 // 25: dnd5e.api.v1alpha1.DraftMetadata
	(*CharacterDraft)(nil),                // 26: dnd5e.api.v1alpha1.CharacterDraft
	(*CreateDraftRequest)(nil),            // 27: dnd5e.api.v1alpha1.CreateDraftRequest
	(*CreateDraftResponse)(nil),           // 28: dnd5e.api.v1alpha1.CreateDraftResponse
	(*GetDraftRequest)(nil),               // 29: dnd5e.api.v1alpha1.GetDraftRequest
	(*GetDraftResponse)(nil),              // 30: dnd5e.api.v1alpha1.GetDraftResponse
	(*UpdateDraftRequest)(nil),            // 31: dnd5e.api.v1alpha1.UpdateDraftRequest
	(*UpdateDraftResponse)(nil),           // 32: dnd5e.api.v1alpha1.UpdateDraftResponse
	(*UpdateNameRequest)(nil),             // 33: dnd5e.api.v1alpha1.UpdateNameRequest
	(*UpdateRaceRequest)(nil),             // 34: dnd5e.api.v1alpha1.UpdateRaceRequest
	(*UpdateClassRequest)(nil),            // 35: dnd5e.api.v1alpha1.UpdateClassRequest
	(*UpdateBackgroundRequest)(nil),       // 36: dnd5e.api.v1alpha1.UpdateBackgroundRequest
	(*UpdateAbilityScoresRequest)(nil),    // 37: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	(*UpdateSkillsRequest)(nil),           // 38: dnd5e.api.v1alpha1.UpdateSkillsRequest
	(*UpdateNameResponse)(nil),            // 39: dnd5e.api.v1alpha1.UpdateNameResponse
	(*UpdateRaceResponse)(nil),            // 40: dnd5e.api.v1alpha1.UpdateRaceResponse
	(*UpdateClassResponse)(nil),           // 41: dnd5e.api.v1alpha1.UpdateClassResponse
	(*UpdateBackgroundResponse)(nil),      // 42: dnd5e.api.v1alpha1.UpdateBackgroundResponse
	(*UpdateAbilityScoresResponse)(nil),   // 43: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	(*UpdateSkillsResponse)(nil),          // 44: dnd5e.api.v1alpha1.UpdateSkillsResponse
	(*ListDraftsRequest)(nil),             // 45: dnd5e.api.v1alpha1.ListDraftsRequest
	(*ListDraftsResponse)(nil),            // 46: dnd5e.api.v1alpha1.ListDraftsResponse
	(*ValidateDraftRequest)(nil),          // 47: dnd5e.api.v1alpha1.ValidateDraftRequest
	(*ValidateDraftResponse)(nil),         // 48: dnd5e.api.v1alpha1.ValidateDraftResponse
	(*GetDraftPreviewRequest)(nil),        // 49: dnd5e.api.v1alpha1.GetDraftPreviewRequest
	(*GetDraftPreviewResponse)(nil),       // 50: dnd5e.api.v1alpha1.GetDraftPreviewResponse
	(*FinalizeDraftRequest)(nil),          // 51: dnd5e.api.v1alpha1.FinalizeDraftRequest
	(*FinalizeDraftResponse)(nil),         // 52: dnd5e.api.v1alpha1.FinalizeDraftResponse
	(*DeleteDraftRequest)(nil),            // 53: dnd5e.api.v1alpha1.DeleteDraftRequest
	(*DeleteDraftResponse)(nil),           // 54: dnd5e.api.v1alpha1.DeleteDraftResponse
	(*RaceInfo)(nil),                      // 55: dnd5e.api.v1alpha1.RaceInfo
	(*SubraceInfo)(nil),                   // 56: dnd5e.api.v1alpha1.SubraceInfo
	(*RacialTrait)(nil),                   // 57: dnd5e.api.v1alpha1.RacialTrait
	(*ClassInfo)(nil),                     // 58: dnd5e.api.v1alpha1.ClassInfo
	(*SubclassInfo)(nil),                  // 59: dnd5e.api.v1alpha1.SubclassInfo
	(*SpellcastingInfo)(nil),              // 60: dnd5e.api.v1alpha1.SpellcastingInfo
	(*SpellInfo)(nil),                     // 61: dnd5e.api.v1alpha1.SpellInfo
	...
	(FeatureId)(0),                        // 116: dnd5e.api.v1alpha1.FeatureId
	(ActionType)(0),                       // 117: dnd5e.api.v1alpha1.ActionType
	(Race)(0),                             // 118: dnd5e.api.v1alpha1.Race
	(Subrace)(0),                          // 119: dnd5e.api.v1alpha1.Subrace
	(Class)(0),                            // 120: dnd5e.api.v1alpha1.Class
	(Background)(0),                       // 121: dnd5e.api.v1alpha1.Background
	(Alignment)(0),                        // 122: dnd5e.api.v1alpha1.Alignment
	(*AbilityScores)(nil),                 // 123: dnd5e.api.v1alpha1.AbilityScores
	(Language)(0),                         // 124: dnd5e.api.v1alpha1.Language
	(FightingStyle)(0),                    // 125: dnd5e.api.v1alpha1.FightingStyle
	(*Condition)(nil),                     // 126: dnd5e.api.v1alpha1.Condition
	(Armor)(0),                            // 127: dnd5e.api.v1alpha1.Armor
	(Weapon)(0),                           // 128: dnd5e.api.v1alpha1.Weapon
	(Tool)(0),                             // 129: dnd5e.api.v1alpha1.Tool
	(Skill)(0),                            // 130: dnd5e.api.v1alpha1.Skill
	(Ability)(0),                          // 131: dnd5e.api.v1alpha1.Ability
	(ArmorProficiencyCategory)(0),         // 132: dnd5e.api.v1alpha1.ArmorProficiencyCategory
	(WeaponProficiencyCategory)(0),        // 133: dnd5e.api.v1alpha1.WeaponProficiencyCategory
	(Subclass)(0),                         // 134: dnd5e.api.v1alpha1.Subclass
	(*ChoiceData)(nil),                    // 135: dnd5e.api.v1alpha1.ChoiceData
	(*ValidationResult)(nil),              // 136: dnd5e.api.v1alpha1.ValidationResult
	(*Choice)(nil),                        // 137: dnd5e.api.v1alpha1.Choice
	(Spell)(0),                            // 138: dnd5e.api.v1alpha1.Spell
	(*EquipmentSelection)(nil),            // 139: dnd5e.api.v1alpha1.EquipmentSelection
	(SpellSelectionType)(0),               // 140: dnd5e.api.v1alpha1.SpellSelectionType
	(*ChoiceSubmission)(nil),              // 141: dnd5e.api.v1alpha1.ChoiceSubmission
	(EquipmentCategory)(0),                // 142: dnd5e.api.v1alpha1.EquipmentCategory
	(WeaponCategory)(0),                   // 143: dnd5e.api.v1alpha1.WeaponCategory
	(DamageType)(0),                       // 144: dnd5e.api.v1alpha1.DamageType
	(WeaponProperty)(0),                   // 145: dnd5e.api.v1alpha1.WeaponProperty
	(ArmorCategory)(0),                    // 146: dnd5e.api.v1alpha1.ArmorCategory
	(GearCategory)(0),                     // 147: dnd5e.api.v1alpha1.GearCategory
	(EquipmentType)(0),                    // 148: dnd5e.api.v1alpha1.EquipmentType
}
var file_dnd5e_api_v1alpha1_character_proto_depIdxs = []int32{
	116, // 0: dnd5e.api.v1alpha1.CharacterFeature.id:type_name -> dnd5e.api.v1alpha1.FeatureId
	117, // 1: dnd5e.api.v1alpha1.CharacterFeature.action_type:type_name -> dnd5e.api.v1alpha1.ActionType
	...
	118, // 4: dnd5e.api.v1alpha1.Character.race:type_name -> dnd5e.api.v1alpha1.Race
	119, // 5: dnd5e.api.v1alpha1.Character.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	120, // 6: dnd5e.api.v1alpha1.Character.class:type_name -> dnd5e.api.v1alpha1.Class
	121, // 7: dnd5e.api.v1alpha1.Character.background:type_name -> dnd5e.api.v1alpha1.Background
	122, // 8: dnd5e.api.v1alpha1.Character.alignment:type_name -> dnd5e.api.v1alpha1.Alignment
	123, // 9: dnd5e.api.v1alpha1.Character.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	10,  // 10: dnd5e.api.v1alpha1.Character.ability_modifiers:type_name -> dnd5e.api.v1alpha1.AbilityModifiers
	11,  // 11: dnd5e.api.v1alpha1.Character.combat_stats:type_name -> dnd5e.api.v1alpha1.CombatStats
	13,  // 12: dnd5e.api.v1alpha1.Character.proficiencies:type_name -> dnd5e.api.v1alpha1.Proficiencies
	124, // 13: dnd5e.api.v1alpha1.Character.languages:type_name -> dnd5e.api.v1alpha1.Language
	14,  // 14: dnd5e.api.v1alpha1.Character.metadata:type_name -> dnd5e.api.v1alpha1.CharacterMetadata
	93,  // 15: dnd5e.api.v1alpha1.Character.equipment_slots:type_name -> dnd5e.api.v1alpha1.EquipmentSlots
	94,  // 16: dnd5e.api.v1alpha1.Character.inventory:type_name -> dnd5e.api.v1alpha1.InventoryItem
	95,  // 17: dnd5e.api.v1alpha1.Character.encumbrance:type_name -> dnd5e.api.v1alpha1.EncumbranceInfo
	6,   // 18: dnd5e.api.v1alpha1.Character.features:type_name -> dnd5e.api.v1alpha1.CharacterFeature
	125, // 19: dnd5e.api.v1alpha1.Character.fighting_styles:type_name -> dnd5e.api.v1alpha1.FightingStyle
	...
	126, // 24: dnd5e.api.v1alpha1.Character.active_conditions:type_name -> dnd5e.api.v1alpha1.Condition
	127, // 25: dnd5e.api.v1alpha1.ProficiencyGrants.armor:type_name -> dnd5e.api.v1alpha1.Armor
	128, // 26: dnd5e.api.v1alpha1.ProficiencyGrants.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	129, // 27: dnd5e.api.v1alpha1.ProficiencyGrants.tools:type_name -> dnd5e.api.v1alpha1.Tool
	130, // 28: dnd5e.api.v1alpha1.ProficiencyGrants.skills:type_name -> dnd5e.api.v1alpha1.Skill
	124, // 29: dnd5e.api.v1alpha1.ProficiencyGrants.languages:type_name -> dnd5e.api.v1alpha1.Language
	130, // 30: dnd5e.api.v1alpha1.Proficiencies.skills:type_name -> dnd5e.api.v1alpha1.Skill
	131, // 31: dnd5e.api.v1alpha1.Proficiencies.saving_throws:type_name -> dnd5e.api.v1alpha1.Ability
	132, // 32: dnd5e.api.v1alpha1.Proficiencies.armor_categories:type_name -> dnd5e.api.v1alpha1.ArmorProficiencyCategory
	133, // 33: dnd5e.api.v1alpha1.Proficiencies.weapon_categories:type_name -> dnd5e.api.v1alpha1.WeaponProficiencyCategory
	128, // 34: dnd5e.api.v1alpha1.Proficiencies.specific_weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	129, // 35: dnd5e.api.v1alpha1.Proficiencies.tools:type_name -> dnd5e.api.v1alpha1.Tool
	127, // 36: dnd5e.api.v1alpha1.Proficiencies.armor:type_name -> dnd5e.api.v1alpha1.Armor
	128, // 37: dnd5e.api.v1alpha1.Proficiencies.weapons:type_name -> dnd5e.api.v1alpha1.Weapon
	9,   // 38: dnd5e.api.v1alpha1.GetCharacterResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	9,   // 39: dnd5e.api.v1alpha1.ListCharactersResponse.characters:type_name -> dnd5e.api.v1alpha1.Character
	9,   // 40: dnd5e.api.v1alpha1.UpdateCharacterRequest.character:type_name -> dnd5e.api.v1alpha1.Character
	9,   // 41: dnd5e.api.v1alpha1.UpdateCharacterResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	118, // 42: dnd5e.api.v1alpha1.CharacterDraftData.race:type_name -> dnd5e.api.v1alpha1.Race
	119, // 43: dnd5e.api.v1alpha1.CharacterDraftData.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	120, // 44: dnd5e.api.v1alpha1.CharacterDraftData.class:type_name -> dnd5e.api.v1alpha1.Class
	134, // 45: dnd5e.api.v1alpha1.CharacterDraftData.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	121, // 46: dnd5e.api.v1alpha1.CharacterDraftData.background:type_name -> dnd5e.api.v1alpha1.Background
	123, // 47: dnd5e.api.v1alpha1.CharacterDraftData.base_ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	135, // 48: dnd5e.api.v1alpha1.CharacterDraftData.choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	24,  // 49: dnd5e.api.v1alpha1.CharacterDraftData.progress:type_name -> dnd5e.api.v1alpha1.CreationProgress
	118, // 50: dnd5e.api.v1alpha1.CharacterDraft.race:type_name -> dnd5e.api.v1alpha1.Race
	119, // 51: dnd5e.api.v1alpha1.CharacterDraft.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	120, // 52: dnd5e.api.v1alpha1.CharacterDraft.class:type_name -> dnd5e.api.v1alpha1.Class
	134, // 53: dnd5e.api.v1alpha1.CharacterDraft.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	121, // 54: dnd5e.api.v1alpha1.CharacterDraft.background:type_name -> dnd5e.api.v1alpha1.Background
	123, // 55: dnd5e.api.v1alpha1.CharacterDraft.base_ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	135, // 56: dnd5e.api.v1alpha1.CharacterDraft.choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	24,  // 57: dnd5e.api.v1alpha1.CharacterDraft.progress:type_name -> dnd5e.api.v1alpha1.CreationProgress
	136, // 58: dnd5e.api.v1alpha1.CharacterDraft.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	55,  // 59: dnd5e.api.v1alpha1.CharacterDraft.race_info:type_name -> dnd5e.api.v1alpha1.RaceInfo
	56,  // 60: dnd5e.api.v1alpha1.CharacterDraft.subrace_info:type_name -> dnd5e.api.v1alpha1.SubraceInfo
	58,  // 61: dnd5e.api.v1alpha1.CharacterDraft.class_info:type_name -> dnd5e.api.v1alpha1.ClassInfo
	62,  // 62: dnd5e.api.v1alpha1.CharacterDraft.background_info:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	23,  // 63: dnd5e.api.v1alpha1.CreateDraftRequest.initial_data:type_name -> dnd5e.api.v1alpha1.CharacterDraftData
	26,  // 64: dnd5e.api.v1alpha1.CreateDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	26,  // 65: dnd5e.api.v1alpha1.GetDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	23,  // 66: dnd5e.api.v1alpha1.UpdateDraftRequest.updates:type_name -> dnd5e.api.v1alpha1.CharacterDraftData
	26,  // 67: dnd5e.api.v1alpha1.UpdateDraftResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	118, // 68: dnd5e.api.v1alpha1.UpdateRaceRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	119, // 69: dnd5e.api.v1alpha1.UpdateRaceRequest.subrace:type_name -> dnd5e.api.v1alpha1.Subrace
	135, // 70: dnd5e.api.v1alpha1.UpdateRaceRequest.race_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	120, // 71: dnd5e.api.v1alpha1.UpdateClassRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	135, // 72: dnd5e.api.v1alpha1.UpdateClassRequest.class_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	134, // 73: dnd5e.api.v1alpha1.UpdateClassRequest.subclass:type_name -> dnd5e.api.v1alpha1.Subclass
	121, // 74: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background:type_name -> dnd5e.api.v1alpha1.Background
	135, // 75: dnd5e.api.v1alpha1.UpdateBackgroundRequest.background_choices:type_name -> dnd5e.api.v1alpha1.ChoiceData
	123, // 76: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.ability_scores:type_name -> dnd5e.api.v1alpha1.AbilityScores
	86,  // 77: dnd5e.api.v1alpha1.UpdateAbilityScoresRequest.roll_assignments:type_name -> dnd5e.api.v1alpha1.RollAssignments
	130, // 78: dnd5e.api.v1alpha1.UpdateSkillsRequest.skills:type_name -> dnd5e.api.v1alpha1.Skill
	26,  // 79: dnd5e.api.v1alpha1.UpdateNameResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	26,  // 80: dnd5e.api.v1alpha1.UpdateRaceResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	26,  // 81: dnd5e.api.v1alpha1.UpdateClassResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	26,  // 82: dnd5e.api.v1alpha1.UpdateBackgroundResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	26,  // 83: dnd5e.api.v1alpha1.UpdateAbilityScoresResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	26,  // 84: dnd5e.api.v1alpha1.UpdateSkillsResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	26,  // 85: dnd5e.api.v1alpha1.ListDraftsResponse.drafts:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	136, // 86: dnd5e.api.v1alpha1.ValidateDraftResponse.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	26,  // 87: dnd5e.api.v1alpha1.GetDraftPreviewResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	9,   // 88: dnd5e.api.v1alpha1.GetDraftPreviewResponse.preview:type_name -> dnd5e.api.v1alpha1.Character
	9,   // 89: dnd5e.api.v1alpha1.FinalizeDraftResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	136, // 90: dnd5e.api.v1alpha1.FinalizeDraftResponse.final_validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	118, // 91: dnd5e.api.v1alpha1.RaceInfo.race_id:type_name -> dnd5e.api.v1alpha1.Race
	3,   // 92: dnd5e.api.v1alpha1.RaceInfo.size:type_name -> dnd5e.api.v1alpha1.Size
	114, // 93: dnd5e.api.v1alpha1.RaceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.RaceInfo.AbilityBonusesEntry
	57,  // 94: dnd5e.api.v1alpha1.RaceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	56,  // 95: dnd5e.api.v1alpha1.RaceInfo.subraces:type_name -> dnd5e.api.v1alpha1.SubraceInfo
	12,  // 96: dnd5e.api.v1alpha1.RaceInfo.proficiency_grants:type_name -> dnd5e.api.v1alpha1.ProficiencyGrants
	124, // 97: dnd5e.api.v1alpha1.RaceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	137, // 98: dnd5e.api.v1alpha1.RaceInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	119, // 99: dnd5e.api.v1alpha1.SubraceInfo.subrace_id:type_name -> dnd5e.api.v1alpha1.Subrace
	115, // 100: dnd5e.api.v1alpha1.SubraceInfo.ability_bonuses:type_name -> dnd5e.api.v1alpha1.SubraceInfo.AbilityBonusesEntry
	57,  // 101: dnd5e.api.v1alpha1.SubraceInfo.traits:type_name -> dnd5e.api.v1alpha1.RacialTrait
	124, // 102: dnd5e.api.v1alpha1.SubraceInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	12,  // 103: dnd5e.api.v1alpha1.SubraceInfo.proficiency_grants:type_name -> dnd5e.api.v1alpha1.ProficiencyGrants
	120, // 104: dnd5e.api.v1alpha1.ClassInfo.class_id:type_name -> dnd5e.api.v1alpha1.Class
	131, // 105: dnd5e.api.v1alpha1.ClassInfo.primary_ability:type_name -> dnd5e.api.v1alpha1.Ability
	132, // 106: dnd5e.api.v1alpha1.ClassInfo.armor_proficiency_categories:type_name -> dnd5e.api.v1alpha1.ArmorProficiencyCategory
	133, // 107: dnd5e.api.v1alpha1.ClassInfo.weapon_proficiency_categories:type_name -> dnd5e.api.v1alpha1.WeaponProficiencyCategory
	128, // 108: dnd5e.api.v1alpha1.ClassInfo.specific_weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.Weapon
	129, // 109: dnd5e.api.v1alpha1.ClassInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	131, // 110: dnd5e.api.v1alpha1.ClassInfo.saving_throw_proficiencies:type_name -> dnd5e.api.v1alpha1.Ability
	63,  // 111: dnd5e.api.v1alpha1.ClassInfo.level_1_features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	60,  // 112: dnd5e.api.v1alpha1.ClassInfo.spellcasting:type_name -> dnd5e.api.v1alpha1.SpellcastingInfo
	137, // 113: dnd5e.api.v1alpha1.ClassInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	59,  // 114: dnd5e.api.v1alpha1.ClassInfo.subclasses:type_name -> dnd5e.api.v1alpha1.SubclassInfo
	134, // 115: dnd5e.api.v1alpha1.SubclassInfo.subclass_id:type_name -> dnd5e.api.v1alpha1.Subclass
	127, // 116: dnd5e.api.v1alpha1.SubclassInfo.armor_proficiencies:type_name -> dnd5e.api.v1alpha1.Armor
	128, // 117: dnd5e.api.v1alpha1.SubclassInfo.weapon_proficiencies:type_name -> dnd5e.api.v1alpha1.Weapon
	129, // 118: dnd5e.api.v1alpha1.SubclassInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	137, // 119: dnd5e.api.v1alpha1.SubclassInfo.additional_choices:type_name -> dnd5e.api.v1alpha1.Choice
	63,  // 120: dnd5e.api.v1alpha1.SubclassInfo.features:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	138, // 121: dnd5e.api.v1alpha1.SpellInfo.spell_id:type_name -> dnd5e.api.v1alpha1.Spell
	121, // 122: dnd5e.api.v1alpha1.BackgroundInfo.background_id:type_name -> dnd5e.api.v1alpha1.Background
	130, // 123: dnd5e.api.v1alpha1.BackgroundInfo.skill_proficiencies:type_name -> dnd5e.api.v1alpha1.Skill
	129, // 124: dnd5e.api.v1alpha1.BackgroundInfo.tool_proficiencies:type_name -> dnd5e.api.v1alpha1.Tool
	124, // 125: dnd5e.api.v1alpha1.BackgroundInfo.languages:type_name -> dnd5e.api.v1alpha1.Language
	139, // 126: dnd5e.api.v1alpha1.BackgroundInfo.starting_equipment:type_name -> dnd5e.api.v1alpha1.EquipmentSelection
	137, // 127: dnd5e.api.v1alpha1.FeatureInfo.choices:type_name -> dnd5e.api.v1alpha1.Choice
	64,  // 128: dnd5e.api.v1alpha1.FeatureInfo.spell_selection:type_name -> dnd5e.api.v1alpha1.SpellSelectionInfo
	140, // 129: dnd5e.api.v1alpha1.SpellSelectionInfo.selection_type:type_name -> dnd5e.api.v1alpha1.SpellSelectionType
	55,  // 130: dnd5e.api.v1alpha1.ListRacesResponse.races:type_name -> dnd5e.api.v1alpha1.RaceInfo
	58,  // 131: dnd5e.api.v1alpha1.ListClassesResponse.classes:type_name -> dnd5e.api.v1alpha1.ClassInfo
	62,  // 132: dnd5e.api.v1alpha1.ListBackgroundsResponse.backgrounds:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	55,  // 133: dnd5e.api.v1alpha1.GetRaceDetailsResponse.race:type_name -> dnd5e.api.v1alpha1.RaceInfo
	58,  // 134: dnd5e.api.v1alpha1.GetClassDetailsResponse.class:type_name -> dnd5e.api.v1alpha1.ClassInfo
	62,  // 135: dnd5e.api.v1alpha1.GetBackgroundDetailsResponse.background:type_name -> dnd5e.api.v1alpha1.BackgroundInfo
	63,  // 136: dnd5e.api.v1alpha1.GetFeatureResponse.feature:type_name -> dnd5e.api.v1alpha1.FeatureInfo
	80,  // 137: dnd5e.api.v1alpha1.RollAbilityScoresResponse.rolls:type_name -> dnd5e.api.v1alpha1.AbilityScoreRoll
	120, // 138: dnd5e.api.v1alpha1.GetRequirementsRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	118, // 139: dnd5e.api.v1alpha1.GetRequirementsRequest.race:type_name -> dnd5e.api.v1alpha1.Race
	137, // 140: dnd5e.api.v1alpha1.GetRequirementsResponse.requirements:type_name -> dnd5e.api.v1alpha1.Choice
	141, // 141: dnd5e.api.v1alpha1.SubmitChoicesRequest.submissions:type_name -> dnd5e.api.v1alpha1.ChoiceSubmission
	26,  // 142: dnd5e.api.v1alpha1.SubmitChoicesResponse.draft:type_name -> dnd5e.api.v1alpha1.CharacterDraft
	136, // 143: dnd5e.api.v1alpha1.SubmitChoicesResponse.validation:type_name -> dnd5e.api.v1alpha1.ValidationResult
	137, // 144: dnd5e.api.v1alpha1.SubmitChoicesResponse.remaining_requirements:type_name -> dnd5e.api.v1alpha1.Choice
	142, // 145: dnd5e.api.v1alpha1.Equipment.category:type_name -> dnd5e.api.v1alpha1.EquipmentCategory
	87,  // 146: dnd5e.api.v1alpha1.Equipment.cost:type_name -> dnd5e.api.v1alpha1.Cost
	88,  // 147: dnd5e.api.v1alpha1.Equipment.weight:type_name -> dnd5e.api.v1alpha1.Weight
	90,  // 148: dnd5e.api.v1alpha1.Equipment.weapon_data:type_name -> dnd5e.api.v1alpha1.WeaponData
	91,  // 149: dnd5e.api.v1alpha1.Equipment.armor_data:type_name -> dnd5e.api.v1alpha1.ArmorData
	92,  // 150: dnd5e.api.v1alpha1.Equipment.gear_data:type_name -> dnd5e.api.v1alpha1.GearData
	143, // 151: dnd5e.api.v1alpha1.WeaponData.weapon_category:type_name -> dnd5e.api.v1alpha1.WeaponCategory
	144, // 152: dnd5e.api.v1alpha1.WeaponData.damage_type:type_name -> dnd5e.api.v1alpha1.DamageType
	145, // 153: dnd5e.api.v1alpha1.WeaponData.properties:type_name -> dnd5e.api.v1alpha1.WeaponProperty
	146, // 154: dnd5e.api.v1alpha1.ArmorData.armor_category:type_name -> dnd5e.api.v1alpha1.ArmorCategory
	147, // 155: dnd5e.api.v1alpha1.GearData.gear_category:type_name -> dnd5e.api.v1alpha1.GearCategory
	94,  // 156: dnd5e.api.v1alpha1.EquipmentSlots.main_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	94,  // 157: dnd5e.api.v1alpha1.EquipmentSlots.off_hand:type_name -> dnd5e.api.v1alpha1.InventoryItem
	94,  // 158: dnd5e.api.v1alpha1.EquipmentSlots.armor:type_name -> dnd5e.api.v1alpha1.InventoryItem
	94,  // 159: dnd5e.api.v1alpha1.EquipmentSlots.helmet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	94,  // 160: dnd5e.api.v1alpha1.EquipmentSlots.boots:type_name -> dnd5e.api.v1alpha1.InventoryItem
	94,  // 161: dnd5e.api.v1alpha1.EquipmentSlots.gloves:type_name -> dnd5e.api.v1alpha1.InventoryItem
	94,  // 162: dnd5e.api.v1alpha1.EquipmentSlots.cloak:type_name -> dnd5e.api.v1alpha1.InventoryItem
	94,  // 163: dnd5e.api.v1alpha1.EquipmentSlots.amulet:type_name -> dnd5e.api.v1alpha1.InventoryItem
	94,  // 164: dnd5e.api.v1alpha1.EquipmentSlots.ring_1:type_name -> dnd5e.api.v1alpha1.InventoryItem
	94,  // 165: dnd5e.api.v1alpha1.EquipmentSlots.ring_2:type_name -> dnd5e.api.v1alpha1.InventoryItem
	94,  // 166: dnd5e.api.v1alpha1.EquipmentSlots.belt:type_name -> dnd5e.api.v1alpha1.InventoryItem
	89,  // 167: dnd5e.api.v1alpha1.InventoryItem.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	4,   // 168: dnd5e.api.v1alpha1.EncumbranceInfo.level:type_name -> dnd5e.api.v1alpha1.EncumbranceLevel
	144, // 169: dnd5e.api.v1alpha1.SpellDamage.damage_type:type_name -> dnd5e.api.v1alpha1.DamageType
	97,  // 170: dnd5e.api.v1alpha1.SpellDamage.damage_at_slot_level:type_name -> dnd5e.api.v1alpha1.DamageAtSlotLevel
	148, // 171: dnd5e.api.v1alpha1.ListEquipmentByTypeRequest.equipment_type:type_name -> dnd5e.api.v1alpha1.EquipmentType
	89,  // 172: dnd5e.api.v1alpha1.ListEquipmentByTypeResponse.equipment:type_name -> dnd5e.api.v1alpha1.Equipment
	120, // 173: dnd5e.api.v1alpha1.ListSpellsByLevelRequest.class:type_name -> dnd5e.api.v1alpha1.Class
	61,  // 174: dnd5e.api.v1alpha1.ListSpellsByLevelResponse.spells:type_name -> dnd5e.api.v1alpha1.SpellInfo
	93,  // 175: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.equipment_slots:type_name -> dnd5e.api.v1alpha1.EquipmentSlots
	94,  // 176: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.inventory:type_name -> dnd5e.api.v1alpha1.InventoryItem
	95,  // 177: dnd5e.api.v1alpha1.GetCharacterInventoryResponse.encumbrance:type_name -> dnd5e.api.v1alpha1.EncumbranceInfo
	5,   // 178: dnd5e.api.v1alpha1.EquipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	9,   // 179: dnd5e.api.v1alpha1.EquipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	94,  // 180: dnd5e.api.v1alpha1.EquipItemResponse.previously_equipped_item:type_name -> dnd5e.api.v1alpha1.InventoryItem
	5,   // 181: dnd5e.api.v1alpha1.UnequipItemRequest.slot:type_name -> dnd5e.api.v1alpha1.EquipmentSlot
	9,   // 182: dnd5e.api.v1alpha1.UnequipItemResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	110, // 183: dnd5e.api.v1alpha1.AddToInventoryRequest.items:type_name -> dnd5e.api.v1alpha1.InventoryAddition
	9,   // 184: dnd5e.api.v1alpha1.AddToInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	9,   // 185: dnd5e.api.v1alpha1.RemoveFromInventoryResponse.character:type_name -> dnd5e.api.v1alpha1.Character
	27,  // 186: dnd5e.api.v1alpha1.CharacterService.CreateDraft:input_type -> dnd5e.api.v1alpha1.CreateDraftRequest
	29,  // 187: dnd5e.api.v1alpha1.CharacterService.GetDraft:input_type -> dnd5e.api.v1alpha1.GetDraftRequest
	45,  // 188: dnd5e.api.v1alpha1.CharacterService.ListDrafts:input_type -> dnd5e.api.v1alpha1.ListDraftsRequest
	53,  // 189: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:input_type -> dnd5e.api.v1alpha1.DeleteDraftRequest
	33,  // 190: dnd5e.api.v1alpha1.CharacterService.UpdateName:input_type -> dnd5e.api.v1alpha1.UpdateNameRequest
	34,  // 191: dnd5e.api.v1alpha1.CharacterService.UpdateRace:input_type -> dnd5e.api.v1alpha1.UpdateRaceRequest
	35,  // 192: dnd5e.api.v1alpha1.CharacterService.UpdateClass:input_type -> dnd5e.api.v1alpha1.UpdateClassRequest
	36,  // 193: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:input_type -> dnd5e.api.v1alpha1.UpdateBackgroundRequest
	37,  // 194: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:input_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresRequest
	38,  // 195: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:input_type -> dnd5e.api.v1alpha1.UpdateSkillsRequest
	47,  // 196: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:input_type -> dnd5e.api.v1alpha1.ValidateDraftRequest
	49,  // 197: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:input_type -> dnd5e.api.v1alpha1.GetDraftPreviewRequest
	51,  // 198: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:input_type -> dnd5e.api.v1alpha1.FinalizeDraftRequest
	15,  // 199: dnd5e.api.v1alpha1.CharacterService.GetCharacter:input_type -> dnd5e.api.v1alpha1.GetCharacterRequest
	17,  // 200: dnd5e.api.v1alpha1.CharacterService.ListCharacters:input_type -> dnd5e.api.v1alpha1.ListCharactersRequest
	21,  // 201: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:input_type -> dnd5e.api.v1alpha1.DeleteCharacterRequest
	65,  // 202: dnd5e.api.v1alpha1.CharacterService.ListRaces:input_type -> dnd5e.api.v1alpha1.ListRacesRequest
	67,  // 203: dnd5e.api.v1alpha1.CharacterService.ListClasses:input_type -> dnd5e.api.v1alpha1.ListClassesRequest
	69,  // 204: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:input_type -> dnd5e.api.v1alpha1.ListBackgroundsRequest
	71,  // 205: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:input_type -> dnd5e.api.v1alpha1.GetRaceDetailsRequest
	73,  // 206: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:input_type -> dnd5e.api.v1alpha1.GetClassDetailsRequest
	75,  // 207: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:input_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsRequest
	77,  // 208: dnd5e.api.v1alpha1.CharacterService.GetFeature:input_type -> dnd5e.api.v1alpha1.GetFeatureRequest
	79,  // 209: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:input_type -> dnd5e.api.v1alpha1.RollAbilityScoresRequest
	82,  // 210: dnd5e.api.v1alpha1.CharacterService.GetRequirements:input_type -> dnd5e.api.v1alpha1.GetRequirementsRequest
	84,  // 211: dnd5e.api.v1alpha1.CharacterService.SubmitChoices:input_type -> dnd5e.api.v1alpha1.SubmitChoicesRequest
	99,  // 212: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:input_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeRequest
	101, // 213: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:input_type -> dnd5e.api.v1alpha1.ListSpellsByLevelRequest
	103, // 214: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:input_type -> dnd5e.api.v1alpha1.GetCharacterInventoryRequest
	105, // 215: dnd5e.api.v1alpha1.CharacterService.EquipItem:input_type -> dnd5e.api.v1alpha1.EquipItemRequest
	107, // 216: dnd5e.api.v1alpha1.CharacterService.UnequipItem:input_type -> dnd5e.api.v1alpha1.UnequipItemRequest
	109, // 217: dnd5e.api.v1alpha1.CharacterService.AddToInventory:input_type -> dnd5e.api.v1alpha1.AddToInventoryRequest
	112, // 218: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:input_type -> dnd5e.api.v1alpha1.RemoveFromInventoryRequest
	28,  // 219: dnd5e.api.v1alpha1.CharacterService.CreateDraft:output_type -> dnd5e.api.v1alpha1.CreateDraftResponse
	30,  // 220: dnd5e.api.v1alpha1.CharacterService.GetDraft:output_type -> dnd5e.api.v1alpha1.GetDraftResponse
	46,  // 221: dnd5e.api.v1alpha1.CharacterService.ListDrafts:output_type -> dnd5e.api.v1alpha1.ListDraftsResponse
	54,  // 222: dnd5e.api.v1alpha1.CharacterService.DeleteDraft:output_type -> dnd5e.api.v1alpha1.DeleteDraftResponse
	39,  // 223: dnd5e.api.v1alpha1.CharacterService.UpdateName:output_type -> dnd5e.api.v1alpha1.UpdateNameResponse
	40,  // 224: dnd5e.api.v1alpha1.CharacterService.UpdateRace:output_type -> dnd5e.api.v1alpha1.UpdateRaceResponse
	41,  // 225: dnd5e.api.v1alpha1.CharacterService.UpdateClass:output_type -> dnd5e.api.v1alpha1.UpdateClassResponse
	42,  // 226: dnd5e.api.v1alpha1.CharacterService.UpdateBackground:output_type -> dnd5e.api.v1alpha1.UpdateBackgroundResponse
	43,  // 227: dnd5e.api.v1alpha1.CharacterService.UpdateAbilityScores:output_type -> dnd5e.api.v1alpha1.UpdateAbilityScoresResponse
	44,  // 228: dnd5e.api.v1alpha1.CharacterService.UpdateSkills:output_type -> dnd5e.api.v1alpha1.UpdateSkillsResponse
	48,  // 229: dnd5e.api.v1alpha1.CharacterService.ValidateDraft:output_type -> dnd5e.api.v1alpha1.ValidateDraftResponse
	50,  // 230: dnd5e.api.v1alpha1.CharacterService.GetDraftPreview:output_type -> dnd5e.api.v1alpha1.GetDraftPreviewResponse
	52,  // 231: dnd5e.api.v1alpha1.CharacterService.FinalizeDraft:output_type -> dnd5e.api.v1alpha1.FinalizeDraftResponse
	16,  // 232: dnd5e.api.v1alpha1.CharacterService.GetCharacter:output_type -> dnd5e.api.v1alpha1.GetCharacterResponse
	18,  // 233: dnd5e.api.v1alpha1.CharacterService.ListCharacters:output_type -> dnd5e.api.v1alpha1.ListCharactersResponse
	22,  // 234: dnd5e.api.v1alpha1.CharacterService.DeleteCharacter:output_type -> dnd5e.api.v1alpha1.DeleteCharacterResponse
	66,  // 235: dnd5e.api.v1alpha1.CharacterService.ListRaces:output_type -> dnd5e.api.v1alpha1.ListRacesResponse
	68,  // 236: dnd5e.api.v1alpha1.CharacterService.ListClasses:output_type -> dnd5e.api.v1alpha1.ListClassesResponse
	70,  // 237: dnd5e.api.v1alpha1.CharacterService.ListBackgrounds:output_type -> dnd5e.api.v1alpha1.ListBackgroundsResponse
	72,  // 238: dnd5e.api.v1alpha1.CharacterService.GetRaceDetails:output_type -> dnd5e.api.v1alpha1.GetRaceDetailsResponse
	74,  // 239: dnd5e.api.v1alpha1.CharacterService.GetClassDetails:output_type -> dnd5e.api.v1alpha1.GetClassDetailsResponse
	76,  // 240: dnd5e.api.v1alpha1.CharacterService.GetBackgroundDetails:output_type -> dnd5e.api.v1alpha1.GetBackgroundDetailsResponse
	78,  // 241: dnd5e.api.v1alpha1.CharacterService.GetFeature:output_type -> dnd5e.api.v1alpha1.GetFeatureResponse
	81,  // 242: dnd5e.api.v1alpha1.CharacterService.RollAbilityScores:output_type -> dnd5e.api.v1alpha1.RollAbilityScoresResponse
	83,  // 243: dnd5e.api.v1alpha1.CharacterService.GetRequirements:output_type -> dnd5e.api.v1alpha1.GetRequirementsResponse
	85,  // 244: dnd5e.api.v1alpha1.CharacterService.SubmitChoices:output_type -> dnd5e.api.v1alpha1.SubmitChoicesResponse
	100, // 245: dnd5e.api.v1alpha1.CharacterService.ListEquipmentByType:output_type -> dnd5e.api.v1alpha1.ListEquipmentByTypeResponse
	102, // 246: dnd5e.api.v1alpha1.CharacterService.ListSpellsByLevel:output_type -> dnd5e.api.v1alpha1.ListSpellsByLevelResponse
	104, // 247: dnd5e.api.v1alpha1.CharacterService.GetCharacterInventory:output_type -> dnd5e.api.v1alpha1.GetCharacterInventoryResponse
	106, // 248: dnd5e.api.v1alpha1.CharacterService.EquipItem:output_type -> dnd5e.api.v1alpha1.EquipItemResponse
	108, // 249: dnd5e.api.v1alpha1.CharacterService.UnequipItem:output_type -> dnd5e.api.v1alpha1.UnequipItemResponse
	111, // 250: dnd5e.api.v1alpha1.CharacterService.AddToInventory:output_type -> dnd5e.api.v1alpha1.AddToInventoryResponse
	113, // 251: dnd5e.api.v1alpha1.CharacterService.RemoveFromInventory:output_type -> dnd5e.api.v1alpha1.RemoveFromInventoryResponse
	219, // [219:252] is the sub-list for method output_type
	186, // [186:219] is the sub-list for method input_type
...
func file_dnd5e_api_v1alpha1_character_proto_init() {
	...
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[83].OneofWrappers = []any{
		(*Equipment_WeaponData)(nil),
		(*Equipment_ArmorData)(nil),
		(*Equipment_GearData)(nil),
	}
	file_dnd5e_api_v1alpha1_character_proto_msgTypes[106].OneofWrappers = []any{
