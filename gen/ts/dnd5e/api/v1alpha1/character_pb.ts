...
export const CharacterService: GenService<{
   ...
   * no RPC here or anywhere else writes it: the first in-toolkit source of
   * experience brings its own mutator with it, and a host never grants a game
   * quantity. A levelled fixture is seeded on the persisted sheet, never called
   * into existence through this service.
   *
